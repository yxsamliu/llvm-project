...
program mb
   ...
   contains
   ! CHECK-LABEL: func.func private @_QFPimplicitly_captured(
   ...
   ! CHECK-LABEL: func.func private @_QFPtarget_function(
   ! CHECK-SAME: {{.*}}attributes {{{.*}}omp.declare_target = #omp.declaretarget<device_type = (any), capture_clause = (to), automap = false>{{.*}}}
   ...
   ! CHECK-LABEL: func.func private @_QFPimplicitly_captured_twice()
   ! CHECK-SAME: {{.*}}attributes {{{.*}}omp.declare_target = #omp.declaretarget<device_type = (any), capture_clause = (to), automap = false>{{.*}}}
   ...
   ! CHECK-LABEL: func.func private @_QFPtarget_function_twice_host()
   ...
   ! DEVICE-LABEL: func.func @_QFPtarget_function_twice_device()
   ...
   ! DEVICE-LABEL: func.func @_QFPimplicitly_captured_nest()
   ! DEVICE-SAME: {{.*}}attributes {{{.*}}omp.declare_target = #omp.declaretarget<device_type = (nohost), capture_clause = (to), automap = false>{{.*}}}
   ...
   ! DEVICE-LABEL: func.func @_QFPimplicitly_captured_one()
   ...
   ! DEVICE-LABEL: func.func @_QFPimplicitly_captured_two()
   ! DEVICE-SAME: {{.*}}attributes {{{.*}}omp.declare_target = #omp.declaretarget<device_type = (nohost), capture_clause = (to), automap = false>{{.*}}}
   ...
   ! DEVICE-LABEL: func.func @_QFPtarget_function_test()
   ! DEVICE-SAME: {{.*}}attributes {{{.*}}omp.declare_target = #omp.declaretarget<device_type = (nohost), capture_clause = (to), automap = false>{{.*}}}
   ...
   ! CHECK-LABEL: func.func private @_QFPimplicitly_captured_two_twice()
   ! CHECK-SAME: {{.*}}attributes {{{.*}}omp.declare_target = #omp.declaretarget<device_type = (any), capture_clause = (to), automap = false>{{.*}}}
   ...
   ! DEVICE-LABEL: func.func @_QFPtarget_function_test_device()
   ! DEVICE-SAME: {{.*}}attributes {{{.*}}omp.declare_target = #omp.declaretarget<device_type = (nohost), capture_clause = (to), automap = false>{{.*}}}
   ...
   ! CHECK-LABEL: func.func private @_QFPtarget_function_test_host()
   ! CHECK-SAME: {{.*}}attributes {{{.*}}omp.declare_target = #omp.declaretarget<device_type = (host), capture_clause = (to), automap = false>{{.*}}}
...
! DEVICE-NOT: func.func @_QPimplicitly_captured_with_dev_type_recursive()
