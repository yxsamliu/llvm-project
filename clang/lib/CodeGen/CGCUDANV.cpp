...
void CGNVCUDARuntime::emitDeviceStubBodyNew(CodeGenFunction &CGF,
  ...
  // HIP kernel launching API name depends on --default-stream option. For
  ...
  if (CGF.getLangOpts().HIP && CGF.getLangOpts().DefaultStream ==
                                   LangOptions::DefaultStreamKind::PerThread)
