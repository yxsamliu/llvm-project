...
// Clang version.
template <typename T>
__host__ __device__ S(T) -> S<T>; // expected-warning {{cuda/hip target attributes on deduction guides are deprecated; they will be rejected in a future version of Clang}}
