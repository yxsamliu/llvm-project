// RUN: %clang_cc1 -std=c++14 -fsyntax-only -verify=host,com %s
// RUN: %clang_cc1 -std=c++14 -fsyntax-only -fcuda-is-device -verify=dev,com %s
// RUN: %clang_cc1 -std=c++14 -fsyntax-only -fgpu-rdc -verify=host,com %s
// RUN: %clang_cc1 -std=c++14 -fsyntax-only -fgpu-rdc -fcuda-is-device -verify=dev,com %s
