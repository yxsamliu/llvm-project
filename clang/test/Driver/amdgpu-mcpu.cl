...
// RUN: %clang -### -target amdgcn -mcpu=gfx1260 %s 2>&1 | FileCheck --check-prefix=GFX1260 %s
...
// RUN: %clang -### -target amdgcn -mcpu=gfx131F %s 2>&1 | FileCheck --check-prefix=GFX131F %s
