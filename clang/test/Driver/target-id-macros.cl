...
// ID1-DAG: #define __amdgcn_sramecc__ 0
// ID1-DAG: #define __amdgcn_target_id__ "gfx908:xnack+:sramecc-"

// ID2-DAG: #define __amdgcn_target_id__ "gfx908"
// ID2-NOT: #define __amdgcn_xnack__
// ID2-NOT: #define __amdgcn_sramecc__

// NONE-NOT: #define __amdgcn_processor__
// NONE-NOT: #define __amdgcn_xnack__
// NONE-NOT: #define __amdgcn_sramecc__
