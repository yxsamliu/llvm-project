...
// CHECK-GFX1260-LABEL: @test_amdgcn_s_sema_set_state(
// CHECK-GFX1260-NEXT:  entry:
// CHECK-GFX1260-NEXT:    [[TMP0:%.*]] = addrspacecast ptr addrspace(5) [[SEM:%.*]] to ptr addrspace(3)
// CHECK-GFX1260-NEXT:    tail call void @llvm.amdgcn.s.sema.set.state(ptr addrspace(3) [[TMP0]], i32 1)
// CHECK-GFX1260-NEXT:    tail call void @llvm.amdgcn.s.sema.set.state(ptr addrspace(3) [[TMP0]], i32 [[ARG:%.*]])
...
// CHECK-GFX1260-LABEL: @test_amdgcn_s_sema_set_limit(
// CHECK-GFX1260-NEXT:  entry:
// CHECK-GFX1260-NEXT:    [[TMP0:%.*]] = addrspacecast ptr addrspace(5) [[SEM:%.*]] to ptr addrspace(3)
// CHECK-GFX1260-NEXT:    tail call void @llvm.amdgcn.s.sema.set.limit(ptr addrspace(3) [[TMP0]], i32 1)
// CHECK-GFX1260-NEXT:    ret void
//
...
// CHECK-GFX1260-NEXT:  entry:
// CHECK-GFX1260-NEXT:    [[TMP0:%.*]] = addrspacecast ptr addrspace(5) [[SEM:%.*]] to ptr addrspace(3)
// CHECK-GFX1260-NEXT:    tail call void @llvm.amdgcn.s.sema.wait(ptr addrspace(3) [[TMP0]])
// CHECK-GFX1260-NEXT:    ret void
//
