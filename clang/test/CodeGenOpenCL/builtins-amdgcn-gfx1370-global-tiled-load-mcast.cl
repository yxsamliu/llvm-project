...
// RUN: %clang_cc1 -triple amdgcn-unknown-unknown -target-cpu gfx1370 -target-feature +wavefrontsize32 -target-feature +global-tiled-load-mcast -emit-llvm -o - %s | FileCheck %s --check-prefix=CHECK-GFX1370
