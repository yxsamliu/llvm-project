...
// CHECK-LABEL: @hip.used.external = appending {{.*}}global
// CHECK-DAG: @_Z7kernel1v
// CHECK-DAG: @_Z7kernel4v
// CHECK-DAG: @var1
// CHECK-LABEL: @llvm.compiler.used = {{.*}} @hip.used.external

// NEG-NOT: @hip.used.external = {{.*}} @_Z7kernel2v
// NEG-NOT: @hip.used.external = {{.*}} @_Z7kernel3v
// NEG-NOT: @hip.used.external = {{.*}} @var2
// NEG-NOT: @hip.used.external = {{.*}} @var3
// NORDC-NOT: @hip.used.external = {{.*}} @_Z7kernel1v
// NORDC-NOT: @hip.used.external = {{.*}} @_Z7kernel4v
// NORDC-NOT: @hip.used.external = {{.*}} @var1
