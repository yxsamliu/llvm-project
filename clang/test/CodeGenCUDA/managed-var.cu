...
// RUN: %clang_cc1 -triple amdgcn-amd-amdhsa -fcuda-is-device -std=c++11 \
// RUN:   -emit-llvm -fgpu-rdc -cuid=abc -o - -x hip %s | FileCheck \
// RUN:   -check-prefixes=COMMON,DEV,RDC-D %s
...
// NORDC-DAG: @x.init = internal global i32 1
// RDC-DAG: @x.init = dso_local global i32 1
...
// HOST-DAG: @ex.init = external global i32
...
// RDC-DAG: @[[DEVNAMESX:[0-9]+]] = {{.*}}c"_ZL2sx.static.[[HASH:b04fd23c98500190]]\00"
