...
clang++ -mllvm -debug-only=pgo-instrumentation -Wno-unused-value -O2 -fprofile-generate=my.profraw --offload-arch=native -save-temps -x hip tmp_rovodev_hip_pgo_comprehensive_test.hip -o tmp_rovodev_hip_pgo_test_direct
...
clang++ -mllvm -debug-only=pgo-instrumentation -Wno-unused-value -O2 -fprofile-use=my.profdata --offload-arch=native -save-temps -x hip tmp_rovodev_hip_pgo_comprehensive_test.hip -o tmp_rovodev_hip_pgo_test_direct
