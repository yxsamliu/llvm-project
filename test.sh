...
assert/bin/clang++ -Wno-unused-value -O2 --hip-path=/home/yaxunl/git/clr/Debug/install -fprofile-instr-generate=my.profraw --offload-arch=gfx1100 -save-temps -x hip tmp_rovodev_hip_pgo_comprehensive_test.hip -o tmp_rovodev_hip_pgo_test_direct
