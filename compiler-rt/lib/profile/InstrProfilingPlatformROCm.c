...
static void EnsureHipLoaded(void) {
  ...
  void *Handle = __interception_open_library(HipLibName);
  if (!Handle)
    return;

  pHipGetSymbolAddress =
      (hipGetSymbolAddressTy)__interception_lookup_symbol(
          Handle, "hipGetSymbolAddress");
  pHipMemcpy =
      (hipMemcpyTy)__interception_lookup_symbol(Handle, "hipMemcpy");
  pHipModuleGetGlobal =
      (hipModuleGetGlobalTy)__interception_lookup_symbol(Handle,
                                                         "hipModuleGetGlobal");
  pHipGetDeviceCount =
      (hipGetDeviceCountTy)__interception_lookup_symbol(Handle,
                                                        "hipGetDeviceCount");
  pHipGetDevice =
      (hipGetDeviceTy)__interception_lookup_symbol(Handle, "hipGetDevice");
  pHipSetDevice =
      (hipSetDeviceTy)__interception_lookup_symbol(Handle, "hipSetDevice");
  pHipGetDeviceProperties =
      (hipGetDevicePropertiesTy)__interception_lookup_symbol(
