...
static void EnsureHipLoaded(void) {
  ...
  pHipGetSymbolAddress =
      (hipGetSymbolAddressTy)__interception::LookupSymbol(
          Handle, "hipGetSymbolAddress");
  pHipMemcpy =
      (hipMemcpyTy)__interception::LookupSymbol(Handle, "hipMemcpy");
  pHipModuleGetGlobal =
      (hipModuleGetGlobalTy)__interception::LookupSymbol(Handle,
                                                         "hipModuleGetGlobal");
  pHipGetDeviceCount =
      (hipGetDeviceCountTy)__interception::LookupSymbol(Handle,
                                                        "hipGetDeviceCount");
  pHipGetDevice =
...
extern "C" void __llvm_profile_offload_register_section_shadow_variable(void *ptr) {
