...
private:
  ...
  // To track the vector registers reserved for WWM instructions. They get
  // stack slots later during PrologEpilogInserter and get added into the
  // superset WWMSpills for actual spilling. A separate set makes the register
  // reserved part and the serialization easier.
