...
static cl::opt<bool>
    PartialSpillCleanup("amdgpu-experimental-partial-spill-cleanup",
...
// A reload establishes the value of each stored word even when the store
// that produced it is outside this block. Follow copies of just this word;
// neither stack liveness nor the other words' values prove it unchanged.
...
bool SILowerSGPRSpills::run(MachineFunction &MF) {
  ...
  bool MadeChange = PartialSpillCleanup && removeRedundantPartialSpills(MF);
