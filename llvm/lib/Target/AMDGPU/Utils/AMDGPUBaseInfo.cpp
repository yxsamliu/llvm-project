...
TargetIDSetting AMDGPUTargetID::getXnackSetting() const {
  return XnackSetting;
}

TargetIDSetting AMDGPUTargetID::getSramEccSetting() const {
  return SramEccSetting;
}

bool AMDGPUTargetID::isXnackOnOrAny() const {
  return XnackSetting == TargetIDSetting::On ||
         XnackSetting == TargetIDSetting::Any;
}

bool AMDGPUTargetID::isSramEccOnOrAny() const {
  return SramEccSetting == TargetIDSetting::On ||
         SramEccSetting == TargetIDSetting::Any;
}

bool AMDGPUTargetID::isXnackSupported() const {
  return XnackSetting != TargetIDSetting::Unsupported;
}
bool AMDGPUTargetID::isSramEccSupported() const {
