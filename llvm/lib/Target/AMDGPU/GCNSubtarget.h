...
#define GCN_SUBTARGET_HAS_FEATURE(X)                                           \
  ...
  X(VGPRIndexMode)                                                             \
  X(VGPRIndexingRegisters)                                                     \
  X(VGPRSingleUseHintInsts)                                                    \
  X(VmemPrefInsts)                                                             \
  X(VMemToLDSLoad)                                                             \
...
protected:
  ...
  bool HasGFX1251GEMMInsts = false;
...
#undef GCN_SUBTARGET_HAS_FEATURE_MEMBER_ONLY
  ...
  bool supportsWGP() const {
    if (HasGFX1250Insts && !HasGFX13Insts)
      return false;
  ...
  bool hasExportInsts() const {
    return HasGFX13Insts || (!hasGFX940Insts() && !hasGFX1250Insts());
  }

  bool hasVINTERPEncoding() const { return HasGFX13Insts || !hasGFX1250Insts(); }
  ...
  bool hasGFX1251GEMMInsts() const { return HasGFX1251GEMMInsts; }
  ...
  bool hasMovB64() const { return HasGFX940Insts || (HasGFX1250Insts && !HasGFX13Insts); }
  ...
  bool hasGFX13Insts() const { return HasGFX13Insts; }

  bool hasINVWBL2WaitCntRequirement() const { return HasGFX1250Insts && !HasGFX13Insts; }

  bool hasVOPD3() const { return HasGFX1250Insts; }

  // \returns true if the target has V_MUL_U64/V_MUL_I64 instructions.
  bool hasVectorMulU64() const { return HasGFX1250Insts && !HasGFX13Insts; }

  // \returns true if the target has V_MAD_NC_U64_U32/V_MAD_NC_I64_I32
  // instructions.
  bool hasMadU64U32NoCarry() const { return HasGFX1250Insts && !HasGFX13Insts; }

  // \returns true if the target has V_{MIN|MAX}_{I|U}64 instructions.
  bool hasIntMinMax64() const { return HasGFX1250Insts && !HasGFX13Insts; }

  // \returns true if the target has V_PK_{MIN|MAX}3_{I|U}16 instructions.
  bool hasPkMinMax3Insts() const { return HasGFX1250Insts && !HasGFX13Insts; }
  ...
  bool requiresWaitXCntBeforeAtomicStores() const { return HasGFX1250Insts && !HasGFX13Insts; }
  ...
  bool requiresWaitXCntForSingleAccessInstructions() const {
    return HasGFX1250Insts && !HasGFX13Insts;;
  }
