...
#define BCaseMask(X, M) IO.maskedBitSetCase(Value, #X, ELF::X, ELF::M)
  ...
  case ELF::EM_AMDGPU:
    ...
    BCaseMask(EF_AMDGPU_MACH_AMDGCN_GFX115E, EF_AMDGPU_MACH);
    ...
    BCaseMask(EF_AMDGPU_MACH_AMDGCN_GFX1260, EF_AMDGPU_MACH);
    BCaseMask(EF_AMDGPU_MACH_AMDGCN_GFX130E, EF_AMDGPU_MACH);
    BCaseMask(EF_AMDGPU_MACH_AMDGCN_GFX1310, EF_AMDGPU_MACH);
    BCaseMask(EF_AMDGPU_MACH_AMDGCN_GFX131F, EF_AMDGPU_MACH);
    BCaseMask(EF_AMDGPU_MACH_AMDGCN_GFX1360, EF_AMDGPU_MACH);
    BCaseMask(EF_AMDGPU_MACH_AMDGCN_GFX1370, EF_AMDGPU_MACH);
