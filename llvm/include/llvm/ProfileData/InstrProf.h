...
struct InstrProfRecord {
  ...
  InstrProfRecord(std::vector<uint64_t> Counts, uint16_t NumOffloadProfilingThreads)
   : Counts(std::move(Counts)), NumOffloadProfilingThreads(NumOffloadProfilingThreads) {}
...
struct NamedInstrProfRecord : InstrProfRecord {
  ...
  NamedInstrProfRecord(StringRef Name, uint64_t Hash,
                       std::vector<uint64_t> Counts, uint16_t NumOffloadProfilingThreads)
      : InstrProfRecord(std::move(Counts), NumOffloadProfilingThreads), Name(Name), Hash(Hash) {}
  NamedInstrProfRecord(StringRef Name, uint64_t Hash,
                       std::vector<uint64_t> Counts,
                       std::vector<uint8_t> BitmapBytes)
