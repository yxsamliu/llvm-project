...
// [GFX6-GFX12].
#define COMPUTE_PGM_RSRC1_GFX6_GFX12(NAME, SHIFT, WIDTH)                       \
  AMDHSA_BITS_ENUM_ENTRY(COMPUTE_PGM_RSRC1_GFX6_GFX12_##NAME, SHIFT, WIDTH)
// [GFX6-GFX120].
...
// GFX13+.
#define COMPUTE_PGM_RSRC1_GFX13_PLUS(NAME, SHIFT, WIDTH)                       \
  AMDHSA_BITS_ENUM_ENTRY(COMPUTE_PGM_RSRC1_GFX13_PLUS_##NAME, SHIFT, WIDTH)
enum : int32_t {
  COMPUTE_PGM_RSRC1_GFX6_GFX12(GRANULATED_WORKITEM_VGPR_COUNT, 0, 6),
  COMPUTE_PGM_RSRC1_GFX6_GFX12(GRANULATED_WAVEFRONT_SGPR_COUNT, 6, 4),
  COMPUTE_PGM_RSRC1_GFX13_PLUS(GRANULATED_WORKITEM_VGPR_COUNT, 0, 7),
...
enum : int32_t {
  ...
  KERNEL_CODE_PROPERTY(ENABLE_SPATIAL_CLUSTER, 13, 1), // GFX13+
  KERNEL_CODE_PROPERTY(RESERVED1, 14, 1),
  KERNEL_CODE_PROPERTY(ENABLE_ASYMMETRIC_CLUSTER_CLAMP, 15, 1), // GFX13+
};
