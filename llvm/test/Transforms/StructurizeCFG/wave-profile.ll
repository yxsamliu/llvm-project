...
; surviving blocks. The synthesized flow block remains unprofiled rather than
; receiving an invented identity or measurement.
...
; CHECK: [[PROFILE]] = !{i64 2, i64 2685589004101179296, i64 11, i64 10, i64 7, i64 3, i64 10}
; CHECK: [[ENTRY_MD]] = !{i64 2, i64 2685589004101179296, i64 1, i64 1, i64 2, i64 3}
; CHECK: [[LEFT_MD]] = !{i64 2, i64 2685589004101179296, i64 2, i64 1, i64 4}
; CHECK: [[RIGHT_MD]] = !{i64 2, i64 2685589004101179296, i64 3, i64 1, i64 4}
