...
; The measured header count is the sum of the entry and body counts. Rotation
; can therefore fold the old header into the body without inventing a count.
...
;
; CHECK: [[PROFILE]] = !{i64 2, i64 2480672276464841217, i64 6, i64 6, i64 24}
; CHECK: [[ENTRY]] = !{i64 2, i64 2480672276464841217, i64 0, i64 1, i64 2}
; CHECK: [[EXIT]] = !{i64 2, i64 2480672276464841217, i64 1, i64 1}
; CHECK: [[BODY]] = !{i64 2, i64 2480672276464841217, i64 2, i64 1, i64 2, i64 1}
entry:
