...
; CHECK-NEXT:    [[TMP0:%.*]] = fsub reassoc nsz float 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[A:%.*]] = fmul reassoc nsz float [[Y:%.*]], [[X:%.*]]
; CHECK-NEXT:    [[B:%.*]] = fmul reassoc nsz float [[A]], 1.000000e+00
...
; CHECK-NEXT:    [[TMP0:%.*]] = fsub reassoc nsz float 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[A:%.*]] = fmul reassoc nsz float [[X2:%.*]], [[X1:%.*]]
; CHECK-NEXT:    [[B:%.*]] = fmul reassoc nsz float [[A]], 1.000000e+00
