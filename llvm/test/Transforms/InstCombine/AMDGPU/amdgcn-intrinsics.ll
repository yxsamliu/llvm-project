...
; RUN: opt -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1010 -passes=instcombine -S < %s | FileCheck %s -check-prefixes=CHECK,GFX10
; RUN: opt -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1300 -passes=instcombine -S < %s | FileCheck %s -check-prefixes=CHECK,GFX13
...
; GFX10-LABEL: @image_sample_a16_c_d_o_2darray_const_noopt(
; GFX10-NEXT:    [[S32:%.*]] = fpext half [[S:%.*]] to float
; GFX10-NEXT:    [[SLICE32:%.*]] = fpext half [[SLICE:%.*]] to float
; GFX10-NEXT:    [[RES:%.*]] = call <2 x float> @llvm.amdgcn.image.sample.c.d.o.2darray.v2f32.f16.f32.v8i32.v4i32(i32 6, i32 [[OFFSET:%.*]], float [[ZCOMPARE:%.*]], half [[DSDH:%.*]], half [[DTDH:%.*]], half [[DSDV:%.*]], half [[DTDV:%.*]], float [[S32]], float 1.000000e+10, float [[SLICE32]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <2 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 8
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_a16_c_d_o_2darray_const_noopt(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DTDH32:%.*]] = fpext half [[DTDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[DTDV32:%.*]] = fpext half [[DTDV:%.*]] to float
; GFX13-NEXT:    [[S32:%.*]] = fpext half [[S:%.*]] to float
; GFX13-NEXT:    [[SLICE32:%.*]] = fpext half [[SLICE:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <2 x float> @llvm.amdgcn.image.sample.c.d.o.2darray.v2f32.f32.f32.v8i32.v4i32(i32 6, i32 [[OFFSET:%.*]], float [[ZCOMPARE:%.*]], float [[DSDH32]], float [[DTDH32]], float [[DSDV32]], float [[DTDV32]], float [[S32]], float 1.000000e+10, float [[SLICE32]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <2 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 8
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
  %dtdh32 = fpext half %dtdh to float
...
; GFX10-LABEL: @image_sample_g16_d_1d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.d.1d.v4f32.f16.f32.v8i32.v4i32(i32 15, half [[DSDH:%.*]], half [[DSDV:%.*]], float [[S:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_d_1d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.d.1d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[DSDH32]], float [[DSDV32]], float [[S:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
  %dsdv32 = fpext half %dsdv to float
...
; GFX10-LABEL: @image_sample_g16_d_2d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.d.2d.v4f32.f16.f32.v8i32.v4i32(i32 15, half [[DSDH:%.*]], half [[DTDH:%.*]], half [[DSDV:%.*]], half [[DTDV:%.*]], float [[S:%.*]], float [[T:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_d_2d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DTDH32:%.*]] = fpext half [[DTDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[DTDV32:%.*]] = fpext half [[DTDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.d.2d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[DSDH32]], float [[DTDH32]], float [[DSDV32]], float [[DTDV32]], float [[S:%.*]], float [[T:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_d_3d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.d.3d.v4f32.f16.f32.v8i32.v4i32(i32 15, half [[DSDH:%.*]], half [[DTDH:%.*]], half [[DRDH:%.*]], half [[DSDV:%.*]], half [[DTDV:%.*]], half [[DRDV:%.*]], float [[S:%.*]], float [[T:%.*]], float [[R:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_d_3d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DTDH32:%.*]] = fpext half [[DTDH:%.*]] to float
; GFX13-NEXT:    [[DRDH32:%.*]] = fpext half [[DRDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[DTDV32:%.*]] = fpext half [[DTDV:%.*]] to float
; GFX13-NEXT:    [[DRDV32:%.*]] = fpext half [[DRDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.d.3d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[DSDH32]], float [[DTDH32]], float [[DRDH32]], float [[DSDV32]], float [[DTDV32]], float [[DRDV32]], float [[S:%.*]], float [[T:%.*]], float [[R:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_c_d_1d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.d.1d.v4f32.f16.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], half [[DSDH:%.*]], half [[DSDV:%.*]], float [[S:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_c_d_1d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.d.1d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], float [[DSDH32]], float [[DSDV32]], float [[S:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_c_d_2d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.d.2d.v4f32.f16.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], half [[DSDH:%.*]], half [[DTDH:%.*]], half [[DSDV:%.*]], half [[DTDV:%.*]], float [[S:%.*]], float [[T:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_c_d_2d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DTDH32:%.*]] = fpext half [[DTDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[DTDV32:%.*]] = fpext half [[DTDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.d.2d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], float [[DSDH32]], float [[DTDH32]], float [[DSDV32]], float [[DTDV32]], float [[S:%.*]], float [[T:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_d_cl_1d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.d.cl.1d.v4f32.f16.f32.v8i32.v4i32(i32 15, half [[DSDH:%.*]], half [[DSDV:%.*]], float [[S:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_d_cl_1d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.d.cl.1d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[DSDH32]], float [[DSDV32]], float [[S:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_d_cl_2d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.d.cl.2d.v4f32.f16.f32.v8i32.v4i32(i32 15, half [[DSDH:%.*]], half [[DTDH:%.*]], half [[DSDV:%.*]], half [[DTDV:%.*]], float [[S:%.*]], float [[T:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_d_cl_2d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DTDH32:%.*]] = fpext half [[DTDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[DTDV32:%.*]] = fpext half [[DTDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.d.cl.2d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[DSDH32]], float [[DTDH32]], float [[DSDV32]], float [[DTDV32]], float [[S:%.*]], float [[T:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_c_d_cl_1d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.d.cl.1d.v4f32.f16.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], half [[DSDH:%.*]], half [[DSDV:%.*]], float [[S:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_c_d_cl_1d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.d.cl.1d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], float [[DSDH32]], float [[DSDV32]], float [[S:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_c_d_cl_2d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.d.cl.2d.v4f32.f16.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], half [[DSDH:%.*]], half [[DTDH:%.*]], half [[DSDV:%.*]], half [[DTDV:%.*]], float [[S:%.*]], float [[T:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_c_d_cl_2d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DTDH32:%.*]] = fpext half [[DTDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[DTDV32:%.*]] = fpext half [[DTDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.d.cl.2d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], float [[DSDH32]], float [[DTDH32]], float [[DSDV32]], float [[DTDV32]], float [[S:%.*]], float [[T:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_cd_1d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.cd.1d.v4f32.f16.f32.v8i32.v4i32(i32 15, half [[DSDH:%.*]], half [[DSDV:%.*]], float [[S:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_cd_1d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.cd.1d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[DSDH32]], float [[DSDV32]], float [[S:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_cd_2d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.cd.2d.v4f32.f16.f32.v8i32.v4i32(i32 15, half [[DSDH:%.*]], half [[DTDH:%.*]], half [[DSDV:%.*]], half [[DTDV:%.*]], float [[S:%.*]], float [[T:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_cd_2d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DTDH32:%.*]] = fpext half [[DTDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[DTDV32:%.*]] = fpext half [[DTDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.cd.2d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[DSDH32]], float [[DTDH32]], float [[DSDV32]], float [[DTDV32]], float [[S:%.*]], float [[T:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_c_cd_1d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.cd.1d.v4f32.f16.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], half [[DSDH:%.*]], half [[DSDV:%.*]], float [[S:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_c_cd_1d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.cd.1d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], float [[DSDH32]], float [[DSDV32]], float [[S:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_c_cd_2d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.cd.2d.v4f32.f16.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], half [[DSDH:%.*]], half [[DTDH:%.*]], half [[DSDV:%.*]], half [[DTDV:%.*]], float [[S:%.*]], float [[T:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_c_cd_2d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DTDH32:%.*]] = fpext half [[DTDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[DTDV32:%.*]] = fpext half [[DTDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.cd.2d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], float [[DSDH32]], float [[DTDH32]], float [[DSDV32]], float [[DTDV32]], float [[S:%.*]], float [[T:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_cd_cl_1d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.cd.cl.1d.v4f32.f16.f32.v8i32.v4i32(i32 15, half [[DSDH:%.*]], half [[DSDV:%.*]], float [[S:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_cd_cl_1d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.cd.cl.1d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[DSDH32]], float [[DSDV32]], float [[S:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_cd_cl_2d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.cd.cl.2d.v4f32.f16.f32.v8i32.v4i32(i32 15, half [[DSDH:%.*]], half [[DTDH:%.*]], half [[DSDV:%.*]], half [[DTDV:%.*]], float [[S:%.*]], float [[T:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_cd_cl_2d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DTDH32:%.*]] = fpext half [[DTDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[DTDV32:%.*]] = fpext half [[DTDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.cd.cl.2d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[DSDH32]], float [[DTDH32]], float [[DSDV32]], float [[DTDV32]], float [[S:%.*]], float [[T:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_c_cd_cl_1d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.cd.cl.1d.v4f32.f16.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], half [[DSDH:%.*]], half [[DSDV:%.*]], float [[S:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_c_cd_cl_1d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.cd.cl.1d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], float [[DSDH32]], float [[DSDV32]], float [[S:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_c_cd_cl_2d(
; GFX10-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.cd.cl.2d.v4f32.f16.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], half [[DSDH:%.*]], half [[DTDH:%.*]], half [[DSDV:%.*]], half [[DTDV:%.*]], float [[S:%.*]], float [[T:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_c_cd_cl_2d(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DTDH32:%.*]] = fpext half [[DTDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[DTDV32:%.*]] = fpext half [[DTDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.c.cd.cl.2d.v4f32.f32.f32.v8i32.v4i32(i32 15, float [[ZCOMPARE:%.*]], float [[DSDH32]], float [[DTDH32]], float [[DSDV32]], float [[DTDV32]], float [[S:%.*]], float [[T:%.*]], float [[CLAMP:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <4 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 16
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
...
; GFX10-LABEL: @image_sample_g16_c_d_o_2darray_V1(
; GFX10-NEXT:    [[RES:%.*]] = call float @llvm.amdgcn.image.sample.c.d.o.2darray.f32.f16.f32.v8i32.v4i32(i32 4, i32 [[OFFSET:%.*]], float [[ZCOMPARE:%.*]], half [[DSDH:%.*]], half [[DTDH:%.*]], half [[DSDV:%.*]], half [[DTDV:%.*]], float [[S:%.*]], float [[T:%.*]], float [[SLICE:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store float [[RES]], ptr addrspace(1) [[OUT:%.*]], align 4
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_c_d_o_2darray_V1(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DTDH32:%.*]] = fpext half [[DTDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[DTDV32:%.*]] = fpext half [[DTDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call float @llvm.amdgcn.image.sample.c.d.o.2darray.f32.f32.f32.v8i32.v4i32(i32 4, i32 [[OFFSET:%.*]], float [[ZCOMPARE:%.*]], float [[DSDH32]], float [[DTDH32]], float [[DSDV32]], float [[DTDV32]], float [[S:%.*]], float [[T:%.*]], float [[SLICE:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store float [[RES]], ptr addrspace(1) [[OUT:%.*]], align 4
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
  %dtdh32 = fpext half %dtdh to float
...
; GFX10-LABEL: @image_sample_g16_c_d_o_2darray_V2(
; GFX10-NEXT:    [[RES:%.*]] = call <2 x float> @llvm.amdgcn.image.sample.c.d.o.2darray.v2f32.f16.f32.v8i32.v4i32(i32 6, i32 [[OFFSET:%.*]], float [[ZCOMPARE:%.*]], half [[DSDH:%.*]], half [[DTDH:%.*]], half [[DSDV:%.*]], half [[DTDV:%.*]], float [[S:%.*]], float [[T:%.*]], float [[SLICE:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX10-NEXT:    store <2 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 8
; GFX10-NEXT:    ret void
;
; GFX13-LABEL: @image_sample_g16_c_d_o_2darray_V2(
; GFX13-NEXT:    [[DSDH32:%.*]] = fpext half [[DSDH:%.*]] to float
; GFX13-NEXT:    [[DTDH32:%.*]] = fpext half [[DTDH:%.*]] to float
; GFX13-NEXT:    [[DSDV32:%.*]] = fpext half [[DSDV:%.*]] to float
; GFX13-NEXT:    [[DTDV32:%.*]] = fpext half [[DTDV:%.*]] to float
; GFX13-NEXT:    [[RES:%.*]] = call <2 x float> @llvm.amdgcn.image.sample.c.d.o.2darray.v2f32.f32.f32.v8i32.v4i32(i32 6, i32 [[OFFSET:%.*]], float [[ZCOMPARE:%.*]], float [[DSDH32]], float [[DTDH32]], float [[DSDV32]], float [[DTDV32]], float [[S:%.*]], float [[T:%.*]], float [[SLICE:%.*]], <8 x i32> [[RSRC:%.*]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; GFX13-NEXT:    store <2 x float> [[RES]], ptr addrspace(1) [[OUT:%.*]], align 8
; GFX13-NEXT:    ret void
;
  %dsdh32 = fpext half %dsdh to float
