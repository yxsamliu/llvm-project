...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx1200 -filetype=null %s 2>&1 | FileCheck --check-prefix=GFX12 --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx1300 -filetype=null %s 2>&1 | FileCheck --check-prefix=GFX12 --implicit-check-not=error: %s
