...
// GFX13: buffer_load_d16_format_x v5, off, s8, s3 offset:8388607 ; encoding: [0x03,0x00,0x20,0xc4,0x05,0x10,0x81,0x00,0x00,0xff,0xff,0x7f]

buffer_load_d16_format_x v5, off, v8, s3 offset:8388607
// GFX12-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX13: buffer_load_d16_format_x v5, off, v8, s3 offset:8388607 ; encoding: [0x03,0x00,0x20,0xc4,0x05,0x10,0x82,0x00,0x00,0xff,0xff,0x7f]
...
// GFX13: buffer_load_d16_format_xyz v[5:6], off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS ; encoding: [0x03,0x80,0x20,0xc4,0x05,0x10,0xbc,0x00,0x00,0xff,0xff,0x7f]

buffer_load_d16_format_xyz v[5:6], off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_128B
// GFX12-ERR: :[[@LINE-1]]:106: error: Cache fill size is not supported on this GPU
// GFX13: buffer_load_d16_format_xyz v[5:6], off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_128B ; encoding: [0x03,0x81,0x20,0xc4,0x05,0x10,0xbc,0x00,0x00,0xff,0xff,0x7f]

buffer_load_d16_format_xyz v[5:6], off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_64B
// GFX12-ERR: :[[@LINE-1]]:106: error: Cache fill size is not supported on this GPU
// GFX13: buffer_load_d16_format_xyz v[5:6], off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_64B ; encoding: [0x03,0x82,0x20,0xc4,0x05,0x10,0xbc,0x00,0x00,0xff,0xff,0x7f]

buffer_load_d16_format_xyz v[5:6], off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_32B
// GFX12-ERR: :[[@LINE-1]]:106: error: Cache fill size is not supported on this GPU
// GFX13: buffer_load_d16_format_xyz v[5:6], off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_32B ; encoding: [0x03,0x83,0x20,0xc4,0x05,0x10,0xbc,0x00,0x00,0xff,0xff,0x7f]
...
// GFX12-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX13: buffer_load_d16_format_xyzw v[5:6], v0, s8, s3 offen offset:8388607 ; encoding: [0x03,0xc0,0x20,0xc4,0x05,0x10,0x81,0x40,0x00,0xff,0xff,0x7f]

buffer_load_d16_format_xyzw v[5:6], v0, v8, s3 offen offset:8388607
// GFX12-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX13: buffer_load_d16_format_xyzw v[5:6], v0, v8, s3 offen offset:8388607 ; encoding: [0x03,0xc0,0x20,0xc4,0x05,0x10,0x82,0x40,0x00,0xff,0xff,0x7f]
...
// GFX12-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX13: buffer_load_d16_hi_format_x v5, off, s8, s3 offset:8388607 ; encoding: [0x03,0x80,0x09,0xc4,0x05,0x10,0x81,0x00,0x00,0xff,0xff,0x7f]

buffer_load_d16_hi_format_x v5, off, v8, s3 offset:8388607
// GFX12-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX13: buffer_load_d16_hi_format_x v5, off, v8, s3 offset:8388607 ; encoding: [0x03,0x80,0x09,0xc4,0x05,0x10,0x82,0x00,0x00,0xff,0xff,0x7f]
...
// GFX12-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX13: buffer_load_format_x v5, off, s8, s3 offset:7 ; encoding: [0x03,0x00,0x00,0xc4,0x05,0x10,0x81,0x00,0x00,0x07,0x00,0x00]

buffer_load_format_x v5, off, v8, s3 offset:7
// GFX12-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX13: buffer_load_format_x v5, off, v8, s3 offset:7 ; encoding: [0x03,0x00,0x00,0xc4,0x05,0x10,0x82,0x00,0x00,0x07,0x00,0x00]
...
// GFX13: buffer_load_format_x v5, off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS ; encoding: [0x03,0x00,0x00,0xc4,0x05,0x10,0xbc,0x00,0x00,0xff,0xff,0x7f]

buffer_load_format_x v5, off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_128B
// GFX12-ERR: :[[@LINE-1]]:96: error: Cache fill size is not supported on this GPU
// GFX13: buffer_load_format_x v5, off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_128B ; encoding: [0x03,0x01,0x00,0xc4,0x05,0x10,0xbc,0x00,0x00,0xff,0xff,0x7f]

buffer_load_format_x v5, off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_64B
// GFX12-ERR: :[[@LINE-1]]:96: error: Cache fill size is not supported on this GPU
// GFX13: buffer_load_format_x v5, off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_64B ; encoding: [0x03,0x02,0x00,0xc4,0x05,0x10,0xbc,0x00,0x00,0xff,0xff,0x7f]

buffer_load_format_x v5, off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_32B
// GFX12-ERR: :[[@LINE-1]]:96: error: Cache fill size is not supported on this GPU
// GFX13: buffer_load_format_x v5, off, s[8:11], s3 offset:8388607 th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_32B ; encoding: [0x03,0x03,0x00,0xc4,0x05,0x10,0xbc,0x00,0x00,0xff,0xff,0x7f]
...
// GFX12-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX13: buffer_store_d16_format_x v1, off, s12, s4 offset:8388607 ; encoding: [0x04,0x00,0x21,0xc4,0x01,0x18,0x81,0x00,0x00,0xff,0xff,0x7f]

buffer_store_d16_format_x v1, off, v12, s4 offset:8388607
// GFX12-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX13: buffer_store_d16_format_x v1, off, v12, s4 offset:8388607 ; encoding: [0x04,0x00,0x21,0xc4,0x01,0x18,0x82,0x00,0x00,0xff,0xff,0x7f]
...
// GFX12-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX13: buffer_store_d16_format_xyz v[1:2], off, s12, s4 offset:7 ; encoding: [0x04,0x80,0x21,0xc4,0x01,0x18,0x81,0x00,0x00,0x07,0x00,0x00]

buffer_store_d16_format_xyz v[1:2], off, v12, s4 offset:7
// GFX12-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX13: buffer_store_d16_format_xyz v[1:2], off, v12, s4 offset:7 ; encoding: [0x04,0x80,0x21,0xc4,0x01,0x18,0x82,0x00,0x00,0x07,0x00,0x00]
...
// GFX12-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX13: buffer_store_format_x v1, off, s12, s4 offset:8388607 ; encoding: [0x04,0x00,0x01,0xc4,0x01,0x18,0x81,0x00,0x00,0xff,0xff,0x7f]

buffer_store_format_x v1, off, v12, s4 offset:8388607
// GFX12-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// GFX13: buffer_store_format_x v1, off, v12, s4 offset:8388607 ; encoding: [0x04,0x00,0x01,0xc4,0x01,0x18,0x82,0x00,0x00,0xff,0xff,0x7f]
