...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx1300 -mattr=+real-true16 -show-encoding %s 2>&1 | FileCheck --check-prefix=GFX13-ERR --implicit-check-not=error: --strict-whitespace %s
...
// GFX13-ERR: :[[@LINE-1]]:1: error: e64_dpp variant of this instruction is not supported
