...
// RUN: llvm-mc -triple=amdgcn -mcpu=gfx1300 -show-encoding < %s | FileCheck -check-prefixes=GFX13,GFX13-ASM %s
// RUN: llvm-mc -triple=amdgcn -mcpu=gfx1300 -show-encoding %s | %extract-encodings | llvm-mc -triple=amdgcn -mcpu=gfx1300 -disassemble -show-encoding | FileCheck --strict-whitespace --check-prefixes=GFX13,GFX13-DIS %s
...
//      s_set_gpr_idx_u32 <OPS-IDX>
//      s_add_gpr_idx_u32 <OPS-IDX>
//      s_get_pc_i64 <SREG64>
//      s_set_pc_i64 <SREG64>
//      s_swap_pc_i64 <OPS64>
//      s_rfe_i64 <SREG64>
...
//      s_alloc_vgpr <SRC32>
//      s_sleep_var <SRC32>
//      s_mov_from_global_b32 <SREG32>, s0
//      s_mov_from_global_b32 s0, <SREG32-XEXEC-XM0-XNULL>
//      s_mov_from_global_b64 <SREG64>, s[0:1]
//      s_mov_from_global_b64 s[0:1], <SREG64-XEXEC-XNULL>
//      s_mov_to_global_b32 <SREG32-XEXEC-XM0-XNULL>, s0
//      s_mov_to_global_b32 s0, <SRC32>
//      s_mov_to_global_b64 <SREG64-XEXEC-XNULL>, s[0:1]
//      s_mov_to_global_b64 s[0:1], <SRC64>
//      s_ceil_f32 <OPS32>
//      s_floor_f32 <OPS32>
//      s_trunc_f32 <OPS32>
//      s_rndne_f32 <OPS32>
...
// GFX13: s_set_gpr_idx_u32 idx3, s17             ; encoding: [0x11,0x6f,0x83,0xbe]

s_set_gpr_idx_u32 idx3, 0x1
// GFX13: s_set_gpr_idx_u32 idx3, 1               ; encoding: [0x81,0x6f,0x83,0xbe]

s_set_gpr_idx_u32 idx3, 0x12345678
// GFX13: s_set_gpr_idx_u32 idx3, 0x12345678      ; encoding: [0xff,0x6f,0x83,0xbe,0x78,0x56,0x34,0x12]

s_add_gpr_idx_u32 idx3, s17
// GFX13: s_add_gpr_idx_u32 idx3, s17             ; encoding: [0x11,0x70,0x83,0xbe]

s_add_gpr_idx_u32 idx3, 0x1
// GFX13: s_add_gpr_idx_u32 idx3, 1               ; encoding: [0x81,0x70,0x83,0xbe]

s_add_gpr_idx_u32 idx3, 0x12345678
// GFX13: s_add_gpr_idx_u32 idx3, 0x12345678      ; encoding: [0xff,0x70,0x83,0xbe,0x78,0x56,0x34,0x12]
...
s_sendmsg_rtn_b32 s0, sendmsg(MSG_RTN_GET_SEMA1)
// GFX13: s_sendmsg_rtn_b32 s0, sendmsg(MSG_RTN_GET_SEMA1) ; encoding: [0x8c,0x4c,0x80,0xbe]

s_sendmsg_rtn_b32 s0, sendmsg(MSG_RTN_GET_SEMA2)
// GFX13: s_sendmsg_rtn_b32 s0, sendmsg(MSG_RTN_GET_SEMA2) ; encoding: [0x8d,0x4c,0x80,0xbe]

s_sendmsg_rtn_b32 s0, sendmsg(MSG_RTN_GET_SEMA3)
// GFX13: s_sendmsg_rtn_b32 s0, sendmsg(MSG_RTN_GET_SEMA3) ; encoding: [0x8e,0x4c,0x80,0xbe]

s_sendmsg_rtn_b32 s0, sendmsg(MSG_RTN_GET_SEMA4)
// GFX13: s_sendmsg_rtn_b32 s0, sendmsg(MSG_RTN_GET_SEMA4) ; encoding: [0x8f,0x4c,0x80,0xbe]

s_sendmsg_rtn_b32 s0, sendmsg(MSG_RTN_GET_SEMA5)
// GFX13: s_sendmsg_rtn_b32 s0, sendmsg(MSG_RTN_GET_SEMA5) ; encoding: [0x90,0x4c,0x80,0xbe]
...
// GFX13: s_mov_from_global_b32 s105, s0          ; encoding: [0x00,0x5b,0xe9,0xbe]

s_mov_from_global_b32 vcc_lo, s0
// GFX13: s_mov_from_global_b32 vcc_lo, s0        ; encoding: [0x00,0x5b,0xea,0xbe]

s_mov_from_global_b32 exec_lo, s0
// GFX13: s_mov_from_global_b32 exec_lo, s0       ; encoding: [0x00,0x5b,0xfe,0xbe]

s_mov_from_global_b32 m0, s0
// GFX13: s_mov_from_global_b32 m0, s0            ; encoding: [0x00,0x5b,0xfd,0xbe]

s_mov_from_global_b32 null, s0
// GFX13: s_mov_from_global_b32 null, s0          ; encoding: [0x00,0x5b,0xfc,0xbe]

s_mov_from_global_b32 s0, s105
// GFX13: s_mov_from_global_b32 s0, s105          ; encoding: [0x69,0x5b,0x80,0xbe]

s_mov_from_global_b32 s0, vcc_lo
// GFX13: s_mov_from_global_b32 s0, vcc_lo        ; encoding: [0x6a,0x5b,0x80,0xbe]

s_mov_from_global_b64 s[104:105], s[0:1]
// GFX13: s_mov_from_global_b64 s[104:105], s[0:1] ; encoding: [0x00,0x5c,0xe8,0xbe]

s_mov_from_global_b64 vcc, s[0:1]
// GFX13: s_mov_from_global_b64 vcc, s[0:1]       ; encoding: [0x00,0x5c,0xea,0xbe]

s_mov_from_global_b64 exec, s[0:1]
// GFX13: s_mov_from_global_b64 exec, s[0:1]      ; encoding: [0x00,0x5c,0xfe,0xbe]

s_mov_from_global_b64 null, s[0:1]
// GFX13: s_mov_from_global_b64 null, s[0:1]      ; encoding: [0x00,0x5c,0xfc,0xbe]

s_mov_from_global_b64 s[0:1], s[104:105]
// GFX13: s_mov_from_global_b64 s[0:1], s[104:105] ; encoding: [0x68,0x5c,0x80,0xbe]

s_mov_from_global_b64 s[0:1], vcc
// GFX13: s_mov_from_global_b64 s[0:1], vcc       ; encoding: [0x6a,0x5c,0x80,0xbe]

s_mov_to_global_b32 s105, s0
// GFX13: s_mov_to_global_b32 s105, s0            ; encoding: [0x00,0x5d,0xe9,0xbe]

s_mov_to_global_b32 vcc_lo, s0
// GFX13: s_mov_to_global_b32 vcc_lo, s0          ; encoding: [0x00,0x5d,0xea,0xbe]

s_mov_to_global_b32 s0, s105
// GFX13: s_mov_to_global_b32 s0, s105            ; encoding: [0x69,0x5d,0x80,0xbe]

s_mov_to_global_b32 s0, vcc_lo
// GFX13: s_mov_to_global_b32 s0, vcc_lo          ; encoding: [0x6a,0x5d,0x80,0xbe]

s_mov_to_global_b32 s0, exec_lo
// GFX13: s_mov_to_global_b32 s0, exec_lo         ; encoding: [0x7e,0x5d,0x80,0xbe]

s_mov_to_global_b32 s0, m0
// GFX13: s_mov_to_global_b32 s0, m0              ; encoding: [0x7d,0x5d,0x80,0xbe]

s_mov_to_global_b32 s0, null
// GFX13: s_mov_to_global_b32 s0, null            ; encoding: [0x7c,0x5d,0x80,0xbe]

s_mov_to_global_b32 s0, 0
// GFX13: s_mov_to_global_b32 s0, 0               ; encoding: [0x80,0x5d,0x80,0xbe]

s_mov_to_global_b32 s0, 0.5
// GFX13: s_mov_to_global_b32 s0, 0.5             ; encoding: [0xf0,0x5d,0x80,0xbe]

s_mov_to_global_b32 s0, 0x12345678
// GFX13: s_mov_to_global_b32 s0, 0x12345678      ; encoding: [0xff,0x5d,0x80,0xbe,0x78,0x56,0x34,0x12]

s_mov_to_global_b64 s[104:105], s[0:1]
// GFX13: s_mov_to_global_b64 s[104:105], s[0:1]  ; encoding: [0x00,0x5e,0xe8,0xbe]

s_mov_to_global_b64 vcc, s[0:1]
// GFX13: s_mov_to_global_b64 vcc, s[0:1]         ; encoding: [0x00,0x5e,0xea,0xbe]

s_mov_to_global_b64 s[0:1], s[104:105]
// GFX13: s_mov_to_global_b64 s[0:1], s[104:105]  ; encoding: [0x68,0x5e,0x80,0xbe]

s_mov_to_global_b64 s[0:1], vcc
// GFX13: s_mov_to_global_b64 s[0:1], vcc         ; encoding: [0x6a,0x5e,0x80,0xbe]

s_mov_to_global_b64 s[0:1], exec
// GFX13: s_mov_to_global_b64 s[0:1], exec        ; encoding: [0x7e,0x5e,0x80,0xbe]

s_mov_to_global_b64 s[0:1], null
// GFX13: s_mov_to_global_b64 s[0:1], null        ; encoding: [0x7c,0x5e,0x80,0xbe]

s_mov_to_global_b64 s[0:1], 0
// GFX13: s_mov_to_global_b64 s[0:1], 0           ; encoding: [0x80,0x5e,0x80,0xbe]

s_mov_to_global_b64 s[0:1], 0.5
// GFX13: s_mov_to_global_b64 s[0:1], 0.5         ; encoding: [0xf0,0x5e,0x80,0xbe]

s_mov_to_global_b64 s[0:1], 0x123456789abcdef0
// GFX13: s_mov_to_global_b64 s[0:1], 0x123456789abcdef0 ; encoding: [0xfe,0x5e,0x80,0xbe,0xf0,0xde,0xbc,0x9a,0x78,0x56,0x34,0x12]
