...
// GFX13: :[[@LINE-1]]:48: error: not a valid operand.
...
// GFX13: :[[@LINE-1]]:47: error: not a valid operand.
...
// GFX13: :[[@LINE-1]]:52: error: not a valid operand.

v_div_scale_f64 v[4:5], s2, v[2:3], v[6:7], v[8:9] quad_perm:[3,2,1,0]
// GFX13: :[[@LINE-1]]:52: error: not a valid operand.

v_dot2_bf16_bf16 v5, v1, v2, s3
// GFX13: :[[@LINE-1]]:1: error: instruction not supported on this GPU
...
// GFX13: :[[@LINE-1]]:45: error: not a valid operand.
...
// GFX13: :[[@LINE-1]]:38: error: not a valid operand.
...
// GFX13: :[[@LINE-1]]:33: error: invalid op_sel operand

v_permlanex16_b32 v5, v1, s2, s3 op_sel:[0, 0, 1, 0]
// GFX13: :[[@LINE-1]]:34: error: invalid op_sel operand

v_permlane16_var_b32 v5, v1, v2 clamp
// GFX13: :[[@LINE-1]]:33: error: invalid operand for instruction

v_permlane16_var_b32 v5, v1, v2 div:2
// GFX13: :[[@LINE-1]]:33: error: not a valid operand.
...
v_permlane16_var_b32 v5, v1, -v2 op_sel:[0, 1]
// GFX13: :[[@LINE-1]]:30: error: not a valid operand.
...
v_pdep_b32 v5, v3, -v1
// GFX13: :[[@LINE-1]]:20: error: not a valid operand.
...
// W32: :[[@LINE-1]]:51: error: invalid operand for instruction
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32

v_cvt_scalef32_pk8_fp8_f32 v[10:11], v[20:27], v8 mul:2
// W32: :[[@LINE-1]]:51: error: not a valid operand.
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32
...
// W32: :[[@LINE-1]]:52: error: invalid operand for instruction
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32

v_cvt_scalef32_pk8_fp8_bf16 v[10:11], v[20:23], v8 mul:2
// W32: :[[@LINE-1]]:52: error: not a valid operand.
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32
...
// W32: :[[@LINE-1]]:53: error: invalid operand for instruction
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32

v_cvt_scalef32_sr_pk8_fp4_f32 v10, v[20:27], v4, v8 mul:2
// W32: :[[@LINE-1]]:53: error: not a valid operand.
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32
...
// W32: :[[@LINE-1]]:58: error: invalid operand for instruction
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32

v_cvt_scalef32_sr_pk8_fp8_f32 v[10:11], v[20:27], v4, v8 mul:2
// W32: :[[@LINE-1]]:58: error: not a valid operand.
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32
...
// W32: :[[@LINE-1]]:47: error: invalid operand for instruction
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32

v_cvt_scalef32_pk8_fp4_bf16 v10, v[20:23], v8 mul:2
// W32: :[[@LINE-1]]:47: error: not a valid operand.
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32
...
// W32: :[[@LINE-1]]:54: error: invalid operand for instruction
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32

v_cvt_scalef32_sr_pk8_fp4_bf16 v10, v[20:23], v4, v8 mul:2
// W32: :[[@LINE-1]]:54: error: not a valid operand.
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32
...
// W32: :[[@LINE-1]]:59: error: invalid operand for instruction
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32

v_cvt_scalef32_sr_pk8_fp8_bf16 v[10:11], v[20:23], v4, v8 mul:2
// W32: :[[@LINE-1]]:59: error: not a valid operand.
// W64: :[[@LINE-2]]:1: error: instruction requires wavesize=32
