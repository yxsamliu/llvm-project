...
// GFX13: global_load_async_mcast_to_lds_b8 v1, v[2:3], off ; encoding: [0x7c,0x00,0x1b,0xee,0x01,0x00,0x00,0x00,0x02,0x00,0x00,0x00]

cluster_load_async_to_lds_b32 v1, v[2:3], off
// GFX13: global_load_async_mcast_to_lds_b32 v1, v[2:3], off ; encoding: [0x7c,0x40,0x1b,0xee,0x01,0x00,0x00,0x00,0x02,0x00,0x00,0x00]

cluster_load_async_to_lds_b64 v1, v[2:3], off
// GFX13: global_load_async_mcast_to_lds_b64 v1, v[2:3], off ; encoding: [0x7c,0x80,0x1b,0xee,0x01,0x00,0x00,0x00,0x02,0x00,0x00,0x00]

cluster_load_async_to_lds_b128 v1, v[2:3], off
// GFX13: global_load_async_mcast_to_lds_b128 v1, v[2:3], off ; encoding: [0x7c,0xc0,0x1b,0xee,0x01,0x00,0x00,0x00,0x02,0x00,0x00,0x00]

cluster_load_b32 v1, v[2:3], off
// GFX13: global_load_mcast_b32 v1, v[2:3], off   ; encoding: [0x7c,0x40,0x1a,0xee,0x01,0x00,0x00,0x00,0x02,0x00,0x00,0x00]

cluster_load_b64 v[0:1], v[2:3], off
// GFX13: global_load_mcast_b64 v[0:1], v[2:3], off ; encoding: [0x7c,0x80,0x1a,0xee,0x00,0x00,0x00,0x00,0x02,0x00,0x00,0x00]

cluster_load_b128 v[0:3], v[4:5], off
// GFX13: global_load_mcast_b128 v[0:3], v[4:5], off ; encoding: [0x7c,0xc0,0x1a,0xee,0x00,0x00,0x00,0x00,0x04,0x00,0x00,0x00]
