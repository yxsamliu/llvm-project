...
v_convolve_f32_iu8 v[2:5], v[2:5], v[6:23], v[24:26], v[34:36], v[30:32] shape:SHAPE_4X2X16 filter:FILTER_3X3 accum_chan_order clamp supr
// GFX13: v_convolve_f32_iu8 v[2:5], v[2:5], v[6:23], v[24:26], v[34:36], v[30:32] shape:SHAPE_4X2X16 filter:FILTER_3X3 accum_chan_order clamp supr ; encoding: [0x02,0x70,0x38,0xde,0x02,0xc4,0x80,0x2c,0x18,0x80,0x00,0x00,0x22,0xe0,0x01,0x00]

v_convolve_f16_fp8_fp8 v[2:3], v[2:3], v[4:11], v12, v13, v14, v15 shape:SHAPE_4X2X16 filter:FILTER_1X1 accum_chan_order iter:4 supr
// GFX13: v_convolve_f16_fp8_fp8 v[2:3], v[2:3], v[4:11], v12, v13, v14, v15 shape:SHAPE_4X2X16 filter:FILTER_1X1 accum_chan_order iter:4 supr ; encoding: [0x02,0xa0,0x3a,0xdf,0x02,0x84,0x80,0x0c,0x0c,0x80,0xfc,0x00,0x0d,0xe0,0x00,0x00]
...
v_fma_from_tensor_bf16_bf16 v[2:3], v[2:3], v4, v5, v[6:7] layout:LAYOUT_CONVOLVE_8X4 clamp supr
// GFX13: v_fma_from_tensor_bf16_bf16 v[2:3], v[2:3], v4, v5, v[6:7] layout:LAYOUT_CONVOLVE_8X4 clamp supr ; encoding: [0x02,0xf0,0x19,0xde,0x02,0x84,0x80,0x00,0x05,0x00,0x00,0x7c,0x06,0x00,0x00,0x00]

v_cvt_to_tensor_i4_f32 v1, v[5:8], s42 shape:SHAPE_4X2X16 accum_chan_order clamp supr
// GFX13: v_cvt_to_tensor_i4_f32 v1, v[5:8], s42 shape:SHAPE_4X2X16 accum_chan_order clamp supr ; encoding: [0x01,0x30,0x0c,0xdd,0x05,0x04,0x00,0x0c,0x00,0x20,0x00,0x2a]
