...
// GFX13-ERR: :[[@LINE-1]]:34: error: invalid VOPDY instruction

v_dual_fma_f32 v7, v1, v2, v3 :: v_dual_cndmask_b32 v2, v4, v1
// GFX13-ERR: :[[@LINE-1]]:1: error: too few operands for instruction
...
// GFX13-ERR: :[[@LINE-1]]:1: error: instruction must set modifier r128=1

rts_trace_ray_nonblock v14, [v0, v[1:3], v[5:8], v[9:12]], s[4:7]
// GFX13-ERR: :[[@LINE-1]]:1: error: instruction must set modifier r128=1

rts_trace_ray [v0, v[1:3], v[5:7], v[8:10]], s[4:7] r128
// GFX13-ERR: :[[@LINE-1]]:28: error: invalid operand for instruction
...
// GFX13-ERR: :[[@LINE-1]]:24: error: invalid hardware register: not supported on this GPU

s_getreg_b32 s0, hwreg(HW_REG_SHADER_CYCLES_HI)
// GFX13-ERR: :[[@LINE-1]]:24: error: invalid hardware register: not supported on this GPU

s_mov_from_global_b32 s1, m0
// GFX13-ERR: :[[@LINE-1]]:27: error: expected an SGPR or vcc/vcc_lo/vcc_hi

s_mov_from_global_b32 s1, ttmp5
// GFX13-ERR: :[[@LINE-1]]:27: error: expected an SGPR or vcc/vcc_lo/vcc_hi

s_mov_from_global_b64 s[2:3], null
// GFX13-ERR: :[[@LINE-1]]:31: error: expected an SGPR or vcc/vcc_lo/vcc_hi

s_mov_to_global_b32 s[4:5], s10
// GFX13-ERR: :[[@LINE-1]]:21: error: expected a 32-bit register

s_mov_to_global_b64 s5, s[10:11]
// GFX13-ERR: :[[@LINE-1]]:21: error: expected a 64-bit register

s_mov_to_global_b64 s[5:6], s[10:11]
// GFX13-ERR: :[[@LINE-1]]:21: error: invalid register alignment

s_mov_to_global_b64 exec, s[10:11]
// GFX13-ERR: :[[@LINE-1]]:21: error: expected an SGPR or vcc/vcc_lo/vcc_hi

v_cvt_f32_f64 g123, v[0:1]
// GFX13-ERR: :[[@LINE-1]]:15: error: invalid operand for instruction
