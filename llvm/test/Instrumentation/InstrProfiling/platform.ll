...
; AMDGPU: @__profc_foo = private addrspace(1) global [1 x i64] zeroinitializer, section "__llvm_prf_cnts", comdat, align 8
...
;; Check for start/stop symbols created for GPU targets
; AMDGPU: @__start___llvm_prf_cnts = hidden addrspace(1) constant [0 x i8] zeroinitializer
; AMDGPU: @__stop___llvm_prf_cnts = hidden addrspace(1) constant [0 x i8] zeroinitializer
; AMDGPU: @__start___llvm_prf_data = hidden addrspace(1) constant [0 x i8] zeroinitializer
; AMDGPU: @__stop___llvm_prf_data = hidden addrspace(1) constant [0 x i8] zeroinitializer
; AMDGPU: @__start___llvm_prf_names = hidden addrspace(1) constant [0 x i8] zeroinitializer
; AMDGPU: @__stop___llvm_prf_names = hidden addrspace(1) constant [0 x i8] zeroinitializer
