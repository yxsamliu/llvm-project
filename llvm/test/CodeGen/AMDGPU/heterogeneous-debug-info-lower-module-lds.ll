...
; CHECK: @llvm.amdgcn.kernel.hello.lds = internal addrspace(3) global %llvm.amdgcn.kernel.hello.lds.t undef, align 8, !dbg.def ![[HELLO_FRAGMENT:[0-9]+]]
; CHECK: @llvm.amdgcn.kernel.bye.lds = internal addrspace(3) global %llvm.amdgcn.kernel.bye.lds.t undef, align 8, !dbg.def ![[BYE_FRAGMENT:[0-9]+]]
...
!11 = distinct !DIGlobalVariable(name: "One32", scope: !12, file: !7, line: 2, type: !16, isLocal: true, isDefinition: true)
...
!17 = !{!18}
!18 = !DILocalVariable(name: "A", arg: 1, scope: !12, file: !7, line: 1, type: !15)
!19 = distinct !DILifetime(object: !20, location: !DIExpr(DIOpArg(0, ptr addrspace(3)), DIOpDeref(i64)), argObjects: {!1})
!20 = distinct !DIGlobalVariable(name: "Two64", scope: !12, file: !7, line: 3, type: !9, isLocal: true, isDefinition: true)
!21 = distinct !DILifetime(object: !22, location: !DIExpr(DIOpArg(0, ptr addrspace(3)), DIOpDeref(i32)), argObjects: {!2})
!22 = distinct !DIGlobalVariable(name: "Three32", scope: !12, file: !7, line: 4, type: !16, isLocal: true, isDefinition: true)
!23 = distinct !DILifetime(object: !24, location: !DIExpr(DIOpArg(0, ptr addrspace(3)), DIOpDeref(i64)), argObjects: {!3})
!24 = distinct !DIGlobalVariable(name: "Four64", scope: !25, file: !7, line: 12, type: !9, isLocal: true, isDefinition: true)
...
!26 = !{!27}
!27 = !DILocalVariable(name: "B", arg: 1, scope: !25, file: !7, line: 11, type: !15)
!28 = distinct !DILifetime(object: !29, location: !DIExpr(DIOpArg(0, ptr addrspace(3)), DIOpDeref(i32)), argObjects: {!4})
!29 = distinct !DIGlobalVariable(name: "Five32", scope: !25, file: !7, line: 13, type: !16, isLocal: true, isDefinition: true)
!30 = distinct !DILifetime(object: !31, location: !DIExpr(DIOpArg(0, ptr addrspace(3)), DIOpDeref(i32)), argObjects: {!5})
!31 = distinct !DIGlobalVariable(name: "Six32", scope: !25, file: !7, line: 14, type: !16, isLocal: true, isDefinition: true)
