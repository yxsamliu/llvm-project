...
define amdgpu_ps float @test1(i32 %rsrc, i32 %data, i32 %vindex, i32 %voffset) {
...
; GFX13-SDAG-NEXT:    buffer_atomic_swap_b32 v1, v2, v0, null idxen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    buffer_atomic_swap_b32 v1, v4, v0, null idxen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    buffer_atomic_swap_b32 v1, v[2:3], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    v_add_nc_u32_e32 v3, 42, v3
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    buffer_atomic_swap_b32 v1, v[4:5], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    buffer_atomic_swap_b32 v1, v[2:3], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v3, 0x1ffc
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    buffer_atomic_swap_b32 v1, v[2:3], v0, null idxen offen offset:4 th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    s_clause 0x1
; GFX13-SDAG-NEXT:    buffer_atomic_swap_b32 v1, v2, v0, null idxen
; GFX13-SDAG-NEXT:    buffer_atomic_swap_b32 v1, v2, v0, null idxen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-GISEL-NEXT:    buffer_atomic_swap_b32 v1, v[4:5], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    buffer_atomic_swap_b32 v1, v4, v0, null idxen offset:8192 th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-SDAG:       ; %bb.0: ; %main_body
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v5, v3 :: v_dual_mov_b32 v3, 0
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v8, v2 :: v_dual_mov_b32 v7, v1
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v6, v4
; GFX13-SDAG-NEXT:    buffer_atomic_cmpswap_b32 v[7:8], v3, v0, null idxen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v8, v2
; GFX13-SDAG-NEXT:    buffer_atomic_cmpswap_b32 v[7:8], v5, v0, null idxen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v8, v2
; GFX13-SDAG-NEXT:    buffer_atomic_cmpswap_b32 v[7:8], v[3:4], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v8, v2 :: v_dual_add_nc_u32 v4, 44, v4
; GFX13-SDAG-NEXT:    buffer_atomic_cmpswap_b32 v[7:8], v[5:6], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v8, v2
; GFX13-SDAG-NEXT:    buffer_atomic_cmpswap_b32 v[7:8], v[3:4], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v8, v2
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v4, 0x1ffc
; GFX13-SDAG-NEXT:    buffer_atomic_cmpswap_b32 v[7:8], v[3:4], v0, null idxen offen offset:4 th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v0, v7
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-LABEL: test3:
; GFX13-GISEL:       ; %bb.0: ; %main_body
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v6, v4 :: v_dual_mov_b32 v5, 0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v8, v2 :: v_dual_mov_b32 v7, v1
; GFX13-GISEL-NEXT:    buffer_atomic_cmpswap_b32 v[7:8], v5, v0, null idxen th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v8, v2
; GFX13-GISEL-NEXT:    buffer_atomic_cmpswap_b32 v[7:8], v3, v0, null idxen th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v8, v2
; GFX13-GISEL-NEXT:    buffer_atomic_cmpswap_b32 v[7:8], v[5:6], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v8, v2 :: v_dual_add_nc_u32 v6, 44, v6
; GFX13-GISEL-NEXT:    buffer_atomic_cmpswap_b32 v[7:8], v[3:4], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v8, v2
; GFX13-GISEL-NEXT:    buffer_atomic_cmpswap_b32 v[7:8], v[5:6], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v8, v2
; GFX13-GISEL-NEXT:    buffer_atomic_cmpswap_b32 v[7:8], v5, v0, null idxen offset:8192 th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v0, v7
; GFX13-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v11, v3
; GFX13-SDAG-NEXT:    buffer_atomic_cmpswap_b64 v[9:12], v7, v0, null idxen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v11, v3
; GFX13-SDAG-NEXT:    buffer_atomic_cmpswap_b64 v[9:12], v[5:6], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v11, v3
; GFX13-SDAG-NEXT:    v_add_nc_u32_e32 v6, 44, v6
; GFX13-SDAG-NEXT:    buffer_atomic_cmpswap_b64 v[9:12], v[7:8], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v11, v3
; GFX13-SDAG-NEXT:    buffer_atomic_cmpswap_b64 v[9:12], v[5:6], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v12, v4
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v6, 0x1ffc :: v_dual_mov_b32 v11, v3
; GFX13-SDAG-NEXT:    buffer_atomic_cmpswap_b64 v[9:12], v[5:6], v0, null idxen offen offset:4 th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_xor_b32_e32 v0, v9, v10
; GFX13-SDAG-NEXT:    v_cls_i32_e32 v1, v10
...
; GFX13-SDAG-NEXT:    v_lshlrev_b64_e32 v[0:1], v2, v[9:10]
; GFX13-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX13-GISEL:       ; %bb.0: ; %main_body
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v11, v3
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v8, v6 :: v_dual_mov_b32 v7, 0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v10, v2 :: v_dual_mov_b32 v9, v1
; GFX13-GISEL-NEXT:    buffer_atomic_cmpswap_b64 v[9:12], v7, v0, null idxen th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v11, v3
; GFX13-GISEL-NEXT:    buffer_atomic_cmpswap_b64 v[9:12], v5, v0, null idxen th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v11, v3
; GFX13-GISEL-NEXT:    buffer_atomic_cmpswap_b64 v[9:12], v[7:8], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v11, v3
; GFX13-GISEL-NEXT:    v_add_nc_u32_e32 v8, 44, v8
; GFX13-GISEL-NEXT:    buffer_atomic_cmpswap_b64 v[9:12], v[5:6], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v11, v3
; GFX13-GISEL-NEXT:    buffer_atomic_cmpswap_b64 v[9:12], v[7:8], v0, null idxen offen th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v11, v3
; GFX13-GISEL-NEXT:    buffer_atomic_cmpswap_b64 v[9:12], v7, v0, null idxen offset:8192 th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_xor_b32_e32 v0, v9, v10
; GFX13-GISEL-NEXT:    v_cls_i32_e32 v1, v10
...
; GFX13-GISEL-NEXT:    v_lshlrev_b64_e32 v[0:1], v2, v[9:10]
; GFX13-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
