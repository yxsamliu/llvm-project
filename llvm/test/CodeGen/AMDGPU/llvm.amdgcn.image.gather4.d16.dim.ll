...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 | FileCheck -check-prefixes=GCN,GFX13 %s
...
; GFX13: image_gather4_b v[0:1], [v4, v3, v2], s[0:7], s[8:11] dmask:0x4 dim:SQ_RSRC_IMG_2D d16{{$}}
