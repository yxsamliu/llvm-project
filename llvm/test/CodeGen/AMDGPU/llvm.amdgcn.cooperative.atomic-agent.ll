...
; GFX1250Plus-NEXT:    flat_load_b32 v0, v[0:1] scope:SCOPE_DEV
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
...
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_load_b64 v[0:1], v[0:1] scope:SCOPE_DEV
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_load_b128 v[0:3], v[0:1] scope:SCOPE_DEV
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_store_b32 v[0:1], v2 scope:SCOPE_DEV
...
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_store_b64 v[0:1], v[2:3] scope:SCOPE_DEV
; GFX1250Plus-NEXT:    s_wait_dscnt 0x0
; GFX1250Plus-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_store_b128 v[0:1], v[2:5] scope:SCOPE_DEV
; GFX1250Plus-NEXT:    s_wait_dscnt 0x0
; GFX1250Plus-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1260-NEXT:    global_wb scope:SCOPE_DEV
; GFX1260-NEXT:    s_wait_storecnt 0x0
; GFX1260-NEXT:    flat_store_b64 v[0:1], v[2:3] scope:SCOPE_DEV
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1260-NEXT:    global_wb scope:SCOPE_DEV
; GFX1260-NEXT:    s_wait_storecnt 0x0
; GFX1260-NEXT:    flat_store_b128 v[0:1], v[2:5] scope:SCOPE_DEV
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
entry:
