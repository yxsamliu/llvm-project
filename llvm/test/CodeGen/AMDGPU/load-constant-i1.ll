...
; GFX1260-NEXT:    v_mov_b32_e32 v3, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_mov_b32_e32 v5, v3
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_load_b64 s[2:3], s[2:3], 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
...
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s5
; GFX1260-NEXT:    s_lshr_b32 s4, s3, 31
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x1001e
; GFX1260-NEXT:    s_bfe_u32 s6, s3, 0x10002
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:416
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s5
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s4, s3, 0x1001d
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x1001c
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:496
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s5
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s4, s3, 0x1001b
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x1001a
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:480
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s5
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s4, s3, 0x10019
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x10018
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:464
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s5
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s4, s3, 0x10017
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x10016
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:448
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s5
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s4, s3, 0x10013
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x10012
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:432
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s5
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s4, s3, 0x10011
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x10010
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:400
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s5
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s4, s3, 0x1000f
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x1000e
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:384
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s5
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s4, s3, 0x1000d
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x1000c
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:368
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s5
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s4, s3, 0x1000b
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x1000a
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:352
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s5
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s4, s3, 0x10009
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x10008
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:336
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s5
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s4, s3, 0x10007
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x10006
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:320
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s5
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s4, s3, 0x10005
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x10004
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:304
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s5
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s5, s3, 0x10003
; GFX1260-NEXT:    s_mov_b32 s4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s3, 0x10001
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:288
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s6
; GFX1260-NEXT:    v_mov_b32_e32 v4, s5
; GFX1260-NEXT:    s_and_b64 s[4:5], s[4:5], 1
; GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1260-NEXT:    v_mov_b32_e32 v0, s4
; GFX1260-NEXT:    v_mov_b32_e32 v1, s5
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:272
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s3
; GFX1260-NEXT:    s_lshr_b32 s3, s2, 31
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x1001e
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x1001d
; GFX1260-NEXT:    global_store_b128 v3, v[0:3], s[0:1] offset:256
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x1001c
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:240
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x1001b
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x1001a
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:224
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x10019
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x10018
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:208
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x10017
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x10016
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:192
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x10014
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x10015
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:176
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s3
; GFX1260-NEXT:    v_mov_b32_e32 v4, s4
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x10013
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x10012
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:160
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x10011
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x10010
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:144
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x1000f
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x1000e
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:128
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x1000d
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x1000c
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:112
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x1000b
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x1000a
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:96
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x10009
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x10008
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:80
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x10007
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x10006
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:64
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x10005
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x10004
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:48
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x10003
; GFX1260-NEXT:    s_bfe_u32 s4, s2, 0x10002
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:32
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s4
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    s_bfe_u32 s3, s2, 0x10001
; GFX1260-NEXT:    s_and_b32 s2, s2, 1
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:16
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, s2
; GFX1260-NEXT:    v_mov_b32_e32 v4, s3
; GFX1260-NEXT:    global_store_b128 v3, v[2:5], s[0:1]
; GFX1260-NEXT:    s_endpgm
  %load = load <64 x i1>, ptr addrspace(4) %in
