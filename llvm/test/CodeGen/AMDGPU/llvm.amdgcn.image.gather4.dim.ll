...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 -show-mc-encoding < %s | FileCheck -check-prefixes=GCN,GFX12PLUS,GFX13 %s
...
; GFX13: image_gather4 v[0:3], [v6, v5, v4], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_CUBE ;
...
; GFX13: image_gather4_c v[0:3], [v6, v5, v4], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D ;
...
; GFX13: image_gather4_cl v[0:3], [v6, v5, v4], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D ;
...
; GFX13: image_gather4_b v[0:3], [v6, v5, v4], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D ;
...
; GFX13: image_gather4_c_b_cl v[0:3], [v8, v7, v6, v[4:5]], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D ;
...
; GFX13: image_gather4_l v[0:3], [v6, v5, v4], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D ;
...
; GFX13: image_gather4_lz v[0:3], [v5, v4], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D ;
...
; GFX13: image_gather4_c_lz v[0:3], [v6, v5, v4], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D ;
...
; GFX13: image_gather4 v[0:3], [v5, v4], s[0:7], s[8:11] dmask:0x2 dim:SQ_RSRC_IMG_2D ;
...
; GFX13: image_gather4 v[0:3], [v5, v4], s[0:7], s[8:11] dmask:0x4 dim:SQ_RSRC_IMG_2D ;
...
; GFX13: image_gather4 v[0:3], [v5, v4], s[0:7], s[8:11] dmask:0x8 dim:SQ_RSRC_IMG_2D ;
