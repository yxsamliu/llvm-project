...
; GFX13-NEXT:    s_wait_rtscnt 0x0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    v_perm_b32 v0, v0, v1, 0xc0c0004
; GFX13-NEXT:    s_mov_b64 s[0:1], 2
; GFX13-NEXT:    s_mov_b32 s3, 0x31016000
; GFX13-NEXT:    s_mov_b32 s2, -1
; GFX13-NEXT:    buffer_store_b8 v2, off, s[0:3], null
; GFX13-NEXT:    s_mov_b64 s[0:1], 0
; GFX13-NEXT:    buffer_store_b16 v0, off, s[0:3], null
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    v_perm_b32 v0, v0, v1, 0xc0c0004
; GFX13-NEXT:    v_perm_b32 v1, v2, v3, 0xc0c0004
; GFX13-NEXT:    s_mov_b64 s[0:1], 0
; GFX13-NEXT:    s_mov_b32 s3, 0x31016000
; GFX13-NEXT:    s_mov_b32 s2, -1
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_lshl_or_b32 v0, v1, 16, v0
; GFX13-NEXT:    buffer_store_b32 v0, off, s[0:3], null
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX13-NEXT:    v_perm_b32 v0, v0, v1, 0xc0c0004
; GFX13-NEXT:    v_perm_b32 v1, v2, v3, 0xc0c0004
; GFX13-NEXT:    s_mov_b64 s[0:1], 4
; GFX13-NEXT:    s_mov_b32 s3, 0x31016000
; GFX13-NEXT:    s_mov_b32 s2, -1
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_lshl_or_b32 v0, v1, 16, v0
; GFX13-NEXT:    buffer_store_b8 v4, off, s[0:3], null
; GFX13-NEXT:    s_mov_b64 s[0:1], 0
; GFX13-NEXT:    buffer_store_b32 v0, off, s[0:3], null
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX13-NEXT:    s_wait_rtscnt 0x0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    v_perm_b32 v4, v4, v5, 0xc0c0004
; GFX13-NEXT:    v_perm_b32 v5, v6, v7, 0xc0c0004
; GFX13-NEXT:    v_perm_b32 v0, v0, v1, 0xc0c0004
; GFX13-NEXT:    v_perm_b32 v2, v2, v3, 0xc0c0004
; GFX13-NEXT:    s_mov_b64 s[0:1], 0
; GFX13-NEXT:    s_mov_b32 s3, 0x31016000
; GFX13-NEXT:    v_lshl_or_b32 v1, v5, 16, v4
; GFX13-NEXT:    s_mov_b32 s2, -1
; GFX13-NEXT:    v_lshl_or_b32 v0, v2, 16, v0
; GFX13-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], null
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX13-TRUE16-NEXT:    s_wait_rtscnt 0x0
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    v_perm_b32 v8, v8, v9, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v9.l, v11.l
; GFX13-TRUE16-NEXT:    v_perm_b32 v12, v12, v13, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v13, v14, v15, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v4, v4, v5, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v5, v6, v7, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v9, v10, v9, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v0, v0, v1, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v6, v2, v3, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_lshl_or_b32 v3, v13, 16, v12
; GFX13-TRUE16-NEXT:    v_lshl_or_b32 v1, v5, 16, v4
; GFX13-TRUE16-NEXT:    v_lshl_or_b32 v2, v9, 16, v8
; GFX13-TRUE16-NEXT:    s_mov_b64 s[0:1], 0
; GFX13-TRUE16-NEXT:    v_lshl_or_b32 v0, v6, 16, v0
; GFX13-TRUE16-NEXT:    s_mov_b32 s3, 0x31016000
; GFX13-TRUE16-NEXT:    s_mov_b32 s2, -1
...
; GFX13-FAKE16-NEXT:    s_wait_rtscnt 0x0
; GFX13-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-FAKE16-NEXT:    v_perm_b32 v12, v12, v13, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v13, v14, v15, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v8, v8, v9, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v9, v10, v11, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v4, v4, v5, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v5, v6, v7, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v0, v0, v1, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v6, v2, v3, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_lshl_or_b32 v3, v13, 16, v12
; GFX13-FAKE16-NEXT:    v_lshl_or_b32 v2, v9, 16, v8
; GFX13-FAKE16-NEXT:    v_lshl_or_b32 v1, v5, 16, v4
; GFX13-FAKE16-NEXT:    s_mov_b64 s[0:1], 0
; GFX13-FAKE16-NEXT:    v_lshl_or_b32 v0, v6, 16, v0
; GFX13-FAKE16-NEXT:    s_mov_b32 s3, 0x31016000
; GFX13-FAKE16-NEXT:    s_mov_b32 s2, -1
...
; GFX13-TRUE16-NEXT:    s_wait_rtscnt 0x0
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    scratch_load_u8 v31, off, s32
; GFX13-TRUE16-NEXT:    v_perm_b32 v12, v12, v13, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v13, v14, v15, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v8, v8, v9, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v9, v10, v11, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v10, v4, v5, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v11, v6, v7, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v0, v0, v1, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v14, v2, v3, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v1, v24, v25, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v4, v26, v27, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v5, v20, v21, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v7, v22, v23, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v15, v16, v17, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v16, v18, v19, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_perm_b32 v17, v28, v29, 0xc0c0004
; GFX13-TRUE16-NEXT:    v_lshl_or_b32 v3, v13, 16, v12
; GFX13-TRUE16-NEXT:    v_lshl_or_b32 v6, v4, 16, v1
; GFX13-TRUE16-NEXT:    v_lshl_or_b32 v5, v7, 16, v5
; GFX13-TRUE16-NEXT:    v_lshl_or_b32 v4, v16, 16, v15
; GFX13-TRUE16-NEXT:    v_lshl_or_b32 v2, v9, 16, v8
; GFX13-TRUE16-NEXT:    v_lshl_or_b32 v1, v11, 16, v10
; GFX13-TRUE16-NEXT:    v_lshl_or_b32 v0, v14, 16, v0
; GFX13-TRUE16-NEXT:    s_mov_b64 s[0:1], 16
; GFX13-TRUE16-NEXT:    s_mov_b32 s3, 0x31016000
; GFX13-TRUE16-NEXT:    s_mov_b32 s2, -1
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-TRUE16-NEXT:    v_perm_b32 v12, v30, v31, 0xc0c0004
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-TRUE16-NEXT:    v_lshl_or_b32 v7, v12, 16, v17
...
; GFX13-FAKE16-NEXT:    v_perm_b32 v8, v8, v9, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v9, v10, v11, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v10, v4, v5, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v11, v6, v7, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v0, v0, v1, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v14, v2, v3, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v1, v28, v29, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v4, v24, v25, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v5, v26, v27, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v7, v20, v21, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v15, v22, v23, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v16, v16, v17, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_perm_b32 v17, v18, v19, 0xc0c0004
; GFX13-FAKE16-NEXT:    v_lshl_or_b32 v3, v13, 16, v12
; GFX13-FAKE16-NEXT:    v_lshl_or_b32 v6, v5, 16, v4
; GFX13-FAKE16-NEXT:    v_lshl_or_b32 v5, v15, 16, v7
; GFX13-FAKE16-NEXT:    v_lshl_or_b32 v2, v9, 16, v8
; GFX13-FAKE16-NEXT:    v_lshl_or_b32 v4, v17, 16, v16
; GFX13-FAKE16-NEXT:    v_lshl_or_b32 v0, v14, 16, v0
; GFX13-FAKE16-NEXT:    s_mov_b64 s[0:1], 16
; GFX13-FAKE16-NEXT:    s_mov_b32 s3, 0x31016000
; GFX13-FAKE16-NEXT:    s_mov_b32 s2, -1
; GFX13-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-FAKE16-NEXT:    v_perm_b32 v12, v30, v31, 0xc0c0004
; GFX13-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-FAKE16-NEXT:    v_lshl_or_b32 v7, v12, 16, v1
; GFX13-FAKE16-NEXT:    v_lshl_or_b32 v1, v11, 16, v10
