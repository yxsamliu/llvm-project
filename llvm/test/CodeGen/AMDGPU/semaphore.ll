...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1260 < %s | FileCheck -check-prefix=GFX1260 %s
...
; GFX1260-NEXT:    s_sema_signal 1
; GFX1260-NEXT:    s_sema_signal 2
; GFX1260-NEXT:    s_sema_signal 49
; GFX1260-NEXT:    s_sema_wait 1
; GFX1260-NEXT:    s_sema_wait 2
; GFX1260-NEXT:    s_sema_wait 1
...
;
; GFX1260-LABEL: test_sema_non_kernel:
; GFX1260:       ; %bb.0:
...
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_sema_callee_func:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
...
; GFX13-NEXT:    s_endpgm
;
; GFX1260-LABEL: test_sema_calling_kernel_1:
; GFX1260:       ; %bb.0:
...
; GFX1260-NEXT:    s_add_nc_u64 s[8:9], s[4:5], 40
...
; GFX13-NEXT:    s_endpgm
;
; GFX1260-LABEL: test_sema_calling_kernel_2:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_mov_b32 s32, 0
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_mov_b64 s[10:11], s[6:7]
