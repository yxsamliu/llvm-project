...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[0:3], v[0:3], s[8:11]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x9
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[4:7], v[4:7], s[12:15]
...
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xa
; GFX1251-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[28:31], v[28:31], s[56:59]
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[16:19], v[16:19], s[52:55]
...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[20:23], v[20:23], s[40:43]
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[8:11], v[8:11], s[36:39]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x4
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[46:49], v[46:49], s[48:51]
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[42:45], v[42:45], s[44:47]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x3
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[50:53], v[50:53], s[20:23]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x2
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[36:39], v[36:39], s[24:27]
...
; GFX1251-SDAG-NEXT:    global_load_b128 v[50:53], v40, s[0:1] offset:16
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xa
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[0:3], v[0:3], s[8:11]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x9
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[4:7], v[4:7], s[12:15]
...
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xa
; GFX1251-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[28:31], v[28:31], s[56:59]
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[16:19], v[16:19], s[52:55]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x8
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[24:27], v[24:27], s[64:67]
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[12:15], v[12:15], s[60:63]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x6
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[20:23], v[20:23], s[40:43]
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[8:11], v[8:11], s[36:39]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x4
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[46:49], v[46:49], s[48:51]
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[42:45], v[42:45], s[44:47]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x3
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[50:53], v[50:53], s[20:23]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x2
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[36:39], v[36:39], s[24:27]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x1
