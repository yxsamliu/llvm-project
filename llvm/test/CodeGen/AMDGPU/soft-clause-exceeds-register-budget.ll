...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_load_dword s1, s[4:5], 0x18
; CHECK-NEXT:    s_lshl_b32 s2, s6, 8
; CHECK-NEXT:    s_mov_b32 s0, 0x5397829d
; CHECK-NEXT:    v_mov_b32_e32 v2, 0
; CHECK-NEXT:    v_mov_b32_e32 v3, 0
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_add_i32 s1, s1, s2
; CHECK-NEXT:    v_add_u32_e32 v1, s1, v0
; CHECK-NEXT:    v_mul_hi_u32 v1, v1, s0
; CHECK-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; CHECK-NEXT:    s_load_dwordx4 s[8:11], s[4:5], 0x10
; CHECK-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
; CHECK-NEXT:    v_lshrrev_b32_e32 v28, 4, v1
; CHECK-NEXT:    v_mov_b32_e32 v4, 0
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_mov_b32_e32 v1, s9
; CHECK-NEXT:    v_add_co_u32_e32 v0, vcc, s8, v0
...
; CHECK-NEXT:  BB0_1: ; %for.cond28.preheader
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    global_load_dword v35, v[0:1], off
; CHECK-NEXT:    global_load_dword v36, v[0:1], off offset:196
; CHECK-NEXT:    global_load_dword v37, v[0:1], off offset:392
; CHECK-NEXT:    global_load_dword v38, v[0:1], off offset:588
; CHECK-NEXT:    s_add_u32 s6, s0, s4
; CHECK-NEXT:    s_addc_u32 s7, s1, s5
; CHECK-NEXT:    s_load_dwordx16 s[8:23], s[6:7], 0x0
; CHECK-NEXT:    s_load_dwordx16 s[36:51], s[6:7], 0x40
; CHECK-NEXT:    s_load_dwordx16 s[52:67], s[6:7], 0x1000
; CHECK-NEXT:    s_load_dwordx16 s[68:83], s[6:7], 0x1040
; CHECK-NEXT:    s_add_u32 s4, s4, 0x4000
; CHECK-NEXT:    v_add_co_u32_e32 v0, vcc, 0x310, v0
; CHECK-NEXT:    s_addc_u32 s5, s5, 0
; CHECK-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_writelane_b32 v43, s68, 0
; CHECK-NEXT:    v_writelane_b32 v43, s69, 1
; CHECK-NEXT:    v_writelane_b32 v43, s70, 2
; CHECK-NEXT:    v_writelane_b32 v43, s71, 3
; CHECK-NEXT:    v_writelane_b32 v43, s72, 4
; CHECK-NEXT:    v_writelane_b32 v43, s73, 5
; CHECK-NEXT:    v_writelane_b32 v43, s74, 6
; CHECK-NEXT:    v_writelane_b32 v43, s75, 7
; CHECK-NEXT:    v_writelane_b32 v43, s76, 8
; CHECK-NEXT:    v_writelane_b32 v43, s77, 9
; CHECK-NEXT:    v_writelane_b32 v43, s78, 10
; CHECK-NEXT:    v_writelane_b32 v43, s79, 11
; CHECK-NEXT:    v_writelane_b32 v43, s80, 12
; CHECK-NEXT:    v_writelane_b32 v43, s81, 13
; CHECK-NEXT:    v_writelane_b32 v43, s82, 14
; CHECK-NEXT:    v_writelane_b32 v43, s83, 15
; CHECK-NEXT:    s_load_dwordx16 s[68:83], s[6:7], 0x2000
; CHECK-NEXT:    s_cmp_lg_u32 s4, 0x800000
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_writelane_b32 v43, s68, 16
; CHECK-NEXT:    v_writelane_b32 v43, s69, 17
; CHECK-NEXT:    v_writelane_b32 v43, s70, 18
; CHECK-NEXT:    v_writelane_b32 v43, s71, 19
; CHECK-NEXT:    v_writelane_b32 v43, s72, 20
; CHECK-NEXT:    v_writelane_b32 v43, s73, 21
; CHECK-NEXT:    v_writelane_b32 v43, s74, 22
; CHECK-NEXT:    v_writelane_b32 v43, s75, 23
; CHECK-NEXT:    v_writelane_b32 v43, s76, 24
; CHECK-NEXT:    v_writelane_b32 v43, s77, 25
; CHECK-NEXT:    v_writelane_b32 v43, s78, 26
; CHECK-NEXT:    v_writelane_b32 v43, s79, 27
; CHECK-NEXT:    v_writelane_b32 v43, s80, 28
; CHECK-NEXT:    v_writelane_b32 v43, s81, 29
; CHECK-NEXT:    v_writelane_b32 v43, s82, 30
; CHECK-NEXT:    v_writelane_b32 v43, s83, 31
; CHECK-NEXT:    v_readlane_b32 s68, v43, 0
; CHECK-NEXT:    v_readlane_b32 s69, v43, 1
; CHECK-NEXT:    v_readlane_b32 s70, v43, 2
; CHECK-NEXT:    v_readlane_b32 s71, v43, 3
; CHECK-NEXT:    v_readlane_b32 s72, v43, 4
; CHECK-NEXT:    v_readlane_b32 s73, v43, 5
; CHECK-NEXT:    v_readlane_b32 s74, v43, 6
; CHECK-NEXT:    v_readlane_b32 s75, v43, 7
; CHECK-NEXT:    v_readlane_b32 s76, v43, 8
; CHECK-NEXT:    v_readlane_b32 s77, v43, 9
; CHECK-NEXT:    v_readlane_b32 s78, v43, 10
; CHECK-NEXT:    v_readlane_b32 s79, v43, 11
; CHECK-NEXT:    v_readlane_b32 s80, v43, 12
; CHECK-NEXT:    v_readlane_b32 s81, v43, 13
; CHECK-NEXT:    v_readlane_b32 s82, v43, 14
; CHECK-NEXT:    v_readlane_b32 s83, v43, 15
; CHECK-NEXT:    s_waitcnt vmcnt(3)
; CHECK-NEXT:    v_fmac_f32_e32 v34, s8, v35
; CHECK-NEXT:    v_fmac_f32_e32 v33, s9, v35
; CHECK-NEXT:    v_fmac_f32_e32 v32, s10, v35
; CHECK-NEXT:    v_fmac_f32_e32 v31, s11, v35
; CHECK-NEXT:    v_fmac_f32_e32 v30, s12, v35
; CHECK-NEXT:    v_fmac_f32_e32 v29, s13, v35
; CHECK-NEXT:    v_fmac_f32_e32 v27, s14, v35
; CHECK-NEXT:    v_fmac_f32_e32 v26, s15, v35
; CHECK-NEXT:    v_fmac_f32_e32 v25, s16, v35
; CHECK-NEXT:    v_fmac_f32_e32 v24, s17, v35
; CHECK-NEXT:    v_fmac_f32_e32 v23, s18, v35
; CHECK-NEXT:    v_fmac_f32_e32 v22, s19, v35
; CHECK-NEXT:    v_fmac_f32_e32 v21, s20, v35
; CHECK-NEXT:    v_fmac_f32_e32 v20, s21, v35
; CHECK-NEXT:    v_fmac_f32_e32 v19, s22, v35
; CHECK-NEXT:    v_fmac_f32_e32 v18, s23, v35
; CHECK-NEXT:    s_load_dwordx16 s[8:23], s[6:7], 0x2040
; CHECK-NEXT:    v_fmac_f32_e32 v17, s36, v35
; CHECK-NEXT:    v_fmac_f32_e32 v16, s37, v35
; CHECK-NEXT:    v_fmac_f32_e32 v15, s38, v35
; CHECK-NEXT:    v_fmac_f32_e32 v14, s39, v35
; CHECK-NEXT:    v_fmac_f32_e32 v9, s40, v35
; CHECK-NEXT:    v_fmac_f32_e32 v8, s41, v35
; CHECK-NEXT:    v_fmac_f32_e32 v7, s42, v35
; CHECK-NEXT:    v_fmac_f32_e32 v6, s43, v35
; CHECK-NEXT:    v_fmac_f32_e32 v5, s44, v35
; CHECK-NEXT:    v_fmac_f32_e32 v4, s45, v35
; CHECK-NEXT:    v_fmac_f32_e32 v3, s46, v35
; CHECK-NEXT:    v_fmac_f32_e32 v2, s47, v35
; CHECK-NEXT:    v_fmac_f32_e32 v10, s48, v35
; CHECK-NEXT:    v_fmac_f32_e32 v11, s49, v35
; CHECK-NEXT:    v_fmac_f32_e32 v12, s50, v35
; CHECK-NEXT:    v_fmac_f32_e32 v13, s51, v35
; CHECK-NEXT:    s_load_dwordx16 s[36:51], s[6:7], 0x3000
; CHECK-NEXT:    s_waitcnt vmcnt(2)
; CHECK-NEXT:    v_fmac_f32_e32 v34, s52, v36
; CHECK-NEXT:    v_fmac_f32_e32 v33, s53, v36
; CHECK-NEXT:    v_fmac_f32_e32 v32, s54, v36
; CHECK-NEXT:    v_fmac_f32_e32 v31, s55, v36
; CHECK-NEXT:    v_fmac_f32_e32 v30, s56, v36
; CHECK-NEXT:    v_fmac_f32_e32 v29, s57, v36
; CHECK-NEXT:    v_fmac_f32_e32 v27, s58, v36
; CHECK-NEXT:    v_fmac_f32_e32 v26, s59, v36
; CHECK-NEXT:    v_fmac_f32_e32 v25, s60, v36
; CHECK-NEXT:    v_fmac_f32_e32 v24, s61, v36
; CHECK-NEXT:    v_fmac_f32_e32 v23, s62, v36
; CHECK-NEXT:    v_fmac_f32_e32 v22, s63, v36
; CHECK-NEXT:    v_fmac_f32_e32 v21, s64, v36
; CHECK-NEXT:    v_fmac_f32_e32 v20, s65, v36
; CHECK-NEXT:    v_fmac_f32_e32 v19, s66, v36
; CHECK-NEXT:    v_fmac_f32_e32 v18, s67, v36
; CHECK-NEXT:    s_load_dwordx16 s[52:67], s[6:7], 0x3040
; CHECK-NEXT:    v_fmac_f32_e32 v17, s68, v36
; CHECK-NEXT:    v_fmac_f32_e32 v16, s69, v36
; CHECK-NEXT:    v_fmac_f32_e32 v15, s70, v36
; CHECK-NEXT:    v_fmac_f32_e32 v14, s71, v36
; CHECK-NEXT:    v_fmac_f32_e32 v9, s72, v36
; CHECK-NEXT:    v_fmac_f32_e32 v8, s73, v36
; CHECK-NEXT:    v_fmac_f32_e32 v7, s74, v36
; CHECK-NEXT:    v_fmac_f32_e32 v6, s75, v36
; CHECK-NEXT:    v_fmac_f32_e32 v5, s76, v36
; CHECK-NEXT:    v_fmac_f32_e32 v4, s77, v36
; CHECK-NEXT:    v_fmac_f32_e32 v3, s78, v36
; CHECK-NEXT:    v_fmac_f32_e32 v2, s79, v36
; CHECK-NEXT:    v_fmac_f32_e32 v10, s80, v36
; CHECK-NEXT:    v_fmac_f32_e32 v11, s81, v36
; CHECK-NEXT:    v_fmac_f32_e32 v12, s82, v36
; CHECK-NEXT:    v_fmac_f32_e32 v13, s83, v36
; CHECK-NEXT:    v_readlane_b32 s68, v43, 16
; CHECK-NEXT:    v_readlane_b32 s69, v43, 17
; CHECK-NEXT:    v_readlane_b32 s70, v43, 18
; CHECK-NEXT:    v_readlane_b32 s71, v43, 19
; CHECK-NEXT:    v_readlane_b32 s72, v43, 20
; CHECK-NEXT:    v_readlane_b32 s73, v43, 21
; CHECK-NEXT:    v_readlane_b32 s74, v43, 22
; CHECK-NEXT:    v_readlane_b32 s75, v43, 23
; CHECK-NEXT:    v_readlane_b32 s76, v43, 24
; CHECK-NEXT:    v_readlane_b32 s77, v43, 25
; CHECK-NEXT:    v_readlane_b32 s78, v43, 26
; CHECK-NEXT:    v_readlane_b32 s79, v43, 27
; CHECK-NEXT:    v_readlane_b32 s80, v43, 28
; CHECK-NEXT:    v_readlane_b32 s81, v43, 29
; CHECK-NEXT:    v_readlane_b32 s82, v43, 30
; CHECK-NEXT:    v_readlane_b32 s83, v43, 31
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    v_fmac_f32_e32 v34, s68, v37
; CHECK-NEXT:    v_fmac_f32_e32 v33, s69, v37
; CHECK-NEXT:    v_fmac_f32_e32 v32, s70, v37
; CHECK-NEXT:    v_fmac_f32_e32 v31, s71, v37
; CHECK-NEXT:    v_fmac_f32_e32 v30, s72, v37
; CHECK-NEXT:    v_fmac_f32_e32 v29, s73, v37
; CHECK-NEXT:    v_fmac_f32_e32 v27, s74, v37
; CHECK-NEXT:    v_fmac_f32_e32 v26, s75, v37
; CHECK-NEXT:    v_fmac_f32_e32 v25, s76, v37
; CHECK-NEXT:    v_fmac_f32_e32 v24, s77, v37
; CHECK-NEXT:    v_fmac_f32_e32 v23, s78, v37
; CHECK-NEXT:    v_fmac_f32_e32 v22, s79, v37
; CHECK-NEXT:    v_fmac_f32_e32 v21, s80, v37
; CHECK-NEXT:    v_fmac_f32_e32 v20, s81, v37
; CHECK-NEXT:    v_fmac_f32_e32 v19, s82, v37
; CHECK-NEXT:    v_fmac_f32_e32 v18, s83, v37
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_fmac_f32_e32 v17, s8, v37
; CHECK-NEXT:    v_fmac_f32_e32 v16, s9, v37
; CHECK-NEXT:    v_fmac_f32_e32 v15, s10, v37
; CHECK-NEXT:    v_fmac_f32_e32 v14, s11, v37
; CHECK-NEXT:    v_fmac_f32_e32 v9, s12, v37
; CHECK-NEXT:    v_fmac_f32_e32 v8, s13, v37
; CHECK-NEXT:    v_fmac_f32_e32 v7, s14, v37
; CHECK-NEXT:    v_fmac_f32_e32 v6, s15, v37
; CHECK-NEXT:    v_fmac_f32_e32 v5, s16, v37
; CHECK-NEXT:    v_fmac_f32_e32 v4, s17, v37
; CHECK-NEXT:    v_fmac_f32_e32 v3, s18, v37
; CHECK-NEXT:    v_fmac_f32_e32 v2, s19, v37
...
; CHECK-NEXT:    v_fmac_f32_e32 v29, s41, v38
; CHECK-NEXT:    v_fmac_f32_e32 v27, s42, v38
; CHECK-NEXT:    v_fmac_f32_e32 v26, s43, v38
; CHECK-NEXT:    v_fmac_f32_e32 v25, s44, v38
; CHECK-NEXT:    v_fmac_f32_e32 v24, s45, v38
; CHECK-NEXT:    v_fmac_f32_e32 v23, s46, v38
; CHECK-NEXT:    v_fmac_f32_e32 v22, s47, v38
; CHECK-NEXT:    v_fmac_f32_e32 v21, s48, v38
; CHECK-NEXT:    v_fmac_f32_e32 v20, s49, v38
; CHECK-NEXT:    v_fmac_f32_e32 v19, s50, v38
; CHECK-NEXT:    v_fmac_f32_e32 v18, s51, v38
; CHECK-NEXT:    v_fmac_f32_e32 v17, s52, v38
; CHECK-NEXT:    v_fmac_f32_e32 v16, s53, v38
; CHECK-NEXT:    v_fmac_f32_e32 v15, s54, v38
; CHECK-NEXT:    v_fmac_f32_e32 v14, s55, v38
; CHECK-NEXT:    v_fmac_f32_e32 v9, s56, v38
; CHECK-NEXT:    v_fmac_f32_e32 v8, s57, v38
; CHECK-NEXT:    v_fmac_f32_e32 v7, s58, v38
; CHECK-NEXT:    v_fmac_f32_e32 v6, s59, v38
; CHECK-NEXT:    v_fmac_f32_e32 v5, s60, v38
; CHECK-NEXT:    v_fmac_f32_e32 v4, s61, v38
; CHECK-NEXT:    v_fmac_f32_e32 v3, s62, v38
; CHECK-NEXT:    v_fmac_f32_e32 v2, s63, v38
; CHECK-NEXT:    v_fmac_f32_e32 v10, s64, v38
; CHECK-NEXT:    v_fmac_f32_e32 v11, s65, v38
; CHECK-NEXT:    v_fmac_f32_e32 v12, s66, v38
; CHECK-NEXT:    v_fmac_f32_e32 v13, s67, v38
; CHECK-NEXT:    s_cbranch_scc1 BB0_1
; CHECK-NEXT:  ; %bb.2: ; %for.cond.cleanup26
; CHECK-NEXT:    s_mov_b32 s0, 0x31000
; CHECK-NEXT:    v_mul_lo_u32 v0, v28, s0
; CHECK-NEXT:    v_mov_b32_e32 v1, 0
; CHECK-NEXT:    v_mov_b32_e32 v28, s3
; CHECK-NEXT:    s_mov_b32 s0, 0
; CHECK-NEXT:    v_lshlrev_b64 v[35:36], 2, v[0:1]
; CHECK-NEXT:    s_mov_b32 s1, s0
; CHECK-NEXT:    v_add_co_u32_e32 v35, vcc, s2, v35
; CHECK-NEXT:    v_addc_co_u32_e32 v36, vcc, v28, v36, vcc
; CHECK-NEXT:    v_add_co_u32_e32 v28, vcc, 0x310, v35
...
; CHECK-NEXT:    global_store_dword v[35:36], v29, off offset:3920
; CHECK-NEXT:    v_addc_co_u32_e32 v29, vcc, 0, v36, vcc
; CHECK-NEXT:    v_add_co_u32_e32 v32, vcc, 0x620, v35
; CHECK-NEXT:    v_addc_co_u32_e32 v33, vcc, 0, v36, vcc
; CHECK-NEXT:    v_add_co_u32_e32 v37, vcc, 0x930, v35
; CHECK-NEXT:    v_addc_co_u32_e32 v38, vcc, 0, v36, vcc
; CHECK-NEXT:    v_add_co_u32_e32 v39, vcc, 0xc40, v35
; CHECK-NEXT:    v_mov_b32_e32 v31, s1
; CHECK-NEXT:    v_mov_b32_e32 v30, s0
; CHECK-NEXT:    v_addc_co_u32_e32 v40, vcc, 0, v36, vcc
; CHECK-NEXT:    s_movk_i32 s0, 0xf50
; CHECK-NEXT:    v_add_co_u32_e32 v41, vcc, s0, v35
; CHECK-NEXT:    v_addc_co_u32_e32 v42, vcc, 0, v36, vcc
; CHECK-NEXT:    v_add_co_u32_e32 v0, vcc, s0, v28
; CHECK-NEXT:    global_store_dwordx2 v[35:36], v[30:31], off offset:840
; CHECK-NEXT:    global_store_dword v[35:36], v1, off offset:3924
; CHECK-NEXT:    global_store_dword v[28:29], v1, off offset:3924
; CHECK-NEXT:    global_store_dword v[28:29], v27, off offset:3920
; CHECK-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v29, vcc
...
; CHECK-NEXT:    v_add_co_u32_e32 v28, vcc, s0, v37
; CHECK-NEXT:    v_addc_co_u32_e32 v29, vcc, 0, v38, vcc
; CHECK-NEXT:    global_store_dwordx2 v[37:38], v[30:31], off offset:3976
; CHECK-NEXT:    global_store_dword v[37:38], v25, off offset:3920
; CHECK-NEXT:    global_store_dword v[39:40], v24, off offset:3920
; CHECK-NEXT:    v_add_co_u32_e32 v24, vcc, s0, v39
; CHECK-NEXT:    v_addc_co_u32_e32 v25, vcc, 0, v40, vcc
; CHECK-NEXT:    v_add_co_u32_e32 v30, vcc, s0, v41
; CHECK-NEXT:    v_addc_co_u32_e32 v31, vcc, 0, v42, vcc
; CHECK-NEXT:    global_store_dword v[0:1], v22, off offset:3920
; CHECK-NEXT:    v_add_co_u32_e32 v0, vcc, s0, v0
; CHECK-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; CHECK-NEXT:    global_store_dword v[41:42], v23, off offset:3920
...
; CHECK-NEXT:    v_add_co_u32_e32 v26, vcc, s0, v28
; CHECK-NEXT:    v_addc_co_u32_e32 v27, vcc, 0, v29, vcc
; CHECK-NEXT:    global_store_dword v[24:25], v19, off offset:3920
; CHECK-NEXT:    v_add_co_u32_e32 v19, vcc, s0, v24
; CHECK-NEXT:    global_store_dword v[28:29], v20, off offset:3920
; CHECK-NEXT:    v_addc_co_u32_e32 v20, vcc, 0, v25, vcc
; CHECK-NEXT:    v_add_co_u32_e32 v23, vcc, s0, v30
; CHECK-NEXT:    v_addc_co_u32_e32 v24, vcc, 0, v31, vcc
; CHECK-NEXT:    global_store_dword v[0:1], v17, off offset:3920
; CHECK-NEXT:    v_add_co_u32_e32 v0, vcc, s0, v0
; CHECK-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; CHECK-NEXT:    global_store_dword v[21:22], v16, off offset:3920
; CHECK-NEXT:    v_add_co_u32_e32 v16, vcc, s0, v21
; CHECK-NEXT:    v_addc_co_u32_e32 v17, vcc, 0, v22, vcc
; CHECK-NEXT:    v_add_co_u32_e32 v21, vcc, s0, v26
; CHECK-NEXT:    v_addc_co_u32_e32 v22, vcc, 0, v27, vcc
; CHECK-NEXT:    global_store_dword v[30:31], v18, off offset:3920
; CHECK-NEXT:    global_store_dword v[19:20], v14, off offset:3920
; CHECK-NEXT:    v_add_co_u32_e32 v14, vcc, s0, v19
; CHECK-NEXT:    global_store_dword v[26:27], v15, off offset:3920
; CHECK-NEXT:    v_addc_co_u32_e32 v15, vcc, 0, v20, vcc
; CHECK-NEXT:    v_add_co_u32_e32 v18, vcc, s0, v23
; CHECK-NEXT:    v_addc_co_u32_e32 v19, vcc, 0, v24, vcc
; CHECK-NEXT:    global_store_dword v[0:1], v8, off offset:3920
; CHECK-NEXT:    v_add_co_u32_e32 v0, vcc, s0, v0
; CHECK-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; CHECK-NEXT:    global_store_dword v[16:17], v7, off offset:3920
; CHECK-NEXT:    v_add_co_u32_e32 v7, vcc, s0, v16
; CHECK-NEXT:    v_addc_co_u32_e32 v8, vcc, 0, v17, vcc
; CHECK-NEXT:    v_add_co_u32_e32 v16, vcc, s0, v21
; CHECK-NEXT:    v_addc_co_u32_e32 v17, vcc, 0, v22, vcc
; CHECK-NEXT:    v_add_co_u32_e32 v20, vcc, s0, v14
; CHECK-NEXT:    global_store_dword v[21:22], v6, off offset:3920
; CHECK-NEXT:    v_addc_co_u32_e32 v21, vcc, 0, v15, vcc
; CHECK-NEXT:    global_store_dword v[23:24], v9, off offset:3920
; CHECK-NEXT:    global_store_dword v[14:15], v5, off offset:3920
; CHECK-NEXT:    v_add_co_u32_e32 v5, vcc, s0, v18
; CHECK-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v19, vcc
; CHECK-NEXT:    v_add_co_u32_e32 v14, vcc, s0, v0
; CHECK-NEXT:    global_store_dword v[18:19], v4, off offset:3920
; CHECK-NEXT:    v_addc_co_u32_e32 v15, vcc, 0, v1, vcc
; CHECK-NEXT:    global_store_dword v[0:1], v3, off offset:3920
; CHECK-NEXT:    global_store_dword v[7:8], v2, off offset:3920
; CHECK-NEXT:    global_store_dword v[16:17], v10, off offset:3920
; CHECK-NEXT:    global_store_dword v[20:21], v11, off offset:3920
; CHECK-NEXT:    global_store_dword v[5:6], v12, off offset:3920
; CHECK-NEXT:    global_store_dword v[14:15], v13, off offset:3920
; CHECK-NEXT:    s_endpgm
