...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX1260-LABEL: test_add_u64_ss:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_add_nc_u64 s[0:1], s[0:1], s[2:3]
; GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1260-NEXT:    v_mov_b32_e32 v0, s0
; GFX1260-NEXT:    v_mov_b32_e32 v1, s1
; GFX1260-NEXT:    ; return to shader part epilog
; GFX_LIT64-LABEL: test_add_u64_ss:
; GFX_LIT64:       ; %bb.0:
; GFX_LIT64-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX_LIT64-NEXT:    s_add_nc_u64 s[0:1], s[0:1], s[2:3]
; GFX_LIT64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX_LIT64-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX_LIT64-NEXT:    ; return to shader part epilog
  %add = add i64 %a, %b
  %ret = bitcast i64 %add to <2 x float>
  ret <2 x float> %ret
...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX1260-LABEL: test_add_u64_v_inline_lit:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX1260-LABEL: test_add_u64_v_small_imm:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_add_nc_u64_e32 v[0:1], 0x1f4, v[0:1]
; GFX1260-NEXT:    ; return to shader part epilog
...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX1260-LABEL: test_add_u64_v_64bit_imm:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_add_nc_u64_e32 v[0:1], 0x13b9ac9ff, v[0:1]
; GFX1260-NEXT:    ; return to shader part epilog
...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX1260-LABEL: test_add_u64_s_small_imm:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 0x1f4
; GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1260-NEXT:    v_mov_b32_e32 v0, s0
; GFX1260-NEXT:    v_mov_b32_e32 v1, s1
; GFX1260-NEXT:    ; return to shader part epilog
; GFX_LIT64-LABEL: test_add_u64_s_small_imm:
; GFX_LIT64:       ; %bb.0:
; GFX_LIT64-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX_LIT64-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 0x1f4
; GFX_LIT64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX_LIT64-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX_LIT64-NEXT:    ; return to shader part epilog
  %add = add i64 %a, 500
