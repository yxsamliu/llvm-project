; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1260 < %s | FileCheck -check-prefix=GCN %s
; RUN: llc -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1260 < %s | FileCheck -check-prefix=MESA %s

; GFX1250 supports upto 660 KB configurable LDS memory.
; This test checks the min and max size of LDS that can be allocated.

@lds.i8 = addrspace(3) global i8 undef
@lds.array.i8 = addrspace(3) global [675839 x i8] undef
@lds.i16 = addrspace(3) global i16 undef
@lds.array.i16 = addrspace(3) global [337919 x i16] undef
@lds.i32 = addrspace(3) global i32 undef
@lds.array.i32 = addrspace(3) global [168959 x i32] undef
...
; GCN: .amdhsa_group_segment_fixed_size 675840
; GCN: ; LDSByteSize: 675840 bytes/workgroup
; MESA: granulated_lds_size = 165
define amdgpu_kernel void @test_lds_array_i8() {
  %gep = getelementptr inbounds [675839 x i8], ptr addrspace(3) @lds.array.i8, i32 0, i32 5
...
define amdgpu_kernel void @test_lds_array_i16() {
  %gep = getelementptr inbounds [337919 x i16], ptr addrspace(3) @lds.array.i16, i32 0, i32 10
...
define amdgpu_kernel void @test_lds_array_i32() {
  %gep = getelementptr inbounds [168959 x i32], ptr addrspace(3) @lds.array.i32, i32 0, i32 20
