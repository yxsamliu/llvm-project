...
; SICI-DAG: s_mov_b32 s3, 0
; SICI-DAG: s_mov_b32 s2, s1
; SICI-DAG: s_mov_b32 s1, s3
; SICI-DAG: s_load_dwordx2 s[{{.*}}], s[0:1], 0x0
; SICI-DAG: s_load_dwordx2 s[{{.*}}], s[2:3], 0x4
; VIGFX9-DAG: s_mov_b32 s6, s1
; VIGFX9-DAG: s_mov_b32 s7, 0
; VIGFX9-DAG: s_mov_b32 s1, s7
; VIGFX9-DAG: s_load_dwordx2 s[{{.*}}], s[0:1], 0x0
; VIGFX9-DAG: s_load_dwordx2 s[{{.*}}], s[6:7], 0x10
