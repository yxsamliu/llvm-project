...
; GFX13-NEXT:    image_msaa_load v[0:3], [v7, v6, v5, v4], s[0:7] dmask:0x4 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm ; encoding: [0x07,0x20,0x20,0xe5,0x00,0x00,0x00,0x00,0x07,0x06,0x05,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v5, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x04,0x04]
; GFX13-NEXT:    image_msaa_load v[0:1], [v5, v4, v2, v3], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm d16 ; encoding: [0x27,0x20,0x60,0xe4,0x00,0x00,0x00,0x00,0x05,0x04,0x02,0x03]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
