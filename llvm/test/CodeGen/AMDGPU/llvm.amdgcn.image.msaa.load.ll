...
; GFX13-NEXT:    image_msaa_load v[0:3], [v6, v5, v4], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm ; encoding: [0x06,0x20,0x60,0xe4,0x00,0x00,0x00,0x00,0x06,0x05,0x04,0x00]
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v7, v3 :: v_dual_mov_b32 v4, v2 ; encoding: [0x03,0x01,0x10,0xca,0x02,0x01,0x04,0x07]
; GFX13-NEXT:    v_dual_mov_b32 v5, v1 :: v_dual_mov_b32 v6, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x06,0x05]
; GFX13-NEXT:    image_msaa_load v[0:3], [v6, v5, v4, v7], s[0:7] dmask:0x4 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm ; encoding: [0x07,0x20,0x20,0xe5,0x00,0x00,0x00,0x00,0x06,0x05,0x04,0x07]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v9, 0 :: v_dual_mov_b32 v8, v3 ; encoding: [0x80,0x00,0x10,0xca,0x03,0x01,0x08,0x09]
; GFX13-NEXT:    v_dual_mov_b32 v5, v2 :: v_dual_mov_b32 v6, v1 ; encoding: [0x02,0x01,0x10,0xca,0x01,0x01,0x06,0x05]
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3) ; encoding: [0xb2,0x01,0xae,0xbf]
; GFX13-NEXT:    v_dual_mov_b32 v7, v0 :: v_dual_mov_b32 v10, v9 ; encoding: [0x00,0x01,0x10,0xca,0x09,0x01,0x0a,0x07]
...
; GFX13-NEXT:    image_msaa_load v[0:4], [v7, v6, v5, v8], s[0:7] dmask:0x8 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm tfe ; encoding: [0x0f,0x20,0x20,0xe6,0x00,0x00,0x00,0x00,0x07,0x06,0x05,0x08]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    global_store_b32 v9, v4, s[8:9] ; encoding: [0x08,0x00,0x07,0xee,0x00,0x00,0x00,0x02,0x09,0x00,0x00,0x00]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_dual_mov_b32 v4, v2 :: v_dual_mov_b32 v5, v1 ; encoding: [0x02,0x01,0x10,0xca,0x01,0x01,0x04,0x04]
; GFX13-NEXT:    v_mov_b32_e32 v6, v0 ; encoding: [0x00,0x03,0x0c,0x7e]
; GFX13-NEXT:    image_msaa_load v[0:3], [v6, v5, v4], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm th:TH_LOAD_NT ; encoding: [0x06,0x20,0x60,0xe4,0x00,0x00,0x10,0x00,0x06,0x05,0x04,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_dual_mov_b32 v4, v2 :: v_dual_mov_b32 v5, v1 ; encoding: [0x02,0x01,0x10,0xca,0x01,0x01,0x04,0x04]
; GFX13-NEXT:    v_mov_b32_e32 v6, v0 ; encoding: [0x00,0x03,0x0c,0x7e]
; GFX13-NEXT:    image_msaa_load v[0:3], [v6, v5, v4], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm th:TH_LOAD_HT ; encoding: [0x06,0x20,0x60,0xe4,0x00,0x00,0x20,0x00,0x06,0x05,0x04,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_dual_mov_b32 v4, v2 :: v_dual_mov_b32 v5, v1 ; encoding: [0x02,0x01,0x10,0xca,0x01,0x01,0x04,0x04]
; GFX13-NEXT:    v_mov_b32_e32 v6, v0 ; encoding: [0x00,0x03,0x0c,0x7e]
; GFX13-NEXT:    image_msaa_load v[0:3], [v6, v5, v4], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm th:TH_LOAD_LU ; encoding: [0x06,0x20,0x60,0xe4,0x00,0x00,0x30,0x00,0x06,0x05,0x04,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v4, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x04,0x03]
; GFX13-NEXT:    image_msaa_load v[0:1], [v4, v3, v2], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm d16 ; encoding: [0x26,0x20,0x60,0xe4,0x00,0x00,0x00,0x00,0x04,0x03,0x02,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v5, v1 :: v_dual_mov_b32 v4, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x04,0x05]
; GFX13-NEXT:    image_msaa_load v[0:1], [v4, v5, v2, v3], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm d16 ; encoding: [0x27,0x20,0x60,0xe4,0x00,0x00,0x00,0x00,0x04,0x05,0x02,0x03]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v5, v0 :: v_dual_mov_b32 v7, 0 ; encoding: [0x00,0x81,0x20,0xcf,0x80,0x00,0x00,0x00,0x05,0x00,0x00,0x07]
; GFX13-NEXT:    v_dual_mov_b32 v6, v2 :: v_dual_mov_b32 v4, v1 ; encoding: [0x02,0x81,0x20,0xcf,0x01,0x01,0x00,0x00,0x06,0x00,0x00,0x04]
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1) ; encoding: [0x92,0x00,0xae,0xbf]
...
; GFX13-NEXT:    image_msaa_load v[0:2], [v5, v4, v6, v3], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm tfe d16 ; encoding: [0x2f,0x20,0x60,0xe4,0x00,0x00,0x00,0x00,0x05,0x04,0x06,0x03]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    global_store_b32 v7, v2, s[8:9] ; encoding: [0x08,0x00,0x07,0xee,0x00,0x00,0x00,0x01,0x07,0x00,0x00,0x00]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v5.l, v0.l ; encoding: [0x00,0x39,0x0a,0x7e]
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v5.h, v1.l ; encoding: [0x01,0x39,0x0a,0x7f]
; GFX13-TRUE16-NEXT:    image_msaa_load v[0:3], [v5, v4], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm a16 ; encoding: [0x46,0x20,0x60,0xe4,0x00,0x00,0x00,0x00,0x05,0x04,0x00,0x00]
...
; GFX13-FAKE16-NEXT:    v_perm_b32 v5, v1, v0, 0x5040100 ; encoding: [0x05,0x00,0x44,0xd7,0x01,0x01,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX13-FAKE16-NEXT:    image_msaa_load v[0:3], [v5, v4], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm a16 ; encoding: [0x46,0x20,0x60,0xe4,0x00,0x00,0x00,0x00,0x05,0x04,0x00,0x00]
...
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v5.l, v0.l ; encoding: [0x00,0x39,0x0a,0x7e]
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v5.h, v1.l ; encoding: [0x01,0x39,0x0a,0x7f]
; GFX13-TRUE16-NEXT:    image_msaa_load v[0:3], [v5, v4], s[0:7] dmask:0x4 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm a16 ; encoding: [0x47,0x20,0x20,0xe5,0x00,0x00,0x00,0x00,0x05,0x04,0x00,0x00]
; GFX13-TRUE16-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-TRUE16-NEXT:    ; return to shader part epilog
;
; GFX13-FAKE16-LABEL: load_2darraymsaa_a16:
; GFX13-FAKE16:       ; %bb.0: ; %main_body
; GFX13-FAKE16-NEXT:    v_perm_b32 v4, v3, v2, 0x5040100 ; encoding: [0x04,0x00,0x44,0xd7,0x03,0x05,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX13-FAKE16-NEXT:    v_perm_b32 v5, v1, v0, 0x5040100 ; encoding: [0x05,0x00,0x44,0xd7,0x01,0x01,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX13-FAKE16-NEXT:    image_msaa_load v[0:3], [v5, v4], s[0:7] dmask:0x4 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm a16 ; encoding: [0x47,0x20,0x20,0xe5,0x00,0x00,0x00,0x00,0x05,0x04,0x00,0x00]
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-FAKE16-NEXT:    ; return to shader part epilog
main_body:
