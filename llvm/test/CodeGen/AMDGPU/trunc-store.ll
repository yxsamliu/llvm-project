...
;
; GFX13-LABEL: truncstore_v5i32_to_v5i1:
; GFX13:       ; %bb.0:
...
; GFX13-NEXT:    v_and_b32_e32 v4, 1, v4
; GFX13-NEXT:    v_and_b32_e32 v5, 1, v5
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX13-NEXT:    v_lshlrev_b16 v3, 1, v3
; GFX13-NEXT:    v_lshlrev_b16 v4, 2, v4
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX13-NEXT:    v_lshlrev_b16 v5, 3, v5
; GFX13-NEXT:    v_bitop3_b16 v2, v2, v3, 1 bitop3:0xec
; GFX13-NEXT:    v_lshlrev_b16 v3, 4, v6
...
; GFX13-NEXT:    v_bitop3_b16 v2, v2, v3, 0xff bitop3:0xec
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: truncstore_v6i32_to_v6i1:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    v_bitop3_b16 v2, v2, v3, 0xff bitop3:0xec
; GFX13-NEXT:    v_bitop3_b16 v3, v4, v5, 0xff bitop3:0xec
; GFX13-NEXT:    v_lshlrev_b16 v4, 8, v7
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX13-NEXT:    v_and_b32_e32 v2, 0xffff, v2
; GFX13-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: truncstore_v6i32_to_v6i16:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: truncstore_v10i32_to_v10i16:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    s_wait_rtscnt 0x0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    v_perm_b32 v7, v7, v6, 0x5040100
; GFX13-NEXT:    v_perm_b32 v6, v5, v4, 0x5040100
; GFX13-NEXT:    v_perm_b32 v4, v11, v10, 0x5040100
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: truncstore_v18i32_to_v18i16:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    v_perm_b32 v7, v7, v6, 0x5040100
; GFX13-NEXT:    v_perm_b32 v6, v5, v4, 0x5040100
; GFX13-NEXT:    v_perm_b32 v4, v19, v18, 0x5040100
; GFX13-NEXT:    v_perm_b32 v16, v17, v16, 0x5040100
; GFX13-NEXT:    v_perm_b32 v15, v15, v14, 0x5040100
; GFX13-NEXT:    v_perm_b32 v14, v13, v12, 0x5040100
; GFX13-NEXT:    v_perm_b32 v13, v11, v10, 0x5040100
; GFX13-NEXT:    v_perm_b32 v8, v9, v8, 0x5040100
; GFX13-NEXT:    v_perm_b32 v5, v3, v2, 0x5040100
; GFX13-NEXT:    s_clause 0x2
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: truncstore_v36i32_to_v36i16:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    s_wait_rtscnt 0x0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_clause 0x6
; GFX13-NEXT:    scratch_load_b32 v31, off, s32
; GFX13-NEXT:    scratch_load_b32 v32, off, s32 offset:8
; GFX13-NEXT:    scratch_load_b32 v33, off, s32 offset:4
; GFX13-NEXT:    scratch_load_b32 v34, off, s32 offset:16
; GFX13-NEXT:    scratch_load_b32 v35, off, s32 offset:24
; GFX13-NEXT:    scratch_load_b32 v36, off, s32 offset:20
; GFX13-NEXT:    scratch_load_b32 v37, off, s32 offset:12
; GFX13-NEXT:    v_perm_b32 v16, v17, v16, 0x5040100
; GFX13-NEXT:    v_perm_b32 v15, v15, v14, 0x5040100
; GFX13-NEXT:    v_perm_b32 v14, v13, v12, 0x5040100
; GFX13-NEXT:    v_perm_b32 v13, v11, v10, 0x5040100
...
; GFX13-NEXT:    v_perm_b32 v6, v5, v4, 0x5040100
; GFX13-NEXT:    v_perm_b32 v5, v3, v2, 0x5040100
; GFX13-NEXT:    v_perm_b32 v10, v21, v20, 0x5040100
; GFX13-NEXT:    v_perm_b32 v9, v19, v18, 0x5040100
; GFX13-NEXT:    v_perm_b32 v18, v29, v28, 0x5040100
; GFX13-NEXT:    v_perm_b32 v17, v27, v26, 0x5040100
; GFX13-NEXT:    v_perm_b32 v12, v25, v24, 0x5040100
; GFX13-NEXT:    v_perm_b32 v11, v23, v22, 0x5040100
; GFX13-NEXT:    s_wait_loadcnt 0x6
; GFX13-NEXT:    v_perm_b32 v19, v31, v30, 0x5040100
; GFX13-NEXT:    s_wait_loadcnt 0x4
; GFX13-NEXT:    v_perm_b32 v20, v32, v33, 0x5040100
; GFX13-NEXT:    s_wait_loadcnt 0x1
; GFX13-NEXT:    v_perm_b32 v3, v35, v36, 0x5040100
