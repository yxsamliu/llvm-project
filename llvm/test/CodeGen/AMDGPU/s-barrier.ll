...
; GFX13-GISEL-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-SDAG-LABEL: func2:
; GFX1260-SDAG:       ; %bb.0:
; GFX1260-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1260-SDAG-NEXT:    s_mov_b32 m0, 1
; GFX1260-SDAG-NEXT:    s_barrier_join m0
; GFX1260-SDAG-NEXT:    s_mov_b32 m0, 0x70001
; GFX1260-SDAG-NEXT:    s_barrier_signal m0
; GFX1260-SDAG-NEXT:    s_barrier_wait 1
; GFX1260-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-GISEL-LABEL: func2:
; GFX1260-GISEL:       ; %bb.0:
; GFX1260-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1260-GISEL-NEXT:    s_mov_b32 m0, 0x70001
; GFX1260-GISEL-NEXT:    s_barrier_join 1
; GFX1260-GISEL-NEXT:    s_barrier_signal m0
; GFX1260-GISEL-NEXT:    s_barrier_wait 1
; GFX1260-GISEL-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX13-SDAG-NEXT:    s_mov_b64 s[6:7], s[2:3]
; GFX13-SDAG-NEXT:    s_load_b32 s2, s[4:5], 0x2c
...
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    s_lshr_b32 s2, s2, 4
...
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    s_swap_pc_i64 s[30:31], s[2:3]
; GFX13-SDAG-NEXT:    s_get_barrier_state s0, -1
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: kernel1:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_mov_b64 s[12:13], s[4:5]
; GFX13-GISEL-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GFX13-GISEL-NEXT:    s_load_b32 s0, s[12:13], 0x2c
...
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    s_swap_pc_i64 s[30:31], s[0:1]
; GFX13-GISEL-NEXT:    s_get_barrier_state s0, -1
...
; GFX1260-SDAG-NEXT:    s_mov_b32 m0, 0xc0002
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v31, v0
; GFX1260-SDAG-NEXT:    s_barrier_init m0
...
; GFX1260-SDAG-NEXT:    s_and_b32 s2, s2, 63
; GFX1260-SDAG-NEXT:    s_or_b32 s3, 0x90000, s2
; GFX1260-SDAG-NEXT:    s_cmp_eq_u32 0, 0
; GFX1260-SDAG-NEXT:    s_mov_b32 m0, s3
; GFX1260-SDAG-NEXT:    s_barrier_init m0
; GFX1260-SDAG-NEXT:    s_mov_b32 m0, 0xc0002
; GFX1260-SDAG-NEXT:    s_barrier_signal m0
; GFX1260-SDAG-NEXT:    s_mov_b32 m0, s3
...
; GFX1260-SDAG-NEXT:    s_barrier_signal -1
; GFX1260-SDAG-NEXT:    s_barrier_join m0
...
; GFX1260-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1260-SDAG-NEXT:    s_get_pc_i64 s[2:3]
; GFX1260-SDAG-NEXT:    s_add_nc_u64 s[2:3], s[2:3], func1@gotpcrel+4
; GFX1260-SDAG-NEXT:    s_barrier_signal -1
; GFX1260-SDAG-NEXT:    s_load_b64 s[2:3], s[2:3], 0x0
; GFX1260-SDAG-NEXT:    s_barrier_wait -1
; GFX1260-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1260-SDAG-NEXT:    s_swap_pc_i64 s[30:31], s[2:3]
; GFX1260-SDAG-NEXT:    s_get_pc_i64 s[2:3]
; GFX1260-SDAG-NEXT:    s_add_nc_u64 s[2:3], s[2:3], func2@gotpcrel+4
; GFX1260-SDAG-NEXT:    s_load_b64 s[2:3], s[2:3], 0x0
; GFX1260-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1260-SDAG-NEXT:    s_swap_pc_i64 s[30:31], s[2:3]
; GFX1260-SDAG-NEXT:    s_get_barrier_state s0, -1
...
; GFX1260-GISEL-NEXT:    s_mov_b32 m0, 0xc0002
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v31, v0
...
; GFX1260-GISEL-NEXT:    s_and_b32 s0, s0, 63
; GFX1260-GISEL-NEXT:    s_or_b32 s1, s0, 0x90000
; GFX1260-GISEL-NEXT:    s_cmp_eq_u32 0, 0
; GFX1260-GISEL-NEXT:    s_mov_b32 m0, s1
; GFX1260-GISEL-NEXT:    s_barrier_init m0
; GFX1260-GISEL-NEXT:    s_mov_b32 m0, 0xc0002
; GFX1260-GISEL-NEXT:    s_barrier_signal m0
; GFX1260-GISEL-NEXT:    s_mov_b32 m0, s1
; GFX1260-GISEL-NEXT:    s_barrier_signal m0
; GFX1260-GISEL-NEXT:    s_mov_b32 m0, s0
...
; GFX1260-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1260-GISEL-NEXT:    s_get_pc_i64 s[0:1]
...
; GFX1260-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1260-GISEL-NEXT:    s_swap_pc_i64 s[30:31], s[0:1]
; GFX1260-GISEL-NEXT:    s_get_barrier_state s0, -1
...
; GFX13-GISEL-NEXT:    s_movk_i32 m0, 0x7002
; GFX13-GISEL-NEXT:    s_add_co_ci_u32 s9, s5, 0
; GFX13-GISEL-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GFX13-GISEL-NEXT:    s_mov_b64 s[6:7], s[2:3]
; GFX13-GISEL-NEXT:    s_mov_b32 s32, 0
; GFX13-GISEL-NEXT:    s_barrier_signal m0
...
; GFX1260-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-SDAG-NEXT:    s_mov_b64 s[10:11], s[6:7]
; GFX1260-SDAG-NEXT:    s_get_pc_i64 s[6:7]
; GFX1260-SDAG-NEXT:    s_add_nc_u64 s[6:7], s[6:7], func2@gotpcrel+4
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v31, v0
; GFX1260-SDAG-NEXT:    s_load_b64 s[12:13], s[6:7], 0x0
; GFX1260-SDAG-NEXT:    s_mov_b32 m0, 0x70002
; GFX1260-SDAG-NEXT:    s_add_nc_u64 s[8:9], s[4:5], 48
; GFX1260-SDAG-NEXT:    s_barrier_signal m0
; GFX1260-SDAG-NEXT:    s_mov_b32 m0, 2
; GFX1260-SDAG-NEXT:    s_mov_b64 s[4:5], s[0:1]
...
; GFX1260-SDAG-NEXT:    s_barrier_wait 1
; GFX1260-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1260-SDAG-NEXT:    s_swap_pc_i64 s[30:31], s[12:13]
; GFX1260-SDAG-NEXT:    s_endpgm
;
...
; GFX1260-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-GISEL-NEXT:    s_mov_b64 s[10:11], s[6:7]
; GFX1260-GISEL-NEXT:    s_get_pc_i64 s[6:7]
; GFX1260-GISEL-NEXT:    s_add_nc_u64 s[6:7], s[6:7], func2@gotpcrel+4
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v31, v0
; GFX1260-GISEL-NEXT:    s_load_b64 s[12:13], s[6:7], 0x0
; GFX1260-GISEL-NEXT:    s_add_co_u32 s8, s4, 48
; GFX1260-GISEL-NEXT:    s_mov_b32 m0, 0x70002
; GFX1260-GISEL-NEXT:    s_add_co_ci_u32 s9, s5, 0
; GFX1260-GISEL-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GFX1260-GISEL-NEXT:    s_wait_xcnt 0x0
; GFX1260-GISEL-NEXT:    s_mov_b64 s[6:7], s[2:3]
; GFX1260-GISEL-NEXT:    s_barrier_signal m0
...
; GFX1260-GISEL-NEXT:    s_barrier_wait 1
; GFX1260-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1260-GISEL-NEXT:    s_swap_pc_i64 s[30:31], s[12:13]
; GFX1260-GISEL-NEXT:    s_endpgm
...
; GFX12-NEXT:    s_endpgm
;
; GFX13-LABEL: test_barrier_leave_write_to_scc:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_cmp_lg_u32 s0, 0
; GFX13-NEXT:    s_movk_i32 s0, 0x7b
; GFX13-NEXT:    s_barrier_leave 1
; GFX13-NEXT:    s_cselect_b32 s0, s0, 0x1c8
