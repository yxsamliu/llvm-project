...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs -mattr=+real-true16 | FileCheck -check-prefixes=GFX13,GFX13-TRUE16 %s
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs -mattr=-real-true16 | FileCheck -check-prefixes=GFX13,GFX13-FAKE16 %s
...
; GFX13-NEXT:    buffer_store_b128 v[1:4], v13, v0, null idxen
; GFX13-NEXT:    buffer_store_b128 v[5:8], v13, v0, null idxen th:TH_STORE_NT
; GFX13-NEXT:    buffer_store_b128 v[9:12], v13, v0, null idxen th:TH_STORE_HT
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13-NEXT:    buffer_store_b128 v[1:4], v5, v0, null idxen offset:42
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    buffer_store_b128 v[1:4], v5, v0, null idxen
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13-NEXT:    buffer_store_b128 v[1:4], v[5:6], v0, null idxen offen
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13-NEXT:    buffer_store_b128 v[1:4], v[6:7], v0, null idxen offen
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13-NEXT:    buffer_store_b128 v[1:4], v5, v0, null idxen
; GFX13-NEXT:    buffer_load_b128 v[1:4], v6, v0, null idxen
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    buffer_store_b128 v[1:4], v7, v0, null idxen
; GFX13-NEXT:    s_endpgm
main_body:
  call void @llvm.amdgcn.struct.buffer.store.v4f32(<4 x float> %1, i32 %0, i32 %2, i32 0, i32 0, i32 0)
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    buffer_store_b64 v[1:2], v3, v0, null idxen
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13-NEXT:    s_clause 0x2
; GFX13-NEXT:    buffer_store_b128 v[1:4], v8, v0, null idxen
; GFX13-NEXT:    buffer_store_b64 v[5:6], v8, v0, null idxen th:TH_STORE_NT
; GFX13-NEXT:    buffer_store_b32 v7, v8, v0, null idxen th:TH_STORE_HT
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13-TRUE16:       ; %bb.0:
; GFX13-TRUE16-NEXT:    v_cvt_f16_f32_e32 v1.l, v1
; GFX13-TRUE16-NEXT:    buffer_store_b16 v1, v2, v0, null idxen
; GFX13-TRUE16-NEXT:    s_endpgm
;
; GFX13-FAKE16-LABEL: struct_buffer_store_f16:
; GFX13-FAKE16:       ; %bb.0:
; GFX13-FAKE16-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX13-FAKE16-NEXT:    buffer_store_b16 v1, v2, v0, null idxen
