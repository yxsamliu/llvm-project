...
; GCN-IR-NEXT:    v_cndmask_b32_e32 v4, v0, v1, vcc
; GCN-IR-NEXT:    v_mov_b32_e32 v0, s15
; GCN-IR-NEXT:    v_mov_b32_e32 v1, s14
; GCN-IR-NEXT:    v_cmp_eq_u32_e64 vcc, s11, 0
; GCN-IR-NEXT:    v_cndmask_b32_e32 v5, v0, v1, vcc
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, v4, v5
...
; GCN-IR-NEXT:    v_addc_u32_e32 v3, vcc, 0, v1, vcc
; GCN-IR-NEXT:    v_cmp_lt_u64_e64 s[0:1], v[2:3], v[0:1]
...
; GCN-IR-NEXT:    v_lshr_b64 v[6:7], s[10:11], v2
; GCN-IR-NEXT:    v_not_b32_e32 v2, v4
; GCN-IR-NEXT:    s_add_u32 s10, s6, -1
; GCN-IR-NEXT:    v_add_i32_e32 v4, vcc, v2, v5
...
; GCN-IR-NEXT:    v_cndmask_b32_e32 v0, v7, v0, vcc
...
; GCN-IR-NEXT:    v_cndmask_b32_e32 v13, v8, v7, vcc
...
; GCN-IR-NEXT:    v_or_b32_e32 v0, v15, v0
; GCN-IR-NEXT:    v_lshl_b64 v[7:8], v[7:8], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v11, vcc, v18, v0
; GCN-IR-NEXT:    v_subb_u32_e32 v11, vcc, v19, v16, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v7, v13, v7
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v13, 31, v11
; GCN-IR-NEXT:    v_and_b32_e32 v15, v13, v2
; GCN-IR-NEXT:    v_and_b32_e32 v11, 1, v13
; GCN-IR-NEXT:    v_and_b32_e32 v17, v13, v3
; GCN-IR-NEXT:    v_add_i32_e32 v13, vcc, 1, v9
; GCN-IR-NEXT:    v_or_b32_e32 v8, v14, v8
; GCN-IR-NEXT:    v_addc_u32_e32 v14, vcc, 0, v10, vcc
; GCN-IR-NEXT:    v_cmp_lt_u64_e32 vcc, v[13:14], v[9:10]
; GCN-IR-NEXT:    v_mov_b32_e32 v9, v13
; GCN-IR-NEXT:    v_mov_b32_e32 v12, 0
; GCN-IR-NEXT:    v_sub_i32_e64 v15, s[4:5], v0, v15
; GCN-IR-NEXT:    v_mov_b32_e32 v10, v14
; GCN-IR-NEXT:    v_mov_b32_e32 v14, v12
; GCN-IR-NEXT:    v_subb_u32_e64 v16, s[4:5], v16, v17, s[4:5]
...
; GCN-IR-NEXT:    v_cmp_eq_u32_e64 vcc, s7, 0
; GCN-IR-NEXT:    v_cndmask_b32_e32 v4, v0, v1, vcc
; GCN-IR-NEXT:    v_add_i32_e32 v0, vcc, 0xffffffc5, v4
...
; GCN-IR-NEXT:    v_sub_i32_e32 v4, vcc, 58, v4
; GCN-IR-NEXT:    v_mov_b32_e32 v8, 0
