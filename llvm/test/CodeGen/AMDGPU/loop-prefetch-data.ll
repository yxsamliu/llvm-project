...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1260 -amdgpu-loop-prefetch < %s | FileCheck --check-prefix=GFX1260 %s
...
; GFX12ES2-SPREFETCH-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_SCHED_MODE, 0, 2), 0
...
; GFX1260-NEXT:    s_cmp_eq_u32 s6, 0
; GFX1260-NEXT:    s_cbranch_scc1 .LBB0_3
; GFX1260-NEXT:  ; %bb.1: ; %for.body.preheader
; GFX1260-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1260-NEXT:    v_mov_b32_e32 v0, 0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_add_nc_u64 s[2:3], s[2:3], 0xb0
; GFX1260-NEXT:  .LBB0_2: ; %for.body
; GFX1260-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1260-NEXT:    flat_load_b128 v[2:5], v0, s[2:3] offset:-176
; GFX1260-NEXT:    flat_prefetch_b8 v0, s[2:3] scope:SCOPE_SE
; GFX1260-NEXT:    s_add_co_i32 s6, s6, -1
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    s_add_nc_u64 s[2:3], s[2:3], 16
; GFX1260-NEXT:    s_cmp_lg_u32 s6, 0
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    flat_store_b128 v0, v[2:5], s[0:1]
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 16
; GFX1260-NEXT:    s_cbranch_scc1 .LBB0_2
; GFX1260-NEXT:  .LBB0_3: ; %for.end
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: copy_global:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_load_b32 s6, s[4:5], 0x34
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_cmp_eq_u32 s6, 0
; GFX1260-NEXT:    s_cbranch_scc1 .LBB1_3
; GFX1260-NEXT:  ; %bb.1: ; %for.body.preheader
; GFX1260-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1260-NEXT:    v_mov_b32_e32 v0, 0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_add_nc_u64 s[2:3], s[2:3], 0xb0
; GFX1260-NEXT:  .LBB1_2: ; %for.body
; GFX1260-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1260-NEXT:    global_load_b128 v[2:5], v0, s[2:3] offset:-176
; GFX1260-NEXT:    global_prefetch_b8 v0, s[2:3] scope:SCOPE_SE
; GFX1260-NEXT:    s_add_co_i32 s6, s6, -1
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    s_add_nc_u64 s[2:3], s[2:3], 16
; GFX1260-NEXT:    s_cmp_lg_u32 s6, 0
; GFX1260-NEXT:    s_wait_loadcnt 0x0
; GFX1260-NEXT:    global_store_b128 v0, v[2:5], s[0:1]
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 16
; GFX1260-NEXT:    s_cbranch_scc1 .LBB1_2
; GFX1260-NEXT:  .LBB1_3: ; %for.end
; GFX1260-NEXT:    s_endpgm
entry:
  %cmp6.not = icmp eq i32 %n, 0
  br i1 %cmp6.not, label %for.end, label %for.body
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: copy_constant:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_load_b32 s6, s[4:5], 0x34
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_cmp_eq_u32 s6, 0
; GFX1260-NEXT:    s_cbranch_scc1 .LBB2_3
; GFX1260-NEXT:  ; %bb.1: ; %for.body.preheader
; GFX1260-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1260-NEXT:    v_mov_b32_e32 v0, 0
; GFX1260-NEXT:  .LBB2_2: ; %for.body
; GFX1260-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_prefetch_b8 v0, s[2:3] offset:176 scope:SCOPE_SE
; GFX1260-NEXT:    s_load_b128 s[8:11], s[2:3], 0x0
; GFX1260-NEXT:    s_add_co_i32 s6, s6, -1
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    s_add_nc_u64 s[2:3], s[2:3], 16
; GFX1260-NEXT:    s_cmp_lg_u32 s6, 0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mov_b64_e32 v[2:3], s[8:9]
; GFX1260-NEXT:    v_mov_b64_e32 v[4:5], s[10:11]
; GFX1260-NEXT:    global_store_b128 v0, v[2:5], s[0:1]
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 16
; GFX1260-NEXT:    s_cbranch_scc1 .LBB2_2
; GFX1260-NEXT:  .LBB2_3: ; %for.end
; GFX1260-NEXT:    s_endpgm
entry:
  %cmp6.not = icmp eq i32 %n, 0
  br i1 %cmp6.not, label %for.end, label %for.body
...
; GFX1260-NEXT:  .LBB3_1: ; %for.body
; GFX1260-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1260-NEXT:    v_mov_b32_e32 v2, s1
; GFX1260-NEXT:    v_mov_b32_e32 v4, s0
; GFX1260-NEXT:    s_add_co_i32 s2, s2, -1
; GFX1260-NEXT:    s_add_co_i32 s0, s0, 16
; GFX1260-NEXT:    s_add_co_i32 s1, s1, 16
; GFX1260-NEXT:    ds_load_b64 v[0:1], v2 offset:8
; GFX1260-NEXT:    ds_load_b64 v[2:3], v2
; GFX1260-NEXT:    s_cmp_lg_u32 s2, 0
; GFX1260-NEXT:    s_wait_dscnt 0x1
; GFX1260-NEXT:    ds_store_b64 v4, v[0:1] offset:8
; GFX1260-NEXT:    s_wait_dscnt 0x1
; GFX1260-NEXT:    ds_store_b64 v4, v[2:3]
; GFX1260-NEXT:    s_cbranch_scc1 .LBB3_1
; GFX1260-NEXT:  .LBB3_2: ; %for.end
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: copy_flat_divergent:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_load_b32 s2, s[4:5], 0x34
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_cmp_eq_u32 s2, 0
; GFX1260-NEXT:    s_cbranch_scc1 .LBB4_3
; GFX1260-NEXT:  ; %bb.1: ; %for.body.preheader
; GFX1260-NEXT:    s_load_b128 s[8:11], s[4:5], 0x24
; GFX1260-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1260-NEXT:    v_mov_b32_e32 v1, 0
; GFX1260-NEXT:    s_mov_b64 s[0:1], 0xffffffffffffff50
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 4, v0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_add_nc_u64_e32 v[2:3], s[10:11], v[0:1]
; GFX1260-NEXT:    v_add_nc_u64_e32 v[0:1], s[8:9], v[0:1]
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1260-NEXT:    v_add_nc_u64_e32 v[2:3], 0xb0, v[2:3]
; GFX1260-NEXT:  .LBB4_2: ; %for.body
; GFX1260-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(SALU_CYCLE_1)
; GFX1260-NEXT:    v_add_nc_u64_e32 v[4:5], s[0:1], v[2:3]
; GFX1260-NEXT:    flat_prefetch_b8 v[2:3] scope:SCOPE_SE
; GFX1260-NEXT:    v_add_nc_u64_e32 v[2:3], 16, v[2:3]
; GFX1260-NEXT:    s_add_co_i32 s2, s2, -1
; GFX1260-NEXT:    s_cmp_lg_u32 s2, 0
; GFX1260-NEXT:    flat_load_b128 v[4:7], v[4:5]
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    flat_store_b128 v[0:1], v[4:7]
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_add_nc_u64_e32 v[0:1], 16, v[0:1]
; GFX1260-NEXT:    s_cbranch_scc1 .LBB4_2
; GFX1260-NEXT:  .LBB4_3: ; %for.end
; GFX1260-NEXT:    s_endpgm
entry:
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: copy_global_divergent:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_load_b32 s0, s[4:5], 0x34
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_cmp_eq_u32 s0, 0
; GFX1260-NEXT:    s_cbranch_scc1 .LBB5_3
; GFX1260-NEXT:  ; %bb.1: ; %for.body.preheader
; GFX1260-NEXT:    s_load_b128 s[8:11], s[4:5], 0x24
; GFX1260-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1260-NEXT:    v_mov_b32_e32 v1, 0
...
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1260-NEXT:    v_add_nc_u64_e32 v[2:3], 0xb0, v[2:3]
; GFX1260-NEXT:  .LBB5_2: ; %for.body
; GFX1260-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1260-NEXT:    global_load_b128 v[4:7], v[2:3], off offset:-176
; GFX1260-NEXT:    global_prefetch_b8 v[2:3], off scope:SCOPE_SE
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_add_nc_u64_e32 v[2:3], 16, v[2:3]
...
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    v_add_nc_u64_e32 v[0:1], 16, v[0:1]
; GFX1260-NEXT:    s_cbranch_scc1 .LBB5_2
; GFX1260-NEXT:  .LBB5_3: ; %for.end
; GFX1260-NEXT:    s_endpgm
entry:
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
