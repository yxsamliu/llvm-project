...
; RUN: llc -mcpu=gfx1300 -mattr=+real-true16 -mtriple=amdgcn-- < %s | FileCheck -check-prefixes=GFX13,GFX13-TRUE16 %s
; RUN: llc -mcpu=gfx1300 -mattr=-real-true16 -mtriple=amdgcn-- < %s | FileCheck -check-prefixes=GFX13,GFX13-FAKE16 %s
...
;
; GFX13-TRUE16-LABEL: main:
; GFX13-TRUE16:       ; %bb.0: ; %bb
; GFX13-TRUE16-NEXT:    s_mov_b32 s1, exec_lo
; GFX13-TRUE16-NEXT:  .LBB0_1: ; =>This Inner Loop Header: Depth=1
; GFX13-TRUE16-NEXT:    v_readfirstlane_b32 s4, v0
; GFX13-TRUE16-NEXT:    v_readfirstlane_b32 s5, v1
; GFX13-TRUE16-NEXT:    v_readfirstlane_b32 s6, v2
; GFX13-TRUE16-NEXT:    v_readfirstlane_b32 s7, v3
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-TRUE16-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[0:1]
; GFX13-TRUE16-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[2:3]
...
; GFX13-FAKE16-NEXT:    s_mov_b32 s1, exec_lo
; GFX13-FAKE16-NEXT:  .LBB0_1: ; =>This Inner Loop Header: Depth=1
; GFX13-FAKE16-NEXT:    v_readfirstlane_b32 s4, v0
; GFX13-FAKE16-NEXT:    v_readfirstlane_b32 s5, v1
; GFX13-FAKE16-NEXT:    v_readfirstlane_b32 s6, v2
; GFX13-FAKE16-NEXT:    v_readfirstlane_b32 s7, v3
; GFX13-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-FAKE16-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[0:1]
; GFX13-FAKE16-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[2:3]
; GFX13-FAKE16-NEXT:    s_and_b32 s0, vcc_lo, s0
