...
; GFX7-NEXT:    s_bcnt1_i32_b64 s2, exec
; GFX7-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, exec_hi, v0
; GFX7-NEXT:    v_cvt_f32_ubyte0_e32 v1, s2
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[2:3], v2, v3
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx2 s[4:5], s[0:1], 0xb
; GFX8-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, exec_lo, 0
; GFX8-NEXT:    s_bcnt1_i32_b64 s2, exec
; GFX8-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, exec_hi, v0
...
; GFX8-NEXT:    v_mov_b32_e32 v2, s10
; GFX8-NEXT:    v_add_f32_e32 v4, v3, v1
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    ds_cmpst_rtn_b32 v2, v2, v3, v4
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[2:3], v2, v3
; GFX8-NEXT:    s_or_b64 s[8:9], s[2:3], s[8:9]
