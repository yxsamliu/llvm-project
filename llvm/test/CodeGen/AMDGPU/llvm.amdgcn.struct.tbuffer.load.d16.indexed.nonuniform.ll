...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs -mattr=+real-true16 | FileCheck -enable-var-scope -check-prefixes=GFX13-PACKED,GFX13-PACKED-TRUE16 %s
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs -mattr=-real-true16 | FileCheck -enable-var-scope -check-prefixes=GFX13-PACKED,GFX13-PACKED-FAKE16 %s
...
; GFX13-PACKED-TRUE16-LABEL: tbuffer_load_d16_xy:
; GFX13-PACKED-TRUE16:       ; %bb.0: ; %main_body
; GFX13-PACKED-TRUE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-PACKED-TRUE16-NEXT:    tbuffer_load_d16_format_xy v0, v1, v0, null format:[BUF_FMT_32_FLOAT] idxen
; GFX13-PACKED-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-PACKED-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v0.h
; GFX13-PACKED-TRUE16-NEXT:    ; return to shader part epilog
;
; GFX13-PACKED-FAKE16-LABEL: tbuffer_load_d16_xy:
; GFX13-PACKED-FAKE16:       ; %bb.0: ; %main_body
; GFX13-PACKED-FAKE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-PACKED-FAKE16-NEXT:    tbuffer_load_d16_format_xy v0, v1, v0, null format:[BUF_FMT_32_FLOAT] idxen
; GFX13-PACKED-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-PACKED-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
...
; GFX13-PACKED-TRUE16:       ; %bb.0: ; %main_body
; GFX13-PACKED-TRUE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-PACKED-TRUE16-NEXT:    tbuffer_load_d16_format_xyz v[0:1], v1, v0, null format:[BUF_FMT_32_FLOAT] idxen
; GFX13-PACKED-TRUE16-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-PACKED-FAKE16:       ; %bb.0: ; %main_body
; GFX13-PACKED-FAKE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-PACKED-FAKE16-NEXT:    tbuffer_load_d16_format_xyz v[0:1], v1, v0, null format:[BUF_FMT_32_FLOAT] idxen
; GFX13-PACKED-FAKE16-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-PACKED-TRUE16-LABEL: tbuffer_load_d16_xyzw:
; GFX13-PACKED-TRUE16:       ; %bb.0: ; %main_body
; GFX13-PACKED-TRUE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-PACKED-TRUE16-NEXT:    tbuffer_load_d16_format_xyzw v[0:1], v1, v0, null format:[BUF_FMT_32_FLOAT] idxen
; GFX13-PACKED-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-PACKED-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v1.h
; GFX13-PACKED-TRUE16-NEXT:    ; return to shader part epilog
;
; GFX13-PACKED-FAKE16-LABEL: tbuffer_load_d16_xyzw:
; GFX13-PACKED-FAKE16:       ; %bb.0: ; %main_body
; GFX13-PACKED-FAKE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-PACKED-FAKE16-NEXT:    tbuffer_load_d16_format_xyzw v[0:1], v1, v0, null format:[BUF_FMT_32_FLOAT] idxen
; GFX13-PACKED-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-PACKED-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, 16, v1
; GFX13-PACKED-FAKE16-NEXT:    ; return to shader part epilog
main_body:
