...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1260 < %s | FileCheck --check-prefixes=GCN,GFX1250,GL2-ONLY %s
...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1260 -mattr=+safe-smem-prefetch < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX1250-SPREFETCH,GFX13-SPREFETCH-SDAG %s
...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1260 -mattr=+safe-cu-prefetch < %s | FileCheck --check-prefixes=GCN,GFX1250,SAFE-CU %s
...
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1260 < %s | FileCheck --check-prefixes=GCN,GFX1250,GL2-ONLY %s
...
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1260 -mattr=+safe-smem-prefetch < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX1250-SPREFETCH,GFX1250-SPREFETCH-GISEL %s
...
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1260 -mattr=+safe-cu-prefetch < %s | FileCheck --check-prefixes=GCN,GFX1250,SAFE-CU %s
