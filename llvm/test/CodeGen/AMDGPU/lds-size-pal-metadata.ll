...
; RUN: llc -mtriple=amdgcn--amdpal -mcpu=gfx1200 < %s | FileCheck -check-prefix=PAL-GFX12 %s
; RUN: llc -mtriple=amdgcn--amdpal -mcpu=gfx1300 < %s | FileCheck -check-prefix=PAL-GFX13 %s
...
; PAL-GFX12-LABEL: f1:
; PAL-GFX12:       ; %bb.0:
; PAL-GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
; PAL-GFX12-NEXT:    s_wait_expcnt 0x0
; PAL-GFX12-NEXT:    s_wait_samplecnt 0x0
; PAL-GFX12-NEXT:    s_wait_bvhcnt 0x0
; PAL-GFX12-NEXT:    s_wait_kmcnt 0x0
; PAL-GFX12-NEXT:    v_mov_b32_e32 v1, 0
; PAL-GFX12-NEXT:    ds_store_b32 v1, v0
; PAL-GFX12-NEXT:    s_wait_dscnt 0x0
; PAL-GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; PAL-GFX13-LABEL: f1:
; PAL-GFX13:       ; %bb.0:
; PAL-GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; PAL-GFX13-NEXT:    s_wait_expcnt 0x0
; PAL-GFX13-NEXT:    s_wait_samplecnt 0x0
; PAL-GFX13-NEXT:    s_wait_rtscnt 0x0
; PAL-GFX13-NEXT:    s_wait_kmcnt 0x0
; PAL-GFX13-NEXT:    v_mov_b32_e32 v1, 0
; PAL-GFX13-NEXT:    ds_store_b32 v1, v0
; PAL-GFX13-NEXT:    s_wait_dscnt 0x0
...
; PAL-GFX12-NEXT:    s_wait_bvhcnt 0x0
; PAL-GFX12-NEXT:    s_wait_kmcnt 0x0
; PAL-GFX12-NEXT:    global_store_b32 v[1:2], v0, off
; PAL-GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; PAL-GFX13-LABEL: f2:
; PAL-GFX13:       ; %bb.0:
