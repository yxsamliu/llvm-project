...
; RUN: llc -mtriple=amdgcn -mattr=+real-true16 -mcpu=gfx1260 < %s | FileCheck -check-prefixes=GFX1250-TRUE16 %s
; RUN: llc -mtriple=amdgcn -mattr=-real-true16 -mcpu=gfx1250 < %s | FileCheck -check-prefixes=GFX1250-FAKE16 %s
; RUN: llc -mtriple=amdgcn -mattr=-real-true16 -mcpu=gfx1260 < %s | FileCheck -check-prefixes=GFX1250-FAKE16 %s
; RUN: llc -mtriple=amdgcn -mattr=+real-true16 -mcpu=gfx1300 < %s | FileCheck -check-prefixes=GFX1300-TRUE16 %s
; RUN: llc -mtriple=amdgcn -mattr=-real-true16 -mcpu=gfx1300 < %s | FileCheck -check-prefixes=GFX1300-FAKE16 %s
...
; GFX1250-TRUE16-NEXT:    s_load_b96 s[0:2], s[4:5], 0x2c
; GFX1250-TRUE16-NEXT:    s_load_b64 s[6:7], s[4:5], 0x24
...
; GFX1250-FAKE16-NEXT:    s_load_b96 s[0:2], s[4:5], 0x2c
; GFX1250-FAKE16-NEXT:    s_load_b64 s[6:7], s[4:5], 0x24
...
; GFX1300-TRUE16-NEXT:    s_load_b96 s[0:2], s[4:5], 0x2c
; GFX1300-TRUE16-NEXT:    s_load_b64 s[4:5], s[4:5], 0x24
...
; GFX1300-FAKE16-NEXT:    s_load_b96 s[0:2], s[4:5], 0x2c
; GFX1300-FAKE16-NEXT:    s_load_b64 s[4:5], s[4:5], 0x24
