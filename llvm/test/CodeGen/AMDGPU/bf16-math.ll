...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1260 < %s | FileCheck --check-prefix=GCN %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 -mattr=+cu-stores,+real-true16 < %s | FileCheck --check-prefixes=GFX13,GCN-TRUE16 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 -mattr=+cu-stores,-real-true16 < %s | FileCheck --check-prefixes=GFX13,GCN-FAKE16 %s
...
; GCN-NEXT:    s_endpgm
;
; GCN-TRUE16-LABEL: llvm_sqrt_bf16_v:
; GCN-TRUE16:       ; %bb.0:
; GCN-TRUE16-NEXT:    v_sqrt_bf16_e32 v2.l, v2.l
; GCN-TRUE16-NEXT:    global_store_b16 v[0:1], v2, off
; GCN-TRUE16-NEXT:    s_endpgm
;
; GCN-FAKE16-LABEL: llvm_sqrt_bf16_v:
; GCN-FAKE16:       ; %bb.0:
; GCN-FAKE16-NEXT:    v_sqrt_bf16_e32 v2, v2
; GCN-FAKE16-NEXT:    global_store_b16 v[0:1], v2, off
...
; GCN-NEXT:    s_endpgm
;
; GCN-TRUE16-LABEL: llvm_sqrt_bf16_s:
; GCN-TRUE16:       ; %bb.0:
; GCN-TRUE16-NEXT:    v_sqrt_bf16_e32 v2.l, s0
; GCN-TRUE16-NEXT:    global_store_b16 v[0:1], v2, off
; GCN-TRUE16-NEXT:    s_endpgm
;
; GCN-FAKE16-LABEL: llvm_sqrt_bf16_s:
; GCN-FAKE16:       ; %bb.0:
; GCN-FAKE16-NEXT:    v_sqrt_bf16_e32 v2, s0
; GCN-FAKE16-NEXT:    global_store_b16 v[0:1], v2, off
; GCN-FAKE16-NEXT:    s_endpgm
  %sqrt = call bfloat @llvm.sqrt.bf16(bfloat %src)
  store bfloat %sqrt, ptr addrspace(1) %out, align 2
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_add_v2bf16_vv:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_add_bf16 v2, v2, v3
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_add_v2bf16_vs:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_add_bf16 v2, v2, s0
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
  %add = fadd <2 x bfloat> %a, %b
  store <2 x bfloat> %add, ptr addrspace(1) %out
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_add_v2bf16_ss:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_add_bf16 v2, s0, s1
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
  %add = fadd <2 x bfloat> %a, %b
  store <2 x bfloat> %add, ptr addrspace(1) %out
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_add_v2bf16_vc:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_add_bf16 v2, v2, 2.0 op_sel_hi:[1,0]
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_add_v2bf16_vl:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_add_bf16 v2, 0x42c83f80, v2
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_sub_v2bf16_vv:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_add_bf16 v2, v2, v3 neg_lo:[0,1] neg_hi:[0,1]
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_sub_v2bf16_vs:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_add_bf16 v2, v2, s0 neg_lo:[0,1] neg_hi:[0,1]
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
  %add = fsub <2 x bfloat> %a, %b
  store <2 x bfloat> %add, ptr addrspace(1) %out
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_sub_v2bf16_ss:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_add_bf16 v2, s0, s1 neg_lo:[0,1] neg_hi:[0,1]
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
  %add = fsub <2 x bfloat> %a, %b
  store <2 x bfloat> %add, ptr addrspace(1) %out
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_sub_v2bf16_vc:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_add_bf16 v2, v2, -2.0 op_sel_hi:[1,0]
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_sub_v2bf16_vl:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_add_bf16 v2, 0xc2c8bf80, v2
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_sub_v2bf16_lv:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_add_bf16 v2, 0x42c83f80, v2 neg_lo:[0,1] neg_hi:[0,1]
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_sub_v2bf16_iv:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_add_bf16 v2, v2, 1.0 op_sel_hi:[1,0] neg_lo:[1,0] neg_hi:[1,0]
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_mul_v2bf16_vv:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_mul_bf16 v2, v2, v3
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_mul_v2bf16_vs:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_mul_bf16 v2, v2, s0
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
  %mul = fmul <2 x bfloat> %a, %b
  store <2 x bfloat> %mul, ptr addrspace(1) %out
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_mul_v2bf16_ss:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_mul_bf16 v2, s0, s1
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
  %mul = fmul <2 x bfloat> %a, %b
  store <2 x bfloat> %mul, ptr addrspace(1) %out
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_mul_v2bf16_vc:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_mul_bf16 v2, v2, 0.5 op_sel_hi:[1,0]
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_mul_v2bf16_vl:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_mul_bf16 v2, 0x42c83f80, v2
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_min_v2bf16_vv:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_min_num_bf16 v2, v2, v3
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_min_v2bf16_vs:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_min_num_bf16 v2, v2, s0
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
  %min = call <2 x bfloat> @llvm.minnum.v2bf16(<2 x bfloat> %a, <2 x bfloat> %b)
  store <2 x bfloat> %min, ptr addrspace(1) %out
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_min_v2bf16_ss:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_min_num_bf16 v2, s0, s1
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
  %min = call <2 x bfloat> @llvm.minnum.v2bf16(<2 x bfloat> %a, <2 x bfloat> %b)
  store <2 x bfloat> %min, ptr addrspace(1) %out
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_min_v2bf16_vc:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_min_num_bf16 v2, v2, 0.5 op_sel_hi:[1,0]
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_min_v2bf16_vl:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_min_num_bf16 v2, 0x42c83f80, v2
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_max_v2bf16_vv:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_max_num_bf16 v2, v2, v3
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_max_v2bf16_vs:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_max_num_bf16 v2, v2, s0
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
  %max = call <2 x bfloat> @llvm.maxnum.v2bf16(<2 x bfloat> %a, <2 x bfloat> %b)
  store <2 x bfloat> %max, ptr addrspace(1) %out
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_max_v2bf16_ss:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_max_num_bf16 v2, s0, s1
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
  %max = call <2 x bfloat> @llvm.maxnum.v2bf16(<2 x bfloat> %a, <2 x bfloat> %b)
  store <2 x bfloat> %max, ptr addrspace(1) %out
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_max_v2bf16_vc:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_max_num_bf16 v2, v2, 0.5 op_sel_hi:[1,0]
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_max_v2bf16_vl:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_max_num_bf16 v2, 0x42c83f80, v2
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
;
; GFX13-LABEL: test_clamp_bf16:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_max_num_bf16 v0, v0, v0 clamp
...
; GCN-NEXT:    ; return to shader part epilog
;
; GCN-TRUE16-LABEL: test_clamp_bf16_s:
; GCN-TRUE16:       ; %bb.0:
; GCN-TRUE16-NEXT:    v_mov_b16_e32 v0.l, s0
; GCN-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-TRUE16-NEXT:    v_pk_max_num_bf16 v0, v0, v0 clamp
; GCN-TRUE16-NEXT:    ; return to shader part epilog
;
; GCN-FAKE16-LABEL: test_clamp_bf16_s:
; GCN-FAKE16:       ; %bb.0:
; GCN-FAKE16-NEXT:    v_pk_max_num_bf16 v0, s0, s0 clamp
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: test_clamp_v2bf16_s:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_max_num_bf16 v0, s0, s0 clamp
; GFX13-NEXT:    ; return to shader part epilog
  %max = call <2 x bfloat> @llvm.maxnum.v2bf16(<2 x bfloat> %src, <2 x bfloat> <bfloat 0.0, bfloat 0.0>)
  %clamp = call <2 x bfloat> @llvm.minnum.v2bf16(<2 x bfloat> %max, <2 x bfloat> <bfloat 1.0, bfloat 1.0>)
  %ret = bitcast <2 x bfloat> %clamp to float
...
; GCN-NEXT:    ; return to shader part epilog
;
; GCN-TRUE16-LABEL: test_clamp_bf16_folding:
; GCN-TRUE16:       ; %bb.0:
; GCN-TRUE16-NEXT:    v_exp_bf16_e32 v0.l, v0.l
; GCN-TRUE16-NEXT:    s_delay_alu instid0(TRANS32_DEP_1)
; GCN-TRUE16-NEXT:    v_pk_max_num_bf16 v0, v0, v0 clamp
; GCN-TRUE16-NEXT:    ; return to shader part epilog
;
; GCN-FAKE16-LABEL: test_clamp_bf16_folding:
; GCN-FAKE16:       ; %bb.0:
; GCN-FAKE16-NEXT:    v_exp_bf16_e32 v0, v0
; GCN-FAKE16-NEXT:    s_delay_alu instid0(TRANS32_DEP_1)
; GCN-FAKE16-NEXT:    v_pk_max_num_bf16 v0, v0, v0 clamp
; GCN-FAKE16-NEXT:    ; return to shader part epilog
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: test_clamp_v2bf16_folding:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_mul_bf16 v0, v0, v1 clamp
; GFX13-NEXT:    ; return to shader part epilog
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_mul_add_v2bf16_vvv:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_fma_bf16 v2, v2, v3, v4
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_mul_add_v2bf16_vss:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_fma_bf16 v2, v2, s0, s1
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
  %mul = fmul contract <2 x bfloat> %a, %b
  %add = fadd contract <2 x bfloat> %mul, %c
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_mul_add_v2bf16_sss:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_mov_b32_e32 v2, s2
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_pk_fma_bf16 v2, s0, s1, v2
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
  %mul = fmul contract <2 x bfloat> %a, %b
  %add = fadd contract <2 x bfloat> %mul, %c
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_mul_add_v2bf16_vsc:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_fma_bf16 v2, v2, s0, 0.5 op_sel_hi:[1,1,0]
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
  %mul = fmul contract <2 x bfloat> %a, %b
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_mul_add_v2bf16_vll:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_mov_b32 s0, 0x43484000
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    v_pk_fma_bf16 v2, 0x42c83f80, v2, s0
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_fma_v2bf16_vvv:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_fma_bf16 v2, v2, v3, v4
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_fma_v2bf16_vss:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_fma_bf16 v2, v2, s0, s1
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_fma_v2bf16_sss:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_mov_b32_e32 v2, s2
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_pk_fma_bf16 v2, s0, s1, v2
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_fma_v2bf16_vsc:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_pk_fma_bf16 v2, v2, s0, 0.5 op_sel_hi:[1,1,0]
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-LABEL: v_test_fma_v2bf16_vll:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_mov_b32 s0, 0x42c83f80
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    v_pk_fma_bf16 v2, v2, s0, 0x43484000
; GFX13-NEXT:    global_store_b32 v[0:1], v2, off
; GFX13-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GCN-TRUE16-LABEL: llvm_log2_bf16_v:
; GCN-TRUE16:       ; %bb.0:
; GCN-TRUE16-NEXT:    v_log_bf16_e32 v2.l, v2.l
; GCN-TRUE16-NEXT:    global_store_b16 v[0:1], v2, off
; GCN-TRUE16-NEXT:    s_endpgm
;
; GCN-FAKE16-LABEL: llvm_log2_bf16_v:
; GCN-FAKE16:       ; %bb.0:
; GCN-FAKE16-NEXT:    v_log_bf16_e32 v2, v2
; GCN-FAKE16-NEXT:    global_store_b16 v[0:1], v2, off
; GCN-FAKE16-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GCN-TRUE16-LABEL: llvm_log2_bf16_s:
; GCN-TRUE16:       ; %bb.0:
; GCN-TRUE16-NEXT:    v_log_bf16_e32 v2.l, s0
; GCN-TRUE16-NEXT:    global_store_b16 v[0:1], v2, off
; GCN-TRUE16-NEXT:    s_endpgm
;
; GCN-FAKE16-LABEL: llvm_log2_bf16_s:
; GCN-FAKE16:       ; %bb.0:
; GCN-FAKE16-NEXT:    v_log_bf16_e32 v2, s0
; GCN-FAKE16-NEXT:    global_store_b16 v[0:1], v2, off
; GCN-FAKE16-NEXT:    s_endpgm
  %log = call bfloat @llvm.log2.bf16(bfloat %src)
  store bfloat %log, ptr addrspace(1) %out, align 2
...
; GCN-NEXT:    s_endpgm
;
; GCN-TRUE16-LABEL: llvm_exp2_bf16_v:
; GCN-TRUE16:       ; %bb.0:
; GCN-TRUE16-NEXT:    v_exp_bf16_e32 v2.l, v2.l
; GCN-TRUE16-NEXT:    global_store_b16 v[0:1], v2, off
; GCN-TRUE16-NEXT:    s_endpgm
;
; GCN-FAKE16-LABEL: llvm_exp2_bf16_v:
; GCN-FAKE16:       ; %bb.0:
; GCN-FAKE16-NEXT:    v_exp_bf16_e32 v2, v2
; GCN-FAKE16-NEXT:    global_store_b16 v[0:1], v2, off
; GCN-FAKE16-NEXT:    s_endpgm
  %exp = call bfloat @llvm.exp2.bf16(bfloat %src)
...
; GCN-NEXT:    s_endpgm
;
; GCN-TRUE16-LABEL: llvm_exp2_bf16_s:
; GCN-TRUE16:       ; %bb.0:
; GCN-TRUE16-NEXT:    v_exp_bf16_e32 v2.l, s0
; GCN-TRUE16-NEXT:    global_store_b16 v[0:1], v2, off
; GCN-TRUE16-NEXT:    s_endpgm
;
; GCN-FAKE16-LABEL: llvm_exp2_bf16_s:
; GCN-FAKE16:       ; %bb.0:
; GCN-FAKE16-NEXT:    v_exp_bf16_e32 v2, s0
; GCN-FAKE16-NEXT:    global_store_b16 v[0:1], v2, off
; GCN-FAKE16-NEXT:    s_endpgm
  %exp = call bfloat @llvm.exp2.bf16(bfloat %src)
  store bfloat %exp, ptr addrspace(1) %out, align 2
