...
; GFX1260-NEXT:    buffer_atomic_add_f32 v0, v[2:3], s[0:3], s16 idxen offen
...
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    buffer_atomic_add_f32 v0, v1, s[0:3], s16 idxen
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1260-NEXT:    v_mov_b32_e32 v3, v2
; GFX1260-NEXT:    v_mov_b32_e32 v2, v1
; GFX1260-NEXT:    buffer_atomic_add_f32 v0, v[2:3], s[0:3], s16 idxen offen th:TH_ATOMIC_NT
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: struct_ptr_buffer_atomic_add_v2f16_noret__vgpr_val__sgpr_rsrc__vgpr_voffset__sgpr_soffset:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v3, v2
; GFX1260-NEXT:    v_mov_b32_e32 v2, v1
; GFX1260-NEXT:    buffer_atomic_pk_add_f16 v0, v[2:3], s[0:3], s16 idxen offen
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: struct_ptr_buffer_atomic_add_f32_noret__vgpr_val__vgpr_rsrc__vgpr_voffset__vgpr_soffset:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
...
; GFX1260-NEXT:    buffer_atomic_add_f32 v0, v[8:9], s[4:7], s3 idxen offen
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: struct_ptr_buffer_atomic_add_v2f16_noret__vgpr_val__vgpr_rsrc__vgpr_voffset__vgpr_soffset:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v9, v6
...
; GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1260-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1260-NEXT:    buffer_atomic_pk_add_f16 v0, v[8:9], s[4:7], s3 idxen offen
; GFX1260-NEXT:    ; implicit-def: $vgpr2_vgpr3_vgpr4_vgpr5
; GFX1260-NEXT:    ; implicit-def: $vgpr7
; GFX1260-NEXT:    ; implicit-def: $vgpr0
; GFX1260-NEXT:    ; implicit-def: $vgpr8_vgpr9
