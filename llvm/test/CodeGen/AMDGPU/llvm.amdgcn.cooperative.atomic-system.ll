...
; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 < %s | FileCheck -check-prefixes=GFX1250Plus,GFX1250,GFX1250-SDAG %s
; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1260 < %s | FileCheck -check-prefixes=GFX1250Plus,GFX1260,GFX1260-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 < %s | FileCheck -check-prefixes=GFX1250Plus,GFX1250,GFX1250-GISEL %s
; RUN: llc -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1260 < %s | FileCheck -check-prefixes=GFX1250Plus,GFX1260,GFX1260-GISEL %s

define i32 @test_flat_amdgcn_cooperative_atomic_load_32x4B_relaxed(ptr noundef readonly %addr)  {
; GFX1250Plus-LABEL: test_flat_amdgcn_cooperative_atomic_load_32x4B_relaxed:
; GFX1250Plus:       ; %bb.0: ; %entry
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_load_b32 v0, v[0:1] scope:SCOPE_SYS
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1250Plus-LABEL: test_flat_amdgcn_cooperative_atomic_load_16x8B_relaxed:
; GFX1250Plus:       ; %bb.0: ; %entry
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_load_b64 v[0:1], v[0:1] scope:SCOPE_SYS
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1250Plus-LABEL: test_flat_amdgcn_cooperative_atomic_load_8x16B_relaxed:
; GFX1250Plus:       ; %bb.0: ; %entry
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_load_b128 v[0:3], v[0:1] scope:SCOPE_SYS
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1250Plus-LABEL: test_flat_amdgcn_cooperative_atomic_store_32x4B_relaxed:
; GFX1250Plus:       ; %bb.0: ; %entry
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_store_b32 v[0:1], v2 scope:SCOPE_SYS
; GFX1250Plus-NEXT:    s_wait_dscnt 0x0
; GFX1250Plus-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1250Plus-LABEL: test_flat_amdgcn_cooperative_atomic_store_16x8B_relaxed:
; GFX1250Plus:       ; %bb.0: ; %entry
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_store_b64 v[0:1], v[2:3] scope:SCOPE_SYS
; GFX1250Plus-NEXT:    s_wait_dscnt 0x0
; GFX1250Plus-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1250Plus-LABEL: test_flat_amdgcn_cooperative_atomic_store_8x16B_relaxed:
; GFX1250Plus:       ; %bb.0: ; %entry
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_store_b128 v[0:1], v[2:5] scope:SCOPE_SYS
; GFX1250Plus-NEXT:    s_wait_dscnt 0x0
; GFX1250Plus-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
;
; GFX1260-LABEL: test_flat_amdgcn_cooperative_atomic_load_32x4B_acquire:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    flat_load_b32 v0, v[0:1] scope:SCOPE_SYS
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_flat_amdgcn_cooperative_atomic_load_16x8B_acquire:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    flat_load_b64 v[0:1], v[0:1] scope:SCOPE_SYS
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    global_inv scope:SCOPE_SYS
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_flat_amdgcn_cooperative_atomic_load_8x16B_acquire:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    flat_load_b128 v[0:3], v[0:1] scope:SCOPE_SYS
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    global_inv scope:SCOPE_SYS
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_flat_amdgcn_cooperative_atomic_store_32x4B_release:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_wb scope:SCOPE_SYS
; GFX1260-NEXT:    s_wait_storecnt 0x0
; GFX1260-NEXT:    flat_store_b32 v[0:1], v2 scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_flat_amdgcn_cooperative_atomic_store_16x8B_release:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_wb scope:SCOPE_SYS
; GFX1260-NEXT:    s_wait_storecnt 0x0
; GFX1260-NEXT:    flat_store_b64 v[0:1], v[2:3] scope:SCOPE_SYS
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_flat_amdgcn_cooperative_atomic_store_8x16B_release:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_wb scope:SCOPE_SYS
; GFX1260-NEXT:    s_wait_storecnt 0x0
; GFX1260-NEXT:    flat_store_b128 v[0:1], v[2:5] scope:SCOPE_SYS
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_flat_amdgcn_cooperative_atomic_load_32x4B_seq_cst:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_wait_storecnt 0x0
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_flat_amdgcn_cooperative_atomic_load_16x8B_seq_cst:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_wait_storecnt 0x0
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_flat_amdgcn_cooperative_atomic_load_8x16B_seq_cst:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_wait_storecnt 0x0
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_flat_amdgcn_cooperative_atomic_store_32x4B_seq_cst:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_wb scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_flat_amdgcn_cooperative_atomic_store_16x8B_seq_cst:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_wb scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_flat_amdgcn_cooperative_atomic_store_8x16B_seq_cst:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_wb scope:SCOPE_SYS
...
; GFX1250Plus-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_load_32x4B_relaxed:
; GFX1250Plus:       ; %bb.0: ; %entry
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_load_b32 v0, v[0:1] scope:SCOPE_SYS
...
; GFX1250Plus-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_load_16x8B_relaxed:
; GFX1250Plus:       ; %bb.0: ; %entry
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_load_b64 v[0:1], v[0:1] scope:SCOPE_SYS
...
; GFX1250Plus-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_load_8x16B_relaxed:
; GFX1250Plus:       ; %bb.0: ; %entry
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_load_b128 v[0:3], v[0:1] scope:SCOPE_SYS
...
; GFX1250Plus-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_store_32x4B_relaxed:
; GFX1250Plus:       ; %bb.0: ; %entry
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_store_b32 v[0:1], v2 scope:SCOPE_SYS
...
; GFX1250Plus-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_store_16x8B_relaxed:
; GFX1250Plus:       ; %bb.0: ; %entry
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_store_b64 v[0:1], v[2:3] scope:SCOPE_SYS
...
; GFX1250Plus-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_store_8x16B_relaxed:
; GFX1250Plus:       ; %bb.0: ; %entry
; GFX1250Plus-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250Plus-NEXT:    s_wait_kmcnt 0x0
; GFX1250Plus-NEXT:    flat_store_b128 v[0:1], v[2:5] scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_load_32x4B_acquire:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    flat_load_b32 v0, v[0:1] scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_load_16x8B_acquire:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    flat_load_b64 v[0:1], v[0:1] scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_load_8x16B_acquire:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    flat_load_b128 v[0:3], v[0:1] scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_store_32x4B_release:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_wb scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_store_16x8B_release:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_wb scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_store_8x16B_release:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_wb scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_load_32x4B_seq_cst:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_wait_storecnt 0x0
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_load_16x8B_seq_cst:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_wait_storecnt 0x0
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_load_8x16B_seq_cst:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_wait_storecnt 0x0
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_store_32x4B_seq_cst:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_wb scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_store_16x8B_seq_cst:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_wb scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_one_as_flat_amdgcn_cooperative_atomic_store_8x16B_seq_cst:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_wb scope:SCOPE_SYS
