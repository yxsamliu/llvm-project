...
; GFX1260-SDAG-NEXT:    flat_load_b32 v0, v[0:1] scope:SCOPE_SYS
; GFX1260-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-SDAG-NEXT:    global_inv scope:SCOPE_SYS
...
; GFX1260-GISEL-NEXT:    flat_load_b32 v0, v[0:1] scope:SCOPE_SYS
; GFX1260-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-GISEL-NEXT:    global_inv scope:SCOPE_SYS
...
; GFX1260-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1260-SDAG-NEXT:    flat_load_b64 v[0:1], v[0:1] scope:SCOPE_SYS
; GFX1260-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-SDAG-NEXT:    global_inv scope:SCOPE_SYS
; GFX1260-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
...
; GFX1260-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1260-GISEL-NEXT:    flat_load_b64 v[0:1], v[0:1] scope:SCOPE_SYS
; GFX1260-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-GISEL-NEXT:    global_inv scope:SCOPE_SYS
; GFX1260-GISEL-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX1260-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1260-SDAG-NEXT:    flat_load_b128 v[0:3], v[0:1] scope:SCOPE_SYS
; GFX1260-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-SDAG-NEXT:    global_inv scope:SCOPE_SYS
; GFX1260-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
...
; GFX1250-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1250-GISEL-NEXT:    flat_load_b128 v[0:3], v[0:1] scope:SCOPE_SYS
; GFX1250-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-GISEL-NEXT:    global_inv scope:SCOPE_SYS
; GFX1250-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX1250-GISEL-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1260-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1260-GISEL-NEXT:    flat_load_b128 v[0:3], v[0:1] scope:SCOPE_SYS
; GFX1260-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-GISEL-NEXT:    global_inv scope:SCOPE_SYS
; GFX1260-GISEL-NEXT:    s_set_pc_i64 s[30:31]
entry:
