...
; GLOBALNESS1-NEXT:    s_xor_b64 s[72:73], s[70:71], -1
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v43, 0x40994400
; GLOBALNESS1-NEXT:    s_bitcmp1_b32 s6, 0
; GLOBALNESS1-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS1-NEXT:    v_cmp_ngt_f64_e64 s[42:43], s[4:5], v[42:43]
; GLOBALNESS1-NEXT:    v_cmp_ngt_f64_e64 s[68:69], s[4:5], 0
...
; GLOBALNESS1-NEXT:    s_load_dwordx2 s[78:79], s[6:7], 0x0
...
; GLOBALNESS1-NEXT:    s_mov_b64 s[64:65], 0x80
; GLOBALNESS1-NEXT:    s_xor_b64 s[76:77], s[4:5], -1
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_15 Depth=2
; GLOBALNESS1-NEXT:    s_andn2_b64 vcc, exec, s[76:77]
...
; GLOBALNESS0-NEXT:    global_load_dword v0, v42, s[64:65]
...
; GLOBALNESS0-NEXT:    s_xor_b64 s[72:73], s[70:71], -1
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v43, 0x40994400
; GLOBALNESS0-NEXT:    s_bitcmp1_b32 s6, 0
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    v_cmp_ngt_f64_e64 s[42:43], s[4:5], v[42:43]
; GLOBALNESS0-NEXT:    v_cmp_ngt_f64_e64 s[68:69], s[4:5], 0
...
; GLOBALNESS0-NEXT:    s_xor_b64 s[76:77], s[4:5], -1
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_15 Depth=2
; GLOBALNESS0-NEXT:    s_andn2_b64 vcc, exec, s[76:77]
