...
; GFX1300-NEXT:    s_load_b32 s3, s[4:5], 0x0
; GFX1300-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8
; GFX1300-NEXT:    v_mov_b32_e32 v0, 0
; GFX1300-NEXT:    s_mov_b32 s2, 0x3ff
; GFX1300-NEXT:    v_and_b32_e64 v1, v1, s2
; GFX1300-NEXT:    s_mov_b32 s2, 2
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    v_lshl_add_u32 v1, v1, s2, s3
; GFX1300-NEXT:    ds_load_b32 v1, v1
; GFX1300-NEXT:    s_wait_dscnt 0x0
; GFX1300-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1300-NEXT:    s_endpgm
...
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1300-NEXT:    s_load_b32 s2, s[4:5], 0x8
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_load_b32 s0, s[0:1], 0x0
; GFX1300-NEXT:    s_mov_b32 s1, 0x3ff
; GFX1300-NEXT:    v_and_b32_e64 v0, v0, s1
; GFX1300-NEXT:    s_mov_b32 s1, 2
; GFX1300-NEXT:    v_lshl_add_u32 v0, v0, s1, s2
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    v_mov_b32_e32 v1, s0
; GFX1300-NEXT:    ds_store_b32 v0, v1
; GFX1300-NEXT:    s_endpgm
