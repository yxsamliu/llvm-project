...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs < %s | FileCheck %s --check-prefixes=GFX13,GFX13-SDAG
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs < %s | FileCheck %s --check-prefixes=GFX13,GFX13-GISEL
...
; GFX13-GISEL-NEXT:    s_add_co_u32 s0, s0, 32
