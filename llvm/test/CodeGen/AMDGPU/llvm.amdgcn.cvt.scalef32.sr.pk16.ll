...
;
; GFX1260-LABEL: test_scalef32_sr_pk16_bf6_bf16_vv:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_cvt_scalef32_sr_pk16_bf6_bf16 v[12:14], v[0:7], v8, v9
; GFX1260-NEXT:    global_store_b96 v[10:11], v[12:14], off
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: test_scalef32_sr_pk16_bf6_bf16_sl:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
...
; GFX1260-NEXT:    v_mov_b32_e32 v7, s5
; GFX1260-NEXT:    v_mov_b32_e32 v8, s6
; GFX1260-NEXT:    v_mov_b32_e32 v9, s7
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_cvt_scalef32_sr_pk16_bf6_bf16 v[10:12], v[2:9], s8, 0x42c80000
; GFX1260-NEXT:    global_store_b96 v[0:1], v[10:12], off
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: test_scalef32_sr_pk16_bf6_f16_vv:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_cvt_scalef32_sr_pk16_bf6_f16 v[12:14], v[0:7], v8, v9
; GFX1260-NEXT:    global_store_b96 v[10:11], v[12:14], off
; GFX1260-NEXT:    s_endpgm
...
;
; GFX1260-SDAG-LABEL: test_scalef32_sr_pk16_bf6_f16_sl:
; GFX1260-SDAG:       ; %bb.0:
...
; GFX1260-SDAG-NEXT:    v_cvt_scalef32_sr_pk16_bf6_f16 v[10:12], v[2:9], s8, 0x42c80000
...
;
; GFX1260-GISEL-LABEL: test_scalef32_sr_pk16_bf6_f16_sl:
; GFX1260-GISEL:       ; %bb.0:
...
; GFX1260-GISEL-NEXT:    v_cvt_scalef32_sr_pk16_bf6_f16 v[10:12], v[2:9], s8, 0x42c80000
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: test_scalef32_sr_pk16_fp6_bf16_vv:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_cvt_scalef32_sr_pk16_fp6_bf16 v[12:14], v[0:7], v8, v9
; GFX1260-NEXT:    global_store_b96 v[10:11], v[12:14], off
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: test_scalef32_sr_pk16_fp6_bf16_sl:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v2, s0
; GFX1260-NEXT:    v_mov_b32_e32 v3, s1
...
; GFX1260-NEXT:    v_mov_b32_e32 v9, s7
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_cvt_scalef32_sr_pk16_fp6_bf16 v[10:12], v[2:9], s8, 0x42c80000
; GFX1260-NEXT:    global_store_b96 v[0:1], v[10:12], off
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: test_scalef32_sr_pk16_fp6_f16_vv:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_cvt_scalef32_sr_pk16_fp6_f16 v[12:14], v[0:7], v8, v9
; GFX1260-NEXT:    global_store_b96 v[10:11], v[12:14], off
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1260-SDAG-LABEL: test_scalef32_sr_pk16_fp6_f16_sl:
; GFX1260-SDAG:       ; %bb.0:
; GFX1260-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v2, s0
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v3, s1
...
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v9, s7
; GFX1260-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-SDAG-NEXT:    v_cvt_scalef32_sr_pk16_fp6_f16 v[10:12], v[2:9], s8, 0x42c80000
; GFX1260-SDAG-NEXT:    global_store_b96 v[0:1], v[10:12], off
; GFX1260-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX1260-GISEL-LABEL: test_scalef32_sr_pk16_fp6_f16_sl:
; GFX1260-GISEL:       ; %bb.0:
; GFX1260-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-GISEL-NEXT:    v_mov_b64_e32 v[8:9], s[6:7]
; GFX1260-GISEL-NEXT:    v_mov_b64_e32 v[6:7], s[4:5]
...
; GFX1260-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[0:1]
; GFX1260-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-GISEL-NEXT:    v_cvt_scalef32_sr_pk16_fp6_f16 v[10:12], v[2:9], s8, 0x42c80000
; GFX1260-GISEL-NEXT:    global_store_b96 v[0:1], v[10:12], off
; GFX1260-GISEL-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: test_scalef32_sr_pk16_bf6_f32_vv:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_cvt_scalef32_sr_pk16_bf6_f32 v[20:22], v[0:15], v16, v17
; GFX1260-NEXT:    global_store_b96 v[18:19], v[20:22], off
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1260-SDAG-LABEL: test_scalef32_sr_pk16_bf6_f32_sl:
; GFX1260-SDAG:       ; %bb.0:
; GFX1260-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v2, s0
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v3, s1
...
; GFX1260-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-SDAG-NEXT:    v_cvt_scalef32_sr_pk16_bf6_f32 v[18:20], v[2:17], s16, 0x42c80000
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX1260-GISEL-LABEL: test_scalef32_sr_pk16_bf6_f32_sl:
; GFX1260-GISEL:       ; %bb.0:
; GFX1260-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
...
; GFX1260-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[0:1]
; GFX1260-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-GISEL-NEXT:    v_cvt_scalef32_sr_pk16_bf6_f32 v[18:20], v[2:17], s16, 0x42c80000
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: test_scalef32_sr_pk16_fp6_f32_vv:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_cvt_scalef32_sr_pk16_fp6_f32 v[20:22], v[0:15], v16, v17
; GFX1260-NEXT:    global_store_b96 v[18:19], v[20:22], off
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1260-SDAG-LABEL: test_scalef32_sr_pk16_fp6_f32_sl:
; GFX1260-SDAG:       ; %bb.0:
; GFX1260-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v2, s0
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v3, s1
...
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v17, s15
; GFX1260-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-SDAG-NEXT:    v_cvt_scalef32_sr_pk16_fp6_f32 v[18:20], v[2:17], s16, 0x42c80000
; GFX1260-SDAG-NEXT:    global_store_b96 v[0:1], v[18:20], off
; GFX1260-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX1260-GISEL-LABEL: test_scalef32_sr_pk16_fp6_f32_sl:
; GFX1260-GISEL:       ; %bb.0:
; GFX1260-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-GISEL-NEXT:    v_mov_b64_e32 v[16:17], s[14:15]
; GFX1260-GISEL-NEXT:    v_mov_b64_e32 v[14:15], s[12:13]
...
; GFX1260-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[0:1]
; GFX1260-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-GISEL-NEXT:    v_cvt_scalef32_sr_pk16_fp6_f32 v[18:20], v[2:17], s16, 0x42c80000
; GFX1260-GISEL-NEXT:    global_store_b96 v[0:1], v[18:20], off
; GFX1260-GISEL-NEXT:    s_endpgm
