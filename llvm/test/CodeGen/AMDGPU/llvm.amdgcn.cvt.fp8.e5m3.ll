...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1260 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX1260,GFX1260-TRUE16 %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-FAKE16 %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1260 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX1260,GFX1260-FAKE16 %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1260 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX1260,GFX1260-GISEL %s
...
;
; GFX1260-TRUE16-LABEL: test_cvt_pk_fp8_f32_word0:
; GFX1260-TRUE16:       ; %bb.0:
; GFX1260-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1260-TRUE16-NEXT:    v_cvt_pk_fp8_f32 v2.l, v0, v1 clamp
; GFX1260-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-TRUE16-NEXT:    v_mov_b32_e32 v0, v2
...
;
; GFX1260-FAKE16-LABEL: test_cvt_pk_fp8_f32_word0:
; GFX1260-FAKE16:       ; %bb.0:
; GFX1260-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1260-FAKE16-NEXT:    v_cvt_pk_fp8_f32 v2, v0, v1 clamp
; GFX1260-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-FAKE16-NEXT:    v_mov_b32_e32 v0, v2
...
;
; GFX1260-GISEL-LABEL: test_cvt_pk_fp8_f32_word0:
; GFX1260-GISEL:       ; %bb.0:
; GFX1260-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1260-GISEL-NEXT:    v_cvt_pk_fp8_f32 v2, v0, v1 clamp
...
; GFX1250-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-TRUE16-LABEL: test_cvt_pk_fp8_f32_word1:
; GFX1260-TRUE16:       ; %bb.0:
; GFX1260-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1260-TRUE16-NEXT:    v_cvt_pk_fp8_f32 v2.h, v0, v1 op_sel:[0,0,1] clamp
; GFX1260-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-TRUE16-NEXT:    v_mov_b32_e32 v0, v2
; GFX1260-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
...
; GFX1250-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-FAKE16-LABEL: test_cvt_pk_fp8_f32_word1:
; GFX1260-FAKE16:       ; %bb.0:
; GFX1260-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1260-FAKE16-NEXT:    v_cvt_pk_fp8_f32 v2, v0, v1 op_sel:[0,0,1] clamp
; GFX1260-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-FAKE16-NEXT:    v_mov_b32_e32 v0, v2
; GFX1260-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
;
...
; GFX1250-GISEL-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-GISEL-LABEL: test_cvt_pk_fp8_f32_word1:
; GFX1260-GISEL:       ; %bb.0:
; GFX1260-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1260-GISEL-NEXT:    v_cvt_pk_fp8_f32 v2, v0, v1 op_sel:[0,0,1] clamp
; GFX1260-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v0, v2
; GFX1260-GISEL-NEXT:    s_set_pc_i64 s[30:31]
...
;
; GFX1260-TRUE16-LABEL: test_cvt_pk_fp8_f32_word1_dpp:
; GFX1260-TRUE16:       ; %bb.0:
; GFX1260-TRUE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-TRUE16-NEXT:    v_mov_b32_dpp v0, v0 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1260-TRUE16-NEXT:    v_mov_b32_e32 v5, v4
; GFX1260-TRUE16-NEXT:    v_mov_b32_e32 v4, v3
; GFX1260-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX1260-TRUE16-NEXT:    v_cvt_pk_fp8_f32 v2.h, v0, v1 op_sel:[0,0,1] clamp
; GFX1260-TRUE16-NEXT:    global_store_b32 v[4:5], v2, off
...
;
; GFX1260-FAKE16-LABEL: test_cvt_pk_fp8_f32_word1_dpp:
; GFX1260-FAKE16:       ; %bb.0:
; GFX1260-FAKE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-FAKE16-NEXT:    v_mov_b32_dpp v0, v0 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1260-FAKE16-NEXT:    v_mov_b32_e32 v5, v4
; GFX1260-FAKE16-NEXT:    v_mov_b32_e32 v4, v3
; GFX1260-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX1260-FAKE16-NEXT:    v_cvt_pk_fp8_f32 v2, v0, v1 op_sel:[0,0,1] clamp
; GFX1260-FAKE16-NEXT:    global_store_b32 v[4:5], v2, off
...
;
; GFX1260-GISEL-LABEL: test_cvt_pk_fp8_f32_word1_dpp:
; GFX1260-GISEL:       ; %bb.0:
; GFX1260-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-GISEL-NEXT:    v_mov_b32_dpp v0, v0 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v6, v3
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v7, v4
; GFX1260-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX1260-GISEL-NEXT:    v_cvt_pk_fp8_f32 v2, v0, v1 op_sel:[0,0,1] clamp
; GFX1260-GISEL-NEXT:    global_store_b32 v[6:7], v2, off
...
;
; GFX1260-LABEL: test_cvt_sr_fp8_f32_byte0:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_cvt_sr_fp8_f32 v2, v0, v1 clamp
...
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_cvt_sr_fp8_f32 v2, v0, v1 byte_sel:1 clamp
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_mov_b32_e32 v0, v2
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_cvt_sr_fp8_f32 v2, v0, v1 byte_sel:2 clamp
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_mov_b32_e32 v0, v2
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_cvt_sr_fp8_f32_byte3:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_cvt_sr_fp8_f32 v2, v0, v1 byte_sel:3 clamp
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_mov_b32_e32 v0, v2
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-TRUE16-NEXT:    s_endpgm
;
; GFX1260-TRUE16-LABEL: test_cvt_sr_fp8_f32_byte1_dpp:
; GFX1260-TRUE16:       ; %bb.0:
; GFX1260-TRUE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-TRUE16-NEXT:    v_mov_b32_e32 v5, v4
; GFX1260-TRUE16-NEXT:    v_mov_b32_e32 v4, v3
; GFX1260-TRUE16-NEXT:    v_cvt_sr_fp8_f32_e64_dpp v2, v0, v1 byte_sel:1 clamp quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1260-TRUE16-NEXT:    global_store_b32 v[4:5], v2, off
; GFX1260-TRUE16-NEXT:    s_endpgm
;
...
; GFX1250-FAKE16-NEXT:    s_endpgm
;
; GFX1260-FAKE16-LABEL: test_cvt_sr_fp8_f32_byte1_dpp:
; GFX1260-FAKE16:       ; %bb.0:
; GFX1260-FAKE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-FAKE16-NEXT:    v_mov_b32_e32 v5, v4
; GFX1260-FAKE16-NEXT:    v_mov_b32_e32 v4, v3
; GFX1260-FAKE16-NEXT:    v_cvt_sr_fp8_f32_e64_dpp v2, v0, v1 byte_sel:1 clamp quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1260-FAKE16-NEXT:    global_store_b32 v[4:5], v2, off
; GFX1260-FAKE16-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX1260-GISEL-LABEL: test_cvt_sr_fp8_f32_byte1_dpp:
; GFX1260-GISEL:       ; %bb.0:
; GFX1260-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v6, v3
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v7, v4
; GFX1260-GISEL-NEXT:    v_cvt_sr_fp8_f32_e64_dpp v2, v0, v1 byte_sel:1 clamp quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1260-GISEL-NEXT:    global_store_b32 v[6:7], v2, off
; GFX1260-GISEL-NEXT:    s_endpgm
  %tmp0 = call i32 @llvm.amdgcn.mov.dpp.i32(i32 %a, i32 228, i32 15, i32 15, i1 1)
  %tmp1 = bitcast i32 %tmp0 to float
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_cvt_f32_fp8_e5m3_byte0:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_cvt_f32_fp8_e64 v0, v0 clamp
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_cvt_f32_fp8_e5m3_byte1:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_cvt_f32_fp8_e64 v0, v0 byte_sel:1 clamp
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_cvt_f32_fp8_e5m3_byte2:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_cvt_f32_fp8_e64 v0, v0 byte_sel:2 clamp
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_cvt_f32_fp8_e5m3_byte3:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_cvt_f32_fp8_e64 v0, v0 byte_sel:3 clamp
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
