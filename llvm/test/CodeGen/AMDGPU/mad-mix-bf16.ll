...
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_bf16lo:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, v2 op_sel_hi:[1,1,1]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16hi_bf16hi_bf16hi_int:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, v2 op_sel:[1,1,1] op_sel_hi:[1,1,1]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16hi_bf16hi_bf16hi_elt:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, v2 op_sel:[1,1,1] op_sel_hi:[1,1,1]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_v2f32:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_and_b32_e32 v5, 0xffff0000, v0
; GFX1260-NEXT:    v_lshlrev_b32_e32 v4, 16, v0
; GFX1260-NEXT:    v_and_b32_e32 v7, 0xffff0000, v1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v6, 16, v1
; GFX1260-NEXT:    v_and_b32_e32 v1, 0xffff0000, v2
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 16, v2
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_pk_fma_f32 v[0:1], v[4:5], v[6:7], v[0:1]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_v2f32_shuffle:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_lshlrev_b32_e32 v5, 16, v0
; GFX1260-NEXT:    v_and_b32_e32 v4, 0xffff0000, v0
; GFX1260-NEXT:    v_and_b32_e32 v7, 0xffff0000, v1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v6, 16, v1
; GFX1260-NEXT:    v_and_b32_e32 v0, 0xffff0000, v2
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_pk_fma_f32 v[0:1], v[4:5], v[6:7], v[0:1] op_sel_hi:[1,1,0]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_negbf16lo_bf16lo_bf16lo:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, -v0, v1, v2 op_sel_hi:[1,1,1]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_absbf16lo_bf16lo_bf16lo:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, |v0|, v1, v2 op_sel_hi:[1,1,1]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_negabsbf16lo_bf16lo_bf16lo:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, -|v0|, v1, v2 op_sel_hi:[1,1,1]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_f32:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, v2 op_sel_hi:[1,1,0]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext bfloat %src0 to float
  %src1.ext = fpext bfloat %src1 to float
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_negf32:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, -v2 op_sel_hi:[1,1,0]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_absf32:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, |v2| op_sel_hi:[1,1,0]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_negabsf32:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, -|v2| op_sel_hi:[1,1,0]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_f32imm1:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_mov_b32 s0, 1.0
; GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, s0 op_sel_hi:[1,1,0]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext bfloat %src0 to float
  %src1.ext = fpext bfloat %src1 to float
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_f32imminv2pi:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_mov_b32 s0, 0.15915494
; GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, s0 op_sel_hi:[1,1,0]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext bfloat %src0 to float
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_cvtbf16imminv2pi:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_mov_b32 s0, 0x3e230000
; GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, s0 op_sel_hi:[1,1,0]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext bfloat %src0 to float
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_cvtbf16imm63:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_mov_b32 s0, 0x367c0000
; GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, s0 op_sel_hi:[1,1,0]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext bfloat %src0 to float
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_v2f32_f32imm1:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_and_b32_e32 v3, 0xffff0000, v0
; GFX1260-NEXT:    v_lshlrev_b32_e32 v2, 16, v0
; GFX1260-NEXT:    v_and_b32_e32 v5, 0xffff0000, v1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v4, 16, v1
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_pk_fma_f32 v[0:1], v[2:3], v[4:5], 1.0 op_sel_hi:[1,1,0]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext <2 x bfloat> %src0 to <2 x float>
  %src1.ext = fpext <2 x bfloat> %src1 to <2 x float>
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_v2f32_cvtbf16imminv2pi:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_and_b32_e32 v3, 0xffff0000, v0
...
; GFX1260-NEXT:    v_pk_fma_f32 v[0:1], v[2:3], v[4:5], s[0:1] op_sel_hi:[1,1,0]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext <2 x bfloat> %src0 to <2 x float>
  %src1.ext = fpext <2 x bfloat> %src1 to <2 x float>
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_v2f32_f32imminv2pi:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_and_b32_e32 v3, 0xffff0000, v0
...
; GFX1260-NEXT:    v_lshlrev_b32_e32 v4, 16, v1
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_pk_fma_f32 v[0:1], v[2:3], v[4:5], 0.15915494 op_sel_hi:[1,1,0]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext <2 x bfloat> %src0 to <2 x float>
  %src1.ext = fpext <2 x bfloat> %src1 to <2 x float>
  %src2 = fpext <2 x bfloat> <bfloat 0xR3e23, bfloat 0xR3e23> to <2 x float>
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_clamp_f32_bf16hi_bf16hi_bf16hi_elt:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, v2 op_sel:[1,1,1] op_sel_hi:[1,1,1] clamp
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %src0.hi = extractelement <2 x bfloat> %src0, i32 1
  %src1.hi = extractelement <2 x bfloat> %src1, i32 1
  %src2.hi = extractelement <2 x bfloat> %src2, i32 1
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: no_mix_simple:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_f32 v0, v0, v1, v2
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: no_mix_simple_fabs:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_f32 v0, |v0|, v1, v2
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_bf16lo_f32_denormals:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, v2 op_sel_hi:[1,1,1]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_f32_denormals:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, v2 op_sel_hi:[1,1,0]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_bf16lo_f32_denormals_fmulfadd:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
...
; GFX1260-NEXT:    v_mul_f32_e32 v0, v0, v1
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_f32_denormals_fmulfadd:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_bf16lo_f32_flush_fmulfadd:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, v2 op_sel_hi:[1,1,1]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_f32_flush_fmulfadd:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, v2 op_sel_hi:[1,1,0]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_negprecvtbf16lo_bf16lo_bf16lo:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, -v0, v1, v2 op_sel_hi:[1,1,1]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_precvtnegbf16hi_abs_bf16lo_bf16lo:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_precvtabsbf16hi_bf16lo_bf16lo:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, |v0|, v1, v2 op_sel:[1,0,0] op_sel_hi:[1,1,1]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %src0.arg.bc = bitcast i32 %src0.arg to <2 x bfloat>
  %src0 = extractelement <2 x bfloat> %src0.arg.bc, i32 1
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_preextractfneg_bf16hi_bf16lo_bf16lo:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, -v0, v1, v2 op_sel:[1,0,0] op_sel_hi:[1,1,1]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_preextractfabs_bf16hi_bf16lo_bf16lo:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, |v0|, v1, v2 op_sel:[1,0,0] op_sel_hi:[1,1,1]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_preextractfabsfneg_bf16hi_bf16lo_bf16lo:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, -|v0|, v1, v2 op_sel:[1,0,0] op_sel_hi:[1,1,1]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_bf16lo_bf16lo_all_cast_from_half:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_lshlrev_b32_e32 v3, 16, v0
; GFX1260-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 16, v2
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_fmac_f32_e32 v0, v3, v1
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: v_mad_mix_f32_bf16lo_cast_from_half_bf16lo_bf16lo:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, v2 op_sel_hi:[0,1,1]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %src0.bf16 = bitcast half %src0 to bfloat
  %src0.ext = fpext bfloat %src0.bf16 to float
  %src1.ext = fpext bfloat %src1 to float
...
;
; GFX1260-LABEL: test_fma_mix_f32_bf16_src2_bf16lo:
; GFX1260:       ; %bb.0: ; %entry
...
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_fma_mix_f32_bf16 v0, s0, 0, s1 op_sel_hi:[0,0,1]
...
; GFX1260-NEXT:    v_cmp_u_f32_e32 vcc_lo, v0, v0
; GFX1260-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
