...
define amdgpu_kernel void @_Z3foov() "amdgpu-wavegroup-enable" {
  ...
  ; CHECK-NEXT:   [[V_LOAD_IDX_B32_:%[0-9]+]]:vgpr_32 = V_LOAD_IDX_B32 [[S_LSHR_B32_]], 0, implicit $exec :: (dereferenceable load (s32) from @v1, !tbaa !7, addrspace 10)
  ...
  ; CHECK-NEXT:   V_STORE_IDX_B32 [[V_LOAD_IDX_B32_1]], [[S_LSHR_B32_3]], 0, implicit $exec :: (store (s32) into @v2, !tbaa !7, addrspace 10)
