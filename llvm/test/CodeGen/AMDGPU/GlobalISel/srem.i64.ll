...
; CHECK-NEXT:    v_xor_b32_e32 v0, v3, v0
...
; CHECK-NEXT:    v_add_i32_e32 v6, vcc, v4, v7
; CHECK-NEXT:    v_addc_u32_e32 v5, vcc, v5, v7, vcc
; CHECK-NEXT:    v_sub_i32_e32 v9, vcc, 0, v1
; CHECK-NEXT:    v_mul_f32_e32 v3, 0x5f7ffffc, v3
; CHECK-NEXT:    v_mul_f32_e32 v8, 0x2f800000, v3
...
; CHECK-NEXT:    v_subb_u32_e32 v10, vcc, 0, v0, vcc
; CHECK-NEXT:    v_xor_b32_e32 v6, v6, v7
; CHECK-NEXT:    v_mul_lo_u32 v11, v10, v3
; CHECK-NEXT:    v_mul_lo_u32 v12, v9, v8
; CHECK-NEXT:    v_mul_hi_u32 v14, v9, v3
; CHECK-NEXT:    v_mul_lo_u32 v13, v9, v3
...
; CHECK-NEXT:    v_mul_lo_u32 v14, v3, v11
; CHECK-NEXT:    v_mul_hi_u32 v15, v3, v13
...
; CHECK-NEXT:    v_mul_hi_u32 v14, v3, v11
...
; CHECK-NEXT:    v_mul_hi_u32 v13, v3, v9
...
; CHECK-NEXT:    v_mul_lo_u32 v11, v5, v8
...
; CHECK-NEXT:    v_mul_lo_u32 v9, v0, v3
; CHECK-NEXT:    v_mul_lo_u32 v8, v1, v8
...
; CHECK-NEXT:    v_subb_u32_e64 v8, s[4:5], v5, v3, vcc
; CHECK-NEXT:    v_sub_i32_e64 v3, s[4:5], v5, v3
...
; CHECK-NEXT:    v_sub_i32_e32 v9, vcc, v6, v1
; CHECK-NEXT:    v_subbrev_u32_e64 v10, s[4:5], 0, v3, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v10, v0
; CHECK-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v9, v1
; CHECK-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], v10, v0
; CHECK-NEXT:    v_subb_u32_e32 v0, vcc, v3, v0, vcc
...
; CHECK-NEXT:    v_sub_i32_e32 v0, vcc, v1, v7
; CHECK-NEXT:    v_subb_u32_e32 v1, vcc, v3, v7, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v18, v13, v2
; CGP-NEXT:    v_mul_lo_u32 v17, v13, v2
...
; CGP-NEXT:    v_mul_lo_u32 v18, v2, v15
; CGP-NEXT:    v_mul_hi_u32 v19, v2, v17
...
; CGP-NEXT:    v_mul_hi_u32 v18, v2, v15
...
; CGP-NEXT:    v_mul_hi_u32 v17, v2, v13
...
; CGP-NEXT:    v_mul_hi_u32 v15, v3, v2
; CGP-NEXT:    v_mul_hi_u32 v2, v11, v2
...
; CGP-NEXT:    v_mul_lo_u32 v15, v11, v12
...
; CGP-NEXT:    v_mul_lo_u32 v13, v0, v2
...
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, v3, v14
; CGP-NEXT:    v_subb_u32_e64 v12, s[4:5], v11, v2, vcc
...
; CGP-NEXT:    v_sub_i32_e32 v13, vcc, v3, v1
; CGP-NEXT:    v_subbrev_u32_e64 v14, s[4:5], 0, v2, vcc
...
; CGP-NEXT:    v_xor_b32_e32 v2, v0, v5
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v1, v5
; CGP-NEXT:    v_subb_u32_e32 v1, vcc, v2, v5, vcc
...
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v8, v7
; CGP-NEXT:    v_addc_u32_e32 v9, vcc, v9, v7, vcc
...
; CGP-NEXT:    v_xor_b32_e32 v9, v9, v7
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v14
...
; CGP-NEXT:    v_mul_lo_u32 v13, v9, v10
...
; CGP-NEXT:    v_mul_lo_u32 v11, v2, v4
...
; CGP-NEXT:    v_sub_i32_e32 v11, vcc, v5, v3
...
; CGP-NEXT:    v_xor_b32_e32 v4, v2, v7
; CGP-NEXT:    v_sub_i32_e32 v2, vcc, v3, v7
; CGP-NEXT:    v_subb_u32_e32 v3, vcc, v4, v7, vcc
; CGP-NEXT:  BB2_6: ; %Flow
; CGP-NEXT:    s_or_saveexec_b64 s[4:5], s[6:7]
; CGP-NEXT:    s_xor_b64 exec, exec, s[4:5]
...
; CHECK-NEXT:    v_rcp_iflag_f32_e32 v2, v2
; CHECK-NEXT:    v_add_i32_e32 v6, vcc, v3, v7
; CHECK-NEXT:    v_addc_u32_e32 v4, vcc, v4, v7, vcc
; CHECK-NEXT:    v_sub_i32_e32 v9, vcc, 0, v1
; CHECK-NEXT:    v_mul_f32_e32 v2, 0x5f7ffffc, v2
; CHECK-NEXT:    v_mul_f32_e32 v8, 0x2f800000, v2
; CHECK-NEXT:    v_trunc_f32_e32 v8, v8
; CHECK-NEXT:    v_mac_f32_e32 v2, 0xcf800000, v8
; CHECK-NEXT:    v_cvt_u32_f32_e32 v2, v2
; CHECK-NEXT:    v_cvt_u32_f32_e32 v8, v8
; CHECK-NEXT:    v_subb_u32_e32 v10, vcc, 0, v0, vcc
; CHECK-NEXT:    v_xor_b32_e32 v6, v6, v7
; CHECK-NEXT:    v_mul_lo_u32 v11, v10, v2
; CHECK-NEXT:    v_mul_lo_u32 v12, v9, v8
; CHECK-NEXT:    v_mul_hi_u32 v14, v9, v2
; CHECK-NEXT:    v_mul_lo_u32 v13, v9, v2
; CHECK-NEXT:    v_xor_b32_e32 v4, v4, v7
; CHECK-NEXT:    v_add_i32_e32 v11, vcc, v11, v12
; CHECK-NEXT:    v_add_i32_e32 v11, vcc, v11, v14
; CHECK-NEXT:    v_mul_lo_u32 v12, v8, v13
; CHECK-NEXT:    v_mul_lo_u32 v14, v2, v11
; CHECK-NEXT:    v_mul_hi_u32 v15, v2, v13
; CHECK-NEXT:    v_mul_hi_u32 v13, v8, v13
; CHECK-NEXT:    v_add_i32_e32 v12, vcc, v12, v14
; CHECK-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v12, vcc, v12, v15
...
; CHECK-NEXT:    v_mul_lo_u32 v15, v8, v11
; CHECK-NEXT:    v_add_i32_e32 v12, vcc, v14, v12
; CHECK-NEXT:    v_mul_hi_u32 v14, v2, v11
; CHECK-NEXT:    v_mul_hi_u32 v11, v8, v11
; CHECK-NEXT:    v_add_i32_e32 v13, vcc, v15, v13
; CHECK-NEXT:    v_cndmask_b32_e64 v15, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v13, vcc, v13, v14
...
; CHECK-NEXT:    v_addc_u32_e64 v12, s[4:5], v8, v11, vcc
; CHECK-NEXT:    v_mul_lo_u32 v10, v10, v2
; CHECK-NEXT:    v_mul_lo_u32 v13, v9, v12
; CHECK-NEXT:    v_mul_lo_u32 v14, v9, v2
; CHECK-NEXT:    v_mul_hi_u32 v9, v9, v2
; CHECK-NEXT:    v_add_i32_e64 v8, s[4:5], v8, v11
; CHECK-NEXT:    v_add_i32_e64 v10, s[4:5], v10, v13
; CHECK-NEXT:    v_mul_hi_u32 v11, v2, v14
; CHECK-NEXT:    v_add_i32_e64 v9, s[4:5], v10, v9
; CHECK-NEXT:    v_mul_lo_u32 v10, v12, v14
; CHECK-NEXT:    v_mul_lo_u32 v13, v2, v9
; CHECK-NEXT:    v_mul_hi_u32 v14, v12, v14
; CHECK-NEXT:    v_add_i32_e64 v10, s[4:5], v10, v13
; CHECK-NEXT:    v_cndmask_b32_e64 v13, 0, 1, s[4:5]
; CHECK-NEXT:    v_add_i32_e64 v10, s[4:5], v10, v11
...
; CHECK-NEXT:    v_mul_lo_u32 v11, v12, v9
; CHECK-NEXT:    v_add_i32_e64 v10, s[4:5], v13, v10
; CHECK-NEXT:    v_mul_hi_u32 v13, v2, v9
; CHECK-NEXT:    v_mul_hi_u32 v9, v12, v9
; CHECK-NEXT:    v_add_i32_e64 v11, s[4:5], v11, v14
; CHECK-NEXT:    v_cndmask_b32_e64 v14, 0, 1, s[4:5]
; CHECK-NEXT:    v_add_i32_e64 v11, s[4:5], v11, v13
...
; CHECK-NEXT:    v_addc_u32_e32 v8, vcc, 0, v8, vcc
; CHECK-NEXT:    v_mul_lo_u32 v9, v4, v2
; CHECK-NEXT:    v_mul_lo_u32 v10, v6, v8
...
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v10, v9
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v8, v9
; CHECK-NEXT:    v_mul_lo_u32 v9, v0, v2
; CHECK-NEXT:    v_mul_lo_u32 v8, v1, v8
...
; CHECK-NEXT:    v_sub_i32_e32 v6, vcc, v6, v10
; CHECK-NEXT:    v_subb_u32_e64 v8, s[4:5], v4, v2, vcc
...
; CHECK-NEXT:    v_sub_i32_e32 v9, vcc, v6, v1
; CHECK-NEXT:    v_subbrev_u32_e64 v10, s[4:5], 0, v2, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v10, v0
; CHECK-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v9, v1
; CHECK-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[4:5]
...
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v8, v0, vcc
; CHECK-NEXT:    v_xor_b32_e32 v1, v1, v7
; CHECK-NEXT:    v_xor_b32_e32 v2, v0, v7
; CHECK-NEXT:    v_sub_i32_e32 v0, vcc, v1, v7
; CHECK-NEXT:    v_subb_u32_e32 v1, vcc, v2, v7, vcc
...
; CGP-NEXT:    v_xor_b32_e32 v1, v1, v0
; CGP-NEXT:    v_xor_b32_e32 v0, v3, v0
...
; CGP-NEXT:    v_addc_u32_e32 v9, vcc, v9, v6, vcc
; CGP-NEXT:    v_sub_i32_e32 v13, vcc, 0, v1
; CGP-NEXT:    v_mul_f32_e32 v3, 0x5f7ffffc, v3
; CGP-NEXT:    v_mul_f32_e32 v12, 0x2f800000, v3
; CGP-NEXT:    v_trunc_f32_e32 v12, v12
; CGP-NEXT:    v_mac_f32_e32 v3, 0xcf800000, v12
...
; CGP-NEXT:    v_mul_lo_u32 v16, v13, v12
; CGP-NEXT:    v_mul_hi_u32 v18, v13, v3
; CGP-NEXT:    v_mul_lo_u32 v17, v13, v3
; CGP-NEXT:    v_xor_b32_e32 v9, v9, v6
; CGP-NEXT:    v_add_i32_e32 v15, vcc, v15, v16
; CGP-NEXT:    v_add_i32_e32 v15, vcc, v15, v18
; CGP-NEXT:    v_mul_lo_u32 v16, v12, v17
; CGP-NEXT:    v_mul_lo_u32 v18, v3, v15
; CGP-NEXT:    v_mul_hi_u32 v19, v3, v17
; CGP-NEXT:    v_mul_hi_u32 v17, v12, v17
; CGP-NEXT:    v_add_i32_e32 v16, vcc, v16, v18
; CGP-NEXT:    v_cndmask_b32_e64 v18, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v16, vcc, v16, v19
...
; CGP-NEXT:    v_mul_lo_u32 v19, v12, v15
; CGP-NEXT:    v_add_i32_e32 v16, vcc, v18, v16
; CGP-NEXT:    v_mul_hi_u32 v18, v3, v15
; CGP-NEXT:    v_mul_hi_u32 v15, v12, v15
; CGP-NEXT:    v_add_i32_e32 v17, vcc, v19, v17
; CGP-NEXT:    v_cndmask_b32_e64 v19, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v17, vcc, v17, v18
...
; CGP-NEXT:    v_addc_u32_e64 v16, s[4:5], v12, v15, vcc
; CGP-NEXT:    v_mul_lo_u32 v14, v14, v3
; CGP-NEXT:    v_mul_lo_u32 v17, v13, v16
; CGP-NEXT:    v_mul_lo_u32 v18, v13, v3
; CGP-NEXT:    v_mul_hi_u32 v13, v13, v3
; CGP-NEXT:    v_add_i32_e64 v12, s[4:5], v12, v15
; CGP-NEXT:    v_add_i32_e64 v14, s[4:5], v14, v17
; CGP-NEXT:    v_mul_hi_u32 v15, v3, v18
; CGP-NEXT:    v_add_i32_e64 v13, s[4:5], v14, v13
; CGP-NEXT:    v_mul_lo_u32 v14, v16, v18
; CGP-NEXT:    v_mul_lo_u32 v17, v3, v13
; CGP-NEXT:    v_mul_hi_u32 v18, v16, v18
; CGP-NEXT:    v_add_i32_e64 v14, s[4:5], v14, v17
; CGP-NEXT:    v_cndmask_b32_e64 v17, 0, 1, s[4:5]
; CGP-NEXT:    v_add_i32_e64 v14, s[4:5], v14, v15
...
; CGP-NEXT:    v_mul_lo_u32 v15, v16, v13
; CGP-NEXT:    v_add_i32_e64 v14, s[4:5], v17, v14
; CGP-NEXT:    v_mul_hi_u32 v17, v3, v13
; CGP-NEXT:    v_mul_hi_u32 v13, v16, v13
; CGP-NEXT:    v_add_i32_e64 v15, s[4:5], v15, v18
; CGP-NEXT:    v_cndmask_b32_e64 v18, 0, 1, s[4:5]
; CGP-NEXT:    v_add_i32_e64 v15, s[4:5], v15, v17
...
; CGP-NEXT:    v_addc_u32_e32 v12, vcc, 0, v12, vcc
; CGP-NEXT:    v_mul_lo_u32 v13, v9, v3
; CGP-NEXT:    v_mul_lo_u32 v14, v4, v12
; CGP-NEXT:    v_mul_hi_u32 v15, v4, v3
...
; CGP-NEXT:    v_subb_u32_e64 v12, s[4:5], v9, v3, vcc
...
; CGP-NEXT:    v_sub_i32_e32 v13, vcc, v4, v1
; CGP-NEXT:    v_subbrev_u32_e64 v14, s[4:5], 0, v3, vcc
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v14, v0
; CGP-NEXT:    v_cndmask_b32_e64 v15, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v13, v1
; CGP-NEXT:    v_cndmask_b32_e64 v16, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v14, v0
; CGP-NEXT:    v_subb_u32_e32 v0, vcc, v3, v0, vcc
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v13, v1
; CGP-NEXT:    v_cndmask_b32_e64 v15, v15, v16, s[4:5]
; CGP-NEXT:    v_subbrev_u32_e32 v0, vcc, 0, v0, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v15
...
; CGP-NEXT:    v_xor_b32_e32 v3, v0, v6
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v1, v6
; CGP-NEXT:    v_subb_u32_e32 v1, vcc, v3, v6, vcc
...
; CGP-NEXT:    v_mac_f32_e32 v4, 0x4f800000, v6
; CGP-NEXT:    v_rcp_iflag_f32_e32 v4, v4
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v5, v8
...
; CGP-NEXT:    v_mul_hi_u32 v16, v11, v4
; CGP-NEXT:    v_mul_lo_u32 v15, v11, v4
; CGP-NEXT:    v_xor_b32_e32 v7, v7, v8
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v14
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v16
...
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v9, v11
; CGP-NEXT:    v_mul_lo_u32 v11, v2, v4
; CGP-NEXT:    v_mul_lo_u32 v9, v3, v9
; CGP-NEXT:    v_mul_lo_u32 v12, v3, v4
; CGP-NEXT:    v_mul_hi_u32 v4, v3, v4
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v11, v9
...
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v9, v2
; CGP-NEXT:    v_subb_u32_e32 v4, vcc, v4, v2, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v7, v7, v11, s[4:5]
; CGP-NEXT:    v_sub_i32_e32 v11, vcc, v6, v3
; CGP-NEXT:    v_subbrev_u32_e64 v12, s[4:5], 0, v4, vcc
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v12, v2
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v11, v3
