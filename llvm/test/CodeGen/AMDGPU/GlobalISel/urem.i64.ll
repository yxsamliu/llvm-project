...
; CHECK-NEXT:    v_subb_u32_e64 v6, s[4:5], v5, v0, vcc
...
; CHECK-NEXT:    v_sub_i32_e32 v7, vcc, v1, v2
; CHECK-NEXT:    v_subbrev_u32_e64 v8, s[4:5], 0, v0, vcc
...
; CHECK-NEXT:    v_cndmask_b32_e32 v7, v8, v0, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v1, v2, v11, vcc
...
; CGP-NEXT:    v_sub_i32_e32 v9, vcc, v3, v6
; CGP-NEXT:    v_subbrev_u32_e64 v10, s[4:5], 0, v2, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v9, v10, v2, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v5
...
; CHECK-NEXT:    v_sub_i32_e32 v7, vcc, v1, v5
; CHECK-NEXT:    v_subbrev_u32_e64 v8, s[4:5], 0, v0, vcc
...
; CHECK-NEXT:    v_cndmask_b32_e64 v10, 0, -1, vcc
; CHECK-NEXT:    v_sub_i32_e32 v11, vcc, v7, v5
; CHECK-NEXT:    v_subbrev_u32_e32 v0, vcc, 0, v0, vcc
; CHECK-NEXT:    v_cmp_eq_u32_e32 vcc, v8, v6
; CHECK-NEXT:    v_cndmask_b32_e32 v6, v10, v9, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v6
; CHECK-NEXT:    v_cndmask_b32_e32 v6, v7, v11, vcc
; CHECK-NEXT:    v_cndmask_b32_e32 v7, v8, v0, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v1, v6, vcc
; CHECK-NEXT:    v_cndmask_b32_e32 v1, v2, v7, vcc
...
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, -1, vcc
; CGP-NEXT:    v_sub_i32_e32 v15, vcc, v9, v2
; CGP-NEXT:    v_subbrev_u32_e32 v0, vcc, 0, v0, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v12, v3
; CGP-NEXT:    v_cndmask_b32_e32 v3, v14, v13, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v3
; CGP-NEXT:    v_cndmask_b32_e32 v3, v9, v15, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v9, v12, v0, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v6
; CGP-NEXT:    v_cndmask_b32_e32 v0, v1, v3, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v1, v4, v9, vcc
...
; CGP-NEXT:    v_subbrev_u32_e64 v8, s[4:5], 0, v2, vcc
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v7, v10
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, -1, s[4:5]
; CGP-NEXT:    v_subb_u32_e32 v2, vcc, v2, v11, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v8, v11
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, -1, vcc
; CGP-NEXT:    v_sub_i32_e32 v13, vcc, v7, v10
; CGP-NEXT:    v_subbrev_u32_e32 v2, vcc, 0, v2, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v8, v11
; CGP-NEXT:    v_cndmask_b32_e32 v9, v12, v9, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v9
; CGP-NEXT:    v_cndmask_b32_e32 v7, v7, v13, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v8, v8, v2, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v6
; CGP-NEXT:    v_cndmask_b32_e32 v2, v3, v7, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v3, v4, v8, vcc
; CGP-NEXT:  BB8_6: ; %Flow
; CGP-NEXT:    s_or_saveexec_b64 s[4:5], s[6:7]
; CGP-NEXT:    s_xor_b64 exec, exec, s[4:5]
