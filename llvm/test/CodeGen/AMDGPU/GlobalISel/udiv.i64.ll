...
; CHECK-NEXT:    v_subb_u32_e64 v9, s[4:5], v5, v6, vcc
...
; CHECK-NEXT:    v_cndmask_b32_e32 v3, v9, v7, vcc
...
; CGP-NEXT:    v_subb_u32_e64 v13, s[4:5], v11, v2, vcc
...
; CGP-NEXT:    v_subb_u32_e64 v11, s[4:5], v9, v4, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v9, v15, v9, vcc
...
; CHECK-NEXT:    v_sub_i32_e32 v7, vcc, v3, v7
...
; CHECK-NEXT:    v_cndmask_b32_e64 v4, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v9, v6
; CHECK-NEXT:    v_cndmask_b32_e64 v13, 0, -1, s[4:5]
; CHECK-NEXT:    v_subb_u32_e32 v2, vcc, v2, v6, vcc
; CHECK-NEXT:    v_cmp_eq_u32_e32 vcc, v9, v6
; CHECK-NEXT:    v_cndmask_b32_e32 v4, v13, v4, vcc
...
; CHECK-NEXT:    v_cndmask_b32_e32 v6, v11, v12, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc
...
; CGP-NEXT:    v_subb_u32_e64 v13, s[4:5], v9, v4, vcc
; CGP-NEXT:    v_sub_i32_e64 v4, s[4:5], v9, v4
...
; CGP-NEXT:    v_cndmask_b32_e32 v9, v17, v9, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v3, v13, v6, vcc
...
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v9, v11
; CGP-NEXT:    v_cndmask_b32_e32 v7, v15, v7, vcc
