...
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[8:9], null, v6, v4, v[1:2]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[1:2], null, v7, v3, v[8:9]
; GFX1300-NEXT:    s_set_pc_i64 s[30:31]
  %result = mul i96 %num, %den
  ret i96 %result
}
...
; GFX1300-NEXT:    v_mad_co_u64_u32 v[13:14], null, v10, v4, v[11:12]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mov_b32_e32 v2, v13
; GFX1300-NEXT:    v_mad_co_u64_u32 v[11:12], vcc_lo, v8, v5, v[1:2]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[1:2], s0, v9, v4, v[11:12]
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v7, null, v14, v7, s0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1300-NEXT:    v_mul_lo_u32 v29, v4, v11
; GFX1300-NEXT:    v_mul_lo_u32 v31, v3, v12
; GFX1300-NEXT:    v_mul_lo_u32 v30, v2, v13
...
; GFX1300-NEXT:    v_mul_lo_u32 v28, v17, v14
; GFX1300-NEXT:    v_mad_co_u64_u32 v[18:19], null, v17, v13, v[0:1]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[0:1], null, v16, v12, 0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[20:21], null, v2, v12, v[18:19]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[18:19], s0, v17, v11, v[0:1]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_cndmask_b32_e64 v22, 0, 1, s0
; GFX1300-NEXT:    v_mad_co_u64_u32 v[0:1], null, v3, v11, v[20:21]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[20:21], vcc_lo, v2, v10, v[18:19]
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v22, null, 0, v22, vcc_lo
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[18:19], null, v4, v10, v[0:1]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[0:1], vcc_lo, v3, v9, v[20:21]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v26, null, 0, v22, vcc_lo
; GFX1300-NEXT:    v_mad_co_u64_u32 v[20:21], null, v5, v9, v[18:19]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[18:19], null, v16, v10, 0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[22:23], vcc_lo, v4, v8, v[0:1]
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v26, null, 0, v26, vcc_lo
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[24:25], null, v6, v8, v[20:21]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[0:1], s0, v17, v9, v[18:19]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX1300-NEXT:    v_mov_b32_e32 v18, v23
; GFX1300-NEXT:    v_cndmask_b32_e64 v27, 0, 1, s0
; GFX1300-NEXT:    v_mul_lo_u32 v23, v6, v9
; GFX1300-NEXT:    v_mov_b32_e32 v19, v24
; GFX1300-NEXT:    v_mul_lo_u32 v24, v5, v10
; GFX1300-NEXT:    v_mad_co_u64_u32 v[20:21], vcc_lo, v2, v8, v[0:1]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v6, null, 0, v27, vcc_lo
; GFX1300-NEXT:    v_mad_co_u64_u32 v[0:1], s0, v16, v13, v[18:19]
; GFX1300-NEXT:    v_mov_b32_e32 v19, v22
; GFX1300-NEXT:    v_mul_lo_u32 v27, v16, v15
; GFX1300-NEXT:    v_mov_b32_e32 v18, v21
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[21:22], vcc_lo, v17, v12, v[0:1]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[14:15], s2, v16, v11, v[18:19]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[0:1], null, v16, v8, 0
; GFX1300-NEXT:    v_cndmask_b32_e64 v32, 0, 1, s2
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[18:19], s1, v2, v11, v[21:22]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[11:12], s2, v17, v10, v[14:15]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_dual_mov_b32 v13, v1 :: v_dual_mov_b32 v14, v20
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v32, s2
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[21:22], s3, v3, v10, v[18:19]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[18:19], s2, v2, v9, v[11:12]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v15, null, 0, v1, s2
; GFX1300-NEXT:    v_mad_co_u64_u32 v[10:11], s4, v16, v9, v[13:14]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[1:2], s2, v4, v9, v[21:22]
; GFX1300-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s4
; GFX1300-NEXT:    v_mad_co_u64_u32 v[12:13], s4, v3, v8, v[18:19]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v9, null, 0, v15, s4
; GFX1300-NEXT:    v_mad_co_u64_u32 v[14:15], s4, v5, v8, v[1:2]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[1:2], s5, v17, v8, v[10:11]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v3, s5, v4, v12, s5
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v4, s5, v6, v13, s5
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v5, s5, v9, v14, s5
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v6, s5, v26, v15, s5
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v9, null, v25, v27, s5
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v9, null, v9, v28, s4
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v9, null, v9, v30, s2
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v9, null, v9, v31, s3
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v9, null, v9, v29, s1
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v9, null, v9, v24, vcc_lo
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v9, null, v9, v23, s0
