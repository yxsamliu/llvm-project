...
; RUN: llc -global-isel -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1300 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX1300 %s
...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX1300-LABEL: s_mul_v2i16:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    v_pk_mul_lo_u16 v0, s0, s1
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1300-NEXT:    s_lshr_b32 s1, s0, 16
; GFX1300-NEXT:    s_add_co_i32 s0, s0, s0
; GFX1300-NEXT:    s_add_co_i32 s1, s1, s1
; GFX1300-NEXT:    s_pack_ll_b32_b16 s0, s0, s1
; GFX1300-NEXT:    ; return to shader part epilog
...
; GFX1300-NEXT:    v_add3_u32 v1, v3, v1, v4
; GFX1300-NEXT:    s_set_pc_i64 s[30:31]
  %result = mul i64 %num, %den
  ret i64 %result
}
...
; GFX1300-NEXT:    v_mov_b32_e32 v8, v3
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mul_lo_u32 v0, v6, v5
; GFX1300-NEXT:    v_mad_co_u64_u32 v[9:10], null, v7, v4, v[0:1]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[0:1], null, v6, v8, 0
; GFX1300-NEXT:    v_mad_co_u64_u32 v[2:3], null, v2, v8, v[9:10]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[9:10], null, v6, v4, v[1:2]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[1:2], null, v7, v8, v[9:10]
; GFX1300-NEXT:    s_set_pc_i64 s[30:31]
  %result = mul i96 %num, %den
  ret i96 %result
}
...
; GFX1300-NEXT:    v_dual_mov_b32 v10, v2 :: v_dual_mov_b32 v11, v3
...
; GFX1300-NEXT:    v_mad_co_u64_u32 v[12:13], null, v9, v5, v[0:1]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[0:1], null, v8, v4, 0
; GFX1300-NEXT:    v_mad_co_u64_u32 v[2:3], null, v10, v4, v[12:13]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[12:13], vcc_lo, v8, v5, v[1:2]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[1:2], s0, v9, v4, v[12:13]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v3, null, v3, v7, s0
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v3, null, v3, v6, vcc_lo
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[5:6], null, v10, v5, v[3:4]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[3:4], null, v11, v4, v[5:6]
; GFX1300-NEXT:    s_set_pc_i64 s[30:31]
  %result = mul i128 %num, %den
  ret i128 %result
}
...
; GFX1300-NEXT:    s_add_co_ci_u32 s18, s21, s18
; GFX1300-NEXT:    s_cselect_b32 s21, 1, 0
; GFX1300-NEXT:    s_cmp_lg_u32 s19, 0
...
; GFX1300-NEXT:    s_cmp_lg_u32 s29, 0
...
; GFX1300-NEXT:    s_cmp_lg_u32 s25, 0
...
; GFX1300-NEXT:    v_dual_mov_b32 v18, v2 :: v_dual_mov_b32 v19, v3
; GFX1300-NEXT:    v_dual_mov_b32 v20, v4 :: v_dual_mov_b32 v21, v5
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[1:2], null, v16, v14, 0
; GFX1300-NEXT:    v_dual_mov_b32 v0, v6 :: v_dual_mov_b32 v22, v7
; GFX1300-NEXT:    v_mad_co_u64_u32 v[25:26], null, v16, v10, 0
; GFX1300-NEXT:    v_mul_lo_u32 v31, v17, v14
; GFX1300-NEXT:    v_mul_lo_u32 v27, v0, v9
; GFX1300-NEXT:    v_mad_co_u64_u32 v[3:4], null, v17, v13, v[1:2]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[1:2], null, v16, v12, 0
; GFX1300-NEXT:    v_mul_lo_u32 v29, v20, v11
; GFX1300-NEXT:    v_mul_lo_u32 v30, v16, v15
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[5:6], null, v18, v12, v[3:4]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[3:4], s0, v17, v11, v[1:2]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s0
; GFX1300-NEXT:    v_mad_co_u64_u32 v[1:2], null, v19, v11, v[5:6]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[5:6], vcc_lo, v18, v10, v[3:4]
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v7, null, 0, v7, vcc_lo
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[3:4], null, v20, v10, v[1:2]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[1:2], vcc_lo, v19, v9, v[5:6]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[23:24], null, v21, v9, v[3:4]
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v3, null, 0, v7, vcc_lo
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[4:5], vcc_lo, v20, v8, v[1:2]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[6:7], null, v0, v8, v[23:24]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[0:1], s0, v17, v9, v[25:26]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v25, null, 0, v3, vcc_lo
; GFX1300-NEXT:    v_cndmask_b32_e64 v28, 0, 1, s0
; GFX1300-NEXT:    v_mul_lo_u32 v26, v21, v10
; GFX1300-NEXT:    v_mad_co_u64_u32 v[23:24], vcc_lo, v16, v13, v[5:6]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[2:3], s0, v18, v8, v[0:1]
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v28, null, 0, v28, s0
; GFX1300-NEXT:    v_mad_co_u64_u32 v[0:1], null, v16, v8, 0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[5:6], s1, v17, v12, v[23:24]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[23:24], s2, v16, v11, v[3:4]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_cndmask_b32_e64 v14, 0, 1, s2
; GFX1300-NEXT:    v_mad_co_u64_u32 v[3:4], s0, v18, v11, v[5:6]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[5:6], s2, v17, v10, v[23:24]
; GFX1300-NEXT:    v_mul_lo_u32 v23, v19, v12
; GFX1300-NEXT:    v_mul_lo_u32 v24, v18, v13
; GFX1300-NEXT:    v_mad_co_u64_u32 v[11:12], s3, v19, v10, v[3:4]
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v10, null, 0, v14, s2
; GFX1300-NEXT:    v_mad_co_u64_u32 v[3:4], s2, v18, v9, v[5:6]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v14, null, 0, v10, s2
; GFX1300-NEXT:    v_mad_co_u64_u32 v[5:6], s2, v20, v9, v[11:12]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[10:11], s4, v16, v9, v[1:2]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s4
; GFX1300-NEXT:    v_mad_co_u64_u32 v[12:13], s4, v19, v8, v[3:4]
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v16, null, 0, v14, s4
; GFX1300-NEXT:    v_mad_co_u64_u32 v[14:15], s4, v21, v8, v[5:6]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[1:2], s5, v17, v8, v[10:11]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v3, s5, v9, v12, s5
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v4, s5, v28, v13, s5
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v5, s5, v16, v14, s5
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v6, s5, v25, v15, s5
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v30, s5
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v31, s4
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v24, s2
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v23, s3
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v29, s0
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v26, s1
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v27, vcc_lo
; GFX1300-NEXT:    v_mad_co_u64_u32 v[7:8], null, v22, v8, v[7:8]
; GFX1300-NEXT:    s_set_pc_i64 s[30:31]
  %result = mul i256 %num, %den
  ret i256 %result
}
...
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    global_load_b32 v4, v[2:3], off
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    v_mad_co_u64_u32 v[2:3], null, 0x50, v4, 0
...
; GFX1300-NEXT:    global_load_b32 v4, v[2:3], off
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    v_mad_co_i64_i32 v[2:3], null, 0x50, v4, 0
; GFX1300-NEXT:    global_store_b64 v[0:1], v[2:3], off
; GFX1300-NEXT:    s_endpgm
  %val = load i32, ptr addrspace(1) %in, align 4
