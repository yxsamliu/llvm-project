...
; CHECK-NEXT:    v_add_i32_e32 v7, vcc, v4, v8
; CHECK-NEXT:    v_addc_u32_e32 v5, vcc, v5, v8, vcc
; CHECK-NEXT:    v_sub_i32_e32 v10, vcc, 0, v1
...
; CHECK-NEXT:    v_xor_b32_e32 v5, v5, v8
...
; CHECK-NEXT:    v_mul_lo_u32 v12, v5, v9
...
; CHECK-NEXT:    v_mul_lo_u32 v11, v1, v9
; CHECK-NEXT:    v_mul_hi_u32 v13, v1, v6
; CHECK-NEXT:    v_mul_lo_u32 v12, v1, v6
; CHECK-NEXT:    v_add_i32_e32 v10, vcc, v10, v11
; CHECK-NEXT:    v_add_i32_e32 v10, vcc, v10, v13
; CHECK-NEXT:    v_sub_i32_e32 v7, vcc, v7, v12
; CHECK-NEXT:    v_subb_u32_e64 v11, s[4:5], v5, v10, vcc
; CHECK-NEXT:    v_sub_i32_e64 v5, s[4:5], v5, v10
...
; CHECK-NEXT:    v_sub_i32_e32 v7, vcc, v7, v1
...
; CHECK-NEXT:    v_cndmask_b32_e64 v13, 0, -1, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v7, v1
...
; CHECK-NEXT:    v_xor_b32_e32 v5, v8, v0
...
; CGP-NEXT:    v_mul_lo_u32 v19, v3, v16
; CGP-NEXT:    v_mul_hi_u32 v20, v3, v18
...
; CGP-NEXT:    v_mul_hi_u32 v19, v3, v16
...
; CGP-NEXT:    v_mul_hi_u32 v18, v3, v14
...
; CGP-NEXT:    v_mul_hi_u32 v16, v5, v3
...
; CGP-NEXT:    v_mul_lo_u32 v14, v2, v3
; CGP-NEXT:    v_mul_lo_u32 v15, v1, v13
; CGP-NEXT:    v_mul_hi_u32 v17, v1, v3
; CGP-NEXT:    v_mul_lo_u32 v16, v1, v3
; CGP-NEXT:    v_add_i32_e32 v14, vcc, v14, v15
; CGP-NEXT:    v_add_i32_e32 v14, vcc, v14, v17
; CGP-NEXT:    v_sub_i32_e32 v5, vcc, v5, v16
; CGP-NEXT:    v_subb_u32_e64 v15, s[4:5], v11, v14, vcc
; CGP-NEXT:    v_sub_i32_e64 v11, s[4:5], v11, v14
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v15, v2
; CGP-NEXT:    v_subb_u32_e32 v11, vcc, v11, v2, vcc
...
; CGP-NEXT:    v_mul_f32_e32 v11, 0x2f800000, v5
; CGP-NEXT:    v_trunc_f32_e32 v11, v11
; CGP-NEXT:    v_mac_f32_e32 v5, 0xcf800000, v11
; CGP-NEXT:    v_cvt_u32_f32_e32 v5, v5
; CGP-NEXT:    v_cvt_u32_f32_e32 v11, v11
; CGP-NEXT:    v_subb_u32_e32 v13, vcc, 0, v4, vcc
; CGP-NEXT:    v_xor_b32_e32 v7, v7, v10
...
; CGP-NEXT:    v_mul_hi_u32 v15, v3, v5
; CGP-NEXT:    v_mul_lo_u32 v14, v3, v5
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v12, v13
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v12, v15
; CGP-NEXT:    v_sub_i32_e32 v7, vcc, v7, v14
...
; CGP-NEXT:    v_sub_i32_e32 v7, vcc, v7, v3
...
; CGP-NEXT:    v_cndmask_b32_e32 v3, v15, v3, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v4, v14, v7, vcc
...
; CHECK-NEXT:    v_cvt_f32_u32_e32 v6, v1
; CHECK-NEXT:    v_cvt_f32_u32_e32 v7, v2
; CHECK-NEXT:    v_ashrrev_i32_e32 v8, 31, v4
; CHECK-NEXT:    v_mac_f32_e32 v6, 0x4f800000, v7
; CHECK-NEXT:    v_rcp_iflag_f32_e32 v6, v6
; CHECK-NEXT:    v_add_i32_e32 v7, vcc, v3, v8
...
; CHECK-NEXT:    v_cvt_u32_f32_e32 v6, v6
; CHECK-NEXT:    v_cvt_u32_f32_e32 v9, v9
; CHECK-NEXT:    v_subb_u32_e32 v11, vcc, 0, v2, vcc
; CHECK-NEXT:    v_xor_b32_e32 v7, v7, v8
; CHECK-NEXT:    v_mul_lo_u32 v12, v11, v6
; CHECK-NEXT:    v_mul_lo_u32 v13, v10, v9
; CHECK-NEXT:    v_mul_hi_u32 v15, v10, v6
...
; CHECK-NEXT:    v_add_i32_e32 v10, vcc, v10, v13
; CHECK-NEXT:    v_sub_i32_e32 v7, vcc, v7, v12
; CHECK-NEXT:    v_subb_u32_e64 v11, s[4:5], v4, v10, vcc
; CHECK-NEXT:    v_sub_i32_e64 v4, s[4:5], v4, v10
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v11, v2
...
; CHECK-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], v11, v2
; CHECK-NEXT:    v_add_i32_e32 v11, vcc, 1, v6
; CHECK-NEXT:    v_cndmask_b32_e64 v10, v10, v12, s[4:5]
; CHECK-NEXT:    v_addc_u32_e32 v12, vcc, 0, v9, vcc
...
; CHECK-NEXT:    v_cndmask_b32_e32 v1, v13, v1, vcc
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, 1, v11
; CHECK-NEXT:    v_addc_u32_e32 v4, vcc, 0, v12, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; CHECK-NEXT:    v_cndmask_b32_e32 v1, v11, v2, vcc
; CHECK-NEXT:    v_cndmask_b32_e32 v2, v12, v4, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v10
; CHECK-NEXT:    v_cndmask_b32_e32 v1, v6, v1, vcc
; CHECK-NEXT:    v_xor_b32_e32 v4, v8, v0
...
; CGP-NEXT:    v_xor_b32_e32 v1, v1, v0
; CGP-NEXT:    v_xor_b32_e32 v3, v3, v0
...
; CGP-NEXT:    v_sub_i32_e32 v14, vcc, 0, v1
; CGP-NEXT:    v_mul_f32_e32 v4, 0x5f7ffffc, v4
; CGP-NEXT:    v_mul_f32_e32 v13, 0x2f800000, v4
; CGP-NEXT:    v_trunc_f32_e32 v13, v13
; CGP-NEXT:    v_mac_f32_e32 v4, 0xcf800000, v13
; CGP-NEXT:    v_cvt_u32_f32_e32 v4, v4
; CGP-NEXT:    v_cvt_u32_f32_e32 v13, v13
; CGP-NEXT:    v_subb_u32_e32 v15, vcc, 0, v3, vcc
; CGP-NEXT:    v_xor_b32_e32 v6, v6, v12
; CGP-NEXT:    v_mul_lo_u32 v16, v15, v4
; CGP-NEXT:    v_mul_lo_u32 v17, v14, v13
; CGP-NEXT:    v_mul_hi_u32 v19, v14, v4
; CGP-NEXT:    v_mul_lo_u32 v18, v14, v4
; CGP-NEXT:    v_xor_b32_e32 v9, v9, v12
; CGP-NEXT:    v_add_i32_e32 v16, vcc, v16, v17
; CGP-NEXT:    v_add_i32_e32 v16, vcc, v16, v19
; CGP-NEXT:    v_mul_lo_u32 v17, v13, v18
; CGP-NEXT:    v_mul_lo_u32 v19, v4, v16
; CGP-NEXT:    v_mul_hi_u32 v20, v4, v18
; CGP-NEXT:    v_mul_hi_u32 v18, v13, v18
; CGP-NEXT:    v_add_i32_e32 v17, vcc, v17, v19
; CGP-NEXT:    v_cndmask_b32_e64 v19, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v17, vcc, v17, v20
...
; CGP-NEXT:    v_mul_lo_u32 v20, v13, v16
; CGP-NEXT:    v_add_i32_e32 v17, vcc, v19, v17
; CGP-NEXT:    v_mul_hi_u32 v19, v4, v16
; CGP-NEXT:    v_mul_hi_u32 v16, v13, v16
; CGP-NEXT:    v_add_i32_e32 v18, vcc, v20, v18
; CGP-NEXT:    v_cndmask_b32_e64 v20, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v18, vcc, v18, v19
...
; CGP-NEXT:    v_addc_u32_e64 v17, s[4:5], v13, v16, vcc
; CGP-NEXT:    v_mul_lo_u32 v15, v15, v4
; CGP-NEXT:    v_mul_lo_u32 v18, v14, v17
; CGP-NEXT:    v_mul_lo_u32 v19, v14, v4
; CGP-NEXT:    v_mul_hi_u32 v14, v14, v4
; CGP-NEXT:    v_add_i32_e64 v13, s[4:5], v13, v16
; CGP-NEXT:    v_add_i32_e64 v15, s[4:5], v15, v18
; CGP-NEXT:    v_mul_hi_u32 v16, v4, v19
; CGP-NEXT:    v_add_i32_e64 v14, s[4:5], v15, v14
; CGP-NEXT:    v_mul_lo_u32 v15, v17, v19
; CGP-NEXT:    v_mul_lo_u32 v18, v4, v14
; CGP-NEXT:    v_mul_hi_u32 v19, v17, v19
; CGP-NEXT:    v_add_i32_e64 v15, s[4:5], v15, v18
; CGP-NEXT:    v_cndmask_b32_e64 v18, 0, 1, s[4:5]
; CGP-NEXT:    v_add_i32_e64 v15, s[4:5], v15, v16
...
; CGP-NEXT:    v_mul_lo_u32 v16, v17, v14
; CGP-NEXT:    v_add_i32_e64 v15, s[4:5], v18, v15
; CGP-NEXT:    v_mul_hi_u32 v18, v4, v14
; CGP-NEXT:    v_mul_hi_u32 v14, v17, v14
; CGP-NEXT:    v_add_i32_e64 v16, s[4:5], v16, v19
; CGP-NEXT:    v_cndmask_b32_e64 v19, 0, 1, s[4:5]
; CGP-NEXT:    v_add_i32_e64 v16, s[4:5], v16, v18
...
; CGP-NEXT:    v_mul_hi_u32 v16, v6, v4
...
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v5, v9
; CGP-NEXT:    v_addc_u32_e32 v7, vcc, v7, v9, vcc
; CGP-NEXT:    v_sub_i32_e32 v12, vcc, 0, v3
; CGP-NEXT:    v_mul_f32_e32 v6, 0x5f7ffffc, v6
; CGP-NEXT:    v_mul_f32_e32 v11, 0x2f800000, v6
; CGP-NEXT:    v_trunc_f32_e32 v11, v11
; CGP-NEXT:    v_mac_f32_e32 v6, 0xcf800000, v11
...
; CGP-NEXT:    v_mul_lo_u32 v13, v8, v11
; CGP-NEXT:    v_mul_hi_u32 v14, v8, v6
...
; CGP-NEXT:    v_mul_lo_u32 v14, v7, v11
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v13, v12
; CGP-NEXT:    v_mul_hi_u32 v13, v8, v11
...
; CGP-NEXT:    v_mul_lo_u32 v14, v3, v6
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v12, v13
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v12, v15
...
; CGP-NEXT:    v_sub_i32_e32 v8, vcc, v8, v3
...
; CGP-NEXT:    v_xor_b32_e32 v6, v9, v2
; CGP-NEXT:    v_cndmask_b32_e32 v4, v11, v4, vcc
