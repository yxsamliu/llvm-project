...
; GCN-NEXT:    ds_read_b128 a[36:39], v1 offset:8288
; GCN-NEXT:    v_add_u32_e32 v4, 0x6000, v1
; GCN-NEXT:    ds_read_b128 a[72:75], v1 offset:24688
; GCN-NEXT:    ds_read_b128 a[68:71], v1 offset:24672
; GCN-NEXT:    ds_read_b128 a[64:67], v1 offset:24656
; GCN-NEXT:    ds_read_b128 a[60:63], v1 offset:24640
; GCN-NEXT:    ds_read_b128 a[56:59], v1 offset:24624
; GCN-NEXT:    ds_read_b128 a[52:55], v1 offset:24608
; GCN-NEXT:    ds_read_b128 a[48:51], v1 offset:24592
; GCN-NEXT:    ds_read_b128 a[44:47], v1 offset:24576
; GCN-NEXT:    ds_read_b128 a[104:107], v1 offset:49264
; GCN-NEXT:    ds_read_b128 a[100:103], v1 offset:49248
; GCN-NEXT:    ds_read_b128 a[96:99], v1 offset:49232
; GCN-NEXT:    ds_read_b128 a[92:95], v1 offset:49216
; GCN-NEXT:    s_nop 3
...
; GCN-NEXT:    ds_read_b128 a[32:35], v1 offset:8272
; GCN-NEXT:    ds_write_b128 v0, a[0:3]
; GCN-NEXT:    ds_read_b128 a[40:43], v1 offset:8304
; GCN-NEXT:    ds_read_b128 a[28:31], v1 offset:8256
; GCN-NEXT:    ds_read_b128 a[24:27], v1 offset:8240
; GCN-NEXT:    ds_read_b128 a[20:23], v1 offset:8224
; GCN-NEXT:    ds_read_b128 a[16:19], v1 offset:8208
; GCN-NEXT:    ds_read_b128 a[12:15], v1 offset:8192
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[12:43], v2, v3, a[12:43]
; GCN-NEXT:    ds_read_b128 a[88:91], v1 offset:49200
; GCN-NEXT:    ds_read_b128 a[84:87], v1 offset:49184
; GCN-NEXT:    ds_read_b128 a[80:83], v1 offset:49168
; GCN-NEXT:    ds_read_b128 a[76:79], v1 offset:49152
; GCN-NEXT:    ds_read_b128 a[136:139], v4 offset:57456
; GCN-NEXT:    ds_read_b128 a[132:135], v4 offset:57440
; GCN-NEXT:    ds_read_b128 a[128:131], v4 offset:57424
; GCN-NEXT:    ds_read_b128 a[124:127], v4 offset:57408
; GCN-NEXT:    ds_read_b128 a[108:111], v4 offset:57344
; GCN-NEXT:    ds_read_b128 a[112:115], v4 offset:57360
; GCN-NEXT:    ds_read_b128 a[116:119], v4 offset:57376
; GCN-NEXT:    ds_read_b128 a[120:123], v4 offset:57392
; GCN-NEXT:    v_mov_b32_e32 v0, s2
; GCN-NEXT:    ; kill: killed $sgpr0_sgpr1
; GCN-NEXT:    ; iglp_opt mask(0x00000000)
; GCN-NEXT:    s_nop 5
; GCN-NEXT:    ds_write_b128 v0, a[36:39] offset:8288
; GCN-NEXT:    ds_write_b128 v0, a[40:43] offset:8304
; GCN-NEXT:    s_waitcnt lgkmcnt(2)
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[108:139], v2, v3, a[108:139]
; GCN-NEXT:    ds_write_b128 v0, a[28:31] offset:8256
; GCN-NEXT:    ds_write_b128 v0, a[32:35] offset:8272
; GCN-NEXT:    ds_write_b128 v0, a[20:23] offset:8224
; GCN-NEXT:    ds_write_b128 v0, a[24:27] offset:8240
; GCN-NEXT:    ds_write_b128 v0, a[12:15] offset:8192
; GCN-NEXT:    ds_write_b128 v0, a[16:19] offset:8208
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[76:107], v2, v3, a[76:107]
; GCN-NEXT:    s_nop 7
; GCN-NEXT:    s_nop 3
; GCN-NEXT:    ds_write_b128 v0, a[132:135] offset:32864
; GCN-NEXT:    ds_write_b128 v0, a[136:139] offset:32880
; GCN-NEXT:    ds_write_b128 v0, a[124:127] offset:32832
; GCN-NEXT:    ds_write_b128 v0, a[128:131] offset:32848
; GCN-NEXT:    ds_write_b128 v0, a[116:119] offset:32800
; GCN-NEXT:    ds_write_b128 v0, a[120:123] offset:32816
; GCN-NEXT:    ds_write_b128 v0, a[108:111] offset:32768
; GCN-NEXT:    ds_write_b128 v0, a[112:115] offset:32784
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[44:75], v2, v3, a[44:75]
; GCN-NEXT:    ds_write_b128 v0, a[100:103] offset:24672
; GCN-NEXT:    ds_write_b128 v0, a[104:107] offset:24688
; GCN-NEXT:    ds_write_b128 v0, a[92:95] offset:24640
; GCN-NEXT:    ds_write_b128 v0, a[96:99] offset:24656
; GCN-NEXT:    ds_write_b128 v0, a[84:87] offset:24608
; GCN-NEXT:    ds_write_b128 v0, a[88:91] offset:24624
; GCN-NEXT:    ds_write_b128 v0, a[76:79] offset:24576
; GCN-NEXT:    ds_write_b128 v0, a[80:83] offset:24592
; GCN-NEXT:    s_nop 7
; GCN-NEXT:    s_nop 2
; GCN-NEXT:    ds_write_b128 v0, a[68:71] offset:16480
; GCN-NEXT:    ds_write_b128 v0, a[72:75] offset:16496
; GCN-NEXT:    ds_write_b128 v0, a[60:63] offset:16448
; GCN-NEXT:    ds_write_b128 v0, a[64:67] offset:16464
; GCN-NEXT:    ds_write_b128 v0, a[52:55] offset:16416
; GCN-NEXT:    ds_write_b128 v0, a[56:59] offset:16432
; GCN-NEXT:    ds_write_b128 v0, a[44:47] offset:16384
; GCN-NEXT:    ds_write_b128 v0, a[48:51] offset:16400
; GCN-NEXT:    s_endpgm
entry:
