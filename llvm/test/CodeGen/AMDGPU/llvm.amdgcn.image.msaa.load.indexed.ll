...
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    v_mov_b32_e32 v4, v2 ; encoding: [0x02,0x03,0x08,0x7e]
; GCN-NEXT:    v_perm_b32 v5, v1, v0, 0x5040100 ; encoding: [0x05,0x00,0x44,0xd7,0x01,0x01,0xfe,0x03,0x00,0x01,0x04,0x05]
; GCN-NEXT:    image_msaa_load v[0:3], [v5, v4], s0 dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm a16 ; encoding: [0x46,0x20,0x60,0xe4,0x00,0x00,0x01,0x00,0x05,0x04,0x00,0x00]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    v_perm_b32 v4, v3, v2, 0x5040100 ; encoding: [0x04,0x00,0x44,0xd7,0x03,0x05,0xfe,0x03,0x00,0x01,0x04,0x05]
; GCN-NEXT:    v_perm_b32 v5, v1, v0, 0x5040100 ; encoding: [0x05,0x00,0x44,0xd7,0x01,0x01,0xfe,0x03,0x00,0x01,0x04,0x05]
; GCN-NEXT:    image_msaa_load v[0:3], [v5, v4], s0 dmask:0x4 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm a16 ; encoding: [0x47,0x20,0x20,0xe5,0x00,0x00,0x01,0x00,0x05,0x04,0x00,0x00]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GCN-NEXT:    ; return to shader part epilog
main_body:
