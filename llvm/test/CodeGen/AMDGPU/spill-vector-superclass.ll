...
define amdgpu_kernel void @test_spill_av_class(<4 x i32> %arg) #0 {
  ...
  ; GCN-NEXT:   INLINEASM &"; def $0", 1 /* sideeffect attdialect */, 32047114 /* regdef:VGPR_32 */, def undef %14.sub0
  ...
  ; GCN-NEXT:   INLINEASM &"; use $0", 1 /* sideeffect attdialect */, 34406409 /* reguse:VReg_64 */, %14
  ; GCN-NEXT:   S_ENDPGM 0
