...
; GCN-NEXT:    s_and_b64 s[18:19], s[20:21], -1
...
; GCN-NEXT:    v_writelane_b32 v45, s40, 6
; GCN-NEXT:    v_writelane_b32 v45, s41, 7
; GCN-NEXT:    v_writelane_b32 v45, s42, 8
; GCN-NEXT:    v_writelane_b32 v45, s43, 9
; GCN-NEXT:    v_writelane_b32 v45, s44, 10
; GCN-NEXT:    v_writelane_b32 v45, s45, 11
; GCN-NEXT:    v_writelane_b32 v45, s46, 12
; GCN-NEXT:    v_writelane_b32 v45, s47, 13
; GCN-NEXT:    v_writelane_b32 v45, s48, 14
; GCN-NEXT:    v_writelane_b32 v45, s49, 15
; GCN-NEXT:    v_writelane_b32 v45, s50, 16
; GCN-NEXT:    v_writelane_b32 v45, s51, 17
; GCN-NEXT:    v_writelane_b32 v45, s52, 18
; GCN-NEXT:    v_writelane_b32 v45, s53, 19
; GCN-NEXT:    v_writelane_b32 v45, s54, 20
; GCN-NEXT:    v_writelane_b32 v45, s55, 21
; GCN-NEXT:    v_writelane_b32 v45, s56, 22
; GCN-NEXT:    v_writelane_b32 v45, s57, 23
...
; GCN-NEXT:    s_andn2_b64 s[4:5], exec, s[50:51]
; GCN-NEXT:    s_and_b64 s[6:7], s[4:5], -1
; GCN-NEXT:    s_cselect_b64 exec, s[4:5], s[50:51]
...
; GCN-NEXT:    s_xor_b64 s[54:55], vcc, exec
...
; GCN-NEXT:  ; %bb.3: ; %bb6
; GCN-NEXT:    ; in Loop: Header=BB1_2 Depth=1
; GCN-NEXT:    s_mov_b64 s[56:57], exec
; GCN-NEXT:    v_cmp_eq_u32_e64 s[44:45], 3, v0
; GCN-NEXT:    s_and_b64 s[4:5], s[44:45], -1
; GCN-NEXT:    s_cmov_b64 exec, s[44:45]
...
; GCN-NEXT:    s_and_b64 s[8:9], s[10:11], -1
...
; GCN-NEXT:    v_readlane_b32 s57, v45, 23
; GCN-NEXT:    v_readlane_b32 s56, v45, 22
; GCN-NEXT:    v_readlane_b32 s55, v45, 21
; GCN-NEXT:    v_readlane_b32 s54, v45, 20
; GCN-NEXT:    v_readlane_b32 s53, v45, 19
; GCN-NEXT:    v_readlane_b32 s52, v45, 18
; GCN-NEXT:    v_readlane_b32 s51, v45, 17
; GCN-NEXT:    v_readlane_b32 s50, v45, 16
; GCN-NEXT:    v_readlane_b32 s49, v45, 15
; GCN-NEXT:    v_readlane_b32 s48, v45, 14
; GCN-NEXT:    v_readlane_b32 s47, v45, 13
; GCN-NEXT:    v_readlane_b32 s46, v45, 12
; GCN-NEXT:    v_readlane_b32 s45, v45, 11
; GCN-NEXT:    v_readlane_b32 s44, v45, 10
; GCN-NEXT:    v_readlane_b32 s43, v45, 9
; GCN-NEXT:    v_readlane_b32 s42, v45, 8
; GCN-NEXT:    v_readlane_b32 s41, v45, 7
; GCN-NEXT:    v_readlane_b32 s40, v45, 6
