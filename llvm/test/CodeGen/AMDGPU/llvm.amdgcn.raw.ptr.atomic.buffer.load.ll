...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 -global-isel=0 | FileCheck %s -check-prefixes=GFX12,GFX1250-SDAG-FAKE16
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1260 -mattr=-real-true16 -global-isel=0 | FileCheck %s -check-prefixes=GFX12,GFX1260-SDAG-FAKE16
...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1260 -mattr=+real-true16 -global-isel=1 -new-reg-bank-select | FileCheck %s -check-prefixes=GFX12,GFX12-GISEL-TRUE16
...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1260 -mattr=-real-true16 -global-isel=1 -new-reg-bank-select | FileCheck %s -check-prefixes=GFX12,GFX12-GISEL-FAKE16
...
;
; GFX1250-SDAG-FAKE16-LABEL: raw_ptr_atomic_buffer_load_i64:
; GFX1250-SDAG-FAKE16:       ; %bb.0: ; %bb
...
; GFX1250-SDAG-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1250-SDAG-FAKE16-NEXT:    s_wait_xcnt 0x0
; GFX1250-SDAG-FAKE16-NEXT:    s_mov_b32 s4, 0
; GFX1250-SDAG-FAKE16-NEXT:  .LBB5_1: ; %bb1
; GFX1250-SDAG-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1250-SDAG-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-FAKE16-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], null offset:4 th:TH_LOAD_NT
; GFX1250-SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-FAKE16-NEXT:    v_cmp_ne_u64_e32 vcc_lo, v[2:3], v[0:1]
; GFX1250-SDAG-FAKE16-NEXT:    s_or_b32 s4, vcc_lo, s4
; GFX1250-SDAG-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-SDAG-FAKE16-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s4
; GFX1250-SDAG-FAKE16-NEXT:    s_cbranch_execnz .LBB5_1
; GFX1250-SDAG-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX1250-SDAG-FAKE16-NEXT:    s_endpgm
;
; GFX1260-SDAG-FAKE16-LABEL: raw_ptr_atomic_buffer_load_i64:
; GFX1260-SDAG-FAKE16:       ; %bb.0: ; %bb
; GFX1260-SDAG-FAKE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-SDAG-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1260-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX1260-SDAG-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1260-SDAG-FAKE16-NEXT:    s_wait_xcnt 0x0
; GFX1260-SDAG-FAKE16-NEXT:    s_mov_b32 s4, 0
; GFX1260-SDAG-FAKE16-NEXT:  .LBB5_1: ; %bb1
; GFX1260-SDAG-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1260-SDAG-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1260-SDAG-FAKE16-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], null offset:4 th:TH_LOAD_NT
; GFX1260-SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX1260-SDAG-FAKE16-NEXT:    v_cmp_ne_u64_e32 vcc_lo, v[2:3], v[0:1]
; GFX1260-SDAG-FAKE16-NEXT:    s_or_b32 s4, vcc_lo, s4
; GFX1260-SDAG-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1260-SDAG-FAKE16-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s4
; GFX1260-SDAG-FAKE16-NEXT:    s_cbranch_execnz .LBB5_1
; GFX1260-SDAG-FAKE16-NEXT:  ; %bb.2: ; %bb2
...
; GFX12-SDAG-TRUE16-NEXT:    s_endpgm
;
; GFX1250-SDAG-FAKE16-LABEL: raw_ptr_atomic_buffer_load_v4i16:
; GFX1250-SDAG-FAKE16:       ; %bb.0: ; %bb
; GFX1250-SDAG-FAKE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-SDAG-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1250-SDAG-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1250-SDAG-FAKE16-NEXT:    s_wait_xcnt 0x0
; GFX1250-SDAG-FAKE16-NEXT:    s_mov_b32 s4, 0
; GFX1250-SDAG-FAKE16-NEXT:  .LBB7_1: ; %bb1
; GFX1250-SDAG-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1250-SDAG-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-FAKE16-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], null offset:4 th:TH_LOAD_NT
; GFX1250-SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-FAKE16-NEXT:    v_and_b32_e32 v1, 0xffff, v2
; GFX1250-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-SDAG-FAKE16-NEXT:    v_lshl_or_b32 v1, v3, 16, v1
; GFX1250-SDAG-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v1, v0
; GFX1250-SDAG-FAKE16-NEXT:    s_or_b32 s4, vcc_lo, s4
; GFX1250-SDAG-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-SDAG-FAKE16-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s4
; GFX1250-SDAG-FAKE16-NEXT:    s_cbranch_execnz .LBB7_1
; GFX1250-SDAG-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX1250-SDAG-FAKE16-NEXT:    s_endpgm
;
; GFX1260-SDAG-FAKE16-LABEL: raw_ptr_atomic_buffer_load_v4i16:
; GFX1260-SDAG-FAKE16:       ; %bb.0: ; %bb
; GFX1260-SDAG-FAKE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-SDAG-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1260-SDAG-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1260-SDAG-FAKE16-NEXT:    s_wait_xcnt 0x0
; GFX1260-SDAG-FAKE16-NEXT:    s_mov_b32 s4, 0
; GFX1260-SDAG-FAKE16-NEXT:  .LBB7_1: ; %bb1
; GFX1260-SDAG-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1260-SDAG-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1260-SDAG-FAKE16-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], null offset:4 th:TH_LOAD_NT
; GFX1260-SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX1260-SDAG-FAKE16-NEXT:    v_and_b32_e32 v1, 0xffff, v2
; GFX1260-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1260-SDAG-FAKE16-NEXT:    v_lshl_or_b32 v1, v3, 16, v1
; GFX1260-SDAG-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v1, v0
; GFX1260-SDAG-FAKE16-NEXT:    s_or_b32 s4, vcc_lo, s4
; GFX1260-SDAG-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1260-SDAG-FAKE16-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s4
; GFX1260-SDAG-FAKE16-NEXT:    s_cbranch_execnz .LBB7_1
; GFX1260-SDAG-FAKE16-NEXT:  ; %bb.2: ; %bb2
; GFX1260-SDAG-FAKE16-NEXT:    s_endpgm
;
