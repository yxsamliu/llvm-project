...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX1260-LABEL: test_sub_u64_ss:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_sub_nc_u64 s[0:1], s[0:1], s[2:3]
; GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1260-NEXT:    v_mov_b32_e32 v0, s0
; GFX1260-NEXT:    v_mov_b32_e32 v1, s1
; GFX1260-NEXT:    ; return to shader part epilog
; GFX_LIT64-LABEL: test_sub_u64_ss:
; GFX_LIT64:       ; %bb.0:
; GFX_LIT64-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX_LIT64-NEXT:    s_sub_nc_u64 s[0:1], s[0:1], s[2:3]
...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX1260-LABEL: test_sub_u64_inline_lit_v:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX1260-LABEL: test_sub_u64_v_inline_lit:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX1260-LABEL: test_sub_u64_small_imm_v:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX1260-LABEL: test_sub_u64_64bit_imm_v:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX1260-LABEL: test_sub_u64_small_imm_s:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_sub_nc_u64 s[0:1], 0x1f4, s[0:1]
; GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1260-NEXT:    v_mov_b32_e32 v0, s0
; GFX1260-NEXT:    v_mov_b32_e32 v1, s1
; GFX1260-NEXT:    ; return to shader part epilog
; GFX_LIT64-LABEL: test_sub_u64_small_imm_s:
; GFX_LIT64:       ; %bb.0:
; GFX_LIT64-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX_LIT64-NEXT:    s_sub_nc_u64 s[0:1], 0x1f4, s[0:1]
; GFX_LIT64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX_LIT64-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX_LIT64-NEXT:    ; return to shader part epilog
  %sub = sub i64 500, %a
