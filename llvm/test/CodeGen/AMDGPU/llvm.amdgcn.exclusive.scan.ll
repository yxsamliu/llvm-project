...
; RUN: llc -global-isel=0 -amdgpu-load-store-vectorizer=0 -mtriple=amdgcn -mcpu=gfx1300 -mattr=+real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX13,GFX13-SDAG,GFX13-TRUE16,GFX13-SDAG-TRUE16 %s
; RUN: llc -global-isel=0 -amdgpu-load-store-vectorizer=0 -mtriple=amdgcn -mcpu=gfx1300 -mattr=-real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX13,GFX13-SDAG,GFX13-SDAG-FAKE16 %s
; RUN: llc -global-isel=1 -amdgpu-load-store-vectorizer=0 -mtriple=amdgcn -mcpu=gfx1300 -mattr=+real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX13,GFX13-GISEL,GFX13-TRUE16,GFX13-GISEL-TRUE16 %s
; RUN: llc -global-isel=1 -amdgpu-load-store-vectorizer=0 -mtriple=amdgcn -mcpu=gfx1300 -mattr=-real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX13,GFX13-GISEL,GFX13-GISEL-FAKE16 %s
...
; GFX13-GISEL-NEXT:    v_dual_add_nc_u32 v0, v0, v1 :: v_dual_mov_b32 v1, 0
...
; GFX13-SDAG-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
...
; GFX13-SDAG-FAKE16:       ; %bb.0:
; GFX13-SDAG-FAKE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
...
; GFX13-GISEL-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13-GISEL-TRUE16-NEXT:    v_bfe_u32 v1, v0, 10, 10
; GFX13-GISEL-TRUE16-NEXT:    v_and_b16 v0.l, 0x3ff, v0.l
; GFX13-GISEL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-GISEL-TRUE16-NEXT:    v_exclusive_scan_min_i16 v0.h, v0.l, v1
; GFX13-GISEL-TRUE16-NEXT:    v_lshlrev_b16 v1.l, 1, v0.l
; GFX13-GISEL-TRUE16-NEXT:    v_mov_b16_e32 v1.h, 0
...
; GFX13-GISEL-FAKE16:       ; %bb.0:
; GFX13-GISEL-FAKE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
...
; GFX13-GISEL-TRUE16-NEXT:    v_and_b16 v0.l, 0x3ff, v0.l
; GFX13-GISEL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-GISEL-TRUE16-NEXT:    v_exclusive_scan_min_u16 v0.h, v0.l, v1
; GFX13-GISEL-TRUE16-NEXT:    v_lshlrev_b16 v1.l, 1, v0.l
; GFX13-GISEL-TRUE16-NEXT:    v_mov_b16_e32 v1.h, 0
; GFX13-GISEL-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-TRUE16-NEXT:    global_store_d16_hi_b16 v1, v0, s[0:1]
...
; GFX13-GISEL-TRUE16-NEXT:    v_and_b16 v0.l, 0x3ff, v0.l
; GFX13-GISEL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-GISEL-TRUE16-NEXT:    v_exclusive_scan_max_i16 v0.h, v0.l, v1
; GFX13-GISEL-TRUE16-NEXT:    v_lshlrev_b16 v1.l, 1, v0.l
; GFX13-GISEL-TRUE16-NEXT:    v_mov_b16_e32 v1.h, 0
; GFX13-GISEL-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-TRUE16-NEXT:    global_store_d16_hi_b16 v1, v0, s[0:1]
...
; GFX13-GISEL-TRUE16-NEXT:    v_and_b16 v0.l, 0x3ff, v0.l
; GFX13-GISEL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-GISEL-TRUE16-NEXT:    v_exclusive_scan_max_u16 v0.h, v0.l, v1
; GFX13-GISEL-TRUE16-NEXT:    v_lshlrev_b16 v1.l, 1, v0.l
; GFX13-GISEL-TRUE16-NEXT:    v_mov_b16_e32 v1.h, 0
; GFX13-GISEL-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-TRUE16-NEXT:    global_store_d16_hi_b16 v1, v0, s[0:1]
