...
; GFX1251-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1251-NEXT:    s_wait_kmcnt 0x0
; GFX1251-NEXT:    s_mov_b32 s0, 4
; GFX1251-NEXT:    s_mov_b32 s1, 5
; GFX1251-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1251-NEXT:    v_dual_mov_b32 v8, s0 :: v_dual_mov_b32 v9, s1
; GFX1251-NEXT:    v_pk_lshl_add_u64 v[0:3], v[0:3], v[8:9], v[4:7]
; GFX1251-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1251-NEXT:    v_pk_lshl_add_u64 v[0:3], v[0:3], v[4:5], v[8:11]
; GFX1251-NEXT:    s_set_pc_i64 s[30:31]
  %shl = shl <2 x i64> %v, %s
  %add = add <2 x i64> %shl, %a
  ret <2 x i64> %add
...
; GFX1251-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX1251-NEXT:    v_dual_mov_b32 v4, s4 :: v_dual_mov_b32 v5, s4
; GFX1251-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1251-NEXT:    s_wait_kmcnt 0x0
; GFX1251-NEXT:    v_pk_lshl_add_u64 v[0:3], s[0:3], v[4:5], v[0:3]
...
; GFX1251-NEXT:    v_pk_add_nc_u64 v[0:3], s[0:3], s[12:15]
; GFX1251-NEXT:    flat_store_b128 v[0:1], v[0:3]
; GFX1251-NEXT:    s_endpgm
  %shl = shl <2 x i64> %v, <i64 2, i64 2>
  %add = add <2 x i64> %shl, %a
...
; GFX1251-NEXT:    s_mov_b32 s0, 2
; GFX1251-NEXT:    s_mov_b32 s1, 0
; GFX1251-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
; GFX1251-NEXT:    v_dual_mov_b32 v9, s0 :: v_dual_ashrrev_i32 v7, 31, v6
; GFX1251-NEXT:    v_mov_b32_e32 v8, s0
; GFX1251-NEXT:    s_mov_b32 s0, 12
; GFX1251-NEXT:    s_mov_b32 s3, s1
; GFX1251-NEXT:    s_mov_b32 s2, s0
; GFX1251-NEXT:    v_pk_lshl_add_u64 v[0:3], v[4:7], v[8:9], v[0:3]
; GFX1251-NEXT:    s_delay_alu instid0(VALU_DEP_1)
