...
; SDAG-NEXT:    v_mul_lo_u32 v26, v33, v2
; SDAG-NEXT:    v_mul_lo_u32 v27, v9, v31
; SDAG-NEXT:    v_mul_lo_u32 v38, v8, v30
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v31, v34, 0
; SDAG-NEXT:    v_mov_b32_e32 v19, 0
; SDAG-NEXT:    v_mul_lo_u32 v9, v21, v7
; SDAG-NEXT:    v_mad_u64_u32 v[22:23], s[4:5], v21, v6, 0
; SDAG-NEXT:    v_mul_lo_u32 v39, v20, v6
; SDAG-NEXT:    v_mul_lo_u32 v48, v15, v37
; SDAG-NEXT:    v_mul_lo_u32 v49, v14, v36
; SDAG-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v37, v21, 0
; SDAG-NEXT:    v_add_i32_e32 v13, vcc, v13, v18
; SDAG-NEXT:    v_mov_b32_e32 v18, v3
; SDAG-NEXT:    v_mad_u64_u32 v[24:25], s[4:5], v30, v34, v[18:19]
; SDAG-NEXT:    v_sub_i32_e32 v15, vcc, v16, v2
; SDAG-NEXT:    v_add_i32_e64 v9, s[4:5], v23, v9
; SDAG-NEXT:    v_add_i32_e64 v13, s[4:5], v13, v26
; SDAG-NEXT:    v_mov_b32_e32 v18, v24
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v31, v33, v[18:19]
; SDAG-NEXT:    v_xor_b32_e32 v24, v15, v28
; SDAG-NEXT:    v_add_i32_e64 v23, s[4:5], v9, v39
; SDAG-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v8, v31, v[12:13]
; SDAG-NEXT:    v_add_i32_e64 v12, s[4:5], v25, v3
; SDAG-NEXT:    v_addc_u32_e64 v13, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v16, vcc, v17, v2, vcc
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v14, v37, v[22:23]
; SDAG-NEXT:    v_mov_b32_e32 v18, v7
; SDAG-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v36, v21, v[18:19]
; SDAG-NEXT:    v_add_i32_e64 v7, s[4:5], v27, v9
; SDAG-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v30, v33, v[12:13]
; SDAG-NEXT:    v_xor_b32_e32 v9, v16, v29
; SDAG-NEXT:    v_add_i32_e64 v3, s[4:5], v48, v3
; SDAG-NEXT:    v_mov_b32_e32 v18, v14
; SDAG-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], v37, v20, v[18:19]
; SDAG-NEXT:    v_add_i32_e64 v7, s[4:5], v38, v7
; SDAG-NEXT:    v_add_i32_e64 v3, s[4:5], v49, v3
; SDAG-NEXT:    v_add_i32_e64 v14, s[4:5], v15, v17
; SDAG-NEXT:    v_addc_u32_e64 v15, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_add_i32_e64 v8, s[4:5], v12, v8
; SDAG-NEXT:    v_addc_u32_e64 v12, s[4:5], v13, v7, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v0, vcc, v0, v8, vcc
; SDAG-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v36, v20, v[14:15]
; SDAG-NEXT:    v_subb_u32_e32 v1, vcc, v1, v12, vcc
; SDAG-NEXT:    v_xor_b32_e32 v12, v0, v28
; SDAG-NEXT:    v_add_i32_e32 v7, vcc, v7, v2
; SDAG-NEXT:    v_addc_u32_e32 v8, vcc, v8, v3, vcc
; SDAG-NEXT:    v_xor_b32_e32 v3, v1, v29
; SDAG-NEXT:    v_sub_i32_e32 v0, vcc, v24, v28
; SDAG-NEXT:    v_subb_u32_e32 v1, vcc, v9, v29, vcc
; SDAG-NEXT:    v_subb_u32_e32 v2, vcc, v12, v28, vcc
; SDAG-NEXT:    v_subb_u32_e32 v3, vcc, v3, v29, vcc
; SDAG-NEXT:    v_sub_i32_e32 v6, vcc, v10, v6
; SDAG-NEXT:    v_subb_u32_e32 v9, vcc, v11, v16, vcc
; SDAG-NEXT:    v_xor_b32_e32 v6, v6, v32
; SDAG-NEXT:    v_subb_u32_e32 v4, vcc, v4, v7, vcc
; SDAG-NEXT:    v_xor_b32_e32 v7, v9, v35
; SDAG-NEXT:    v_subb_u32_e32 v5, vcc, v5, v8, vcc
; SDAG-NEXT:    v_xor_b32_e32 v8, v4, v32
; SDAG-NEXT:    v_xor_b32_e32 v9, v5, v35
; SDAG-NEXT:    v_sub_i32_e32 v4, vcc, v6, v32
; SDAG-NEXT:    v_subb_u32_e32 v5, vcc, v7, v35, vcc
; SDAG-NEXT:    v_subb_u32_e32 v6, vcc, v8, v32, vcc
...
; SDAG-NEXT:    s_or_b64 exec, exec, s[6:7]
; SDAG-NEXT:    v_mul_lo_u32 v22, v33, v11
; SDAG-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v33, v10, 0
; SDAG-NEXT:    v_mul_lo_u32 v30, v32, v10
; SDAG-NEXT:    v_mul_lo_u32 v31, v17, v8
; SDAG-NEXT:    v_mul_lo_u32 v34, v16, v9
; SDAG-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v8, v33, 0
; SDAG-NEXT:    v_mov_b32_e32 v23, 0
; SDAG-NEXT:    v_mul_lo_u32 v17, v25, v15
; SDAG-NEXT:    v_mad_u64_u32 v[26:27], s[4:5], v25, v14, 0
; SDAG-NEXT:    v_mul_lo_u32 v35, v24, v14
; SDAG-NEXT:    v_mul_lo_u32 v36, v19, v12
; SDAG-NEXT:    v_mul_lo_u32 v37, v18, v13
; SDAG-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v12, v25, 0
; SDAG-NEXT:    v_add_i32_e32 v19, vcc, v21, v22
; SDAG-NEXT:    v_mov_b32_e32 v22, v11
; SDAG-NEXT:    v_mad_u64_u32 v[28:29], s[4:5], v9, v33, v[22:23]
; SDAG-NEXT:    v_sub_i32_e32 v0, vcc, v0, v10
; SDAG-NEXT:    v_add_i32_e64 v17, s[4:5], v27, v17
; SDAG-NEXT:    v_add_i32_e64 v21, s[4:5], v19, v30
; SDAG-NEXT:    v_mov_b32_e32 v22, v28
; SDAG-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v8, v32, v[22:23]
; SDAG-NEXT:    v_add_i32_e64 v27, s[4:5], v17, v35
; SDAG-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], v16, v8, v[20:21]
; SDAG-NEXT:    v_add_i32_e64 v19, s[4:5], v29, v11
; SDAG-NEXT:    v_addc_u32_e64 v20, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v1, vcc, v1, v10, vcc
; SDAG-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v18, v12, v[26:27]
; SDAG-NEXT:    v_mov_b32_e32 v22, v15
; SDAG-NEXT:    v_mad_u64_u32 v[25:26], s[4:5], v13, v25, v[22:23]
; SDAG-NEXT:    v_add_i32_e64 v15, s[4:5], v31, v17
; SDAG-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v9, v32, v[19:20]
; SDAG-NEXT:    v_add_i32_e64 v17, s[4:5], v36, v11
; SDAG-NEXT:    v_mov_b32_e32 v22, v25
; SDAG-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v12, v24, v[22:23]
; SDAG-NEXT:    v_add_i32_e64 v15, s[4:5], v34, v15
; SDAG-NEXT:    v_add_i32_e64 v19, s[4:5], v37, v17
; SDAG-NEXT:    v_add_i32_e64 v17, s[4:5], v26, v12
...
; SDAG-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v13, v24, v[17:18]
