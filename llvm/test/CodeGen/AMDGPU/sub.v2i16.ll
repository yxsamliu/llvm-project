...
; VI-NEXT:    v_sub_u16_e32 v0, v4, v5
; VI-NEXT:    v_sub_u16_sdwa v1, v4, v5 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
...
; VI-NEXT:    s_load_dword s10, s[8:9], 0x0
; VI-NEXT:    s_mov_b32 s1, s5
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_lshr_b32 s5, s4, 16
; VI-NEXT:    s_lshr_b32 s6, s10, 16
; VI-NEXT:    s_sub_i32 s4, s4, s10
...
; VI-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; VI-NEXT:    v_sub_u16_e32 v0, v4, v5
; VI-NEXT:    v_sub_u16_sdwa v1, v4, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
...
; VI-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; VI-NEXT:    v_sub_u16_e32 v0, v4, v5
; VI-NEXT:    v_sub_u16_sdwa v2, v4, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
