...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1260 -o - < %s | FileCheck --check-prefixes=KERNEL-GFX1260 %s
...
;
; KERNEL-GFX1260-LABEL: wavegroup_kernel:
; KERNEL-GFX1260:       ; %bb.0: ; %entry
; KERNEL-GFX1260-NEXT:    s_getreg_b32 s0, hwreg(HW_REG_WAVE_GROUP_INFO, 16, 4)
; KERNEL-GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; KERNEL-GFX1260-NEXT:    s_mul_i32 s1, s0, 0
; KERNEL-GFX1260-NEXT:    s_add_co_u32 s1, s1, 0x200
; KERNEL-GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; KERNEL-GFX1260-NEXT:    s_set_gpr_idx_u32 idx0, s1
; KERNEL-GFX1260-NEXT:    s_mul_i32 s33, s0, s2
; KERNEL-GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; KERNEL-GFX1260-NEXT:    s_set_gpr_idx_u32 idx1, 0
; KERNEL-GFX1260-NEXT:    s_set_vgpr_frames 0x41 ; vsrc0_idx=1 vsrc1_idx=0 vsrc2_idx=0 vdst_idx=1 vsrc0_msb=0 vsrc1_msb=0 vsrc2_msb=0 vdst_msb=0
; KERNEL-GFX1260-NEXT:    v_mov_b32_e32 g1[2], g1[1]
; KERNEL-GFX1260-NEXT:    s_barrier_signal -1
; KERNEL-GFX1260-NEXT:    s_barrier_wait -1
; KERNEL-GFX1260-NEXT:    s_endpgm
entry:
...
; KERNEL-GFX1260-NEXT:     .vgpr_count:     512
