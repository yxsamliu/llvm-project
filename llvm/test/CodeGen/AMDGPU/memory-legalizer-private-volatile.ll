...
;
; GFX1300-LABEL: private_volatile_load_0:
; GFX1300:       ; %bb.0: ; %entry
...
; GFX1300-NEXT:    scratch_load_b32 v1, off, s2 scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: private_volatile_load_1:
; GFX1300:       ; %bb.0: ; %entry
...
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    scratch_load_b32 v1, v1, s2 scale_offset scope:SCOPE_SYS
; GFX1300-NEXT:    s_wait_rtscnt 0x0
; GFX1300-NEXT:    s_wait_samplecnt 0x0
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: private_volatile_store_0:
; GFX1300:       ; %bb.0: ; %entry
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: private_volatile_store_1:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b64 s[2:3], s[4:5], 0x0
; GFX1300-NEXT:    s_load_b32 s0, s[4:5], 0x8
; GFX1300-NEXT:    s_wait_kmcnt 0x0
...
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    v_mov_b32_e32 v0, s1
; GFX1300-NEXT:    scratch_store_b32 v1, v0, s0 scale_offset scope:SCOPE_SYS
; GFX1300-NEXT:    s_wait_storecnt 0x0
; GFX1300-NEXT:    s_endpgm
    ptr addrspace(1) %in, ptr addrspace(5) %out) {
entry:
