...
; GCN-NEXT:    v_add_i32_e32 v10, vcc, v13, v12
...
; GCN-NEXT:    v_subrev_i32_e32 v1, vcc, v13, v1
...
; GCN-NEXT:    v_subrev_i32_e32 v2, vcc, v21, v2
...
; GCN-NEXT:    v_subrev_i32_e32 v5, vcc, v7, v3
; GCN-NEXT:    v_cndmask_b32_e64 v3, v3, v5, s[0:1]
; GCN-NEXT:    v_add_i32_e32 v5, vcc, 1, v4
...
; TONGA-NEXT:    v_add_u32_e32 v10, vcc, v13, v12
...
; TONGA-NEXT:    v_subrev_u32_e32 v2, vcc, v21, v2
...
; TONGA-NEXT:    v_subrev_u32_e32 v5, vcc, v7, v3
; TONGA-NEXT:    v_cndmask_b32_e64 v3, v3, v5, s[0:1]
; TONGA-NEXT:    v_add_u32_e32 v5, vcc, 1, v4
...
; GFX9-NEXT:    v_mul_lo_u32 v20, v10, v6
; GFX9-NEXT:    v_mul_lo_u32 v22, v11, v7
...
; GFX9-NEXT:    v_sub_u32_e32 v12, v0, v4
; GFX9-NEXT:    v_add_u32_e32 v15, 1, v9
; GFX9-NEXT:    v_sub_u32_e32 v2, v2, v20
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v8, v13, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[0:1], v1, v5
; GFX9-NEXT:    v_sub_u32_e32 v13, v1, v5
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v0, v12, vcc
; GFX9-NEXT:    v_add_u32_e32 v21, 1, v10
; GFX9-NEXT:    v_sub_u32_e32 v3, v3, v22
; GFX9-NEXT:    v_cndmask_b32_e64 v9, v9, v15, s[0:1]
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[2:3], v2, v6
; GFX9-NEXT:    v_sub_u32_e32 v14, v2, v6
; GFX9-NEXT:    v_add_u32_e32 v12, 1, v8
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v1, v13, s[0:1]
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v4
; GFX9-NEXT:    v_add_u32_e32 v23, 1, v11
; GFX9-NEXT:    v_cndmask_b32_e64 v10, v10, v21, s[2:3]
; GFX9-NEXT:    v_cmp_ge_u32_e64 s[4:5], v3, v7
; GFX9-NEXT:    v_sub_u32_e32 v15, v3, v7
; GFX9-NEXT:    v_add_u32_e32 v13, 1, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v2, v14, s[2:3]
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v8, v12, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v11, v23, s[4:5]
; GFX9-NEXT:    v_add_u32_e32 v14, 1, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v3, v15, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v9, v13, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v6
; GFX9-NEXT:    v_add_u32_e32 v15, 1, v11
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v10, v14, vcc
; GFX9-NEXT:    v_cmp_ge_u32_e32 vcc, v3, v7
; GFX9-NEXT:    v_cndmask_b32_e32 v3, v11, v15, vcc
