...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1260 < %s | FileCheck -check-prefixes=GFX1260 %s
...
;
; GFX1260-LABEL: mad_i64_i32_sextops:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mad_nc_i64_i32 v[0:1], v0, v1, v[2:3]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_i64_i32_sextops_commute:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mad_nc_i64_i32 v[0:1], v0, v1, v[2:3]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_u64_u32_zextops:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[0:1], v0, v1, v[2:3]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_u64_u32_zextops_commute:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[0:1], v0, v1, v[2:3]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_i64_i32_sextops_i32_i128:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v9, 0
; GFX1260-NEXT:    v_mov_b32_e32 v6, v1
; GFX1260-NEXT:    v_mov_b32_e32 v8, v1
; GFX1260-NEXT:    v_ashrrev_i32_e32 v12, 31, v0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1260-NEXT:    v_mov_b32_e32 v1, v9
; GFX1260-NEXT:    v_ashrrev_i32_e32 v7, 31, v6
; GFX1260-NEXT:    v_mov_b32_e32 v21, v9
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1260-NEXT:    v_mov_b32_e32 v13, v12
; GFX1260-NEXT:    v_mul_u64_e32 v[10:11], v[0:1], v[8:9]
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1260-NEXT:    v_mul_u64_e32 v[16:17], v[6:7], v[12:13]
; GFX1260-NEXT:    v_mov_b32_e32 v8, v11
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[14:15], v12, v6, v[8:9]
; GFX1260-NEXT:    v_mov_b32_e32 v8, v14
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[18:19], v0, v7, v[8:9]
; GFX1260-NEXT:    v_mov_b32_e32 v8, v15
; GFX1260-NEXT:    v_mad_nc_i64_i32 v[0:1], v7, v0, v[16:17]
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_mov_b32_e32 v20, v19
; GFX1260-NEXT:    v_add_nc_u64_e32 v[8:9], v[8:9], v[20:21]
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[8:9], v12, v7, v[8:9]
; GFX1260-NEXT:    v_add_nc_u64_e32 v[6:7], v[8:9], v[0:1]
; GFX1260-NEXT:    v_add_co_u32 v0, vcc_lo, v10, v2
; GFX1260-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v18, v3, vcc_lo
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1260-NEXT:    v_add_co_ci_u32_e32 v2, vcc_lo, v6, v4, vcc_lo
; GFX1260-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, v7, v5, vcc_lo
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_i64_i32_sextops_i32_i63:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mad_nc_i64_i32 v[0:1], v0, v1, v[2:3]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_i64_i32_sextops_i31_i63:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_bfe_i32 v1, v1, 0, 31
; GFX1260-NEXT:    v_bfe_i32 v0, v0, 0, 31
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_i64_i32_extops_i32_i64:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v4, v1
; GFX1260-NEXT:    v_mov_b32_e32 v5, v0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[0:1], v5, v4, v[2:3]
; GFX1260-NEXT:    v_ashrrev_i32_e32 v2, 31, v5
; GFX1260-NEXT:    v_mad_u32 v1, v2, v4, v1
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_u64_u32_bitops:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[0:1], v0, v2, v[4:5]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_u64_u32_bitops_lhs_mask_small:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
...
; GFX1260-NEXT:    v_and_b32_e32 v3, 1, v3
; GFX1260-NEXT:    v_mad_u32 v1, v3, v2, v1
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_u64_u32_bitops_rhs_mask_small:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v6, v0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[0:1], v6, v2, v[4:5]
; GFX1260-NEXT:    v_and_b32_e32 v2, 1, v3
; GFX1260-NEXT:    v_mad_u32 v1, v6, v2, v1
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %trunc.lhs = and i64 %arg0, 4294967295
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_i64_i32_bitops:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mad_nc_i64_i32 v[0:1], v0, v2, v[4:5]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_i64_i32_unpack_i64ops:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[0:1], v1, v0, v[0:1]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
;
; GFX1260-LABEL: mad_i64_i32_uniform:
; GFX1260:       ; %bb.0:
...
; GFX1260-NEXT:    s_mov_b32 s2, s3
; GFX1260-NEXT:    s_mov_b32 s3, s5
; GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1260-NEXT:    s_mul_u64 s[2:3], s[4:5], s[2:3]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_i64_i32_twice:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mad_nc_i64_i32 v[2:3], v0, v1, v[2:3]
; GFX1260-NEXT:    v_mad_nc_i64_i32 v[0:1], v0, v1, v[4:5]
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1260-NEXT:    v_xor_b32_e32 v0, v2, v0
; GFX1260-NEXT:    v_xor_b32_e32 v1, v3, v1
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %sext0 = sext i32 %arg0 to i64
  %sext1 = sext i32 %arg1 to i64
  %mul = mul i64 %sext0, %sext1
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_i64_i32_thrice:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v8, v1
...
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_ashrrev_i32_e32 v9, 31, v8
; GFX1260-NEXT:    v_mul_u64_e32 v[0:1], v[0:1], v[8:9]
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX1260-NEXT:    v_add_nc_u64_e32 v[2:3], v[0:1], v[2:3]
; GFX1260-NEXT:    v_add_nc_u64_e32 v[4:5], v[0:1], v[4:5]
; GFX1260-NEXT:    v_add_nc_u64_e32 v[0:1], v[0:1], v[6:7]
; GFX1260-NEXT:    v_xor_b32_e32 v2, v2, v4
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1260-NEXT:    v_xor_b32_e32 v3, v3, v5
; GFX1260-NEXT:    v_xor_b32_e32 v0, v2, v0
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: mad_i64_i32_secondary_use:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v4, v1
...
; GFX1260-NEXT:    v_mul_u64_e32 v[0:1], v[0:1], v[4:5]
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_add_nc_u64_e32 v[2:3], v[0:1], v[2:3]
; GFX1260-NEXT:    v_xor_b32_e32 v0, v2, v0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_2)
...
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[0:1], v6, v2, v[4:5]
; GFX1260-NEXT:    v_mad_u32 v1, v7, v2, v1
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_mad_u32 v1, v6, v3, v1
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %m = mul i48 %arg0, %arg1
  %a = add i48 %m, %arg2
  ret i48 %a
...
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[0:1], 0xfffffc19, v2, v[0:1]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1260-NEXT:    v_mov_b32_e32 v1, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[0:1], 0xd1, v2, v[0:1]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %lsh = lshr i64 %arg0, 32
...
; GFX1260-NEXT:    v_mov_b32_e32 v1, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[0:1], 0xfffffc88, v2, v[0:1]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %lsh = lshr i64 %arg0, 32
...
; GFX1260-NEXT:    v_mov_b32_e32 v1, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_mul_u64_e32 v[2:3], v[2:3], v[0:1]
; GFX1260-NEXT:    v_mov_b32_e32 v0, v2
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[0:1], 0xfffffc88, v3, v[0:1]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: lshr_mad_i64_negative_1:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_lshrrev_b32_e32 v2, 4, v1
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_mad_nc_i64_i32 v[0:1], 0xfffffc19, v2, v[0:1]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: lshr_mad_i64_negative_2:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[2:3], 0xd1, v1, v[0:1]
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 8, v1
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1260-NEXT:    v_sub_nc_u32_e32 v1, v3, v0
; GFX1260-NEXT:    v_mov_b32_e32 v0, v2
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %lsh = lshr i64 %arg0, 32
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: lshr_mad_i64_negative_3:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_lshrrev_b64 v[2:3], 22, v[0:1]
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_and_b32_e32 v2, 0xfffffc00, v2
; GFX1260-NEXT:    v_sub_nc_u64_e32 v[0:1], v[0:1], v[2:3]
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_add_nc_u64_e32 v[0:1], 1, v[0:1]
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %op = add i64 %arg0, 1
  %lsh = lshr i64 %arg0, 32
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: lshr_mad_i64_negative_4:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[2:3], v1, v0, v[0:1]
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1260-NEXT:    v_mad_u32 v1, v1, v1, v3
; GFX1260-NEXT:    v_mov_b32_e32 v0, v2
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
  %lsh = lshr i64 %arg0, 32
...
;
; GFX1260-LABEL: lshr_mad_i64_sgpr:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_mov_b32 s3, 0
; GFX1260-NEXT:    s_mov_b32 s2, s1
; GFX1260-NEXT:    s_mov_b64 s[4:5], 0xffffffffffff1c18
; GFX1260-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1260-NEXT:    s_mul_u64 s[2:3], s[2:3], s[4:5]
; GFX1260-NEXT:    s_add_nc_u64 s[0:1], s[2:3], s[0:1]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: lshr_mad_i64_vec:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[4:5], 0xffff1c18, v1, v[0:1]
; GFX1260-NEXT:    v_mad_nc_u64_u32 v[6:7], 0xffff1118, v3, v[2:3]
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1260-NEXT:    v_sub_nc_u32_e32 v1, v5, v1
; GFX1260-NEXT:    v_sub_nc_u32_e32 v3, v7, v3
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1260-NEXT:    v_mov_b32_e32 v0, v4
; GFX1260-NEXT:    v_mov_b32_e32 v2, v6
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
