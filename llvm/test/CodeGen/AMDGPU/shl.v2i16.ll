...
; VI-NEXT:    s_and_b32 s2, s2, s1
; VI-NEXT:    s_and_b32 s3, s3, s1
; VI-NEXT:    s_lshl_b32 s0, s0, s8
; VI-NEXT:    s_lshl_b32 s2, s2, s3
; VI-NEXT:    s_lshl_b32 s0, s0, 16
; VI-NEXT:    s_and_b32 s1, s2, s1
...
; VI-NEXT:    v_lshlrev_b16_e32 v2, v6, v5
; VI-NEXT:    v_lshlrev_b16_sdwa v3, v6, v5 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
...
; VI-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; VI-NEXT:    v_lshlrev_b16_e32 v4, s2, v3
...
; VI-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; VI-NEXT:    v_lshlrev_b16_e64 v4, v3, s2
...
; VI-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; VI-NEXT:    v_lshlrev_b16_e32 v2, v7, v5
; VI-NEXT:    v_lshlrev_b16_sdwa v3, v7, v5 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; VI-NEXT:    v_lshlrev_b16_e32 v5, v6, v4
; VI-NEXT:    v_lshlrev_b16_sdwa v4, v6, v4 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
