...
; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 < %s | FileCheck -check-prefixes=SDAG %s
; Disabled global-isel run line for release branch cherry-pick
; xxx: llc -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 < %s | FileCheck -check-prefixes=GCN,GISEL %s
...
; GCN-NEXT:    s_cbranch_execz .LBB0_16
...
; GCN-NEXT:    v_sub_u32_e32 v8, 0x80, v9
; GCN-NEXT:    v_cmp_lt_i32_e32 vcc, 25, v8
; GCN-NEXT:    s_mov_b64 s[10:11], 0
; GCN-NEXT:    s_mov_b64 s[4:5], 0
; GCN-NEXT:    s_and_saveexec_b64 s[12:13], vcc
; GCN-NEXT:    s_xor_b64 s[12:13], exec, s[12:13]
; GCN-NEXT:  ; %bb.5: ; %LeafBlock1
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 26, v8
; GCN-NEXT:    s_and_b64 s[4:5], vcc, exec
; GCN-NEXT:  ; %bb.6: ; %Flow3
; GCN-NEXT:    s_andn2_saveexec_b64 s[12:13], s[12:13]
; GCN-NEXT:  ; %bb.7: ; %LeafBlock
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 25, v8
...
; GCN-NEXT:    v_add_u32_e32 v14, 26, v9
...
; GCN-NEXT:    v_subrev_u32_e32 v9, 38, v9
; GCN-NEXT:    v_cndmask_b32_e64 v15, v6, v0, s[4:5]
; GCN-NEXT:    v_or_b32_e32 v6, v13, v11
; GCN-NEXT:    v_or_b32_e32 v11, v12, v10
; GCN-NEXT:    v_lshlrev_b64 v[9:10], v9, v[0:1]
; GCN-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v14
; GCN-NEXT:    v_cndmask_b32_e64 v7, v7, v1, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e32 v6, v10, v6, vcc
; GCN-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v14
; GCN-NEXT:    v_cndmask_b32_e64 v10, v6, v5, s[4:5]
; GCN-NEXT:    v_lshlrev_b64 v[5:6], v14, v[0:1]
; GCN-NEXT:    v_cndmask_b32_e32 v9, v9, v11, vcc
; GCN-NEXT:    v_cndmask_b32_e64 v4, v9, v4, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e32 v6, 0, v6, vcc
; GCN-NEXT:    v_cndmask_b32_e32 v9, 0, v5, vcc
; GCN-NEXT:    v_or_b32_e32 v5, v6, v10
...
; GCN-NEXT:  .LBB0_10: ; %Flow5
; GCN-NEXT:    s_or_b64 exec, exec, s[12:13]
; GCN-NEXT:    s_and_saveexec_b64 s[4:5], s[10:11]
; GCN-NEXT:  ; %bb.11: ; %itofp-sw-bb
; GCN-NEXT:    v_lshlrev_b64 v[6:7], 1, v[0:1]
; GCN-NEXT:  ; %bb.12: ; %itofp-sw-epilog
; GCN-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-NEXT:    v_lshrrev_b32_e32 v0, 2, v6
; GCN-NEXT:    v_and_or_b32 v0, v0, 1, v6
...
; GCN-NEXT:    v_alignbit_b32 v6, v1, v0, 2
; GCN-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GCN-NEXT:  ; %bb.13: ; %itofp-if-then20
; GCN-NEXT:    v_alignbit_b32 v6, v1, v0, 3
; GCN-NEXT:    v_mov_b32_e32 v2, v8
; GCN-NEXT:  ; %bb.14: ; %Flow
; GCN-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-NEXT:  .LBB0_15: ; %Flow7
...
; GCN-NEXT:    v_sub_u32_e32 v6, 0x7f, v8
...
; GCN-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GCN-NEXT:  ; %bb.2: ; %itofp-if-else
; GCN-NEXT:    v_add_u32_e32 v2, 0xffffff98, v8
...
; GCN-NEXT:  ; %bb.4: ; %NodeBlock
; GCN-NEXT:    v_sub_u32_e32 v7, 0x80, v8
; GCN-NEXT:    v_cmp_lt_i32_e32 vcc, 25, v7
; GCN-NEXT:    s_mov_b64 s[10:11], 0
; GCN-NEXT:    s_mov_b64 s[4:5], 0
; GCN-NEXT:    s_and_saveexec_b64 s[12:13], vcc
; GCN-NEXT:    s_xor_b64 s[12:13], exec, s[12:13]
; GCN-NEXT:  ; %bb.5: ; %LeafBlock1
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 26, v7
; GCN-NEXT:    s_and_b64 s[4:5], vcc, exec
; GCN-NEXT:  ; %bb.6: ; %Flow3
; GCN-NEXT:    s_andn2_saveexec_b64 s[12:13], s[12:13]
; GCN-NEXT:  ; %bb.7: ; %LeafBlock
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 25, v7
; GCN-NEXT:    s_andn2_b64 s[4:5], s[4:5], exec
; GCN-NEXT:    s_and_b64 s[14:15], vcc, exec
; GCN-NEXT:    s_mov_b64 s[10:11], exec
; GCN-NEXT:    s_or_b64 s[4:5], s[4:5], s[14:15]
...
; GCN-NEXT:    v_add_u32_e32 v13, 26, v8
...
; GCN-NEXT:    v_subrev_u32_e32 v8, 38, v8
; GCN-NEXT:    v_cndmask_b32_e64 v14, v4, v0, s[4:5]
; GCN-NEXT:    v_or_b32_e32 v4, v12, v10
; GCN-NEXT:    v_or_b32_e32 v10, v11, v9
; GCN-NEXT:    v_lshlrev_b64 v[8:9], v8, v[0:1]
...
; GCN-NEXT:    v_cndmask_b32_e64 v9, v4, v3, s[4:5]
...
; GCN-NEXT:    v_alignbit_b32 v9, v1, v0, 2
; GCN-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GCN-NEXT:  ; %bb.13: ; %itofp-if-then20
; GCN-NEXT:    v_alignbit_b32 v9, v1, v0, 3
; GCN-NEXT:    v_mov_b32_e32 v6, v7
; GCN-NEXT:  ; %bb.14: ; %Flow
; GCN-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-NEXT:  .LBB1_15: ; %Flow7
; GCN-NEXT:    s_or_b64 exec, exec, s[8:9]
; GCN-NEXT:    v_and_b32_e32 v0, 0x7fffff, v9
; GCN-NEXT:    v_lshl_or_b32 v0, v6, 23, v0
; GCN-NEXT:    v_add_u32_e32 v4, 1.0, v0
; GCN-NEXT:  .LBB1_16: ; %Flow8
; GCN-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-NEXT:    v_mov_b32_e32 v0, v4
; GCN-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; GCN-NEXT:    s_cbranch_execz .LBB2_16
; GCN-NEXT:  ; %bb.1: ; %itofp-if-end
; GCN-NEXT:    v_ashrrev_i32_e32 v0, 31, v3
; GCN-NEXT:    v_xor_b32_e32 v4, v0, v4
; GCN-NEXT:    v_xor_b32_e32 v5, v0, v5
; GCN-NEXT:    v_sub_co_u32_e32 v4, vcc, v4, v0
; GCN-NEXT:    v_xor_b32_e32 v2, v0, v2
; GCN-NEXT:    v_subb_co_u32_e32 v5, vcc, v5, v0, vcc
; GCN-NEXT:    v_xor_b32_e32 v1, v0, v3
...
; GCN-NEXT:    v_cndmask_b32_e32 v11, v1, v0, vcc
; GCN-NEXT:    v_sub_u32_e32 v2, 0x7f, v11
...
; GCN-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GCN-NEXT:  ; %bb.2: ; %itofp-if-else
; GCN-NEXT:    v_add_u32_e32 v6, 0xffffffb5, v11
; GCN-NEXT:    v_lshlrev_b64 v[0:1], v6, v[4:5]
; GCN-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v6
; GCN-NEXT:    v_cndmask_b32_e32 v8, 0, v1, vcc
...
; GCN-NEXT:  ; %bb.3: ; %Flow6
; GCN-NEXT:    s_andn2_saveexec_b64 s[8:9], s[4:5]
; GCN-NEXT:    s_cbranch_execz .LBB2_15
; GCN-NEXT:  ; %bb.4: ; %NodeBlock
; GCN-NEXT:    v_sub_u32_e32 v10, 0x80, v11
; GCN-NEXT:    v_cmp_lt_i32_e32 vcc, 54, v10
; GCN-NEXT:    s_mov_b64 s[10:11], 0
; GCN-NEXT:    s_mov_b64 s[4:5], 0
; GCN-NEXT:    s_and_saveexec_b64 s[12:13], vcc
; GCN-NEXT:    s_xor_b64 s[12:13], exec, s[12:13]
; GCN-NEXT:  ; %bb.5: ; %LeafBlock1
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 55, v10
; GCN-NEXT:    s_and_b64 s[4:5], vcc, exec
; GCN-NEXT:  ; %bb.6: ; %Flow3
; GCN-NEXT:    s_andn2_saveexec_b64 s[12:13], s[12:13]
; GCN-NEXT:  ; %bb.7: ; %LeafBlock
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 54, v10
; GCN-NEXT:    s_andn2_b64 s[4:5], s[4:5], exec
; GCN-NEXT:    s_and_b64 s[14:15], vcc, exec
; GCN-NEXT:    s_mov_b64 s[10:11], exec
; GCN-NEXT:    s_or_b64 s[4:5], s[4:5], s[14:15]
...
; GCN-NEXT:    s_and_saveexec_b64 s[12:13], s[4:5]
; GCN-NEXT:    s_xor_b64 s[12:13], exec, s[12:13]
; GCN-NEXT:    s_cbranch_execz .LBB2_10
; GCN-NEXT:  ; %bb.9: ; %itofp-sw-default
; GCN-NEXT:    v_sub_u32_e32 v12, 0x49, v11
; GCN-NEXT:    v_sub_u32_e32 v8, 64, v12
; GCN-NEXT:    v_lshrrev_b64 v[0:1], v12, v[4:5]
; GCN-NEXT:    v_lshlrev_b64 v[8:9], v8, v[6:7]
; GCN-NEXT:    v_sub_u32_e32 v13, 9, v11
; GCN-NEXT:    v_or_b32_e32 v9, v1, v9
; GCN-NEXT:    v_or_b32_e32 v8, v0, v8
; GCN-NEXT:    v_lshrrev_b64 v[0:1], v13, v[6:7]
; GCN-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v12
; GCN-NEXT:    v_cndmask_b32_e32 v1, v1, v9, vcc
; GCN-NEXT:    v_cndmask_b32_e32 v0, v0, v8, vcc
; GCN-NEXT:    v_lshrrev_b64 v[8:9], v12, v[6:7]
; GCN-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v12
; GCN-NEXT:    v_cndmask_b32_e32 v9, 0, v9, vcc
; GCN-NEXT:    v_add_u32_e32 v9, 55, v11
; GCN-NEXT:    v_lshrrev_b64 v[12:13], v13, v[4:5]
; GCN-NEXT:    v_lshlrev_b64 v[14:15], v9, v[6:7]
; GCN-NEXT:    v_add_u32_e32 v11, -9, v11
; GCN-NEXT:    v_or_b32_e32 v14, v14, v12
; GCN-NEXT:    v_lshlrev_b64 v[11:12], v11, v[4:5]
; GCN-NEXT:    v_cndmask_b32_e32 v8, 0, v8, vcc
; GCN-NEXT:    v_or_b32_e32 v13, v15, v13
; GCN-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v9
; GCN-NEXT:    v_cndmask_b32_e64 v1, v1, v5, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e64 v0, v0, v4, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e32 v12, v12, v13, vcc
; GCN-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v9
; GCN-NEXT:    v_cndmask_b32_e64 v13, v12, v7, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e32 v14, v11, v14, vcc
; GCN-NEXT:    v_lshlrev_b64 v[11:12], v9, v[4:5]
; GCN-NEXT:    v_cndmask_b32_e64 v9, v14, v6, s[4:5]
...
; GCN-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[11:12]
; GCN-NEXT:    s_andn2_b64 s[10:11], s[10:11], exec
; GCN-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GCN-NEXT:    v_or_b32_e32 v0, v0, v9
; GCN-NEXT:  .LBB2_10: ; %Flow5
; GCN-NEXT:    s_or_b64 exec, exec, s[12:13]
; GCN-NEXT:    s_and_saveexec_b64 s[4:5], s[10:11]
; GCN-NEXT:  ; %bb.11: ; %itofp-sw-bb
; GCN-NEXT:    v_lshlrev_b64 v[8:9], 1, v[6:7]
; GCN-NEXT:    v_lshrrev_b32_e32 v6, 31, v5
; GCN-NEXT:    v_lshlrev_b64 v[0:1], 1, v[4:5]
...
; GCN-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; GCN-NEXT:    s_cbranch_execz .LBB3_16
; GCN-NEXT:  ; %bb.1: ; %itofp-if-end
; GCN-NEXT:    v_ffbh_u32_e32 v4, v2
; GCN-NEXT:    v_add_u32_e32 v4, 32, v4
; GCN-NEXT:    v_ffbh_u32_e32 v5, v3
...
; GCN-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[2:3]
; GCN-NEXT:    v_add_u32_e32 v5, 64, v5
; GCN-NEXT:    v_cndmask_b32_e32 v11, v5, v4, vcc
; GCN-NEXT:    ; implicit-def: $vgpr4_vgpr5
; GCN-NEXT:    v_sub_u32_e32 v9, 0x7f, v11
; GCN-NEXT:    v_mov_b32_e32 v6, v1
; GCN-NEXT:    v_mov_b32_e32 v8, v3
; GCN-NEXT:    v_cmp_gt_i32_e32 vcc, 54, v9
...
; GCN-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GCN-NEXT:  ; %bb.2: ; %itofp-if-else
; GCN-NEXT:    v_add_u32_e32 v2, 0xffffffb5, v11
; GCN-NEXT:    v_lshlrev_b64 v[0:1], v2, v[0:1]
; GCN-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v2
; GCN-NEXT:    v_cndmask_b32_e32 v12, 0, v1, vcc
; GCN-NEXT:    v_cndmask_b32_e32 v4, 0, v0, vcc
; GCN-NEXT:    ; implicit-def: $vgpr2_vgpr3
; GCN-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GCN-NEXT:    ; implicit-def: $vgpr11
; GCN-NEXT:    ; implicit-def: $vgpr5_vgpr6
; GCN-NEXT:    ; implicit-def: $vgpr7_vgpr8
; GCN-NEXT:  ; %bb.3: ; %Flow6
; GCN-NEXT:    s_andn2_saveexec_b64 s[8:9], s[4:5]
; GCN-NEXT:    s_cbranch_execz .LBB3_15
; GCN-NEXT:  ; %bb.4: ; %NodeBlock
; GCN-NEXT:    v_sub_u32_e32 v10, 0x80, v11
; GCN-NEXT:    v_cmp_lt_i32_e32 vcc, 54, v10
; GCN-NEXT:    s_mov_b64 s[10:11], 0
...
; GCN-NEXT:    s_and_saveexec_b64 s[12:13], s[4:5]
; GCN-NEXT:    s_xor_b64 s[12:13], exec, s[12:13]
; GCN-NEXT:    s_cbranch_execz .LBB3_10
; GCN-NEXT:  ; %bb.9: ; %itofp-sw-default
; GCN-NEXT:    v_sub_u32_e32 v8, 0x49, v11
; GCN-NEXT:    v_sub_u32_e32 v6, 64, v8
; GCN-NEXT:    v_lshrrev_b64 v[4:5], v8, v[0:1]
; GCN-NEXT:    v_lshlrev_b64 v[6:7], v6, v[2:3]
; GCN-NEXT:    v_sub_u32_e32 v13, 9, v11
; GCN-NEXT:    v_or_b32_e32 v7, v5, v7
; GCN-NEXT:    v_or_b32_e32 v12, v4, v6
; GCN-NEXT:    v_lshrrev_b64 v[4:5], v13, v[2:3]
; GCN-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v8
; GCN-NEXT:    v_cndmask_b32_e32 v5, v5, v7, vcc
; GCN-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v8
; GCN-NEXT:    v_cndmask_b32_e64 v6, v5, v1, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e32 v7, v4, v12, vcc
; GCN-NEXT:    v_lshrrev_b64 v[4:5], v8, v[2:3]
; GCN-NEXT:    v_add_u32_e32 v16, 55, v11
; GCN-NEXT:    v_cndmask_b32_e64 v8, v7, v0, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e32 v5, 0, v5, vcc
; GCN-NEXT:    v_lshrrev_b64 v[12:13], v13, v[0:1]
; GCN-NEXT:    v_lshlrev_b64 v[14:15], v16, v[2:3]
; GCN-NEXT:    v_cndmask_b32_e32 v7, 0, v4, vcc
; GCN-NEXT:    v_add_u32_e32 v4, -9, v11
...
; GCN-NEXT:    v_cndmask_b32_e64 v11, v5, v3, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e32 v12, v4, v12, vcc
; GCN-NEXT:    v_lshlrev_b64 v[4:5], v16, v[0:1]
; GCN-NEXT:    v_cndmask_b32_e64 v12, v12, v2, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e32 v5, 0, v5, vcc
; GCN-NEXT:    v_cndmask_b32_e32 v4, 0, v4, vcc
...
; GCN-NEXT:    s_andn2_b64 s[10:11], s[10:11], exec
; GCN-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GCN-NEXT:    v_or_b32_e32 v5, v8, v4
; GCN-NEXT:  .LBB3_10: ; %Flow5
; GCN-NEXT:    s_or_b64 exec, exec, s[12:13]
; GCN-NEXT:    s_and_saveexec_b64 s[4:5], s[10:11]
; GCN-NEXT:  ; %bb.11: ; %itofp-sw-bb
; GCN-NEXT:    v_lshlrev_b64 v[7:8], 1, v[2:3]
; GCN-NEXT:    v_lshrrev_b32_e32 v2, 31, v1
; GCN-NEXT:    v_lshlrev_b64 v[5:6], 1, v[0:1]
; GCN-NEXT:    v_or_b32_e32 v7, v7, v2
; GCN-NEXT:  ; %bb.12: ; %itofp-sw-epilog
; GCN-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-NEXT:    v_lshrrev_b32_e32 v0, 2, v5
; GCN-NEXT:    v_and_or_b32 v0, v0, 1, v5
; GCN-NEXT:    v_add_co_u32_e32 v0, vcc, 1, v0
; GCN-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v6, vcc
; GCN-NEXT:    v_addc_co_u32_e32 v2, vcc, 0, v7, vcc
; GCN-NEXT:    v_lshrrev_b64 v[4:5], 2, v[0:1]
; GCN-NEXT:    v_and_b32_e32 v3, 0x800000, v1
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v3
; GCN-NEXT:    v_alignbit_b32 v12, v2, v1, 2
; GCN-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GCN-NEXT:  ; %bb.13: ; %itofp-if-then20
; GCN-NEXT:    v_lshrrev_b64 v[4:5], 3, v[0:1]
; GCN-NEXT:    v_alignbit_b32 v12, v2, v1, 3
; GCN-NEXT:    v_mov_b32_e32 v9, v10
; GCN-NEXT:  ; %bb.14: ; %Flow
; GCN-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-NEXT:  .LBB3_15: ; %Flow7
; GCN-NEXT:    s_or_b64 exec, exec, s[8:9]
; GCN-NEXT:    v_and_b32_e32 v0, 0xfffff, v12
; GCN-NEXT:    v_lshl_or_b32 v0, v9, 20, v0
; GCN-NEXT:    v_add_u32_e32 v5, 0x3ff00000, v0
; GCN-NEXT:  .LBB3_16: ; %Flow8
; GCN-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-NEXT:    v_mov_b32_e32 v0, v4
; GCN-NEXT:    v_mov_b32_e32 v1, v5
; GCN-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-NEXT:    v_mov_b32_e32 v4, 0
; GCN-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; GCN-NEXT:    s_cbranch_execz .LBB4_16
; GCN-NEXT:  ; %bb.1: ; %itofp-if-end
; GCN-NEXT:    v_ashrrev_i32_e32 v5, 31, v3
; GCN-NEXT:    v_xor_b32_e32 v0, v5, v0
; GCN-NEXT:    v_xor_b32_e32 v1, v5, v1
...
; GCN-NEXT:  ; %bb.3: ; %Flow6
; GCN-NEXT:    s_andn2_saveexec_b64 s[8:9], s[4:5]
; GCN-NEXT:    s_cbranch_execz .LBB4_15
; GCN-NEXT:  ; %bb.4: ; %NodeBlock
; GCN-NEXT:    v_sub_u32_e32 v8, 0x80, v9
; GCN-NEXT:    v_cmp_lt_i32_e32 vcc, 25, v8
; GCN-NEXT:    s_mov_b64 s[10:11], 0
...
; GCN-NEXT:    s_and_saveexec_b64 s[12:13], s[4:5]
; GCN-NEXT:    s_xor_b64 s[12:13], exec, s[12:13]
; GCN-NEXT:    s_cbranch_execz .LBB4_10
; GCN-NEXT:  ; %bb.9: ; %itofp-sw-default
; GCN-NEXT:    v_sub_u32_e32 v12, 0x66, v9
; GCN-NEXT:    v_sub_u32_e32 v10, 64, v12
; GCN-NEXT:    v_lshrrev_b64 v[6:7], v12, v[0:1]
...
; GCN-NEXT:    v_mov_b32_e32 v4, 0
; GCN-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; GCN-NEXT:    s_cbranch_execz .LBB5_16
; GCN-NEXT:  ; %bb.1: ; %itofp-if-end
; GCN-NEXT:    v_ffbh_u32_e32 v4, v2
; GCN-NEXT:    v_add_u32_e32 v4, 32, v4
; GCN-NEXT:    v_ffbh_u32_e32 v5, v3
...
; GCN-NEXT:  ; %bb.3: ; %Flow6
; GCN-NEXT:    s_andn2_saveexec_b64 s[8:9], s[4:5]
; GCN-NEXT:    s_cbranch_execz .LBB5_15
; GCN-NEXT:  ; %bb.4: ; %NodeBlock
; GCN-NEXT:    v_sub_u32_e32 v7, 0x80, v8
; GCN-NEXT:    v_cmp_lt_i32_e32 vcc, 25, v7
; GCN-NEXT:    s_mov_b64 s[10:11], 0
...
; GCN-NEXT:    s_and_saveexec_b64 s[12:13], s[4:5]
; GCN-NEXT:    s_xor_b64 s[12:13], exec, s[12:13]
; GCN-NEXT:    s_cbranch_execz .LBB5_10
; GCN-NEXT:  ; %bb.9: ; %itofp-sw-default
; GCN-NEXT:    v_sub_u32_e32 v11, 0x66, v8
; GCN-NEXT:    v_sub_u32_e32 v9, 64, v11
; GCN-NEXT:    v_lshrrev_b64 v[4:5], v11, v[0:1]
...
; GCN-NEXT:  ; %bb.14: ; %Flow
; GCN-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-NEXT:  .LBB5_15: ; %Flow7
; GCN-NEXT:    s_or_b64 exec, exec, s[8:9]
; GCN-NEXT:    v_and_b32_e32 v0, 0x7fffff, v9
; GCN-NEXT:    v_lshl_or_b32 v0, v6, 23, v0
; GCN-NEXT:    v_add_u32_e32 v0, 1.0, v0
; GCN-NEXT:    v_cvt_f16_f32_e32 v4, v0
; GCN-NEXT:  .LBB5_16: ; %Flow8
; GCN-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-NEXT:    v_mov_b32_e32 v0, v4
; GCN-NEXT:    s_setpc_b64 s[30:31]
