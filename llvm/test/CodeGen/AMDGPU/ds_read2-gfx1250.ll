...
; RUN: llc -mtriple=amdgcn--amdpal -mcpu=gfx1260 -mattr=+load-store-opt,+unaligned-access-mode < %s | FileCheck -enable-var-scope -check-prefixes=GFX1260,GFX1260-UNALIGNED %s
...
;
; GFX1260-LABEL: simple_read2_f32:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_and_b32_e32 v2, 0xffc, v0
; GFX1260-NEXT:    ds_load_2addr_b32 v[0:1], v2 offset1:8
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_f32_e32 v0, v0, v1
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: simple_read2_f32_max_offset:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_and_b32_e32 v2, 0xffc, v0
; GFX1260-NEXT:    ds_load_2addr_b32 v[0:1], v2 offset1:255
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_store_b32 v2, v0, s[0:1]
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: simple_read2_f32_too_far:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_and_b32_e32 v0, 0xffc, v0
; GFX1260-NEXT:    ds_load_b32 v1, v0
; GFX1260-NEXT:    ds_load_b32 v2, v0 offset:1028
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_f32_e32 v1, v1, v2
; GFX1260-NEXT:    s_wait_kmcnt 0x0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: simple_read2_f32_x2:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_and_b32_e32 v4, 0xffc, v0
; GFX1260-NEXT:    ds_load_2addr_b32 v[0:1], v4 offset1:8
; GFX1260-NEXT:    ds_load_2addr_b32 v[2:3], v4 offset0:11 offset1:27
; GFX1260-NEXT:    s_wait_dscnt 0x1
; GFX1260-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_f32_e32 v1, v2, v3
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_store_b32 v4, v0, s[0:1]
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: simple_read2_f32_x2_barrier:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: simple_read2_f32_x2_nonzero_base:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_and_b32_e32 v4, 0xffc, v0
; GFX1260-NEXT:    ds_load_2addr_b32 v[0:1], v4 offset0:2 offset1:8
; GFX1260-NEXT:    ds_load_2addr_b32 v[2:3], v4 offset0:11 offset1:27
; GFX1260-NEXT:    s_wait_dscnt 0x1
; GFX1260-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1260-NEXT:    s_wait_dscnt 0x0
...
; GFX1260-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_store_b32 v4, v0, s[0:1] offset:8
; GFX1260-NEXT:    s_endpgm
  %tid.x = tail call i32 @llvm.amdgcn.workitem.id.x() #1
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: read2_ptr_is_subreg_arg_f32:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
...
; GFX1260-NEXT:    ds_load_b32 v1, v1 offset:32
; GFX1260-NEXT:    ds_load_b32 v2, v2
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_f32_e32 v1, v1, v2
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: read2_ptr_is_subreg_arg_offset_f32:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1260-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
...
; GFX1260-NEXT:    v_mov_b32_e32 v2, s3
; GFX1260-NEXT:    ds_load_b32 v1, v1 offset:32
; GFX1260-NEXT:    ds_load_b32 v2, v2 offset:32
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_f32_e32 v1, v1, v2
; GFX1260-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: read2_ptr_is_subreg_f32:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: simple_read2_f32_volatile_0:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
...
; GFX1260-NEXT:    v_and_b32_e32 v0, 0xffc, v0
; GFX1260-NEXT:    ds_load_b32 v1, v0
; GFX1260-NEXT:    ds_load_b32 v2, v0 offset:32
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_f32_e32 v1, v1, v2
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: simple_read2_f32_volatile_1:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: unaligned_read2_f32:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_and_b32_e32 v0, 0xffc, v0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_add_nc_u32_e32 v1, s2, v0
; GFX1260-NEXT:    ds_load_b32 v2, v1
; GFX1260-NEXT:    ds_load_b32 v1, v1 offset:32
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_f32_e32 v1, v2, v1
; GFX1260-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1260-NEXT:    s_endpgm
  %x.i = tail call i32 @llvm.amdgcn.workitem.id.x() #1
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: unaligned_offset_read2_f32:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
...
; GFX1260-NEXT:    v_and_b32_e32 v2, 0xffc, v0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_add_nc_u32_e32 v0, s2, v2
; GFX1260-NEXT:    ds_load_b64 v[0:1], v0 offset:5
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1260-NEXT:    global_store_b32 v2, v0, s[0:1]
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: misaligned_2_simple_read2_f32:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: simple_read2_f64:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_and_b32_e32 v4, 0x1ff8, v0
; GFX1260-NEXT:    ds_load_2addr_b64 v[0:3], v4 offset1:8
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 2), 0
; GFX1260-NEXT:    v_add_f64_e32 v[0:1], v[0:1], v[2:3]
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_store_b64 v4, v[0:1], s[0:1]
; GFX1260-NEXT:    s_endpgm
  %x.i = tail call i32 @llvm.amdgcn.workitem.id.x() #1
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: simple_read2_f64_max_offset:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_and_b32_e32 v4, 0x1ff8, v0
; GFX1260-NEXT:    ds_load_2addr_b64 v[0:3], v4 offset1:255
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 2), 0
; GFX1260-NEXT:    v_add_f64_e32 v[0:1], v[0:1], v[2:3]
; GFX1260-NEXT:    s_wait_kmcnt 0x0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: simple_read2_f64_too_far:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_and_b32_e32 v4, 0x1ff8, v0
; GFX1260-NEXT:    ds_load_b64 v[0:1], v4
; GFX1260-NEXT:    ds_load_b64 v[2:3], v4 offset:2056
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 2), 0
; GFX1260-NEXT:    v_add_f64_e32 v[0:1], v[0:1], v[2:3]
; GFX1260-NEXT:    s_wait_kmcnt 0x0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: misaligned_read2_f64:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
...
; GFX1260-NEXT:    v_and_b32_e32 v4, 0x1ff8, v0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_add_nc_u32_e32 v2, s2, v4
; GFX1260-NEXT:    ds_load_b64 v[0:1], v2
; GFX1260-NEXT:    ds_load_b64 v[2:3], v2 offset:56
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 2), 0
; GFX1260-NEXT:    v_add_f64_e32 v[0:1], v[0:1], v[2:3]
; GFX1260-NEXT:    global_store_b64 v4, v[0:1], s[0:1]
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: load_constant_adjacent_offsets:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
...
; GFX1260-NEXT:    ds_load_b64 v[0:1], v2
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_nc_u32_e32 v0, v0, v1
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_store_b32 v2, v0, s[0:1]
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: load_constant_disjoint_offsets:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v2, 0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    ds_load_2addr_b32 v[0:1], v2 offset1:2
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_nc_u32_e32 v0, v0, v1
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_store_b32 v2, v0, s[0:1]
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: load_misaligned64_constant_offsets:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v4, 0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    ds_load_b128 v[0:3], v4
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_nc_u64_e32 v[0:1], v[0:1], v[2:3]
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_store_b64 v4, v[0:1], s[0:1]
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: load_misaligned64_constant_large_offsets:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v4, 0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    ds_load_b64 v[0:1], v4 offset:16384
; GFX1260-NEXT:    ds_load_b64 v[2:3], v4 offset:32760
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_nc_u64_e32 v[0:1], v[0:1], v[2:3]
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_store_b64 v4, v[0:1], s[0:1]
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: sgemm_inner_loop_read2_sequence:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_bfe_u32 s0, ttmp6, 0x4000c
; GFX1260-NEXT:    s_and_b32 s1, ttmp6, 15
; GFX1260-NEXT:    s_add_co_i32 s0, s0, 1
; GFX1260-NEXT:    s_getreg_b32 s2, hwreg(HW_REG_IB_STS2, 6, 4)
; GFX1260-NEXT:    s_mul_i32 s0, ttmp9, s0
; GFX1260-NEXT:    v_lshrrev_b32_e32 v0, 8, v0
; GFX1260-NEXT:    s_add_co_i32 s1, s1, s0
; GFX1260-NEXT:    s_cmp_eq_u32 s2, 0
; GFX1260-NEXT:    s_cselect_b32 s0, ttmp9, s1
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1260-NEXT:    v_and_b32_e32 v8, 0xffc, v0
; GFX1260-NEXT:    s_lshl_b32 s0, s0, 2
; GFX1260-NEXT:    v_mov_b32_e32 v1, s0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    ds_load_b64 v[2:3], v1 offset:3104
; GFX1260-NEXT:    ds_load_b64 v[4:5], v1 offset:3168
; GFX1260-NEXT:    ds_load_b64 v[0:1], v8
; GFX1260-NEXT:    ds_load_b64 v[6:7], v8 offset:128
; GFX1260-NEXT:    s_wait_dscnt 0x3
; GFX1260-NEXT:    v_add_f32_e32 v2, v2, v3
; GFX1260-NEXT:    s_wait_dscnt 0x2
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_add_f32_e32 v2, v2, v4
; GFX1260-NEXT:    v_add_f32_e32 v4, v2, v5
; GFX1260-NEXT:    ds_load_b64 v[2:3], v8 offset:256
; GFX1260-NEXT:    s_wait_dscnt 0x2
; GFX1260-NEXT:    v_add_f32_e32 v0, v4, v0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX1260-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1260-NEXT:    v_mov_b32_e32 v1, 0
; GFX1260-NEXT:    s_wait_dscnt 0x1
; GFX1260-NEXT:    v_add_f32_e32 v0, v0, v6
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_add_f32_e32 v0, v0, v7
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_f32_e32 v0, v0, v2
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_add_f32_e32 v0, v0, v3
; GFX1260-NEXT:    s_wait_kmcnt 0x0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: misaligned_read2_v2i32:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX1260-NEXT:    ds_load_b64 v[0:1], v0
; GFX1260-NEXT:    s_wait_dscnt 0x0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: misaligned_read2_i64:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: ds_read_diff_base_interleaving:
; GFX1260:       ; %bb.0: ; %bb
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_load_b128 s[0:3], s[4:5], 0x8
; GFX1260-NEXT:    v_lshrrev_b32_e32 v1, 6, v0
; GFX1260-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1260-NEXT:    v_and_b32_e32 v1, 0x3ff0, v1
; GFX1260-NEXT:    v_and_b32_e32 v0, 0xffc, v0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1260-NEXT:    v_add_nc_u32_e32 v2, s0, v1
; GFX1260-NEXT:    v_add_nc_u32_e32 v3, s1, v0
; GFX1260-NEXT:    v_add_nc_u32_e32 v4, s2, v1
; GFX1260-NEXT:    v_add_nc_u32_e32 v6, s3, v0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    ds_load_b64 v[0:1], v2
; GFX1260-NEXT:    ds_load_2addr_b32 v[2:3], v3 offset1:4
; GFX1260-NEXT:    ds_load_b64 v[4:5], v4
; GFX1260-NEXT:    ds_load_2addr_b32 v[6:7], v6 offset1:4
; GFX1260-NEXT:    s_wait_dscnt 0x2
; GFX1260-NEXT:    v_mul_f32_e32 v0, v0, v2
; GFX1260-NEXT:    v_mul_f32_e32 v1, v1, v3
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_mul_f32_e32 v2, v4, v6
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_add_f32_e32 v0, 2.0, v0
; GFX1260-NEXT:    v_sub_f32_e32 v0, v0, v2
; GFX1260-NEXT:    v_mov_b32_e32 v2, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1260-NEXT:    v_sub_f32_e32 v0, v0, v1
; GFX1260-NEXT:    v_mul_f32_e32 v1, v5, v7
; GFX1260-NEXT:    v_sub_f32_e32 v0, v0, v1
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_store_b32 v2, v0, s[0:1] offset:40
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: ds_read_call_read:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_mov_b32 s32, 0
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_load_b96 s[36:38], s[4:5], 0x0
; GFX1260-NEXT:    v_and_b32_e32 v1, 0x3ff, v0
; GFX1260-NEXT:    v_mov_b32_e32 v31, v0
; GFX1260-NEXT:    s_mov_b64 s[10:11], s[6:7]
; GFX1260-NEXT:    s_add_nc_u64 s[8:9], s[4:5], 12
; GFX1260-NEXT:    s_mov_b64 s[12:13], void_func_void@abs64
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GFX1260-NEXT:    s_mov_b64 s[6:7], s[2:3]
; GFX1260-NEXT:    v_mov_b32_e32 v42, 0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_lshl_add_u32 v40, v1, 2, s38
; GFX1260-NEXT:    ds_load_b32 v41, v40
; GFX1260-NEXT:    s_swap_pc_i64 s[30:31], s[12:13]
; GFX1260-NEXT:    ds_load_b32 v0, v40 offset:4
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_add_nc_u32_e32 v0, v41, v0
; GFX1260-NEXT:    global_store_b32 v42, v0, s[36:37]
; GFX1260-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: read2_v2i32_align1_odd_offset:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v2, 0
; GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1260-NEXT:    ds_load_b64 v[0:1], v2 offset:65
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX1260-NEXT:    s_endpgm
