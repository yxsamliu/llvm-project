...
define amdgpu_ps <4 x float> @load_1d(i32 %rsrc, i32 %s) {
; GFX13-LABEL: load_1d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:3], v1, v0 dmask:0xf dim:SQ_RSRC_IMG_1D
...
define amdgpu_ps <4 x float> @load_1d_tfe(i32 %rsrc, ptr addrspace(1) inreg %out, i32 %s) {
; GFX13-LABEL: load_1d_tfe:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v7, 0 :: v_dual_mov_b32 v6, v1
; GFX13-NEXT:    v_dual_mov_b32 v5, v0 :: v_dual_mov_b32 v8, v7
...
; GFX13-NEXT:    image_load v[0:4], v6, v5 dmask:0xf dim:SQ_RSRC_IMG_1D tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v7, v4, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_1d_lwe(i32 %rsrc, ptr addrspace(1) inreg %out, i32 %s) {
; GFX13-LABEL: load_1d_lwe:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:4], v1, v0 dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    v_mov_b32_e32 v5, 0
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v5, v4, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_2d(i32 %rsrc, i32 %s, i32 %t) {
; GFX13-LABEL: load_2d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:3], [v1, v2], v0 dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_2d_tfe(i32 %rsrc, ptr addrspace(1) inreg %out, i32 %s, i32 %t) {
; GFX13-LABEL: load_2d_tfe:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v5, v0 :: v_dual_mov_b32 v8, 0
...
; GFX13-NEXT:    image_load v[0:4], [v7, v6], v5 dmask:0xf dim:SQ_RSRC_IMG_2D tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v8, v4, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_3d(i32 %rsrc, i32 %s, i32 %t, i32 %r) {
; GFX13-LABEL: load_3d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:3], [v1, v2, v3], v0 dmask:0xf dim:SQ_RSRC_IMG_3D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_3d_tfe_lwe(i32 %rsrc, ptr addrspace(1) inreg %out, i32 %s, i32 %t, i32 %r) {
; GFX13-LABEL: load_3d_tfe_lwe:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v9, 0 :: v_dual_mov_b32 v6, v3
; GFX13-NEXT:    v_dual_mov_b32 v7, v2 :: v_dual_mov_b32 v8, v1
; GFX13-NEXT:    v_dual_mov_b32 v5, v0 :: v_dual_mov_b32 v10, v9
...
; GFX13-NEXT:    image_load v[0:4], [v8, v7, v6], v5 dmask:0xf dim:SQ_RSRC_IMG_3D tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v9, v4, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_cube(i32 %rsrc, i32 %s, i32 %t, i32 %slice) {
; GFX13-LABEL: load_cube:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:3], [v1, v2, v3], v0 dmask:0xf dim:SQ_RSRC_IMG_CUBE
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_cube_lwe(i32 %rsrc, ptr addrspace(1) inreg %out, i32 %s, i32 %t, i32 %slice) {
; GFX13-LABEL: load_cube_lwe:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:4], [v1, v2, v3], v0 dmask:0xf dim:SQ_RSRC_IMG_CUBE
; GFX13-NEXT:    v_mov_b32_e32 v5, 0
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v5, v4, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
...
define amdgpu_ps <4 x float> @load_1darray(i32 %rsrc, i32 %s, i32 %slice) {
; GFX13-LABEL: load_1darray:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:3], [v1, v2], v0 dmask:0xf dim:SQ_RSRC_IMG_1D_ARRAY
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_1darray_tfe(i32 %rsrc, ptr addrspace(1) inreg %out, i32 %s, i32 %slice) {
...
; GFX13-NEXT:    v_dual_mov_b32 v2, v10 :: v_dual_mov_b32 v3, v11
; GFX13-NEXT:    v_mov_b32_e32 v4, v12
; GFX13-NEXT:    image_load v[0:4], [v7, v6], v5 dmask:0xf dim:SQ_RSRC_IMG_1D_ARRAY tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v8, v4, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_2darray(i32 %rsrc, i32 %s, i32 %t, i32 %slice) {
; GFX13-LABEL: load_2darray:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:3], [v1, v2, v3], v0 dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_2darray_lwe(i32 %rsrc, ptr addrspace(1) inreg %out, i32 %s, i32 %t, i32 %slice) {
; GFX13-LABEL: load_2darray_lwe:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:4], [v1, v2, v3], v0 dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY
; GFX13-NEXT:    v_mov_b32_e32 v5, 0
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v5, v4, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
...
define amdgpu_ps <4 x float> @load_2dmsaa(i32 %rsrc, i32 %s, i32 %t, i32 %fragid) {
; GFX13-LABEL: load_2dmsaa:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:3], [v1, v2, v3], v0 dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_2dmsaa_both(i32 %rsrc, ptr addrspace(1) inreg %out, i32 %s, i32 %t, i32 %fragid) {
...
; GFX13-NEXT:    v_dual_mov_b32 v2, v11 :: v_dual_mov_b32 v3, v12
; GFX13-NEXT:    v_mov_b32_e32 v4, v13
; GFX13-NEXT:    image_load v[0:4], [v8, v7, v6], v5 dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v9, v4, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_2darraymsaa(i32 %rsrc, i32 %s, i32 %t, i32 %slice, i32 %fragid) {
; GFX13-LABEL: load_2darraymsaa:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:3], [v1, v2, v3, v4], v0 dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA_ARRAY
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_2darraymsaa_tfe(i32 %rsrc, ptr addrspace(1) inreg %out, i32 %s, i32 %t, i32 %slice, i32 %fragid) {
; GFX13-LABEL: load_2darraymsaa_tfe:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v6, v0 :: v_dual_mov_b32 v10, 0
; GFX13-NEXT:    v_dual_mov_b32 v5, v4 :: v_dual_mov_b32 v7, v3
; GFX13-NEXT:    v_dual_mov_b32 v8, v2 :: v_dual_mov_b32 v9, v1
...
; GFX13-NEXT:    image_load v[0:4], [v9, v8, v7, v5], v6 dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA_ARRAY tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
define amdgpu_ps <4 x float> @load_mip_1d(i32 %rsrc, i32 %s, i32 %mip) {
; GFX13-LABEL: load_mip_1d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load_mip v[0:3], [v1, v2], v0 dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_mip_1d_lwe(i32 %rsrc, ptr addrspace(1) inreg %out, i32 %s, i32 %mip) {
; GFX13-LABEL: load_mip_1d_lwe:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load_mip v[0:4], [v1, v2], v0 dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    v_mov_b32_e32 v5, 0
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v5, v4, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
...
define amdgpu_ps <4 x float> @load_mip_2d(i32 %rsrc, i32 %s, i32 %t, i32 %mip) {
; GFX13-LABEL: load_mip_2d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load_mip v[0:3], [v1, v2, v3], v0 dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_mip_2d_tfe(i32 %rsrc, ptr addrspace(1) inreg %out, i32 %s, i32 %t, i32 %mip) {
...
; GFX13-NEXT:    v_dual_mov_b32 v2, v11 :: v_dual_mov_b32 v3, v12
; GFX13-NEXT:    v_mov_b32_e32 v4, v13
; GFX13-NEXT:    image_load_mip v[0:4], [v8, v7, v6], v5 dmask:0xf dim:SQ_RSRC_IMG_2D tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v9, v4, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps float @load_1d_V2_tfe_dmask0(i32 %rsrc, i32 %s) {
; GFX13-LABEL: load_1d_V2_tfe_dmask0:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_mov_b32_e32 v2, 0
; GFX13-NEXT:    v_mov_b32_e32 v3, v2
; GFX13-NEXT:    image_load v[2:3], v1, v0 dmask:0x1 dim:SQ_RSRC_IMG_1D tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
define amdgpu_ps float @load_1d_V1_tfe_dmask0(i32 %rsrc, i32 %s) {
...
define amdgpu_ps float @load_mip_2d_tfe_dmask0(i32 %rsrc, i32 %s, i32 %t, i32 %mip) {
; GFX13-LABEL: load_mip_2d_tfe_dmask0:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_mov_b32_e32 v4, 0
; GFX13-NEXT:    v_mov_b32_e32 v5, v4
; GFX13-NEXT:    image_load_mip v[4:5], [v1, v2, v3], v0 dmask:0x1 dim:SQ_RSRC_IMG_2D tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
define amdgpu_ps float @load_mip_2d_tfe_nouse(i32 %rsrc, i32 %s, i32 %t, i32 %mip) {
...
define amdgpu_ps float @load_mip_2d_tfe_nouse_V2(i32 %rsrc, i32 %s, i32 %t, i32 %mip) {
...
define amdgpu_ps float @load_mip_2d_tfe_nouse_V1(i32 %rsrc, i32 %s, i32 %t, i32 %mip) {
; GFX13-LABEL: load_mip_2d_tfe_nouse_V1:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_mov_b32_e32 v4, 0
; GFX13-NEXT:    v_mov_b32_e32 v5, v4
; GFX13-NEXT:    image_load_mip v[4:5], [v1, v2, v3], v0 dmask:0x2 dim:SQ_RSRC_IMG_2D tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    v_mov_b32_e32 v0, v5
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v6, 0 :: v_dual_mov_b32 v5, v1
...
; GFX13-NEXT:    image_load v[0:3], v5, v4 dmask:0x7 dim:SQ_RSRC_IMG_1D tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v6, v3, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_1d_tfe_V4_dmask2(i32 %rsrc, ptr addrspace(1) inreg %out, i32 %s) {
; GFX13-LABEL: load_1d_tfe_V4_dmask2:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v5, 0 :: v_dual_mov_b32 v4, v1
; GFX13-NEXT:    v_dual_mov_b32 v3, v0 :: v_dual_mov_b32 v6, v5
; GFX13-NEXT:    v_mov_b32_e32 v7, v5
; GFX13-NEXT:    v_dual_mov_b32 v0, v5 :: v_dual_mov_b32 v1, v6
; GFX13-NEXT:    v_mov_b32_e32 v2, v7
; GFX13-NEXT:    image_load v[0:2], v4, v3 dmask:0x6 dim:SQ_RSRC_IMG_1D tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v5, v2, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_mov_b32_e32 v4, 0
; GFX13-NEXT:    v_mov_b32_e32 v5, v4
; GFX13-NEXT:    v_dual_mov_b32 v2, v4 :: v_dual_mov_b32 v3, v5
; GFX13-NEXT:    image_load v[2:3], v1, v0 dmask:0x8 dim:SQ_RSRC_IMG_1D tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    v_mov_b32_e32 v0, v2
; GFX13-NEXT:    global_store_b32 v4, v3, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_mip_3d(i32 %rsrc, i32 %s, i32 %t, i32 %r, i32 %mip) {
; GFX13-LABEL: load_mip_3d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load_mip v[0:3], [v1, v2, v3, v4], v0 dmask:0xf dim:SQ_RSRC_IMG_3D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_mip_cube(i32 %rsrc, i32 %s, i32 %t, i32 %slice, i32 %mip) {
; GFX13-LABEL: load_mip_cube:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load_mip v[0:3], [v1, v2, v3, v4], v0 dmask:0xf dim:SQ_RSRC_IMG_CUBE
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_mip_1darray(i32 %rsrc, i32 %s, i32 %slice, i32 %mip) {
; GFX13-LABEL: load_mip_1darray:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load_mip v[0:3], [v1, v2, v3], v0 dmask:0xf dim:SQ_RSRC_IMG_1D_ARRAY
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_mip_2darray(i32 %rsrc, i32 %s, i32 %t, i32 %slice, i32 %mip) {
; GFX13-LABEL: load_mip_2darray:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load_mip v[0:3], [v1, v2, v3, v4], v0 dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps void @store_1d(i32 %rsrc, <4 x float> %vdata, i32 %s) {
; GFX13-LABEL: store_1d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:4], v5, v0 dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_2d(i32 %rsrc, <4 x float> %vdata, i32 %s, i32 %t) {
; GFX13-LABEL: store_2d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:4], [v5, v6], v0 dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_3d(i32 %rsrc, <4 x float> %vdata, i32 %s, i32 %t, i32 %r) {
; GFX13-LABEL: store_3d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:4], [v5, v6, v7], v0 dmask:0xf dim:SQ_RSRC_IMG_3D
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_cube(i32 %rsrc, <4 x float> %vdata, i32 %s, i32 %t, i32 %slice) {
; GFX13-LABEL: store_cube:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:4], [v5, v6, v7], v0 dmask:0xf dim:SQ_RSRC_IMG_CUBE
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_1darray(i32 %rsrc, <4 x float> %vdata, i32 %s, i32 %slice) {
; GFX13-LABEL: store_1darray:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:4], [v5, v6], v0 dmask:0xf dim:SQ_RSRC_IMG_1D_ARRAY
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_2darray(i32 %rsrc, <4 x float> %vdata, i32 %s, i32 %t, i32 %slice) {
; GFX13-LABEL: store_2darray:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:4], [v5, v6, v7], v0 dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_2dmsaa(i32 %rsrc, <4 x float> %vdata, i32 %s, i32 %t, i32 %fragid) {
; GFX13-LABEL: store_2dmsaa:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:4], [v5, v6, v7], v0 dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_2darraymsaa(i32 %rsrc, <4 x float> %vdata, i32 %s, i32 %t, i32 %slice, i32 %fragid) {
; GFX13-LABEL: store_2darraymsaa:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:4], [v5, v6, v7, v8], v0 dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA_ARRAY
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_mip_1d(i32 %rsrc, <4 x float> %vdata, i32 %s, i32 %mip) {
; GFX13-LABEL: store_mip_1d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store_mip v[1:4], [v5, v6], v0 dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_mip_2d(i32 %rsrc, <4 x float> %vdata, i32 %s, i32 %t, i32 %mip) {
; GFX13-LABEL: store_mip_2d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store_mip v[1:4], [v5, v6, v7], v0 dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_mip_3d(i32 %rsrc, <4 x float> %vdata, i32 %s, i32 %t, i32 %r, i32 %mip) {
; GFX13-LABEL: store_mip_3d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store_mip v[1:4], [v5, v6, v7, v8], v0 dmask:0xf dim:SQ_RSRC_IMG_3D
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_mip_cube(i32 %rsrc, <4 x float> %vdata, i32 %s, i32 %t, i32 %slice, i32 %mip) {
; GFX13-LABEL: store_mip_cube:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store_mip v[1:4], [v5, v6, v7, v8], v0 dmask:0xf dim:SQ_RSRC_IMG_CUBE
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_mip_1darray(i32 %rsrc, <4 x float> %vdata, i32 %s, i32 %slice, i32 %mip) {
; GFX13-LABEL: store_mip_1darray:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store_mip v[1:4], [v5, v6, v7], v0 dmask:0xf dim:SQ_RSRC_IMG_1D_ARRAY
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_mip_2darray(i32 %rsrc, <4 x float> %vdata, i32 %s, i32 %t, i32 %slice, i32 %mip) {
; GFX13-LABEL: store_mip_2darray:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store_mip v[1:4], [v5, v6, v7, v8], v0 dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps <4 x float> @getresinfo_1d(i32 %rsrc, i32 %mip) {
; GFX13-LABEL: getresinfo_1d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_get_resinfo v[0:3], v1, v0 dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @getresinfo_2d(i32 %rsrc, i32 %mip) {
; GFX13-LABEL: getresinfo_2d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_get_resinfo v[0:3], v1, v0 dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @getresinfo_3d(i32 %rsrc, i32 %mip) {
; GFX13-LABEL: getresinfo_3d:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_get_resinfo v[0:3], v1, v0 dmask:0xf dim:SQ_RSRC_IMG_3D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @getresinfo_cube(i32 %rsrc, i32 %mip) {
; GFX13-LABEL: getresinfo_cube:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_get_resinfo v[0:3], v1, v0 dmask:0xf dim:SQ_RSRC_IMG_CUBE
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @getresinfo_1darray(i32 %rsrc, i32 %mip) {
; GFX13-LABEL: getresinfo_1darray:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_get_resinfo v[0:3], v1, v0 dmask:0xf dim:SQ_RSRC_IMG_1D_ARRAY
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @getresinfo_2darray(i32 %rsrc, i32 %mip) {
; GFX13-LABEL: getresinfo_2darray:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_get_resinfo v[0:3], v1, v0 dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @getresinfo_2dmsaa(i32 %rsrc, i32 %mip) {
; GFX13-LABEL: getresinfo_2dmsaa:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_get_resinfo v[0:3], v1, v0 dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @getresinfo_2darraymsaa(i32 %rsrc, i32 %mip) {
; GFX13-LABEL: getresinfo_2darraymsaa:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_get_resinfo v[0:3], v1, v0 dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA_ARRAY
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps float @load_1d_V1(i32 %rsrc, i32 %s) {
; GFX13-LABEL: load_1d_V1:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v0, v1, v0 dmask:0x8 dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <2 x float> @load_1d_V2(i32 %rsrc, i32 %s) {
; GFX13-LABEL: load_1d_V2:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:1], v1, v0 dmask:0x9 dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps void @store_1d_V1(i32 %rsrc, float %vdata, i32 %s) {
; GFX13-LABEL: store_1d_V1:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v1, v2, v0 dmask:0x2 dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_1d_V2(i32 %rsrc, <2 x float> %vdata, i32 %s) {
; GFX13-LABEL: store_1d_V2:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:2], v3, v0 dmask:0xc dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps <4 x float> @load_1d_glc(i32 %rsrc, i32 %s) {
; GFX13-LABEL: load_1d_glc:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:3], v1, v0 dmask:0xf dim:SQ_RSRC_IMG_1D th:TH_LOAD_NT
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_1d_slc(i32 %rsrc, i32 %s) {
; GFX13-LABEL: load_1d_slc:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:3], v1, v0 dmask:0xf dim:SQ_RSRC_IMG_1D th:TH_LOAD_HT
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @load_1d_glc_slc(i32 %rsrc, i32 %s) {
; GFX13-LABEL: load_1d_glc_slc:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_load v[0:3], v1, v0 dmask:0xf dim:SQ_RSRC_IMG_1D th:TH_LOAD_LU
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps void @store_1d_glc(i32 %rsrc, <4 x float> %vdata, i32 %s) {
; GFX13-LABEL: store_1d_glc:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:4], v5, v0 dmask:0xf dim:SQ_RSRC_IMG_1D th:TH_STORE_NT
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_1d_slc(i32 %rsrc, <4 x float> %vdata, i32 %s) {
; GFX13-LABEL: store_1d_slc:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:4], v5, v0 dmask:0xf dim:SQ_RSRC_IMG_1D th:TH_STORE_HT
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps void @store_1d_glc_slc(i32 %rsrc, <4 x float> %vdata, i32 %s) {
; GFX13-LABEL: store_1d_glc_slc:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:4], v5, v0 dmask:0xf dim:SQ_RSRC_IMG_1D th:TH_STORE_WB
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps <3 x float> @getresinfo_dmask7(i32 %rsrc, <4 x float> %vdata, i32 %mip) {
; GFX13-LABEL: getresinfo_dmask7:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_get_resinfo v[0:2], v1, v0 dmask:0x7 dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <2 x float> @getresinfo_dmask3(i32 %rsrc, <4 x float> %vdata, i32 %mip) {
; GFX13-LABEL: getresinfo_dmask3:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_get_resinfo v[0:1], v1, v0 dmask:0x3 dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps float @getresinfo_dmask1(i32 %rsrc, <4 x float> %vdata, i32 %mip) {
; GFX13-LABEL: getresinfo_dmask1:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_get_resinfo v0, v1, v0 dmask:0x1 dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
define amdgpu_ps <4 x float> @getresinfo_dmask0(i32 %rsrc, <4 x float> %vdata, i32 %mip) #0 {
...
define amdgpu_ps void @image_store_wait(i32 %arg, i32 %arg1, i32 %arg2, <4 x float> %arg3, i32 %arg4) #0 {
; GFX13-LABEL: image_store_wait:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[3:6], v7, v0 dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    image_load v[3:6], v7, v1 dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    image_store v[3:6], v7, v2 dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-NEXT:    s_endpgm
main_body:
...
define amdgpu_ps float @image_load_mmo(i32 %rsrc, ptr addrspace(3) %lds, <2 x i32> %c) #0 {
; GFX13-LABEL: image_load_mmo:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    image_load v0, [v2, v3], v0 dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX13-NEXT:    v_mov_b32_e32 v2, 0
