...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1200 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX12 %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1200 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX12 %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1300 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX13PLUS %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1300 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX13PLUS %s
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX13PLUS-LABEL: atomic_add_flt_1d:
; GFX13PLUS:       ; %bb.0: ; %main_body
; GFX13PLUS-NEXT:    image_atomic_add_flt v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GFX13PLUS-NEXT:    ; return to shader part epilog
main_body:
