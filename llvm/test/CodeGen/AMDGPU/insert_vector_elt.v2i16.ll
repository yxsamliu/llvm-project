...
; VI-NEXT:    s_and_b32 s1, s6, 0xffff
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    s_load_dword s4, s[8:9], 0x0
...
; VI-NEXT:    v_add_u32_e32 v2, vcc, s8, v4
; VI-NEXT:    v_addc_u32_e32 v3, vcc, 0, v3, vcc
...
; VI-NEXT:    v_lshlrev_b32_e32 v2, 4, v5
; VI-NEXT:    v_lshlrev_b32_e64 v2, v2, s2
; VI-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; VI-NEXT:    v_bfi_b32 v2, v2, s0, v6
; VI-NEXT:    flat_store_dword v[0:1], v2
; VI-NEXT:    s_endpgm
;
...
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    v_add_u32_e32 v0, vcc, s0, v4
; VI-NEXT:    s_and_b32 s1, s6, s2
; VI-NEXT:    s_mov_b32 s3, 0
; VI-NEXT:    s_lshl_b32 s0, s1, 16
; VI-NEXT:    s_or_b32 s0, s1, s0
; VI-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
; VI-NEXT:    v_lshlrev_b32_e32 v4, 4, v5
; VI-NEXT:    v_lshlrev_b64 v[4:5], v4, s[2:3]
; VI-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; VI-NEXT:    v_bfi_b32 v3, v5, s0, v3
; VI-NEXT:    v_bfi_b32 v2, v4, s0, v2
...
; VI-NEXT:    v_mov_b32_e32 v3, s1
; VI-NEXT:    s_mov_b32 s3, 0
; VI-NEXT:    s_lshl_b32 s1, s7, 4
; VI-NEXT:    s_and_b32 s4, s6, s2
; VI-NEXT:    v_add_u32_e32 v2, vcc, s0, v2
