...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_f32_16x16_iu8 v[6:13], v[0:1], v[2:3], 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[4:5], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_f32i32_16x16_iu8 v[6:13], v[0:1], v[2:3], 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[4:5], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_i32_16x16_iu8 v[6:13], v[0:1], v[2:3], 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[4:5], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_f32_16x16_iu4 v[4:11], v0, v1, 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_f32i32_16x16_iu4 v[4:11], v0, v1, 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[2:3], v[8:11], off offset:16
; GFX13-NEXT:    global_store_b128 v[2:3], v[4:7], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_i32_16x16_iu4 v[4:11], v0, v1, 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[2:3], v[8:11], off offset:16
; GFX13-NEXT:    global_store_b128 v[2:3], v[4:7], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_f32_16x16_iu8 v[10:17], v[0:3], v[4:7], 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
; GFX13-NEXT:    global_store_b128 v[8:9], v[10:13], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_f32i32_16x16_iu8 v[10:17], v[0:3], v[4:7], 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
; GFX13-NEXT:    global_store_b128 v[8:9], v[10:13], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_i32_16x16_iu8 v[10:17], v[0:3], v[4:7], 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
; GFX13-NEXT:    global_store_b128 v[8:9], v[10:13], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_f32_16x16_iu4 v[6:13], v[0:1], v[2:3], 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[4:5], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_f32i32_16x16_iu4 v[6:13], v[0:1], v[2:3], 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[4:5], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_i32_16x16_iu4 v[6:13], v[0:1], v[2:3], 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[4:5], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_f32_16x16_iu4 v[10:17], v[0:3], v[4:7], 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
; GFX13-NEXT:    global_store_b128 v[8:9], v[10:13], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_f32i32_16x16_iu4 v[10:17], v[0:3], v[4:7], 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
; GFX13-NEXT:    global_store_b128 v[8:9], v[10:13], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_wmma_i32_16x16_iu4 v[10:17], v[0:3], v[4:7], 0 matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
; GFX13-NEXT:    global_store_b128 v[8:9], v[10:13], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v11, v6 :: v_dual_mov_b32 v12, v6
; GFX13-NEXT:    v_mov_b32_e32 v13, v6
; GFX13-NEXT:    v_wmma_f32_16x16_iu8 v[6:13], v[0:1], v[2:3], v[6:13] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[4:5], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v11, v6 :: v_dual_mov_b32 v12, v6
; GFX13-NEXT:    v_mov_b32_e32 v13, v6
; GFX13-NEXT:    v_wmma_f32i32_16x16_iu8 v[6:13], v[0:1], v[2:3], v[6:13] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[4:5], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v11, v6 :: v_dual_mov_b32 v12, v6
; GFX13-NEXT:    v_mov_b32_e32 v13, v6
; GFX13-NEXT:    v_wmma_i32_16x16_iu8 v[6:13], v[0:1], v[2:3], v[6:13] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[4:5], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_wmma_f32_16x16_iu4 v[4:11], v0, v1, v[4:11] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[2:3], v[8:11], off offset:16
; GFX13-NEXT:    global_store_b128 v[2:3], v[4:7], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v9, v4 :: v_dual_mov_b32 v10, v4
; GFX13-NEXT:    v_mov_b32_e32 v11, v4
; GFX13-NEXT:    v_wmma_f32i32_16x16_iu4 v[4:11], v0, v1, v[4:11] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[2:3], v[8:11], off offset:16
; GFX13-NEXT:    global_store_b128 v[2:3], v[4:7], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v9, v4 :: v_dual_mov_b32 v10, v4
; GFX13-NEXT:    v_mov_b32_e32 v11, v4
; GFX13-NEXT:    v_wmma_i32_16x16_iu4 v[4:11], v0, v1, v[4:11] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[2:3], v[8:11], off offset:16
; GFX13-NEXT:    global_store_b128 v[2:3], v[4:7], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v15, v10 :: v_dual_mov_b32 v16, v10
; GFX13-NEXT:    v_mov_b32_e32 v17, v10
; GFX13-NEXT:    v_wmma_f32_16x16_iu8 v[10:17], v[0:3], v[4:7], v[10:17] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
; GFX13-NEXT:    global_store_b128 v[8:9], v[10:13], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v15, v10 :: v_dual_mov_b32 v16, v10
; GFX13-NEXT:    v_mov_b32_e32 v17, v10
; GFX13-NEXT:    v_wmma_f32i32_16x16_iu8 v[10:17], v[0:3], v[4:7], v[10:17] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
; GFX13-NEXT:    global_store_b128 v[8:9], v[10:13], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v15, v10 :: v_dual_mov_b32 v16, v10
; GFX13-NEXT:    v_mov_b32_e32 v17, v10
; GFX13-NEXT:    v_wmma_i32_16x16_iu8 v[10:17], v[0:3], v[4:7], v[10:17] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
; GFX13-NEXT:    global_store_b128 v[8:9], v[10:13], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v11, v6 :: v_dual_mov_b32 v12, v6
; GFX13-NEXT:    v_mov_b32_e32 v13, v6
; GFX13-NEXT:    v_wmma_f32_16x16_iu4 v[6:13], v[0:1], v[2:3], v[6:13] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[4:5], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v11, v6 :: v_dual_mov_b32 v12, v6
; GFX13-NEXT:    v_mov_b32_e32 v13, v6
; GFX13-NEXT:    v_wmma_f32i32_16x16_iu4 v[6:13], v[0:1], v[2:3], v[6:13] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[4:5], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v11, v6 :: v_dual_mov_b32 v12, v6
; GFX13-NEXT:    v_mov_b32_e32 v13, v6
; GFX13-NEXT:    v_wmma_i32_16x16_iu4 v[6:13], v[0:1], v[2:3], v[6:13] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[4:5], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v15, v10 :: v_dual_mov_b32 v16, v10
; GFX13-NEXT:    v_mov_b32_e32 v17, v10
; GFX13-NEXT:    v_wmma_f32_16x16_iu4 v[10:17], v[0:3], v[4:7], v[10:17] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
; GFX13-NEXT:    global_store_b128 v[8:9], v[10:13], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v15, v10 :: v_dual_mov_b32 v16, v10
; GFX13-NEXT:    v_mov_b32_e32 v17, v10
; GFX13-NEXT:    v_wmma_f32i32_16x16_iu4 v[10:17], v[0:3], v[4:7], v[10:17] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
; GFX13-NEXT:    global_store_b128 v[8:9], v[10:13], off
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v15, v10 :: v_dual_mov_b32 v16, v10
; GFX13-NEXT:    v_mov_b32_e32 v17, v10
; GFX13-NEXT:    v_wmma_i32_16x16_iu4 v[10:17], v[0:3], v[4:7], v[10:17] matrix_a_signed matrix_b_signed k:16 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
; GFX13-NEXT:    global_store_b128 v[8:9], v[10:13], off
; GFX13-NEXT:    s_endpgm
