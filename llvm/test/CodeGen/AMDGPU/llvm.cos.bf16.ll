...
; GFX13-TRUE16-NEXT:    v_cos_bf16_e32 v0.l, v0.l
...
; GFX13-FAKE16-NEXT:    v_cos_bf16_e32 v0, v0
...
; GCN-NEXT:    s_endpgm
;
; GFX13-TRUE16-LABEL: cos_bf16_constant_4:
; GFX13-TRUE16:       ; %bb.0:
; GFX13-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX13-TRUE16-NEXT:    v_cos_bf16_e32 v0.l, 0x3f23
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    global_store_b16 v1, v0, s[0:1]
; GFX13-TRUE16-NEXT:    s_endpgm
;
; GFX13-FAKE16-LABEL: cos_bf16_constant_4:
; GFX13-FAKE16:       ; %bb.0:
; GFX13-FAKE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX13-FAKE16-NEXT:    v_cos_bf16_e32 v0, 0x3f23
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-FAKE16-NEXT:    global_store_b16 v1, v0, s[0:1]
; GFX13-FAKE16-NEXT:    s_endpgm
...
; GCN-NEXT:    s_endpgm
;
; GFX13-TRUE16-LABEL: cos_bf16_constant_100:
; GFX13-TRUE16:       ; %bb.0:
; GFX13-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX13-TRUE16-NEXT:    v_cos_bf16_e32 v0.l, 0x417f
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    global_store_b16 v1, v0, s[0:1]
; GFX13-TRUE16-NEXT:    s_endpgm
;
; GFX13-FAKE16-LABEL: cos_bf16_constant_100:
; GFX13-FAKE16:       ; %bb.0:
; GFX13-FAKE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX13-FAKE16-NEXT:    v_cos_bf16_e32 v0, 0x417f
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-FAKE16-NEXT:    global_store_b16 v1, v0, s[0:1]
; GFX13-FAKE16-NEXT:    s_endpgm
