...
;
; GFX1300-LABEL: local_nontemporal_load_0:
; GFX1300:       ; %bb.0: ; %entry
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: local_nontemporal_load_1:
; GFX1300:       ; %bb.0: ; %entry
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: local_nontemporal_store_0:
; GFX1300:       ; %bb.0: ; %entry
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: local_nontemporal_store_1:
; GFX1300:       ; %bb.0: ; %entry
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: local_nontemporal_volatile_load:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b32 s2, s[4:5], 0x0
; GFX1300-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8
; GFX1300-NEXT:    v_mov_b32_e32 v0, 0
