...
; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 -mattr=+real-true16 < %s | FileCheck -check-prefix=SDAG-TRUE16-GFX1250 %s
; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1260 -mattr=+real-true16 < %s | FileCheck -check-prefix=SDAG-TRUE16-GFX1260 %s
; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 -mattr=-real-true16 < %s | FileCheck -check-prefix=SDAG-FAKE16-GFX1250 %s
; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1260 -mattr=-real-true16 < %s | FileCheck -check-prefix=SDAG-FAKE16-GFX1260 %s
...
;
; SDAG-TRUE16-GFX1250-LABEL: rcp_bf16:
; SDAG-TRUE16-GFX1250:       ; %bb.0:
; SDAG-TRUE16-GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-TRUE16-GFX1250-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0
; SDAG-TRUE16-GFX1250-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-TRUE16-GFX1250-NEXT:    s_wait_kmcnt 0x0
; SDAG-TRUE16-GFX1250-NEXT:    v_rcp_bf16_e32 v0.l, s2
; SDAG-TRUE16-GFX1250-NEXT:    global_store_b16 v1, v0, s[0:1]
; SDAG-TRUE16-GFX1250-NEXT:    s_endpgm
;
; SDAG-TRUE16-GFX1260-LABEL: rcp_bf16:
; SDAG-TRUE16-GFX1260:       ; %bb.0:
; SDAG-TRUE16-GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-TRUE16-GFX1260-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0
; SDAG-TRUE16-GFX1260-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-TRUE16-GFX1260-NEXT:    s_wait_kmcnt 0x0
; SDAG-TRUE16-GFX1260-NEXT:    v_rcp_bf16_e32 v0.l, s2
; SDAG-TRUE16-GFX1260-NEXT:    global_store_b16 v1, v0, s[0:1]
; SDAG-TRUE16-GFX1260-NEXT:    s_endpgm
;
; SDAG-FAKE16-GFX1250-LABEL: rcp_bf16:
; SDAG-FAKE16-GFX1250:       ; %bb.0:
; SDAG-FAKE16-GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-FAKE16-GFX1250-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0
; SDAG-FAKE16-GFX1250-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-FAKE16-GFX1250-NEXT:    s_wait_kmcnt 0x0
; SDAG-FAKE16-GFX1250-NEXT:    v_rcp_bf16_e32 v0, s2
; SDAG-FAKE16-GFX1250-NEXT:    global_store_b16 v1, v0, s[0:1]
; SDAG-FAKE16-GFX1250-NEXT:    s_endpgm
;
; SDAG-FAKE16-GFX1260-LABEL: rcp_bf16:
; SDAG-FAKE16-GFX1260:       ; %bb.0:
; SDAG-FAKE16-GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-FAKE16-GFX1260-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0
; SDAG-FAKE16-GFX1260-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-FAKE16-GFX1260-NEXT:    s_wait_kmcnt 0x0
; SDAG-FAKE16-GFX1260-NEXT:    v_rcp_bf16_e32 v0, s2
; SDAG-FAKE16-GFX1260-NEXT:    global_store_b16 v1, v0, s[0:1]
; SDAG-FAKE16-GFX1260-NEXT:    s_endpgm
;
...
; SDAG-FAKE16-NEXT:    s_endpgm
;
; SDAG-TRUE16-GFX1250-LABEL: rcp_bf16_constant_4:
; SDAG-TRUE16-GFX1250:       ; %bb.0:
; SDAG-TRUE16-GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-TRUE16-GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; SDAG-TRUE16-GFX1250-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-TRUE16-GFX1250-NEXT:    v_mov_b16_e32 v0.l, 0x3e80
; SDAG-TRUE16-GFX1250-NEXT:    s_wait_kmcnt 0x0
; SDAG-TRUE16-GFX1250-NEXT:    global_store_b16 v1, v0, s[0:1]
; SDAG-TRUE16-GFX1250-NEXT:    s_endpgm
;
; SDAG-TRUE16-GFX1260-LABEL: rcp_bf16_constant_4:
; SDAG-TRUE16-GFX1260:       ; %bb.0:
; SDAG-TRUE16-GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-TRUE16-GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; SDAG-TRUE16-GFX1260-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-TRUE16-GFX1260-NEXT:    v_mov_b16_e32 v0.l, 0x3e80
; SDAG-TRUE16-GFX1260-NEXT:    s_wait_kmcnt 0x0
; SDAG-TRUE16-GFX1260-NEXT:    global_store_b16 v1, v0, s[0:1]
; SDAG-TRUE16-GFX1260-NEXT:    s_endpgm
;
; SDAG-FAKE16-GFX1250-LABEL: rcp_bf16_constant_4:
; SDAG-FAKE16-GFX1250:       ; %bb.0:
; SDAG-FAKE16-GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-FAKE16-GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; SDAG-FAKE16-GFX1250-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, 0x3e80
; SDAG-FAKE16-GFX1250-NEXT:    s_wait_kmcnt 0x0
; SDAG-FAKE16-GFX1250-NEXT:    global_store_b16 v0, v1, s[0:1]
; SDAG-FAKE16-GFX1250-NEXT:    s_endpgm
;
; SDAG-FAKE16-GFX1260-LABEL: rcp_bf16_constant_4:
; SDAG-FAKE16-GFX1260:       ; %bb.0:
; SDAG-FAKE16-GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-FAKE16-GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; SDAG-FAKE16-GFX1260-NEXT:    v_mov_b32_e32 v0, 0
; SDAG-FAKE16-GFX1260-NEXT:    v_mov_b32_e32 v1, 0x3e80
; SDAG-FAKE16-GFX1260-NEXT:    s_wait_kmcnt 0x0
; SDAG-FAKE16-GFX1260-NEXT:    global_store_b16 v0, v1, s[0:1]
; SDAG-FAKE16-GFX1260-NEXT:    s_endpgm
;
...
; SDAG-FAKE16-NEXT:    s_endpgm
;
; SDAG-TRUE16-GFX1250-LABEL: rcp_bf16_constant_100:
; SDAG-TRUE16-GFX1250:       ; %bb.0:
; SDAG-TRUE16-GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-TRUE16-GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; SDAG-TRUE16-GFX1250-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-TRUE16-GFX1250-NEXT:    v_mov_b16_e32 v0.l, 0x3c24
; SDAG-TRUE16-GFX1250-NEXT:    s_wait_kmcnt 0x0
; SDAG-TRUE16-GFX1250-NEXT:    global_store_b16 v1, v0, s[0:1]
; SDAG-TRUE16-GFX1250-NEXT:    s_endpgm
;
; SDAG-TRUE16-GFX1260-LABEL: rcp_bf16_constant_100:
; SDAG-TRUE16-GFX1260:       ; %bb.0:
; SDAG-TRUE16-GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-TRUE16-GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; SDAG-TRUE16-GFX1260-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-TRUE16-GFX1260-NEXT:    v_mov_b16_e32 v0.l, 0x3c24
; SDAG-TRUE16-GFX1260-NEXT:    s_wait_kmcnt 0x0
; SDAG-TRUE16-GFX1260-NEXT:    global_store_b16 v1, v0, s[0:1]
; SDAG-TRUE16-GFX1260-NEXT:    s_endpgm
;
; SDAG-FAKE16-GFX1250-LABEL: rcp_bf16_constant_100:
; SDAG-FAKE16-GFX1250:       ; %bb.0:
; SDAG-FAKE16-GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-FAKE16-GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; SDAG-FAKE16-GFX1250-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, 0x3c24
; SDAG-FAKE16-GFX1250-NEXT:    s_wait_kmcnt 0x0
; SDAG-FAKE16-GFX1250-NEXT:    global_store_b16 v0, v1, s[0:1]
; SDAG-FAKE16-GFX1250-NEXT:    s_endpgm
;
; SDAG-FAKE16-GFX1260-LABEL: rcp_bf16_constant_100:
; SDAG-FAKE16-GFX1260:       ; %bb.0:
; SDAG-FAKE16-GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-FAKE16-GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; SDAG-FAKE16-GFX1260-NEXT:    v_mov_b32_e32 v0, 0
; SDAG-FAKE16-GFX1260-NEXT:    v_mov_b32_e32 v1, 0x3c24
; SDAG-FAKE16-GFX1260-NEXT:    s_wait_kmcnt 0x0
; SDAG-FAKE16-GFX1260-NEXT:    global_store_b16 v0, v1, s[0:1]
; SDAG-FAKE16-GFX1260-NEXT:    s_endpgm
;
...
; SDAG-FAKE16-NEXT:    s_endpgm
;
; SDAG-TRUE16-GFX1250-LABEL: rcp_undef_bf16:
; SDAG-TRUE16-GFX1250:       ; %bb.0:
; SDAG-TRUE16-GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-TRUE16-GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; SDAG-TRUE16-GFX1250-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-TRUE16-GFX1250-NEXT:    v_mov_b16_e32 v0.l, 0x7fc0
; SDAG-TRUE16-GFX1250-NEXT:    s_wait_kmcnt 0x0
; SDAG-TRUE16-GFX1250-NEXT:    global_store_b16 v1, v0, s[0:1]
; SDAG-TRUE16-GFX1250-NEXT:    s_endpgm
;
; SDAG-TRUE16-GFX1260-LABEL: rcp_undef_bf16:
; SDAG-TRUE16-GFX1260:       ; %bb.0:
; SDAG-TRUE16-GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-TRUE16-GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; SDAG-TRUE16-GFX1260-NEXT:    v_mov_b32_e32 v1, 0
; SDAG-TRUE16-GFX1260-NEXT:    v_mov_b16_e32 v0.l, 0x7fc0
; SDAG-TRUE16-GFX1260-NEXT:    s_wait_kmcnt 0x0
; SDAG-TRUE16-GFX1260-NEXT:    global_store_b16 v1, v0, s[0:1]
; SDAG-TRUE16-GFX1260-NEXT:    s_endpgm
;
; SDAG-FAKE16-GFX1250-LABEL: rcp_undef_bf16:
; SDAG-FAKE16-GFX1250:       ; %bb.0:
; SDAG-FAKE16-GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-FAKE16-GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; SDAG-FAKE16-GFX1250-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, 0x7fc0
; SDAG-FAKE16-GFX1250-NEXT:    s_wait_kmcnt 0x0
; SDAG-FAKE16-GFX1250-NEXT:    global_store_b16 v0, v1, s[0:1]
; SDAG-FAKE16-GFX1250-NEXT:    s_endpgm
;
; SDAG-FAKE16-GFX1260-LABEL: rcp_undef_bf16:
; SDAG-FAKE16-GFX1260:       ; %bb.0:
; SDAG-FAKE16-GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; SDAG-FAKE16-GFX1260-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; SDAG-FAKE16-GFX1260-NEXT:    v_mov_b32_e32 v0, 0
; SDAG-FAKE16-GFX1260-NEXT:    v_mov_b32_e32 v1, 0x7fc0
; SDAG-FAKE16-GFX1260-NEXT:    s_wait_kmcnt 0x0
; SDAG-FAKE16-GFX1260-NEXT:    global_store_b16 v0, v1, s[0:1]
; SDAG-FAKE16-GFX1260-NEXT:    s_endpgm
;
