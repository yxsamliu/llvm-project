...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1200 -amdgpu-enable-vopd=0 | FileCheck %s -check-prefixes=GFX1200_1250,GFX1200
...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 -amdgpu-enable-vopd=0 | FileCheck %s -check-prefixes=GFX12_13,GFX13
...
;
; GFX1200_1250-LABEL: s_buffer_load_imm:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x4
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
;
; GFX12_13-LABEL: s_buffer_load_imm:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x4
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_index:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_index:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_index_divergent:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen
; GFX1200_1250-NEXT:    s_wait_loadcnt 0x0
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_index_divergent:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen
; GFX12_13-NEXT:    s_wait_loadcnt 0x0
; GFX12_13-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
  %load = call i32 @llvm.amdgcn.s.buffer.load.i32(<4 x i32> %desc, i32 %index, i32 0)
  ret i32 %load
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_index_divergent_offset:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen offset:32
; GFX1200_1250-NEXT:    s_wait_loadcnt 0x0
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
; GFX1200_GFX1250-LABEL: s_buffer_load_index_divergent_offset:
; GFX1200_GFX1250:       ; %bb.0: ; %main_body
; GFX1200_GFX1250-NEXT:    v_add_nc_u32_e32 v0, 32, v0
; GFX1200_GFX1250-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen
; GFX1200_GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1200_GFX1250-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_index_divergent_offset:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    v_add_nc_u32_e32 v0, 32, v0
; GFX12_13-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen
; GFX12_13-NEXT:    s_wait_loadcnt 0x0
; GFX12_13-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12_13-NEXT:    ; return to shader part epilog
; GFX12-LABEL: s_buffer_load_index_divergent_offset:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_index_divergent_offset_nuw:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen offset:32
; GFX1200_1250-NEXT:    s_wait_loadcnt 0x0
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s0, v0
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_index_divergent_offset_nuw:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen offset:32
; GFX12_13-NEXT:    s_wait_loadcnt 0x0
; GFX12_13-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_loadx2_imm:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    s_buffer_load_b64 s[0:1], s[0:3], 0x40
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_loadx2_imm:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    s_buffer_load_b64 s[0:1], s[0:3], 0x40
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_loadx2_index:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    s_buffer_load_b64 s[0:1], s[0:3], s4 offset:0x0
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    s_add_f32 s0, s0, s1
; GFX1200_1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX1200_1250-NEXT:    v_mov_b32_e32 v0, s0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_loadx2_index:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    s_buffer_load_b64 s[0:1], s[0:3], s4 offset:0x0
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    s_add_f32 s0, s0, s1
; GFX12_13-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX12_13-NEXT:    v_mov_b32_e32 v0, s0
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_loadx2_index_divergent:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    buffer_load_b64 v[0:1], v0, s[0:3], null offen
; GFX1200_1250-NEXT:    s_wait_loadcnt 0x0
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s1, v1
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_loadx2_index_divergent:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    buffer_load_b64 v[0:1], v0, s[0:3], null offen
; GFX12_13-NEXT:    s_wait_loadcnt 0x0
; GFX12_13-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12_13-NEXT:    v_readfirstlane_b32 s1, v1
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
  %load = call <2 x i32> @llvm.amdgcn.s.buffer.load.v2i32(<4 x i32> %desc, i32 %index, i32 0)
  ret <2 x i32> %load
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_loadx3_imm:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    s_buffer_load_b96 s[0:2], s[0:3], 0x40
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_loadx3_imm:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    s_buffer_load_b96 s[0:2], s[0:3], 0x40
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_loadx3_index:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    s_buffer_load_b96 s[0:2], s[0:3], s4 offset:0x0
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_loadx3_index:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    s_buffer_load_b96 s[0:2], s[0:3], s4 offset:0x0
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_loadx3_index_divergent:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    buffer_load_b96 v[0:2], v0, s[0:3], null offen
; GFX1200_1250-NEXT:    s_wait_loadcnt 0x0
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s1, v1
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s2, v2
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_loadx3_index_divergent:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    buffer_load_b96 v[0:2], v0, s[0:3], null offen
; GFX12_13-NEXT:    s_wait_loadcnt 0x0
; GFX12_13-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12_13-NEXT:    v_readfirstlane_b32 s1, v1
; GFX12_13-NEXT:    v_readfirstlane_b32 s2, v2
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
  %load = call <3 x i32> @llvm.amdgcn.s.buffer.load.v3i32(<4 x i32> %desc, i32 %index, i32 0)
  ret <3 x i32> %load
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_loadx4_imm:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    s_buffer_load_b128 s[0:3], s[0:3], 0xc8
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_loadx4_imm:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    s_buffer_load_b128 s[0:3], s[0:3], 0xc8
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_loadx4_index:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    s_buffer_load_b128 s[0:3], s[0:3], s4 offset:0x0
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_loadx4_index:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    s_buffer_load_b128 s[0:3], s[0:3], s4 offset:0x0
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_loadx4_index_divergent:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], null offen
; GFX1200_1250-NEXT:    s_wait_loadcnt 0x0
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s1, v1
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s2, v2
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s3, v3
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_loadx4_index_divergent:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], null offen
; GFX12_13-NEXT:    s_wait_loadcnt 0x0
; GFX12_13-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12_13-NEXT:    v_readfirstlane_b32 s1, v1
; GFX12_13-NEXT:    v_readfirstlane_b32 s2, v2
; GFX12_13-NEXT:    v_readfirstlane_b32 s3, v3
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
  %load = call <4 x i32> @llvm.amdgcn.s.buffer.load.v4i32(<4 x i32> %desc, i32 %index, i32 0)
  ret <4 x i32> %load
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_mergex2:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    s_buffer_load_b64 s[0:1], s[0:3], 0x4
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
; GFX1200_GFX1250-LABEL: s_buffer_load_imm_mergex2:
; GFX1200_GFX1250:       ; %bb.0: ; %main_body
; GFX1200_GFX1250-NEXT:    s_buffer_load_b64 s[4:5], s[0:3], 0x4
; GFX1200_GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_GFX1250-NEXT:    s_mov_b32 s0, s4
; GFX1200_GFX1250-NEXT:    s_mov_b32 s1, s5
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_mergex2:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    s_buffer_load_b64 s[0:1], s[0:3], 0x4
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_mergex4:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    s_buffer_load_b128 s[0:3], s[0:3], 0x8
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
; GFX1200_GFX1250-LABEL: s_buffer_load_imm_mergex4:
; GFX1200_GFX1250:       ; %bb.0: ; %main_body
; GFX1200_GFX1250-NEXT:    s_buffer_load_b128 s[4:7], s[0:3], 0x8
; GFX1200_GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_GFX1250-NEXT:    s_mov_b32 s0, s4
; GFX1200_GFX1250-NEXT:    s_mov_b32 s1, s5
; GFX1200_GFX1250-NEXT:    s_mov_b32 s2, s6
; GFX1200_GFX1250-NEXT:    s_mov_b32 s3, s7
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_mergex4:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    s_buffer_load_b128 s[0:3], s[0:3], 0x8
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_index_across_bb:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    s_getpc_b64 s[4:5]
; GFX1200_1250-NEXT:    s_sext_i32_i16 s5, s5
; GFX1200_1250-NEXT:    s_add_co_u32 s4, s4, gv@gotpcrel32@lo+8
; GFX1200_1250-NEXT:    s_add_co_ci_u32 s5, s5, gv@gotpcrel32@hi+16
; GFX1200_1250-NEXT:    v_lshlrev_b32_e32 v0, 4, v0
; GFX1200_1250-NEXT:    s_load_b64 s[4:5], s[4:5], 0x0
; GFX1200_1250-NEXT:    v_mov_b32_e32 v1, 0
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    global_store_b32 v1, v0, s[4:5]
; GFX1200_1250-NEXT:    v_or_b32_e32 v0, 8, v0
; GFX1200_1250-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen
; GFX1200_1250-NEXT:    s_wait_loadcnt 0x0
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
; GFX1200_GFX1250-LABEL: s_buffer_load_index_across_bb:
; GFX1200_GFX1250:       ; %bb.0: ; %main_body
; GFX1200_GFX1250-NEXT:    s_get_pc_i64 s[4:5]
; GFX1200_GFX1250-NEXT:    s_add_nc_u64 s[4:5], s[4:5], gv@gotpcrel+4
; GFX1200_GFX1250-NEXT:    v_lshlrev_b32_e32 v0, 4, v0
; GFX1200_GFX1250-NEXT:    s_load_b64 s[4:5], s[4:5], 0x0
; GFX1200_GFX1250-NEXT:    v_mov_b32_e32 v1, 0
; GFX1200_GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_GFX1250-NEXT:    global_store_b32 v1, v0, s[4:5]
; GFX1200_GFX1250-NEXT:    v_or_b32_e32 v0, 8, v0
; GFX1200_GFX1250-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen
; GFX1200_GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1200_GFX1250-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_index_across_bb:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    s_get_pc_i64 s[4:5]
; GFX12_13-NEXT:    s_add_nc_u64 s[4:5], s[4:5], gv@gotpcrel+4
; GFX12_13-NEXT:    v_lshlrev_b32_e32 v0, 4, v0
; GFX12_13-NEXT:    s_load_b64 s[4:5], s[4:5], 0x0
; GFX12_13-NEXT:    v_mov_b32_e32 v1, 0
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    global_store_b32 v1, v0, s[4:5]
; GFX12_13-NEXT:    v_or_b32_e32 v0, 8, v0
; GFX12_13-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen
; GFX12_13-NEXT:    s_wait_loadcnt 0x0
; GFX12_13-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_index_across_bb_merged:
; GFX1200_1250:       ; %bb.0: ; %main_body
; GFX1200_1250-NEXT:    v_lshlrev_b32_e32 v0, 4, v0
; GFX1200_1250-NEXT:    buffer_load_b64 v[0:1], v0, s[0:3], null offen offset:8
; GFX1200_1250-NEXT:    s_wait_loadcnt 0x0
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1200_1250-NEXT:    v_readfirstlane_b32 s1, v1
; GFX1200_1250-NEXT:    ; return to shader part epilog
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_index_across_bb_merged:
; GFX12_13:       ; %bb.0: ; %main_body
; GFX12_13-NEXT:    v_lshlrev_b32_e32 v0, 4, v0
; GFX12_13-NEXT:    buffer_load_b64 v[0:1], v0, s[0:3], null offen offset:8
; GFX12_13-NEXT:    s_wait_loadcnt 0x0
; GFX12_13-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12_13-NEXT:    v_readfirstlane_b32 s1, v1
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_neg1:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_mov_b32 s4, -1
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_neg1:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_mov_b32 s4, -1
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_neg4:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_mov_b32 s4, -4
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_neg4:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_mov_b32 s4, -4
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
  %load = call i32 @llvm.amdgcn.s.buffer.load.i32(<4 x i32> %desc, i32 -4, i32 0)
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_neg8:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_mov_b32 s4, -8
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_neg8:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_mov_b32 s4, -8
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_bit31:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_brev_b32 s4, 1
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_bit31:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_brev_b32 s4, 1
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_bit30:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_mov_b32 s4, 2.0
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_bit30:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_mov_b32 s4, 2.0
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_bit29:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_brev_b32 s4, 4
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_bit29:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_brev_b32 s4, 4
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_bit21:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x200000
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_bit21:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x200000
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_bit20:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x100000
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_bit20:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x100000
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_neg_bit20:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_mov_b32 s4, 0xfff00000
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_neg_bit20:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_mov_b32 s4, 0xfff00000
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
  %load = call i32 @llvm.amdgcn.s.buffer.load.i32(<4 x i32> %desc, i32  -1048576, i32 0)
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_bit19:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x80000
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_bit19:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x80000
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_neg_bit19:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_mov_b32 s4, 0xfff80000
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_neg_bit19:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_mov_b32 s4, 0xfff80000
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], s4 offset:0x0
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
  %load = call i32 @llvm.amdgcn.s.buffer.load.i32(<4 x i32> %desc, i32 -524288, i32 0)
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_255:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], 0xff
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_255:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], 0xff
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_256:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x100
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_256:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x100
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_1016:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x3f8
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_1016:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x3f8
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_1020:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x3fc
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_1020:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x3fc
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_1021:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x3fd
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_1021:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x3fd
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_1024:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x400
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_1024:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x400
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_1025:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x401
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
;
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_1025:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x401
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1200_1250-LABEL: s_buffer_load_imm_1028:
; GFX1200_1250:       ; %bb.0:
; GFX1200_1250-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x400
; GFX1200_1250-NEXT:    s_wait_kmcnt 0x0
; GFX1200_1250-NEXT:    ; return to shader part epilog
...
; GFX1200_GFX1250-NEXT:    ; return to shader part epilog
;
; GFX12_13-LABEL: s_buffer_load_imm_1028:
; GFX12_13:       ; %bb.0:
; GFX12_13-NEXT:    s_buffer_load_b32 s0, s[0:3], 0x400
; GFX12_13-NEXT:    s_wait_kmcnt 0x0
; GFX12_13-NEXT:    ; return to shader part epilog
