...
; GFX8-NEXT:    s_sext_i32_i8 s5, s1
; GFX8-NEXT:    s_bfe_i32 s7, s1, 0x80008
; GFX8-NEXT:    v_mov_b32_e32 v0, s5
; GFX8-NEXT:    v_mov_b32_e32 v1, s10
; GFX8-NEXT:    s_bfe_i32 s9, s1, 0x80010
; GFX8-NEXT:    v_mad_i32_i24 v0, s4, v0, v1
; GFX8-NEXT:    s_bfe_i32 s6, s0, 0x80008
; GFX8-NEXT:    v_mov_b32_e32 v1, s7
; GFX8-NEXT:    s_bfe_i32 s8, s0, 0x80010
...
; GFX9-NODL-NEXT:    v_mad_i32_i24 v2, s0, v1, v0
...
; GFX9-DL-NEXT:    v_dot4_i32_i8 v2, s0, v0, v1
...
; GFX10-DL-NEXT:    v_dot4_i32_i8 v2, s4, s5, v2
...
; GFX9-DL-NEXT:    v_mad_i32_i24 v2, s0, v1, v0
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-DL-NEXT:    s_endpgm
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_lshrrev_b16_e64 v0, 8, s0
; GFX8-NEXT:    v_lshrrev_b16_e64 v1, 8, s1
; GFX8-NEXT:    s_ashr_i32 s6, s1, 24
; GFX8-NEXT:    s_bfe_i32 s7, s1, 0x80010
; GFX8-NEXT:    s_sext_i32_i8 s1, s1
; GFX8-NEXT:    s_ashr_i32 s4, s0, 24
; GFX8-NEXT:    s_bfe_i32 s5, s0, 0x80010
...
; GFX10-DL-NEXT:    s_load_dword s5, s[2:3], 0x0
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_bfe_i32 s1, s4, 0x80000
; GFX10-DL-NEXT:    s_bfe_i32 s2, s5, 0x80000
; GFX10-DL-NEXT:    v_and_b32_e32 v7, s1, v3
; GFX10-DL-NEXT:    v_ashrrev_i16_e64 v4, 8, s4
; GFX10-DL-NEXT:    v_ashrrev_i16_e64 v5, 8, s5
; GFX10-DL-NEXT:    v_and_b32_e32 v6, s2, v3
; GFX10-DL-NEXT:    s_lshr_b32 s0, s4, 16
; GFX10-DL-NEXT:    s_lshr_b32 s1, s5, 16
; GFX10-DL-NEXT:    v_lshl_or_b32 v4, v4, 16, v7
; GFX10-DL-NEXT:    v_ashrrev_i16_e64 v8, 8, s0
...
; GFX10-DL-NEXT:    v_ashrrev_i16_e64 v6, 8, s1
