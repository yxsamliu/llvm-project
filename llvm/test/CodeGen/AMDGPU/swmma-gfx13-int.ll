...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_f32_16x16_iu8 v[6:13], v[0:1], v[2:5], v[6:13], v14 signed_a signed_b sparse_index_odd k:32 clamp
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_f32i32_16x16_iu8 v[6:13], v[0:1], v[2:5], v[6:13], v14 signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[15:16], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[15:16], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_i32_16x16_iu8 v[6:13], v[0:1], v[2:5], v[6:13], v14 signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[15:16], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[15:16], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_f32_16x16_iu4 v[3:10], v0, v[1:2], v[3:10], v11 signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_f32i32_16x16_iu4 v[3:10], v0, v[1:2], v[3:10], v11 signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[12:13], v[7:10], off offset:16
; GFX13-NEXT:    global_store_b128 v[12:13], v[3:6], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_i32_16x16_iu4 v[3:10], v0, v[1:2], v[3:10], v11 signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[12:13], v[7:10], off offset:16
; GFX13-NEXT:    global_store_b128 v[12:13], v[3:6], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_f32_16x16_iu8 v[12:19], v[0:3], v[4:11], v[12:19], v20 signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_f32i32_16x16_iu8 v[12:19], v[0:3], v[4:11], v[12:19], v20 signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[21:22], v[16:19], off offset:16
; GFX13-NEXT:    global_store_b128 v[21:22], v[12:15], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_i32_16x16_iu8 v[12:19], v[0:3], v[4:11], v[12:19], v20 signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[21:22], v[16:19], off offset:16
; GFX13-NEXT:    global_store_b128 v[21:22], v[12:15], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_f32_16x16_iu4 v[6:13], v[0:1], v[2:5], v[6:13], v14 signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[15:16], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[15:16], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_f32i32_16x16_iu4 v[6:13], v[0:1], v[2:5], v[6:13], v14 signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[15:16], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[15:16], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_i32_16x16_iu4 v[6:13], v[0:1], v[2:5], v[6:13], v14 signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[15:16], v[10:13], off offset:16
; GFX13-NEXT:    global_store_b128 v[15:16], v[6:9], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_f32_16x16_iu4 v[12:19], v[0:3], v[4:11], v[12:19], v[20:21] signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_f32i32_16x16_iu4 v[12:19], v[0:3], v[4:11], v[12:19], v[20:21] signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[22:23], v[16:19], off offset:16
; GFX13-NEXT:    global_store_b128 v[22:23], v[12:15], off
; GFX13-NEXT:    s_endpgm
...
; GFX13:       ; %bb.0: ; %bb
; GFX13-NEXT:    v_swmma_i32_16x16_iu4 v[12:19], v[0:3], v[4:11], v[12:19], v[20:21] signed_a signed_b sparse_index_odd k:32 clamp
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v[22:23], v[16:19], off offset:16
; GFX13-NEXT:    global_store_b128 v[22:23], v[12:15], off
; GFX13-NEXT:    s_endpgm
