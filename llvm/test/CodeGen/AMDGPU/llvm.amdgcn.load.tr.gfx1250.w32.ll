...
;
; GFX1260-LABEL: global_load_tr4_b64_vaddr:
; GFX1260:       ; %bb.0: ; %entry
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: global_load_tr4_b64_saddr:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: global_load_tr8_b64_vaddr:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: global_load_tr8_b64_saddr:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: global_load_tr6_b96_vaddr:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: global_load_tr6_b96_saddr:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: global_load_tr16_b128_v8i16_vaddr:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: global_load_tr16_b128_v8i16_saddr:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: global_load_tr16_b128_v8f16_vaddr:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    global_load_tr16_b128 v[4:7], v[0:1], off offset:32
; GFX1260-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: global_load_tr16_b128_v8f16_saddr:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v2, 0
; GFX1260-NEXT:    global_load_tr16_b128 v[2:5], v2, s[0:1] offset:32
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: global_load_tr16_b128_v8b16_vaddr:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    global_load_tr16_b128 v[4:7], v[0:1], off offset:32
; GFX1260-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: global_load_tr16_b128_v8bf16_saddr:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v2, 0
; GFX1260-NEXT:    global_load_tr16_b128 v[2:5], v2, s[0:1] offset:32
...
;
; GFX1260-SDAG-LABEL: ds_load_tr4_b64:
...
; GFX1260-SDAG-NEXT:    ds_load_tr4_b64 v[0:1], v0 offset:32
...
;
; GFX1260-GISEL-LABEL: ds_load_tr4_b64:
...
; GFX1260-GISEL-NEXT:    ds_load_tr4_b64 v[0:1], v0 offset:32
...
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1260-SDAG-LABEL: ds_load_tr8_b64:
; GFX1260-SDAG:       ; %bb.0: ; %entry
; GFX1260-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v3, v2
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v2, v1
; GFX1260-SDAG-NEXT:    ds_load_tr8_b64 v[0:1], v0 offset:32
; GFX1260-SDAG-NEXT:    s_wait_dscnt 0x0
; GFX1260-SDAG-NEXT:    global_store_b64 v[2:3], v[0:1], off
; GFX1260-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX1260-GISEL-LABEL: ds_load_tr8_b64:
; GFX1260-GISEL:       ; %bb.0: ; %entry
; GFX1260-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v4, v1
; GFX1260-GISEL-NEXT:    ds_load_tr8_b64 v[0:1], v0 offset:32
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v5, v2
; GFX1260-GISEL-NEXT:    s_wait_dscnt 0x0
; GFX1260-GISEL-NEXT:    global_store_b64 v[4:5], v[0:1], off
; GFX1260-GISEL-NEXT:    s_endpgm
...
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1260-SDAG-LABEL: ds_load_tr6_b96:
; GFX1260-SDAG:       ; %bb.0: ; %entry
; GFX1260-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v5, v2
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v4, v1
; GFX1260-SDAG-NEXT:    ds_load_tr6_b96 v[0:2], v0 offset:32
; GFX1260-SDAG-NEXT:    s_wait_dscnt 0x0
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX1260-GISEL-LABEL: ds_load_tr6_b96:
; GFX1260-GISEL:       ; %bb.0: ; %entry
; GFX1260-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v4, v1
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v5, v2
; GFX1260-GISEL-NEXT:    ds_load_tr6_b96 v[0:2], v0 offset:32
; GFX1260-GISEL-NEXT:    s_wait_dscnt 0x0
...
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1260-SDAG-LABEL: ds_load_tr16_b128_v8i16:
; GFX1260-SDAG:       ; %bb.0: ; %entry
; GFX1260-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v5, v2
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v4, v1
; GFX1260-SDAG-NEXT:    ds_load_tr16_b128 v[0:3], v0 offset:32
; GFX1260-SDAG-NEXT:    s_wait_dscnt 0x0
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX1260-GISEL-LABEL: ds_load_tr16_b128_v8i16:
; GFX1260-GISEL:       ; %bb.0: ; %entry
; GFX1260-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v4, v1
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v5, v2
; GFX1260-GISEL-NEXT:    ds_load_tr16_b128 v[0:3], v0 offset:32
; GFX1260-GISEL-NEXT:    s_wait_dscnt 0x0
...
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1260-SDAG-LABEL: ds_load_tr16_b128_v8f16:
; GFX1260-SDAG:       ; %bb.0: ; %entry
; GFX1260-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v5, v2
; GFX1260-SDAG-NEXT:    v_mov_b32_e32 v4, v1
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX1260-GISEL-LABEL: ds_load_tr16_b128_v8f16:
; GFX1260-GISEL:       ; %bb.0: ; %entry
; GFX1260-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v4, v1
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v5, v2
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: ds_load_tr16_b128_v8bf16:
; GFX1260:       ; %bb.0: ; %entry
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v5, v2
; GFX1260-NEXT:    v_mov_b32_e32 v4, v1
; GFX1260-NEXT:    ds_load_tr16_b128 v[0:3], v0 offset:32
...
;
; GFX1260-LABEL: global_load_tr6_b96_vaddr_no_align2_requirement:
; GFX1260:       ; %bb.0:
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: global_load_tr6_b96_saddr_no_align2_requirement:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v0, 0
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: ds_load_tr6_b96_no_align2_requirement:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    ds_load_tr6_b96 v[2:4], v0 offset:32
; GFX1260-NEXT:    v_mov_b32_e32 v0, 0
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v1, v2
; GFX1260-NEXT:    v_mov_b32_e32 v2, v3
