...
;
; GFX1300-LABEL: global_nontemporal_load_0:
; GFX1300:       ; %bb.0: ; %entry
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: global_nontemporal_load_1:
; GFX1300:       ; %bb.0: ; %entry
...
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    global_load_b32 v1, v1, s[2:3] scale_offset th:TH_LOAD_NT
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: global_nontemporal_store_0:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b64 s[2:3], s[4:5], 0x0
; GFX1300-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8
; GFX1300-NEXT:    v_mov_b32_e32 v0, 0
...
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    v_mov_b32_e32 v1, s2
; GFX1300-NEXT:    global_store_b32 v0, v1, s[0:1] th:TH_STORE_NT
; GFX1300-NEXT:    s_endpgm
    ptr addrspace(1) %in, ptr addrspace(1) %out) {
entry:
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: global_nontemporal_store_1:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b64 s[2:3], s[4:5], 0x0
; GFX1300-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8
; GFX1300-NEXT:    s_wait_kmcnt 0x0
...
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    v_mov_b32_e32 v1, s2
; GFX1300-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset th:TH_STORE_NT
; GFX1300-NEXT:    s_endpgm
    ptr addrspace(1) %in, ptr addrspace(1) %out) {
entry:
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: global_nontemporal_volatile_load:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    v_mov_b32_e32 v0, 0
; GFX1300-NEXT:    s_load_b64 s[2:3], s[4:5], 0x0
; GFX1300-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    global_load_b32 v1, v0, s[2:3] th:TH_LOAD_NT scope:SCOPE_SYS
