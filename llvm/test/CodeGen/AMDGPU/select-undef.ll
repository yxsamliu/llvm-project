...
; RUN: llc -amdgpu-scalar-ir-passes=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1300 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX13,GFX13-TRUE16 %s
; RUN: llc -amdgpu-scalar-ir-passes=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1300 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX13,GFX13-FAKE16 %s
...
; GCN-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-TRUE16-LABEL: poison_should_freeze:
; GFX13-TRUE16:       ; %bb.0:
...
; GFX13-TRUE16-NEXT:    v_and_b32_e32 v0, 1, v0
...
; GFX13-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 1, v0
; GFX13-TRUE16-NEXT:    v_cndmask_b32_e32 v0, v1, v2, vcc_lo
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX13-TRUE16-NEXT:    v_dual_cndmask_b32 v0, v5, v3 :: v_dual_cndmask_b32 v1, v6, v4
; GFX13-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX13-FAKE16-LABEL: poison_should_freeze:
; GFX13-FAKE16:       ; %bb.0:
...
; GFX13-FAKE16-NEXT:    v_perm_b32 v2, v2, s0, 0x5040100
...
; GFX13-FAKE16-NEXT:    v_cndmask_b32_e32 v0, v1, v2, vcc_lo
; GFX13-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-FAKE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX13-FAKE16-NEXT:    v_dual_cndmask_b32 v0, v5, v3 :: v_dual_cndmask_b32 v1, v6, v4
