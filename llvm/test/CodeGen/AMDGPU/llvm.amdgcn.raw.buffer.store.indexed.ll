...
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    buffer_store_b128 v[1:4], v0, s0, null offen offset:4
; GFX13-NEXT:    buffer_store_b64 v[5:6], v0, s0, null offen offset:28
; GFX13-NEXT:    s_endpgm
bb:
  %a = shl i32 %inp, 6
  %a1 = add i32 %a, 4
...
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    buffer_store_b64 v[1:2], v5, s0, null offen
; GFX13-NEXT:    buffer_store_b64 v[3:4], v0, s0, null offen
; GFX13-NEXT:    s_endpgm
bb:
  %a1 = add i32 %a, 4
  %a2 = add i32 %a, 12
