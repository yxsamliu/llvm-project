...
; RUN: llc -mtriple=amdgcn -global-isel=0 -mcpu=gfx1200 < %s | FileCheck -check-prefix=GFX13-SDAG %s
; RUN: llc -mtriple=amdgcn -global-isel=1 -global-isel-abort=2 -mcpu=gfx1200 < %s | FileCheck -check-prefix=GFX13-GISEL %s

define amdgpu_ps float @atomic_pk_add_f16_1d_v2(<8 x i32> inreg %rsrc, <2 x half> %data, i32 %s) {
; GCN-SDAG-LABEL: atomic_pk_add_f16_1d_v2:
; GCN-SDAG:       ; %bb.0: ; %main_body
; GCN-SDAG-NEXT:    image_atomic_pk_add_f16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
; GCN-SDAG-NEXT:    ; return to shader part epilog
;
; GCN-GISEL-LABEL: atomic_pk_add_f16_1d_v2:
; GCN-GISEL:       ; %bb.0: ; %main_body
; GCN-GISEL-NEXT:    image_atomic_pk_add_f16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
...
;
; GFX13-SDAG-LABEL: atomic_pk_add_f16_1d_v2:
; GFX13-SDAG:       ; %bb.0: ; %main_body
; GFX13-SDAG-NEXT:    image_atomic_pk_add_f16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-LABEL: atomic_pk_add_f16_1d_v2:
; GFX13-GISEL:       ; %bb.0: ; %main_body
; GFX13-GISEL-NEXT:    image_atomic_pk_add_f16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
...
; GCN-SDAG-LABEL: atomic_pk_add_f16_1d_v2_nt:
; GCN-SDAG:       ; %bb.0: ; %main_body
; GCN-SDAG-NEXT:    image_atomic_pk_add_f16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT_RETURN
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
; GCN-SDAG-NEXT:    ; return to shader part epilog
;
; GCN-GISEL-LABEL: atomic_pk_add_f16_1d_v2_nt:
; GCN-GISEL:       ; %bb.0: ; %main_body
; GCN-GISEL-NEXT:    image_atomic_pk_add_f16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT_RETURN
; GCN-GISEL-NEXT:    s_wait_loadcnt 0x0
; GCN-GISEL-NEXT:    ; return to shader part epilog
...
; GFX12-GISEL-NEXT:    ; return to shader part epilog
;
; GFX13-SDAG-LABEL: atomic_pk_add_f16_1d_v2_nt:
; GFX13-SDAG:       ; %bb.0: ; %main_body
; GFX13-SDAG-NEXT:    image_atomic_pk_add_f16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-LABEL: atomic_pk_add_f16_1d_v2_nt:
; GFX13-GISEL:       ; %bb.0: ; %main_body
; GFX13-GISEL-NEXT:    image_atomic_pk_add_f16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-SDAG-LABEL: atomic_pk_add_f16_1d_v2_noret:
; GCN-SDAG:       ; %bb.0: ; %main_body
; GCN-SDAG-NEXT:    image_atomic_pk_add_f16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
; GCN-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GCN-SDAG-NEXT:    ; return to shader part epilog
;
; GCN-GISEL-LABEL: atomic_pk_add_f16_1d_v2_noret:
; GCN-GISEL:       ; %bb.0: ; %main_body
; GCN-GISEL-NEXT:    image_atomic_pk_add_f16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-GISEL-NEXT:    s_wait_loadcnt 0x0
; GCN-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
; GCN-GISEL-NEXT:    ; return to shader part epilog
...
; GFX12-GISEL-NEXT:    ; return to shader part epilog
;
; GFX13-SDAG-LABEL: atomic_pk_add_f16_1d_v2_noret:
; GFX13-SDAG:       ; %bb.0: ; %main_body
; GFX13-SDAG-NEXT:    image_atomic_pk_add_f16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-LABEL: atomic_pk_add_f16_1d_v2_noret:
; GFX13-GISEL:       ; %bb.0: ; %main_body
; GFX13-GISEL-NEXT:    image_atomic_pk_add_f16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-SDAG-LABEL: atomic_pk_add_f16_1d_v4:
; GCN-SDAG:       ; %bb.0: ; %main_body
; GCN-SDAG-NEXT:    image_atomic_pk_add_f16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
; GCN-SDAG-NEXT:    ; return to shader part epilog
;
; GCN-GISEL-LABEL: atomic_pk_add_f16_1d_v4:
; GCN-GISEL:       ; %bb.0: ; %main_body
; GCN-GISEL-NEXT:    image_atomic_pk_add_f16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-GISEL-NEXT:    s_wait_loadcnt 0x0
; GCN-GISEL-NEXT:    ; return to shader part epilog
...
; GFX12-GISEL-NEXT:    ; return to shader part epilog
;
; GFX13-SDAG-LABEL: atomic_pk_add_f16_1d_v4:
; GFX13-SDAG:       ; %bb.0: ; %main_body
; GFX13-SDAG-NEXT:    image_atomic_pk_add_f16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-LABEL: atomic_pk_add_f16_1d_v4:
; GFX13-GISEL:       ; %bb.0: ; %main_body
; GFX13-GISEL-NEXT:    image_atomic_pk_add_f16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-SDAG-LABEL: atomic_pk_add_f16_1d_v4_noret:
; GCN-SDAG:       ; %bb.0: ; %main_body
; GCN-SDAG-NEXT:    image_atomic_pk_add_f16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
; GCN-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GCN-SDAG-NEXT:    ; return to shader part epilog
;
; GCN-GISEL-LABEL: atomic_pk_add_f16_1d_v4_noret:
; GCN-GISEL:       ; %bb.0: ; %main_body
; GCN-GISEL-NEXT:    image_atomic_pk_add_f16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-GISEL-NEXT:    s_wait_loadcnt 0x0
; GCN-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
...
; GFX12-GISEL-NEXT:    ; return to shader part epilog
;
; GFX13-SDAG-LABEL: atomic_pk_add_f16_1d_v4_noret:
; GFX13-SDAG:       ; %bb.0: ; %main_body
; GFX13-SDAG-NEXT:    image_atomic_pk_add_f16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-LABEL: atomic_pk_add_f16_1d_v4_noret:
; GFX13-GISEL:       ; %bb.0: ; %main_body
; GFX13-GISEL-NEXT:    image_atomic_pk_add_f16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-SDAG-LABEL: atomic_pk_add_bf16_1d_v2:
; GCN-SDAG:       ; %bb.0: ; %main_body
; GCN-SDAG-NEXT:    image_atomic_pk_add_bf16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-SDAG-NEXT:    v_mov_b32_e32 v1, 0
; GCN-SDAG-NEXT:    v_mov_b32_e32 v2, 0
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
; GCN-SDAG-NEXT:    flat_store_b32 v[1:2], v0
; GCN-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GCN-SDAG-NEXT:    s_wait_dscnt 0x0
; GCN-SDAG-NEXT:    ; return to shader part epilog
;
; GCN-GISEL-LABEL: atomic_pk_add_bf16_1d_v2:
; GCN-GISEL:       ; %bb.0: ; %main_body
; GCN-GISEL-NEXT:    image_atomic_pk_add_bf16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GCN-GISEL-NEXT:    v_mov_b32_e32 v2, 0
; GCN-GISEL-NEXT:    s_wait_loadcnt 0x0
; GCN-GISEL-NEXT:    flat_store_b32 v[1:2], v0
; GCN-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
...
; GFX12-GISEL-NEXT:    ; return to shader part epilog
;
; GFX13-SDAG-LABEL: atomic_pk_add_bf16_1d_v2:
; GFX13-SDAG:       ; %bb.0: ; %main_body
; GFX13-SDAG-NEXT:    image_atomic_pk_add_bf16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v2, 0
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    flat_store_b32 v[1:2], v0
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-SDAG-NEXT:    s_wait_dscnt 0x0
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-LABEL: atomic_pk_add_bf16_1d_v2:
; GFX13-GISEL:       ; %bb.0: ; %main_body
; GFX13-GISEL-NEXT:    image_atomic_pk_add_bf16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v2, 0
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    flat_store_b32 v[1:2], v0
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
...
; GCN-SDAG-LABEL: atomic_pk_add_bf16_1d_v2_noret:
; GCN-SDAG:       ; %bb.0: ; %main_body
; GCN-SDAG-NEXT:    image_atomic_pk_add_bf16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
; GCN-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GCN-SDAG-NEXT:    ; return to shader part epilog
;
; GCN-GISEL-LABEL: atomic_pk_add_bf16_1d_v2_noret:
; GCN-GISEL:       ; %bb.0: ; %main_body
; GCN-GISEL-NEXT:    image_atomic_pk_add_bf16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-GISEL-NEXT:    s_wait_loadcnt 0x0
; GCN-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
...
; GFX12-GISEL-NEXT:    ; return to shader part epilog
;
; GFX13-SDAG-LABEL: atomic_pk_add_bf16_1d_v2_noret:
; GFX13-SDAG:       ; %bb.0: ; %main_body
; GFX13-SDAG-NEXT:    image_atomic_pk_add_bf16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-LABEL: atomic_pk_add_bf16_1d_v2_noret:
; GFX13-GISEL:       ; %bb.0: ; %main_body
; GFX13-GISEL-NEXT:    image_atomic_pk_add_bf16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-SDAG-LABEL: atomic_pk_add_bf16_1d_v4:
; GCN-SDAG:       ; %bb.0: ; %main_body
; GCN-SDAG-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-SDAG-NEXT:    v_mov_b32_e32 v2, 0
; GCN-SDAG-NEXT:    v_mov_b32_e32 v3, 0
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
; GCN-SDAG-NEXT:    flat_store_b64 v[2:3], v[0:1]
; GCN-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GCN-SDAG-NEXT:    s_wait_dscnt 0x0
; GCN-SDAG-NEXT:    ; return to shader part epilog
;
; GCN-GISEL-LABEL: atomic_pk_add_bf16_1d_v4:
; GCN-GISEL:       ; %bb.0: ; %main_body
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v3, 16, v0
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v4, 16, v1
; GCN-GISEL-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GCN-GISEL-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GCN-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GCN-GISEL-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; GCN-GISEL-NEXT:    v_lshlrev_b32_e32 v4, 16, v4
; GCN-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GCN-GISEL-NEXT:    v_or_b32_e32 v0, v3, v0
; GCN-GISEL-NEXT:    v_or_b32_e32 v1, v4, v1
; GCN-GISEL-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-GISEL-NEXT:    v_mov_b32_e32 v2, 0
; GCN-GISEL-NEXT:    v_mov_b32_e32 v3, 0
; GCN-GISEL-NEXT:    s_wait_loadcnt 0x0
; GCN-GISEL-NEXT:    flat_store_b64 v[2:3], v[0:1]
; GCN-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
; GCN-GISEL-NEXT:    s_wait_dscnt 0x0
; GCN-GISEL-NEXT:    ; return to shader part epilog
...
; GFX12-GISEL-NEXT:    ; return to shader part epilog
;
; GFX13-SDAG-LABEL: atomic_pk_add_bf16_1d_v4:
; GFX13-SDAG:       ; %bb.0: ; %main_body
; GFX13-SDAG-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v2, 0
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v3, 0
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    flat_store_b64 v[2:3], v[0:1]
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-SDAG-NEXT:    s_wait_dscnt 0x0
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-LABEL: atomic_pk_add_bf16_1d_v4:
; GFX13-GISEL:       ; %bb.0: ; %main_body
; GFX13-GISEL-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v2, 0
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v3, 0
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    flat_store_b64 v[2:3], v[0:1]
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-GISEL-NEXT:    s_wait_dscnt 0x0
; GFX13-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-SDAG-LABEL: atomic_pk_add_bf16_1d_v4_noret:
; GCN-SDAG:       ; %bb.0: ; %main_body
; GCN-SDAG-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
; GCN-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GCN-SDAG-NEXT:    ; return to shader part epilog
;
; GCN-GISEL-LABEL: atomic_pk_add_bf16_1d_v4_noret:
; GCN-GISEL:       ; %bb.0: ; %main_body
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v3, 16, v0
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v4, 16, v1
; GCN-GISEL-NEXT:    v_and_b32_e32 v0, 0xffff, v0
...
; GFX12-GISEL-NEXT:    ; return to shader part epilog
;
; GFX13-SDAG-LABEL: atomic_pk_add_bf16_1d_v4_noret:
; GFX13-SDAG:       ; %bb.0: ; %main_body
; GFX13-SDAG-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-LABEL: atomic_pk_add_bf16_1d_v4_noret:
; GFX13-GISEL:       ; %bb.0: ; %main_body
; GFX13-GISEL-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-SDAG-LABEL: atomic_pk_add_bf16_1d_v4_nt:
; GCN-SDAG:       ; %bb.0: ; %main_body
; GCN-SDAG-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT_RETURN
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
; GCN-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GCN-SDAG-NEXT:    ; return to shader part epilog
;
; GCN-GISEL-LABEL: atomic_pk_add_bf16_1d_v4_nt:
; GCN-GISEL:       ; %bb.0: ; %main_body
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v3, 16, v0
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v4, 16, v1
; GCN-GISEL-NEXT:    v_and_b32_e32 v0, 0xffff, v0
...
; GCN-GISEL-NEXT:    v_or_b32_e32 v0, v3, v0
; GCN-GISEL-NEXT:    v_or_b32_e32 v1, v4, v1
; GCN-GISEL-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT_RETURN
; GCN-GISEL-NEXT:    s_wait_loadcnt 0x0
; GCN-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
; GCN-GISEL-NEXT:    ; return to shader part epilog
...
; GFX12-GISEL-NEXT:    ; return to shader part epilog
;
; GFX13-SDAG-LABEL: atomic_pk_add_bf16_1d_v4_nt:
; GFX13-SDAG:       ; %bb.0: ; %main_body
; GFX13-SDAG-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-LABEL: atomic_pk_add_bf16_1d_v4_nt:
; GFX13-GISEL:       ; %bb.0: ; %main_body
; GFX13-GISEL-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-GISEL-NEXT:    ; return to shader part epilog
main_body:
