...
; RUN: llc -mtriple=amdgpu9.0a-amd-amdhsa -verify-machineinstrs < %s | FileCheck -check-prefix=GFX90A %s

; Force high register pressure and whole-wave spilling of scalar-spill vectors.
; Copy-only split fragments must stay in the WWM VGPR pool; overflow is saved
; to memory with all lanes enabled. Direct AGPR copy lowering is covered by
; si-lower-wwm-copies.mir independently of the allocation policy.
...
; GFX90A-NEXT:    v_accvgpr_write_b32 a32, v31
