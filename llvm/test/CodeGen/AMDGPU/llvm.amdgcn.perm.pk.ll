...
;
; GFX1260-LABEL: test_perm_pk16_b4_u4:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_perm_pk16_b4_u4 v[0:1], v0, v1, v[2:3]
; GFX1260-NEXT:    flat_store_b64 v[4:5], v[0:1]
...
;
; GFX1260-SDAG-LABEL: test_perm_pk16_b6_u4:
; GFX1260-SDAG:       ; %bb.0:
...
; GFX1260-SDAG-NEXT:    v_perm_pk16_b6_u4 v[0:2], v0, v[2:3], v[8:9]
; GFX1260-SDAG-NEXT:    flat_store_b96 v[6:7], v[0:2]
...
;
; GFX1260-GISEL-LABEL: test_perm_pk16_b6_u4:
; GFX1260-GISEL:       ; %bb.0:
; GFX1260-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v8, v1
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v9, v2
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v2, v3
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v3, v4
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v4, v5
; GFX1260-GISEL-NEXT:    v_mov_b32_e32 v5, v6
; GFX1260-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX1260-GISEL-NEXT:    v_perm_pk16_b6_u4 v[0:2], v0, v[8:9], v[2:3]
; GFX1260-GISEL-NEXT:    flat_store_b96 v[4:5], v[0:2]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: test_perm_pk16_b8_u4:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_perm_pk16_b8_u4 v[0:3], v[0:1], v[2:3], v[4:5]
; GFX1260-NEXT:    flat_store_b128 v[6:7], v[0:3]
; GFX1260-NEXT:    s_wait_dscnt 0x0
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
