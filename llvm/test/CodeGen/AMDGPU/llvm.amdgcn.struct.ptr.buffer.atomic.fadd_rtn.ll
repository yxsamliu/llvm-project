...
;
; GFX1260-LABEL: struct_ptr_buffer_atomic_add_f32_rtn__vgpr_val__sgpr_rsrc__vgpr_voffset__sgpr_soffset:
; GFX1260:       ; %bb.0:
...
; GFX1260-NEXT:    buffer_atomic_add_f32 v0, v[2:3], s[0:3], s16 idxen offen th:TH_ATOMIC_RETURN
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: struct_ptr_buffer_atomic_add_f32_rtn__vgpr_val__sgpr_rsrc__0_voffset__sgpr_soffset:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    buffer_atomic_add_f32 v0, v1, s[0:3], s16 idxen th:TH_ATOMIC_RETURN
; GFX1260-NEXT:    s_wait_loadcnt 0x0
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: struct_ptr_buffer_atomic_add_f32_rtn__vgpr_val__sgpr_rsrc__vgpr_voffset__sgpr_soffset_slc:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v3, v2
; GFX1260-NEXT:    v_mov_b32_e32 v2, v1
; GFX1260-NEXT:    buffer_atomic_add_f32 v0, v[2:3], s[0:3], s16 idxen offen th:TH_ATOMIC_NT_RETURN
; GFX1260-NEXT:    s_wait_loadcnt 0x0
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: struct_ptr_buffer_atomic_add_v2f16_rtn__vgpr_val__sgpr_rsrc__vgpr_voffset__sgpr_soffset:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v3, v2
; GFX1260-NEXT:    v_mov_b32_e32 v2, v1
; GFX1260-NEXT:    buffer_atomic_pk_add_f16 v0, v[2:3], s[0:3], s16 idxen offen th:TH_ATOMIC_RETURN
; GFX1260-NEXT:    s_wait_loadcnt 0x0
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: struct_ptr_buffer_atomic_add_f32_rtn__vgpr_val__vgpr_rsrc__vgpr_voffset__vgpr_soffset:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
...
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1260-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[2:3]
; GFX1260-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[4:5]
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
...
; GFX1260-NEXT:    s_wait_loadcnt 0x0
; GFX1260-NEXT:    buffer_atomic_add_f32 v0, v[8:9], s[4:7], s3 idxen offen th:TH_ATOMIC_RETURN
...
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1260-LABEL: struct_ptr_buffer_atomic_add_v2f16_rtn__vgpr_val__vgpr_rsrc__vgpr_voffset__vgpr_soffset:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1260-NEXT:    s_wait_kmcnt 0x0
; GFX1260-NEXT:    v_mov_b32_e32 v9, v6
...
; GFX1260-NEXT:    v_mov_b32_e32 v2, v1
; GFX1260-NEXT:    s_mov_b32 s2, exec_lo
; GFX1260-NEXT:  .LBB5_1: ; =>This Inner Loop Header: Depth=1
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1260-NEXT:    v_readfirstlane_b32 s4, v2
; GFX1260-NEXT:    v_readfirstlane_b32 s5, v3
; GFX1260-NEXT:    v_readfirstlane_b32 s6, v4
...
; GFX1260-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1260-NEXT:    s_wait_loadcnt 0x0
; GFX1260-NEXT:    buffer_atomic_pk_add_f16 v0, v[8:9], s[4:7], s3 idxen offen th:TH_ATOMIC_RETURN
; GFX1260-NEXT:    ; implicit-def: $vgpr2_vgpr3_vgpr4_vgpr5
; GFX1260-NEXT:    ; implicit-def: $vgpr7
; GFX1260-NEXT:    ; implicit-def: $vgpr8_vgpr9
; GFX1260-NEXT:    s_wait_xcnt 0x0
; GFX1260-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
; GFX1260-NEXT:    s_cbranch_execnz .LBB5_1
; GFX1260-NEXT:  ; %bb.2:
; GFX1260-NEXT:    s_mov_b32 exec_lo, s2
; GFX1260-NEXT:    s_wait_loadcnt 0x0
; GFX1260-NEXT:    s_set_pc_i64 s[30:31]
