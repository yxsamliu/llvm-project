...
; GFX12-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX12-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX12-NEXT:    s_cbranch_scc0 .LBB28_4
; GFX12-NEXT:  ; %bb.3:
...
; GFX12-NEXT:    ; implicit-def: $vgpr1
; GFX12-NEXT:    s_xor_b32 s4, vcc_lo, exec_lo
; GFX12-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX12-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX12-NEXT:    s_cbranch_scc0 .LBB28_8
; GFX12-NEXT:  ; %bb.7:
...
; GFX940-NEXT:    v_mbcnt_lo_u32_b32 v0, s6, 0
; GFX940-NEXT:    v_mbcnt_hi_u32_b32 v0, s7, v0
...
; GFX940-NEXT:    s_cbranch_scc0 .LBB28_2
; GFX940-NEXT:  ; %bb.1:
...
; GFX940-NEXT:  .LBB28_2:
; GFX940-NEXT:    s_mov_b64 s[6:7], exec
; GFX940-NEXT:    v_mbcnt_lo_u32_b32 v2, s6, 0
; GFX940-NEXT:    v_mbcnt_hi_u32_b32 v2, s7, v2
; GFX940-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; GFX940-NEXT:    s_mov_b64 s[4:5], exec
; GFX940-NEXT:    v_readfirstlane_b32 s8, v1
; GFX940-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX940-NEXT:    s_cmov_b64 exec, vcc
; GFX940-NEXT:    s_cbranch_scc0 .LBB28_4
; GFX940-NEXT:  ; %bb.3:
; GFX940-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX940-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
...
; GFX940-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; GFX940-NEXT:    s_xor_b64 s[4:5], vcc, exec
; GFX940-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX940-NEXT:    ; implicit-def: $vgpr2
; GFX940-NEXT:    s_cmov_b64 exec, vcc
; GFX940-NEXT:    s_cbranch_scc0 .LBB28_8
; GFX940-NEXT:  ; %bb.7:
...
; GFX11-NEXT:    s_cbranch_scc0 .LBB28_2
; GFX11-NEXT:  ; %bb.1:
...
; GFX11-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX11-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX11-NEXT:    s_cbranch_scc0 .LBB28_8
; GFX11-NEXT:  ; %bb.7:
...
; GFX10-NEXT:    s_cbranch_scc0 .LBB28_2
; GFX10-NEXT:  ; %bb.1:
...
; GFX10-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX10-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX10-NEXT:    s_cbranch_scc0 .LBB28_4
; GFX10-NEXT:  ; %bb.3:
...
; GFX10-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX10-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX10-NEXT:    s_cbranch_scc0 .LBB28_8
; GFX10-NEXT:  ; %bb.7:
...
; GFX90A-NEXT:    s_cbranch_scc0 .LBB28_2
; GFX90A-NEXT:  ; %bb.1:
...
; GFX90A-NEXT:  .LBB28_2:
; GFX90A-NEXT:    s_mov_b64 s[6:7], exec
; GFX90A-NEXT:    v_mbcnt_lo_u32_b32 v2, s6, 0
; GFX90A-NEXT:    v_mbcnt_hi_u32_b32 v2, s7, v2
; GFX90A-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; GFX90A-NEXT:    s_mov_b64 s[4:5], exec
; GFX90A-NEXT:    v_readfirstlane_b32 s8, v1
; GFX90A-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX90A-NEXT:    s_cmov_b64 exec, vcc
; GFX90A-NEXT:    s_cbranch_scc0 .LBB28_4
; GFX90A-NEXT:  ; %bb.3:
; GFX90A-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX90A-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
...
; GFX90A-NEXT:    s_cmov_b64 exec, vcc
; GFX90A-NEXT:    s_cbranch_scc0 .LBB28_8
; GFX90A-NEXT:  ; %bb.7:
...
; GFX908-NEXT:    s_cbranch_scc0 .LBB28_2
; GFX908-NEXT:  ; %bb.1:
...
; GFX908-NEXT:  .LBB28_2:
; GFX908-NEXT:    s_mov_b64 s[6:7], exec
; GFX908-NEXT:    v_mbcnt_lo_u32_b32 v2, s6, 0
; GFX908-NEXT:    v_mbcnt_hi_u32_b32 v2, s7, v2
; GFX908-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; GFX908-NEXT:    s_mov_b64 s[4:5], exec
; GFX908-NEXT:    v_readfirstlane_b32 s8, v1
; GFX908-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX908-NEXT:    s_cmov_b64 exec, vcc
; GFX908-NEXT:    s_cbranch_scc0 .LBB28_4
; GFX908-NEXT:  ; %bb.3:
; GFX908-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX908-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
...
; GFX908-NEXT:    s_cmov_b64 exec, vcc
; GFX908-NEXT:    s_cbranch_scc0 .LBB28_8
; GFX908-NEXT:  ; %bb.7:
...
; GFX8-NEXT:  .LBB28_2:
; GFX8-NEXT:    s_mov_b64 s[6:7], exec
; GFX8-NEXT:    v_mbcnt_lo_u32_b32 v2, s6, 0
; GFX8-NEXT:    v_mbcnt_hi_u32_b32 v2, s7, v2
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; GFX8-NEXT:    s_mov_b64 s[4:5], exec
; GFX8-NEXT:    v_readfirstlane_b32 s8, v1
; GFX8-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX8-NEXT:    s_cmov_b64 exec, vcc
; GFX8-NEXT:    s_cbranch_scc0 .LBB28_4
; GFX8-NEXT:  ; %bb.3:
; GFX8-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX8-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
...
; GFX8-NEXT:    s_cmov_b64 exec, vcc
; GFX8-NEXT:    s_cbranch_scc0 .LBB28_8
; GFX8-NEXT:  ; %bb.7:
...
; GFX7-NEXT:    s_cbranch_scc0 .LBB28_4
; GFX7-NEXT:  ; %bb.1:
...
; GFX7-NEXT:    s_cbranch_scc1 .LBB28_2
...
; GFX7-NEXT:    s_cmov_b64 exec, vcc
; GFX7-NEXT:    s_cbranch_scc0 .LBB28_8
; GFX7-NEXT:  ; %bb.5:
...
; GFX7-NEXT:    s_cbranch_scc1 .LBB28_6
; GFX7-NEXT:  ; %bb.7: ; %Flow
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:  .LBB28_8:
...
; GFX7-NEXT:  .LBB28_9: ; %atomicrmw.start8
; GFX7-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-NEXT:    s_cbranch_scc1 .LBB28_9
...
; GFX6-NEXT:    s_cbranch_scc0 .LBB28_4
; GFX6-NEXT:  ; %bb.1:
...
; GFX6-NEXT:    s_andn2_b64 s[8:9], exec, s[6:7]
; GFX6-NEXT:    s_cselect_b64 exec, s[8:9], s[6:7]
; GFX6-NEXT:    s_cbranch_scc1 .LBB28_2
; GFX6-NEXT:  ; %bb.3: ; %Flow16
; GFX6-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX6-NEXT:  .LBB28_4:
; GFX6-NEXT:    s_mov_b64 s[6:7], exec
; GFX6-NEXT:    v_mbcnt_lo_u32_b32_e64 v2, s6, 0
; GFX6-NEXT:    v_mbcnt_hi_u32_b32_e32 v2, s7, v2
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; GFX6-NEXT:    s_and_b64 s[8:9], vcc, -1
; GFX6-NEXT:    s_mov_b64 s[4:5], exec
; GFX6-NEXT:    v_readfirstlane_b32 s8, v1
; GFX6-NEXT:    s_cmov_b64 exec, vcc
; GFX6-NEXT:    s_cbranch_scc0 .LBB28_8
; GFX6-NEXT:  ; %bb.5:
...
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, v4, v3
; GFX6-NEXT:    s_or_b64 s[6:7], vcc, s[6:7]
; GFX6-NEXT:    s_andn2_b64 s[10:11], exec, s[6:7]
; GFX6-NEXT:    v_mov_b32_e32 v3, v4
; GFX6-NEXT:    s_cselect_b64 exec, s[10:11], s[6:7]
; GFX6-NEXT:    s_cbranch_scc1 .LBB28_6
; GFX6-NEXT:  ; %bb.7: ; %Flow
; GFX6-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX6-NEXT:  .LBB28_8:
...
; GFX6-NEXT:  .LBB28_9: ; %atomicrmw.start8
; GFX6-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v3, v1
...
; GFX6-NEXT:    s_andn2_b64 s[4:5], exec, s[2:3]
; GFX6-NEXT:    s_cselect_b64 exec, s[4:5], s[2:3]
; GFX6-NEXT:    s_cbranch_scc1 .LBB28_9
; GFX6-NEXT:  ; %bb.10: ; %atomicrmw.end7
...
; GFX12-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX12-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX12-NEXT:    s_cbranch_scc0 .LBB29_8
; GFX12-NEXT:  ; %bb.7:
; GFX12-NEXT:    v_dual_mov_b32 v1, s2 :: v_dual_mov_b32 v2, s3
; GFX12-NEXT:    ds_add_rtn_f32 v1, v1, v2
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s4
...
; GFX940-NEXT:    ; implicit-def: $vgpr1
; GFX940-NEXT:    s_cmov_b64 exec, vcc
; GFX940-NEXT:    s_cbranch_scc0 .LBB29_2
; GFX940-NEXT:  ; %bb.1:
; GFX940-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX940-NEXT:    s_lshl_b32 s8, s3, 3
; GFX940-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
...
; GFX940-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX940-NEXT:    s_cmov_b64 exec, vcc
; GFX940-NEXT:    s_cbranch_scc0 .LBB29_4
; GFX940-NEXT:  ; %bb.3:
; GFX940-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX940-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
; GFX940-NEXT:    s_lshl_b32 s3, s3, 4
...
; GFX940-NEXT:    ; implicit-def: $vgpr2
; GFX940-NEXT:    s_cmov_b64 exec, vcc
; GFX940-NEXT:    s_cbranch_scc0 .LBB29_8
; GFX940-NEXT:  ; %bb.7:
; GFX940-NEXT:    v_mov_b32_e32 v2, s2
; GFX940-NEXT:    ds_add_rtn_f32 v2, v2, v1
; GFX940-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX11-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX11-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX11-NEXT:    s_cbranch_scc0 .LBB29_8
; GFX11-NEXT:  ; %bb.7:
; GFX11-NEXT:    v_mov_b32_e32 v2, s2
; GFX11-NEXT:    ds_add_rtn_f32 v2, v2, v1
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s3
...
; GFX10-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX10-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX10-NEXT:    s_cbranch_scc0 .LBB29_2
; GFX10-NEXT:  ; %bb.1:
; GFX10-NEXT:    s_bcnt1_i32_b32 s5, s5
; GFX10-NEXT:    v_cvt_f32_ubyte0_e32 v1, s5
; GFX10-NEXT:    s_lshl_b32 s5, s3, 3
...
; GFX10-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX10-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX10-NEXT:    s_cbranch_scc0 .LBB29_4
; GFX10-NEXT:  ; %bb.3:
; GFX10-NEXT:    s_bcnt1_i32_b32 s6, s6
; GFX10-NEXT:    s_lshl_b32 s3, s3, 4
; GFX10-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
...
; GFX10-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX10-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX10-NEXT:    s_cbranch_scc0 .LBB29_8
; GFX10-NEXT:  ; %bb.7:
; GFX10-NEXT:    v_mov_b32_e32 v2, s2
; GFX10-NEXT:    ds_add_rtn_f32 v2, v2, v1
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
...
; GFX90A-NEXT:    ; implicit-def: $vgpr1
; GFX90A-NEXT:    s_cmov_b64 exec, vcc
; GFX90A-NEXT:    s_cbranch_scc0 .LBB29_2
; GFX90A-NEXT:  ; %bb.1:
; GFX90A-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX90A-NEXT:    s_lshl_b32 s8, s3, 3
; GFX90A-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
...
; GFX90A-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX90A-NEXT:    s_cmov_b64 exec, vcc
; GFX90A-NEXT:    s_cbranch_scc0 .LBB29_4
; GFX90A-NEXT:  ; %bb.3:
; GFX90A-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX90A-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
; GFX90A-NEXT:    s_lshl_b32 s3, s3, 4
...
; GFX90A-NEXT:    ; implicit-def: $vgpr2
; GFX90A-NEXT:    s_cmov_b64 exec, vcc
; GFX90A-NEXT:    s_cbranch_scc0 .LBB29_8
; GFX90A-NEXT:  ; %bb.7:
; GFX90A-NEXT:    v_mov_b32_e32 v2, s2
; GFX90A-NEXT:    ds_add_rtn_f32 v2, v2, v1
; GFX90A-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX908-NEXT:    ; implicit-def: $vgpr1
; GFX908-NEXT:    s_cmov_b64 exec, vcc
; GFX908-NEXT:    s_cbranch_scc0 .LBB29_2
; GFX908-NEXT:  ; %bb.1:
; GFX908-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX908-NEXT:    s_lshl_b32 s8, s3, 3
; GFX908-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
...
; GFX908-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX908-NEXT:    s_cmov_b64 exec, vcc
; GFX908-NEXT:    s_cbranch_scc0 .LBB29_4
; GFX908-NEXT:  ; %bb.3:
; GFX908-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX908-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
; GFX908-NEXT:    s_lshl_b32 s3, s3, 4
...
; GFX908-NEXT:    ; implicit-def: $vgpr2
; GFX908-NEXT:    s_cmov_b64 exec, vcc
; GFX908-NEXT:    s_cbranch_scc0 .LBB29_8
; GFX908-NEXT:  ; %bb.7:
; GFX908-NEXT:    v_mov_b32_e32 v2, s2
; GFX908-NEXT:    ds_add_rtn_f32 v2, v2, v1
; GFX908-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX8-NEXT:    s_mov_b32 m0, -1
; GFX8-NEXT:    s_cmov_b64 exec, vcc
; GFX8-NEXT:    s_cbranch_scc0 .LBB29_2
; GFX8-NEXT:  ; %bb.1:
; GFX8-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX8-NEXT:    s_lshl_b32 s8, s3, 3
; GFX8-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
...
; GFX8-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX8-NEXT:    s_cmov_b64 exec, vcc
; GFX8-NEXT:    s_cbranch_scc0 .LBB29_4
; GFX8-NEXT:  ; %bb.3:
; GFX8-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX8-NEXT:    v_cvt_f32_ubyte0_e32 v1, s6
; GFX8-NEXT:    s_lshl_b32 s3, s3, 4
...
; GFX8-NEXT:    ; implicit-def: $vgpr2
; GFX8-NEXT:    s_cmov_b64 exec, vcc
; GFX8-NEXT:    s_cbranch_scc0 .LBB29_8
; GFX8-NEXT:  ; %bb.7:
; GFX8-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NEXT:    s_mov_b32 m0, -1
; GFX8-NEXT:    ds_add_rtn_f32 v2, v2, v1
...
; GFX7-NEXT:    s_mov_b32 m0, -1
; GFX7-NEXT:    s_cmov_b64 exec, vcc
; GFX7-NEXT:    s_cbranch_scc0 .LBB29_4
; GFX7-NEXT:  ; %bb.1:
; GFX7-NEXT:    s_lshl_b32 s8, s3, 3
; GFX7-NEXT:    v_mov_b32_e32 v2, s8
; GFX7-NEXT:    ds_read_b32 v1, v2
...
; GFX7-NEXT:    s_andn2_b64 s[8:9], exec, s[6:7]
; GFX7-NEXT:    s_cselect_b64 exec, s[8:9], s[6:7]
; GFX7-NEXT:    s_cbranch_scc1 .LBB29_2
; GFX7-NEXT:  ; %bb.3: ; %Flow18
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:  .LBB29_4:
; GFX7-NEXT:    s_mov_b64 s[6:7], exec
...
; GFX7-NEXT:    v_readfirstlane_b32 s8, v1
; GFX7-NEXT:    s_cmov_b64 exec, vcc
; GFX7-NEXT:    s_cbranch_scc0 .LBB29_8
; GFX7-NEXT:  ; %bb.5:
; GFX7-NEXT:    s_lshl_b32 s3, s3, 4
; GFX7-NEXT:    v_mov_b32_e32 v1, s3
; GFX7-NEXT:    ds_read_b32 v3, v1
...
; GFX7-NEXT:    v_mov_b32_e32 v3, v4
; GFX7-NEXT:    s_cselect_b64 exec, s[10:11], s[6:7]
; GFX7-NEXT:    s_cbranch_scc1 .LBB29_6
; GFX7-NEXT:  ; %bb.7: ; %Flow
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:  .LBB29_8:
; GFX7-NEXT:    v_mov_b32_e32 v2, s2
...
; GFX7-NEXT:    v_add_f32_e32 v0, s8, v0
; GFX7-NEXT:    s_mov_b64 s[2:3], 0
; GFX7-NEXT:  .LBB29_9: ; %atomicrmw.start8
; GFX7-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mov_b32_e32 v3, v1
; GFX7-NEXT:    v_add_f32_e32 v1, v3, v0
...
; GFX7-NEXT:    s_andn2_b64 s[4:5], exec, s[2:3]
; GFX7-NEXT:    s_cselect_b64 exec, s[4:5], s[2:3]
; GFX7-NEXT:    s_cbranch_scc1 .LBB29_9
; GFX7-NEXT:  ; %bb.10: ; %atomicrmw.end7
; GFX7-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x0
; GFX7-NEXT:    s_mov_b32 s3, 0xf000
; GFX7-NEXT:    s_mov_b32 s2, -1
...
; GFX6-NEXT:    s_mov_b32 m0, -1
; GFX6-NEXT:    s_cmov_b64 exec, vcc
; GFX6-NEXT:    s_cbranch_scc0 .LBB29_4
; GFX6-NEXT:  ; %bb.1:
; GFX6-NEXT:    s_lshl_b32 s8, s3, 3
; GFX6-NEXT:    v_mov_b32_e32 v2, s8
; GFX6-NEXT:    ds_read_b32 v1, v2
...
; GFX6-NEXT:    s_andn2_b64 s[8:9], exec, s[6:7]
; GFX6-NEXT:    s_cselect_b64 exec, s[8:9], s[6:7]
; GFX6-NEXT:    s_cbranch_scc1 .LBB29_2
; GFX6-NEXT:  ; %bb.3: ; %Flow16
; GFX6-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX6-NEXT:  .LBB29_4:
; GFX6-NEXT:    s_mov_b64 s[6:7], exec
...
; GFX6-NEXT:    v_readfirstlane_b32 s8, v1
; GFX6-NEXT:    s_cmov_b64 exec, vcc
; GFX6-NEXT:    s_cbranch_scc0 .LBB29_8
; GFX6-NEXT:  ; %bb.5:
; GFX6-NEXT:    s_lshl_b32 s3, s3, 4
; GFX6-NEXT:    v_mov_b32_e32 v1, s3
; GFX6-NEXT:    ds_read_b32 v3, v1
...
; GFX6-NEXT:    v_mov_b32_e32 v3, v4
; GFX6-NEXT:    s_cselect_b64 exec, s[10:11], s[6:7]
; GFX6-NEXT:    s_cbranch_scc1 .LBB29_6
; GFX6-NEXT:  ; %bb.7: ; %Flow
; GFX6-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX6-NEXT:  .LBB29_8:
; GFX6-NEXT:    v_mov_b32_e32 v2, s2
...
; GFX6-NEXT:    v_add_f32_e32 v0, s8, v0
; GFX6-NEXT:    s_mov_b64 s[2:3], 0
; GFX6-NEXT:  .LBB29_9: ; %atomicrmw.start8
; GFX6-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v3, v1
; GFX6-NEXT:    v_add_f32_e32 v1, v3, v0
...
; GFX6-NEXT:    s_andn2_b64 s[4:5], exec, s[2:3]
; GFX6-NEXT:    s_cselect_b64 exec, s[4:5], s[2:3]
; GFX6-NEXT:    s_cbranch_scc1 .LBB29_9
; GFX6-NEXT:  ; %bb.10: ; %atomicrmw.end7
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x0
; GFX6-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-NEXT:    s_mov_b32 s2, -1
