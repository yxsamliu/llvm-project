...
; GFX13W64-NEXT:    s_load_b32 s3, s[4:5], 0x44
; GFX13W64-NEXT:    s_load_b128 s[8:11], s[4:5], 0x34
; GFX13W64-NEXT:    v_mov_b32_e32 v1, s2
; GFX13W64-NEXT:    s_wait_kmcnt 0x0
...
; GFX13W32-NEXT:    s_load_b32 s2, s[4:5], 0x44
; GFX13W32-NEXT:    s_load_b128 s[8:11], s[4:5], 0x34
; GFX13W32-NEXT:    s_wait_kmcnt 0x0
...
; GFX13W64-NEXT:    s_wait_kmcnt 0x0
; GFX13W64-NEXT:    global_store_b32 v2, v0, s[0:1] scope:SCOPE_SE
; GFX13W64-NEXT:    s_endpgm
;
; GFX13W32-LABEL: add_i32_varying_offset:
; GFX13W32:       ; %bb.0: ; %entry
; GFX13W32-NEXT:    v_and_b32_e32 v2, 0x3ff, v0
; GFX13W32-NEXT:    v_mbcnt_lo_u32_b32 v3, -1, 0
; GFX13W32-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13W32-NEXT:    v_wave_match_b32 v0, v2, v2
; GFX13W32-NEXT:    v_clz_i32_u32_e32 v1, v0
; GFX13W32-NEXT:    v_exclusive_scan_sum_i32 v0, 1, v0
; GFX13W32-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13W32-NEXT:    v_sub_nc_u32_e32 v1, 31, v1
; GFX13W32-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v3, v1
; GFX13W32-NEXT:    ; implicit-def: $vgpr3
; GFX13W32-NEXT:    s_and_saveexec_b32 s0, vcc_lo
; GFX13W32-NEXT:    s_cbranch_execz .LBB4_2
; GFX13W32-NEXT:  ; %bb.1:
; GFX13W32-NEXT:    s_load_b128 s[8:11], s[4:5], 0x34
; GFX13W32-NEXT:    v_add_nc_u32_e32 v3, 1, v0
; GFX13W32-NEXT:    s_wait_kmcnt 0x0
; GFX13W32-NEXT:    buffer_atomic_add_u32 v3, v2, s[8:11], null offen th:TH_ATOMIC_RETURN
; GFX13W32-NEXT:  .LBB4_2:
; GFX13W32-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13W32-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13W32-NEXT:    s_wait_loadcnt 0x0
; GFX13W32-NEXT:    v_bpermute_b32 v1, v3, v1
; GFX13W32-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13W32-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_add_nc_u32 v0, v1, v0
; GFX13W32-NEXT:    s_wait_kmcnt 0x0
; GFX13W32-NEXT:    global_store_b32 v2, v0, s[0:1] scope:SCOPE_SE
; GFX13W32-NEXT:    s_endpgm
entry:
  %lane = call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX13W32-NEXT:    ; implicit-def: $vgpr3
; GFX13W32-NEXT:    s_and_saveexec_b32 s0, vcc_lo
; GFX13W32-NEXT:    s_cbranch_execz .LBB8_2
; GFX13W32-NEXT:  ; %bb.1:
; GFX13W32-NEXT:    s_load_b128 s[8:11], s[4:5], 0x34
; GFX13W32-NEXT:    v_add_nc_u32_e32 v3, 1, v0
; GFX13W32-NEXT:    s_wait_kmcnt 0x0
; GFX13W32-NEXT:    buffer_atomic_sub_u32 v3, v2, s[8:11], null offen th:TH_ATOMIC_RETURN
; GFX13W32-NEXT:  .LBB8_2:
; GFX13W32-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13W32-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13W32-NEXT:    s_wait_loadcnt 0x0
; GFX13W32-NEXT:    v_bpermute_b32 v1, v3, v1
; GFX13W32-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13W32-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_sub_nc_u32 v0, v1, v0
; GFX13W32-NEXT:    s_wait_kmcnt 0x0
; GFX13W32-NEXT:    global_store_b32 v2, v0, s[0:1] scope:SCOPE_SE
; GFX13W32-NEXT:    s_endpgm
entry:
