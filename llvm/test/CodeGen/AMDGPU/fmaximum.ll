...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_maximum_f32 v0, s0, s1
; GCN-NEXT:    ; return to shader part epilog
;
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GCN-LABEL: test_fmaximum_nsz_f32:
; GCN:       ; %bb.0:
; GCN-NEXT:    v_maximum_f32 v0, v0, v1
; GCN-NEXT:    ; return to shader part epilog
;
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GCN-LABEL: test_fmaximum_signed_zero_f32:
; GCN:       ; %bb.0:
...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_maximum_f32 v0, s0, s2
; GCN-NEXT:    v_maximum_f32 v1, s1, s3
; GCN-NEXT:    ; return to shader part epilog
;
...
; GCN-NEXT:    global_load_b32 v1, v0, s[2:3] glc dlc
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    global_load_b32 v2, v0, s[4:5] glc dlc
; GCN-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GCN-LABEL: test_fmaximum_f32_ieee_on:
; GCN:       ; %bb.0:
; GCN-NEXT:    v_maximum_f32 v0, v0, v1
; GCN-NEXT:    ; return to shader part epilog
;
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GCN-LABEL: test_fmaximum_f32_ieee_off:
; GCN:       ; %bb.0:
; GCN-NEXT:    v_maximum_f32 v0, v0, v1
; GCN-NEXT:    ; return to shader part epilog
;
