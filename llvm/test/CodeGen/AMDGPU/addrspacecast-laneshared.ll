...
; SDAG-NEXT:    s_wait_rtscnt 0x0
; SDAG-NEXT:    s_wait_kmcnt 0x0
; SDAG-NEXT:    s_mov_b32 s0, src_flat_scratch_base_lo
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; SDAG-NEXT:    v_subrev_nc_u32_e32 v2, s0, v0
; SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; SDAG-NEXT:    v_cndmask_b32_e32 v0, -1, v2, vcc_lo
; SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
; GISEL-LABEL: flat_to_laneshared:
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GISEL-NEXT:    s_wait_expcnt 0x0
; GISEL-NEXT:    s_wait_samplecnt 0x0
; GISEL-NEXT:    s_wait_rtscnt 0x0
; GISEL-NEXT:    s_wait_kmcnt 0x0
; GISEL-NEXT:    v_mov_b32_e32 v2, src_flat_scratch_base_lo
; GISEL-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[0:1]
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GISEL-NEXT:    v_sub_nc_u32_e32 v2, v0, v2
; GISEL-NEXT:    v_cndmask_b32_e32 v0, -1, v2, vcc_lo
; GISEL-NEXT:    s_set_pc_i64 s[30:31]
