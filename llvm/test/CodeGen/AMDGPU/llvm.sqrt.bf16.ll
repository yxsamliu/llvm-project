...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1260 -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX12-TRUE16 %s
...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1260 -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX12-FAKE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1300 -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX13-TRUE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1300 -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX13-FAKE16 %s
...
;
; GFX13-TRUE16-LABEL: sqrt_bf16:
; GFX13-TRUE16:       ; %bb.0: ; %entry
; GFX13-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX13-TRUE16-NEXT:    s_mov_b32 s6, -1
; GFX13-TRUE16-NEXT:    s_mov_b32 s7, 0x31016000
; GFX13-TRUE16-NEXT:    s_mov_b32 s10, s6
; GFX13-TRUE16-NEXT:    s_mov_b32 s11, s7
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    s_mov_b32 s8, s2
; GFX13-TRUE16-NEXT:    s_mov_b32 s9, s3
; GFX13-TRUE16-NEXT:    s_mov_b32 s4, s0
; GFX13-TRUE16-NEXT:    buffer_load_u16 v0, off, s[8:11], null
; GFX13-TRUE16-NEXT:    s_mov_b32 s5, s1
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-TRUE16-NEXT:    v_sqrt_bf16_e32 v0.l, v0.l
; GFX13-TRUE16-NEXT:    buffer_store_b16 v0, off, s[4:7], null
...
; GFX13-FAKE16-NEXT:    s_mov_b32 s6, -1
; GFX13-FAKE16-NEXT:    s_mov_b32 s7, 0x31016000
; GFX13-FAKE16-NEXT:    s_mov_b32 s10, s6
; GFX13-FAKE16-NEXT:    s_mov_b32 s11, s7
; GFX13-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-FAKE16-NEXT:    s_mov_b32 s8, s2
; GFX13-FAKE16-NEXT:    s_mov_b32 s9, s3
; GFX13-FAKE16-NEXT:    s_mov_b32 s4, s0
; GFX13-FAKE16-NEXT:    buffer_load_u16 v0, off, s[8:11], null
; GFX13-FAKE16-NEXT:    s_mov_b32 s5, s1
; GFX13-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-FAKE16-NEXT:    v_sqrt_bf16_e32 v0, v0
; GFX13-FAKE16-NEXT:    buffer_store_b16 v0, off, s[4:7], null
...
; GFX12-FAKE16-NEXT:    s_endpgm
;
; GFX13-TRUE16-LABEL: sqrt_v2bf16:
; GFX13-TRUE16:       ; %bb.0: ; %entry
; GFX13-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX13-TRUE16-NEXT:    s_mov_b32 s6, -1
; GFX13-TRUE16-NEXT:    s_mov_b32 s7, 0x31016000
...
; GFX13-TRUE16-NEXT:    s_mov_b32 s9, s3
; GFX13-TRUE16-NEXT:    s_mov_b32 s4, s0
; GFX13-TRUE16-NEXT:    buffer_load_b32 v0, off, s[8:11], null
; GFX13-TRUE16-NEXT:    s_mov_b32 s5, s1
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, 16, v0
; GFX13-TRUE16-NEXT:    v_sqrt_bf16_e32 v0.l, v0.l
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-TRUE16-NEXT:    v_sqrt_bf16_e32 v0.h, v1.l
; GFX13-TRUE16-NEXT:    buffer_store_b32 v0, off, s[4:7], null
; GFX13-TRUE16-NEXT:    s_endpgm
;
; GFX13-FAKE16-LABEL: sqrt_v2bf16:
; GFX13-FAKE16:       ; %bb.0: ; %entry
; GFX13-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX13-FAKE16-NEXT:    s_mov_b32 s6, -1
; GFX13-FAKE16-NEXT:    s_mov_b32 s7, 0x31016000
...
; GFX13-FAKE16-NEXT:    s_mov_b32 s9, s3
; GFX13-FAKE16-NEXT:    s_mov_b32 s4, s0
; GFX13-FAKE16-NEXT:    buffer_load_b32 v0, off, s[8:11], null
; GFX13-FAKE16-NEXT:    s_mov_b32 s5, s1
; GFX13-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-FAKE16-NEXT:    v_sqrt_bf16_e32 v1, v0
; GFX13-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; GFX13-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_2)
; GFX13-FAKE16-NEXT:    v_sqrt_bf16_e32 v0, v0
; GFX13-FAKE16-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX13-FAKE16-NEXT:    s_delay_alu instid0(TRANS32_DEP_1) | instid1(VALU_DEP_1)
; GFX13-FAKE16-NEXT:    v_lshl_or_b32 v0, v0, 16, v1
; GFX13-FAKE16-NEXT:    buffer_store_b32 v0, off, s[4:7], null
; GFX13-FAKE16-NEXT:    s_endpgm
entry:
