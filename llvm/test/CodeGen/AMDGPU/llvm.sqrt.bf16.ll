...
; GFX13-TRUE16-NEXT:    s_mov_b32 s5, s1
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-TRUE16-NEXT:    v_sqrt_bf16_e32 v1.l, v0.l
; GFX13-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_2)
; GFX13-TRUE16-NEXT:    v_sqrt_bf16_e32 v0.l, v0.l
; GFX13-TRUE16-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(TRANS32_DEP_1) | instid1(VALU_DEP_1)
; GFX13-TRUE16-NEXT:    v_lshl_or_b32 v0, v0, 16, v1
