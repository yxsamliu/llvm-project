...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1260 %s -o - | FileCheck -check-prefix=GFX1250-SDAG %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 -global-isel %s -o - | FileCheck -check-prefix=GFX1250-GISEL %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1260 -global-isel %s -o - | FileCheck -check-prefix=GFX1250-GISEL %s
