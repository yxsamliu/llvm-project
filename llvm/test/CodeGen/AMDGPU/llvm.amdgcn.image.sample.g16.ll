...
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v4, v2
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v5.l, v1.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v6.l, v0.l
; GFX13-TRUE16-NEXT:    image_sample_d_g16 v[0:3], [v6, v5, v4], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
...
; GFX13-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v6, v5, v4], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
...
; GFX13-TRUE16-NEXT:    image_sample_d_g16 v[0:3], [v7, v6, v4, v5], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX13-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v7, v6, v4, v5], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-TRUE16:       ; %bb.0: ; %main_body
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v9.l, v3.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v9.h, v4.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v2.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v10.l, v0.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v10.h, v1.l
; GFX13-TRUE16-NEXT:    image_sample_d_g16 v[0:3], [v10, v4, v9, v[5:8]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_3D
; GFX13-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-TRUE16-NEXT:    ; return to shader part epilog
;
; GFX13-FAKE16-LABEL: sample_d_3d:
; GFX13-FAKE16:       ; %bb.0: ; %main_body
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v9, v2
; GFX13-FAKE16-NEXT:    v_perm_b32 v4, v4, v3, 0x5040100
; GFX13-FAKE16-NEXT:    v_perm_b32 v10, v1, v0, 0x5040100
; GFX13-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v10, v9, v4, v[5:8]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_3D
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-TRUE16-NEXT:    image_sample_c_d_g16 v[0:3], [v5, v7, v6, v4], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX13-FAKE16-NEXT:    image_sample_c_d_g16 v[0:3], [v7, v6, v5, v4], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v8.l, v3.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v8.h, v4.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v1.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v4.h, v2.l
; GFX13-TRUE16-NEXT:    image_sample_c_d_g16 v[0:3], [v7, v4, v8, v[5:6]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v7, v0
; GFX13-FAKE16-NEXT:    v_perm_b32 v4, v4, v3, 0x5040100
; GFX13-FAKE16-NEXT:    v_perm_b32 v8, v2, v1, 0x5040100
; GFX13-FAKE16-NEXT:    image_sample_c_d_g16 v[0:3], [v7, v8, v4, v[5:6]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-TRUE16:       ; %bb.0: ; %main_body
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v4, v3
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v5, v2
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v6.l, v1.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v7.l, v0.l
; GFX13-TRUE16-NEXT:    image_sample_d_cl_g16 v[0:3], [v7, v6, v5, v4], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v6, v1
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v7, v0
; GFX13-FAKE16-NEXT:    image_sample_d_cl_g16 v[0:3], [v7, v6, v5, v4], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-TRUE16:       ; %bb.0: ; %main_body
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v7.l, v2.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v7.h, v3.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v8.l, v0.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v8.h, v1.l
; GFX13-TRUE16-NEXT:    image_sample_d_cl_g16 v[0:3], [v8, v7, v4, v[5:6]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX13-FAKE16-NEXT:    v_perm_b32 v8, v1, v0, 0x5040100
; GFX13-FAKE16-NEXT:    image_sample_d_cl_g16 v[0:3], [v8, v7, v4, v[5:6]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-TRUE16:       ; %bb.0: ; %main_body
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v5, v4
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v4, v3
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v6, v0
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v7.l, v2.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v8.l, v1.l
; GFX13-TRUE16-NEXT:    image_sample_c_d_cl_g16 v[0:3], [v6, v8, v7, v[4:5]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v4, v3
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v6, v2
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v7, v1
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v8, v0
; GFX13-FAKE16-NEXT:    image_sample_c_d_cl_g16 v[0:3], [v8, v7, v6, v[4:5]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v1.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v4.h, v2.l
; GFX13-TRUE16-NEXT:    image_sample_c_d_cl_g16 v[0:3], [v8, v4, v9, v[5:7]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX13-FAKE16-NEXT:    image_sample_c_d_cl_g16 v[0:3], [v8, v9, v4, v[5:7]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-TRUE16:       ; %bb.0: ; %main_body
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v9, v5
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v5.l, v4.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v2.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v4.h, v3.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v5.h, v9.l
; GFX13-TRUE16-NEXT:    image_sample_c_d_o_g16 v2, [v0, v1, v4, v[5:8]], s[0:7], s[8:11] dmask:0x4 dim:SQ_RSRC_IMG_2D_ARRAY
; GFX13-TRUE16-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-FAKE16-NEXT:    image_sample_c_d_o_g16 v2, [v0, v1, v3, v[5:8]], s[0:7], s[8:11] dmask:0x4 dim:SQ_RSRC_IMG_2D_ARRAY
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-TRUE16:       ; %bb.0: ; %main_body
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v9, v5
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v10, v1
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v11, v0
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v5.l, v4.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v2.h, v3.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v5.h, v9.l
; GFX13-TRUE16-NEXT:    image_sample_c_d_o_g16 v[0:1], [v11, v10, v2, v[5:8]], s[0:7], s[8:11] dmask:0x6 dim:SQ_RSRC_IMG_2D_ARRAY
; GFX13-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX13-FAKE16-NEXT:    image_sample_c_d_o_g16 v[0:1], [v10, v9, v2, v[5:8]], s[0:7], s[8:11] dmask:0x6 dim:SQ_RSRC_IMG_2D_ARRAY
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX13-FAKE16-NEXT:    ; return to shader part epilog
main_body:
