...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1260 < %s | FileCheck --check-prefixes=GCN,SDAG %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1250 < %s | FileCheck --check-prefixes=GCN,GISEL %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1260 < %s | FileCheck --check-prefixes=GCN,GISEL %s
