...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_minimum_f32 v0, s0, s1
; GCN-NEXT:    ; return to shader part epilog
;
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GCN-LABEL: test_fminimum_nsz_f32:
; GCN:       ; %bb.0:
; GCN-NEXT:    v_minimum_f32 v0, v0, v1
; GCN-NEXT:    ; return to shader part epilog
;
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GCN-LABEL: test_fminimum_signed_zero_f32:
; GCN:       ; %bb.0:
...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_minimum_f32 v0, s0, s2
; GCN-NEXT:    v_minimum_f32 v1, s1, s3
; GCN-NEXT:    ; return to shader part epilog
;
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GCN-LABEL: test_fminimum_f32_ieee_on:
; GCN:       ; %bb.0:
; GCN-NEXT:    v_minimum_f32 v0, v0, v1
; GCN-NEXT:    ; return to shader part epilog
;
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GCN-LABEL: test_fminimum_f32_ieee_off:
; GCN:       ; %bb.0:
; GCN-NEXT:    v_minimum_f32 v0, v0, v1
; GCN-NEXT:    ; return to shader part epilog
;
