...
; GCN-NEXT:    v_mov_b32_e32 v0, s6
; GCN-NEXT:    v_cndmask_b32_e32 v2, -1, v0, vcc
; GCN-NEXT:    v_mov_b32_e32 v0, s5
; GCN-NEXT:    v_cndmask_b32_e32 v1, -1, v0, vcc
; GCN-NEXT:    v_mov_b32_e32 v0, s4
...
; GCN-NEXT:    v_cndmask_b32_e64 v3, 14, 7, s[0:1]
; GCN-NEXT:    v_cndmask_b32_e64 v2, 10, 6, s[0:1]
; GCN-NEXT:    v_cndmask_b32_e64 v1, 6, 5, s[0:1]
; GCN-NEXT:    v_cndmask_b32_e64 v0, 2, 9, s[0:1]
; GCN-NEXT:    global_store_dwordx4 v4, v[0:3], s[2:3]
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    s_load_dword s4, s[0:1], 0x2c
; GCN-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
; GCN-NEXT:    v_mov_b32_e32 v0, 0x40c00000
; GCN-NEXT:    v_mov_b32_e32 v1, 0x41500000
; GCN-NEXT:    v_mov_b32_e32 v4, 0
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_bitcmp1_b32 s4, 0
; GCN-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GCN-NEXT:    v_cndmask_b32_e64 v0, 0, 1.0, vcc
; GCN-NEXT:    global_store_dwordx4 v4, v[0:3], s[2:3]
; GCN-NEXT:    s_endpgm
