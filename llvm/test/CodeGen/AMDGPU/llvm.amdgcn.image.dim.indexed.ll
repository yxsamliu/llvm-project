...
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v7, v4, s[2:3]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_mov_b32 s2, s1
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v9, v4, s[2:3]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v5, v3, s[2:3]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v3, v1, s[2:3]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
