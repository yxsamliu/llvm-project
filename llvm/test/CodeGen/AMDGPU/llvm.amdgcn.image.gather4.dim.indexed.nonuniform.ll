...
; GFX13-NEXT:    v_mov_b32_e32 v4, v0 ; encoding: [0x00,0x03,0x08,0x7e]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4 v[0:3], [v6, v5], v4, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x50,0xe4,0x00,0x08,0x02,0x00,0x06,0x05,0x00,0x00]
...
; GFX13-NEXT:    s_mov_b32 s4, exec_lo ; encoding: [0x7e,0x03,0x84,0xbe]
; GFX13-NEXT:    s_wqm_b32 exec_lo, exec_lo ; encoding: [0x7e,0x09,0xfe,0xbe]
; GFX13-NEXT:    v_dual_mov_b32 v5, v0 :: v_dual_mov_b32 v0, 0 ; encoding: [0x00,0x01,0x10,0xca,0x80,0x00,0x00,0x05]
...
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4 v[0:4], [v7, v6], v5, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D tfe ; encoding: [0x09,0x00,0x50,0xe4,0x00,0x0a,0x02,0x00,0x07,0x06,0x00,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_mov_b32 v4, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x04,0x07]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4 v[0:3], [v7, v6, v5], v4, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_CUBE ; encoding: [0x03,0x00,0x50,0xe4,0x00,0x08,0x02,0x00,0x07,0x06,0x05,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_mov_b32 v4, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x04,0x07]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4 v[0:3], [v7, v6, v5], v4, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D_ARRAY ; encoding: [0x05,0x00,0x50,0xe4,0x00,0x08,0x02,0x00,0x07,0x06,0x05,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_mov_b32 v4, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x04,0x07]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_c v[0:3], [v7, v6, v5], v4, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x52,0xe4,0x00,0x08,0x02,0x00,0x07,0x06,0x05,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_mov_b32 v4, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x04,0x07]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_cl v[0:3], [v7, v6, v5], v4, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x40,0x50,0xe4,0x00,0x08,0x02,0x00,0x07,0x06,0x05,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_mov_b32 s4, exec_lo ; encoding: [0x7e,0x03,0x84,0xbe]
; GFX13-NEXT:    s_wqm_b32 exec_lo, exec_lo ; encoding: [0x7e,0x09,0xfe,0xbe]
; GFX13-NEXT:    v_dual_mov_b32 v6, v3 :: v_dual_mov_b32 v7, v2 ; encoding: [0x03,0x01,0x10,0xca,0x02,0x01,0x06,0x06]
; GFX13-NEXT:    v_dual_mov_b32 v8, v1 :: v_dual_mov_b32 v5, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x04,0x08]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_c_cl v[0:3], [v8, v7, v6, v4], v5, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x40,0x52,0xe4,0x00,0x0a,0x02,0x00,0x08,0x07,0x06,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_mov_b32 v4, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x04,0x07]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_b v[0:3], [v7, v6, v5], v4, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x40,0x51,0xe4,0x00,0x08,0x02,0x00,0x07,0x06,0x05,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_dual_mov_b32 v8, v1 :: v_dual_mov_b32 v5, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x04,0x08]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_c_b v[0:3], [v8, v7, v6, v4], v5, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x40,0x53,0xe4,0x00,0x0a,0x02,0x00,0x08,0x07,0x06,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_dual_mov_b32 v8, v1 :: v_dual_mov_b32 v5, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x04,0x08]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_b_cl v[0:3], [v8, v7, v6, v4], v5, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x80,0x51,0xe4,0x00,0x0a,0x02,0x00,0x08,0x07,0x06,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_mov_b32 s4, exec_lo ; encoding: [0x7e,0x03,0x84,0xbe]
; GFX13-NEXT:    s_wqm_b32 exec_lo, exec_lo ; encoding: [0x7e,0x09,0xfe,0xbe]
; GFX13-NEXT:    v_dual_mov_b32 v7, v3 :: v_dual_mov_b32 v8, v2 ; encoding: [0x03,0x01,0x10,0xca,0x02,0x01,0x08,0x07]
; GFX13-NEXT:    v_dual_mov_b32 v9, v1 :: v_dual_mov_b32 v6, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x06,0x09]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_c_b_cl v[0:3], [v9, v8, v7, v[4:5]], v6, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x80,0x53,0xe4,0x00,0x0c,0x02,0x00,0x09,0x08,0x07,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_gather4_l v[4:7], [v1, v2, v3], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x51,0xe4,0x04,0x00,0x02,0x00,0x01,0x02,0x03,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5 ; encoding: [0x04,0x01,0x10,0xca,0x05,0x01,0x00,0x00]
; GFX13-NEXT:    v_dual_mov_b32 v2, v6 :: v_dual_mov_b32 v3, v7 ; encoding: [0x06,0x01,0x10,0xca,0x07,0x01,0x02,0x02]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_gather4_c_l v[5:8], [v1, v2, v3, v4], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x53,0xe4,0x05,0x00,0x02,0x00,0x01,0x02,0x03,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    v_dual_mov_b32 v0, v5 :: v_dual_mov_b32 v1, v6 ; encoding: [0x05,0x01,0x10,0xca,0x06,0x01,0x00,0x00]
; GFX13-NEXT:    v_dual_mov_b32 v2, v7 :: v_dual_mov_b32 v3, v8 ; encoding: [0x07,0x01,0x10,0xca,0x08,0x01,0x02,0x02]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_gather4_lz v[3:6], [v1, v2], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0xc0,0x51,0xe4,0x03,0x00,0x02,0x00,0x01,0x02,0x00,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    v_dual_mov_b32 v0, v3 :: v_dual_mov_b32 v1, v4 ; encoding: [0x03,0x01,0x10,0xca,0x04,0x01,0x00,0x00]
; GFX13-NEXT:    v_dual_mov_b32 v2, v5 :: v_dual_mov_b32 v3, v6 ; encoding: [0x05,0x01,0x10,0xca,0x06,0x01,0x02,0x02]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_gather4_c_lz v[4:7], [v1, v2, v3], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0xc0,0x53,0xe4,0x04,0x00,0x02,0x00,0x01,0x02,0x03,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5 ; encoding: [0x04,0x01,0x10,0xca,0x05,0x01,0x00,0x00]
; GFX13-NEXT:    v_dual_mov_b32 v2, v6 :: v_dual_mov_b32 v3, v7 ; encoding: [0x06,0x01,0x10,0xca,0x07,0x01,0x02,0x02]
; GFX13-NEXT:    ; return to shader part epilog
...
; GFX13-NEXT:    v_mov_b32_e32 v4, v0 ; encoding: [0x00,0x03,0x08,0x7e]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4 v[0:3], [v6, v5], v4, s[0:3] dmask:0x2 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x90,0xe4,0x00,0x08,0x02,0x00,0x06,0x05,0x00,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_mov_b32_e32 v4, v0 ; encoding: [0x00,0x03,0x08,0x7e]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4 v[0:3], [v6, v5], v4, s[0:3] dmask:0x4 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x10,0xe5,0x00,0x08,0x02,0x00,0x06,0x05,0x00,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_mov_b32_e32 v4, v0 ; encoding: [0x00,0x03,0x08,0x7e]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4 v[0:3], [v6, v5], v4, s[0:3] dmask:0x8 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x10,0xe6,0x00,0x08,0x02,0x00,0x06,0x05,0x00,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
