...
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_c_cl v[0:3], [v7, v6, v5, v4], v8, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x40,0x52,0xe4,0x00,0x10,0x02,0x00,0x07,0x06,0x05,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_mov_b32 v8, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x08,0x07]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_c_b v[0:3], [v7, v6, v5, v4], v8, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x40,0x53,0xe4,0x00,0x10,0x02,0x00,0x07,0x06,0x05,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_mov_b32 v8, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x08,0x07]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_b_cl v[0:3], [v7, v6, v5, v4], v8, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x80,0x51,0xe4,0x00,0x10,0x02,0x00,0x07,0x06,0x05,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_dual_mov_b32 v5, v3 :: v_dual_mov_b32 v6, v2 ; encoding: [0x03,0x01,0x10,0xca,0x02,0x01,0x06,0x05]
; GFX13-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_mov_b32 v8, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x08,0x07]
; GFX13-NEXT:    image_gather4_c_l v[0:3], [v7, v6, v5, v4], v8, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x53,0xe4,0x00,0x10,0x02,0x00,0x07,0x06,0x05,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
