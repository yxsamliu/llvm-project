...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 | FileCheck -check-prefixes=GFX1250,GFX1250-TRUE16 %s
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1260 -mattr=+real-true16 | FileCheck -check-prefixes=GFX1260,GFX1260-TRUE16 %s
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 | FileCheck -check-prefixes=GFX1250,GFX1250-FAKE16 %s
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1260 -mattr=-real-true16 | FileCheck -check-prefixes=GFX1260,GFX1260-FAKE16 %s
...
; GFX1250-NEXT:    buffer_store_b128 v[0:3], v12, s[0:3], null idxen
; GFX1250-NEXT:    buffer_store_b128 v[4:7], v12, s[0:3], null idxen th:TH_STORE_NT
; GFX1250-NEXT:    buffer_store_b128 v[8:11], v12, s[0:3], null idxen th:TH_STORE_HT
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: buffer_store:
...
; GFX1260-NEXT:    buffer_store_b128 v[0:3], v12, s[0:3], null idxen
; GFX1260-NEXT:    buffer_store_b128 v[4:7], v12, s[0:3], null idxen th:TH_STORE_NT
; GFX1260-NEXT:    buffer_store_b128 v[8:11], v12, s[0:3], null idxen th:TH_STORE_HT
...
; GFX1250-NEXT:    buffer_store_b128 v[0:3], v4, s[0:3], null idxen offset:42
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: buffer_store_immoffs:
; GFX1260:       ; %bb.0: ; %main_body
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v4, 0
; GFX1260-NEXT:    buffer_store_b128 v[0:3], v4, s[0:3], null idxen offset:42
; GFX1260-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_endpgm
;
; GFX1250-LABEL: buffer_store_idx:
; GFX1250:       ; %bb.0: ; %main_body
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-NEXT:    buffer_store_b128 v[0:3], v4, s[0:3], null idxen
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: buffer_store_idx:
; GFX1260:       ; %bb.0: ; %main_body
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    buffer_store_b128 v[0:3], v4, s[0:3], null idxen
; GFX1260-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    buffer_store_b128 v[0:3], v[4:5], s[0:3], null idxen offen
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: buffer_store_ofs:
; GFX1260:       ; %bb.0: ; %main_body
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v5, v4
; GFX1260-NEXT:    v_mov_b32_e32 v4, 0
; GFX1260-NEXT:    buffer_store_b128 v[0:3], v[4:5], s[0:3], null idxen offen
; GFX1260-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_endpgm
;
; GFX1250-LABEL: buffer_store_both:
; GFX1250:       ; %bb.0: ; %main_body
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-NEXT:    buffer_store_b128 v[0:3], v[4:5], s[0:3], null idxen offen
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: buffer_store_both:
; GFX1260:       ; %bb.0: ; %main_body
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    buffer_store_b128 v[0:3], v[4:5], s[0:3], null idxen offen
; GFX1260-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_endpgm
;
; GFX1250-LABEL: buffer_store_both_reversed:
; GFX1250:       ; %bb.0: ; %main_body
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-NEXT:    v_dual_mov_b32 v6, v5 :: v_dual_mov_b32 v7, v4
; GFX1250-NEXT:    buffer_store_b128 v[0:3], v[6:7], s[0:3], null idxen offen
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: buffer_store_both_reversed:
; GFX1260:       ; %bb.0: ; %main_body
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v6, v5
; GFX1260-NEXT:    v_mov_b32_e32 v7, v4
; GFX1260-NEXT:    buffer_store_b128 v[0:3], v[6:7], s[0:3], null idxen offen
; GFX1260-NEXT:    s_endpgm
;
; GFX13-LABEL: buffer_store_both_reversed:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_mov_b32_e32 v6, v4
; GFX13-NEXT:    buffer_store_b128 v[0:3], v[5:6], s[0:3], null idxen offen
; GFX13-NEXT:    s_endpgm
...
; GFX1250-NEXT:    buffer_store_b128 v[0:3], v4, s[0:3], null idxen
; GFX1250-NEXT:    buffer_load_b128 v[0:3], v5, s[0:3], null idxen
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    buffer_store_b128 v[0:3], v6, s[0:3], null idxen
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: buffer_store_wait:
; GFX1260:       ; %bb.0: ; %main_body
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    s_clause 0x1
; GFX1260-NEXT:    buffer_store_b128 v[0:3], v4, s[0:3], null idxen
; GFX1260-NEXT:    buffer_load_b128 v[0:3], v5, s[0:3], null idxen
; GFX1260-NEXT:    s_wait_loadcnt 0x0
; GFX1260-NEXT:    buffer_store_b128 v[0:3], v6, s[0:3], null idxen
; GFX1260-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: buffer_store_x1:
; GFX1260:       ; %bb.0: ; %main_body
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    buffer_store_b32 v0, v1, s[0:3], null idxen
; GFX1260-NEXT:    s_endpgm
;
...
; GFX1250:       ; %bb.0: ; %main_body
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-NEXT:    buffer_store_b64 v[0:1], v2, s[0:3], null idxen
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: buffer_store_x2:
; GFX1260:       ; %bb.0: ; %main_body
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    buffer_store_b64 v[0:1], v2, s[0:3], null idxen
; GFX1260-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    s_clause 0x2
; GFX1250-NEXT:    buffer_store_b128 v[0:3], v7, s[0:3], null idxen
; GFX1250-NEXT:    buffer_store_b64 v[4:5], v7, s[0:3], null idxen th:TH_STORE_NT
; GFX1250-NEXT:    buffer_store_b32 v6, v7, s[0:3], null idxen th:TH_STORE_HT
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: buffer_store_int:
; GFX1260:       ; %bb.0: ; %main_body
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v7, 0
; GFX1260-NEXT:    s_clause 0x2
; GFX1260-NEXT:    buffer_store_b128 v[0:3], v7, s[0:3], null idxen
; GFX1260-NEXT:    buffer_store_b64 v[4:5], v7, s[0:3], null idxen th:TH_STORE_NT
; GFX1260-NEXT:    buffer_store_b32 v6, v7, s[0:3], null idxen th:TH_STORE_HT
; GFX1260-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_endpgm
;
; GFX1250-LABEL: struct_buffer_store_byte:
; GFX1250:       ; %bb.0: ; %main_body
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX1250-NEXT:    buffer_store_b8 v0, v1, s[0:3], null idxen
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: struct_buffer_store_byte:
; GFX1260:       ; %bb.0: ; %main_body
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX1260-NEXT:    buffer_store_b8 v0, v1, s[0:3], null idxen
; GFX1260-NEXT:    s_endpgm
;
...
;
; GFX1250-TRUE16-LABEL: struct_buffer_store_f16:
; GFX1250-TRUE16:       ; %bb.0:
...
; GFX1250-TRUE16-NEXT:    buffer_store_b16 v0, v1, s[0:3], null idxen
; GFX1250-TRUE16-NEXT:    s_endpgm
;
; GFX1260-TRUE16-LABEL: struct_buffer_store_f16:
; GFX1260-TRUE16:       ; %bb.0:
...
; GFX1260-TRUE16-NEXT:    v_cvt_f16_f32_e32 v0.l, v0
; GFX1260-TRUE16-NEXT:    buffer_store_b16 v0, v1, s[0:3], null idxen
; GFX1260-TRUE16-NEXT:    s_endpgm
;
; GFX1250-FAKE16-LABEL: struct_buffer_store_f16:
; GFX1250-FAKE16:       ; %bb.0:
...
; GFX1250-FAKE16-NEXT:    buffer_store_b16 v0, v1, s[0:3], null idxen
; GFX1250-FAKE16-NEXT:    s_endpgm
;
; GFX1260-FAKE16-LABEL: struct_buffer_store_f16:
; GFX1260-FAKE16:       ; %bb.0:
...
; GFX11-NEXT:    s_endpgm
;
; GFX1250-LABEL: struct_buffer_store_v2f16:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-NEXT:    buffer_store_b32 v0, v1, s[0:3], null idxen
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: struct_buffer_store_v2f16:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    buffer_store_b32 v0, v1, s[0:3], null idxen
; GFX1260-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_endpgm
;
; GFX1250-LABEL: struct_buffer_store_v4f16:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-NEXT:    buffer_store_b64 v[0:1], v2, s[0:3], null idxen
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: struct_buffer_store_v4f16:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    buffer_store_b64 v[0:1], v2, s[0:3], null idxen
; GFX1260-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_endpgm
;
; GFX1250-LABEL: struct_buffer_store_i16:
; GFX1250:       ; %bb.0: ; %main_body
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX1250-NEXT:    buffer_store_b16 v0, v1, s[0:3], null idxen
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: struct_buffer_store_i16:
; GFX1260:       ; %bb.0: ; %main_body
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX1260-NEXT:    buffer_store_b16 v0, v1, s[0:3], null idxen
; GFX1260-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_endpgm
;
; GFX1250-LABEL: struct_buffer_store_vif16:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-NEXT:    buffer_store_b32 v0, v1, s[0:3], null idxen
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: struct_buffer_store_vif16:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    buffer_store_b32 v0, v1, s[0:3], null idxen
; GFX1260-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_endpgm
;
; GFX1250-LABEL: struct_buffer_store_v4i16:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-NEXT:    buffer_store_b64 v[0:1], v2, s[0:3], null idxen
; GFX1250-NEXT:    s_endpgm
;
; GFX1260-LABEL: struct_buffer_store_v4i16:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    buffer_store_b64 v[0:1], v2, s[0:3], null idxen
; GFX1260-NEXT:    s_endpgm
