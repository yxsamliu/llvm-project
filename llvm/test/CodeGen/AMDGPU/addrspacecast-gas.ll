...
; GFX1300-GISEL-NEXT:    s_cselect_b32 s0, 1, 0
; GFX1300-GISEL-NEXT:    v_add_co_ci_u32_e64 v1, null, v2, v1, vcc
; GFX1300-GISEL-NEXT:    s_and_b32 s0, 1, s0
; GFX1300-GISEL-NEXT:    v_mov_b32_e32 v2, 0
; GFX1300-GISEL-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s0
...
; GFX1300-NEXT:    s_mov_b32 s2, src_flat_scratch_base_lo
; GFX1300-NEXT:    v_mov_b32_e32 v0, 0
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_sub_co_i32 s2, s0, s2
...
; GFX1300-SDAG-NEXT:    s_mov_b32 s1, src_flat_scratch_base_lo
; GFX1300-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1300-SDAG-NEXT:    s_sub_co_i32 s0, s0, s1
...
; GFX1300-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1300-GISEL-NEXT:    s_mov_b32 s1, src_flat_scratch_base_lo
; GFX1300-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-GISEL-NEXT:    s_sub_co_i32 s0, s0, s1
