...
; VI-NEXT:    v_cndmask_b32_e32 v1, 0, v0, vcc
...
; GFX90A-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX90A-NEXT:    v_cndmask_b32_e32 v1, 0, v0, vcc
...
; VI-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; VI-NEXT:    s_cmp_gt_u32 s4, 5
; VI-NEXT:    s_cselect_b64 vcc, -1, 0
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v0, s3
; VI-NEXT:    v_mov_b32_e32 v2, s2
; VI-NEXT:    v_cndmask_b32_e32 v1, 63, v0, vcc
...
; GFX90A-NEXT:    v_cndmask_b32_e32 v1, 63, v0, vcc
; GFX90A-NEXT:    v_cndmask_b32_e32 v0, 0, v3, vcc
