...
; GFX90A-NEXT:    v_add_co_u32_e64 v6, s[0:1], 2, v0
; GFX90A-NEXT:    v_addc_co_u32_e64 v7, s[0:1], 0, v1, s[0:1]
; GFX90A-NEXT:    v_add_co_u32_e64 v8, s[0:1], 1, v0
; GFX90A-NEXT:    v_addc_co_u32_e64 v9, s[0:1], 0, v1, s[0:1]
; GFX90A-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v4
; GFX90A-NEXT:    v_cndmask_b32_e64 v4, v9, v7, s[0:1]
...
; GFX90A-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
; GFX90A-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x34
; GFX90A-NEXT:    s_movk_i32 s0, 0xf001
; GFX90A-NEXT:    v_mov_b32_e32 v4, 0
; GFX90A-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v0
; GFX90A-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
; GFX90A-NEXT:    v_trunc_f32_e32 v1, v1
...
; GFX90A-NEXT:    v_mul_hi_u32 v2, v0, s0
...
; GFX90A-NEXT:    v_add_co_u32_e32 v2, vcc, 2, v0
; GFX90A-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v1, vcc
; GFX90A-NEXT:    s_movk_i32 s0, 0xfff
; GFX90A-NEXT:    v_add_co_u32_e32 v5, vcc, 1, v0
; GFX90A-NEXT:    v_mul_lo_u32 v7, v1, s0
; GFX90A-NEXT:    v_mul_hi_u32 v8, v0, s0
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v1, vcc
; GFX90A-NEXT:    v_add_u32_e32 v7, v8, v7
; GFX90A-NEXT:    v_mul_lo_u32 v8, v0, s0
; GFX90A-NEXT:    v_sub_co_u32_e32 v8, vcc, s6, v8
; GFX90A-NEXT:    v_subb_co_u32_e32 v7, vcc, v9, v7, vcc
; GFX90A-NEXT:    v_subrev_co_u32_e32 v9, vcc, s0, v8
; GFX90A-NEXT:    v_subbrev_co_u32_e32 v10, vcc, 0, v7, vcc
; GFX90A-NEXT:    s_movk_i32 s0, 0xffe
; GFX90A-NEXT:    v_cmp_lt_u32_e32 vcc, s0, v9
; GFX90A-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc
; GFX90A-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v10
; GFX90A-NEXT:    v_cndmask_b32_e32 v9, -1, v9, vcc
; GFX90A-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v9
; GFX90A-NEXT:    v_cmp_lt_u32_e64 s[0:1], s0, v8
; GFX90A-NEXT:    v_cndmask_b32_e32 v3, v6, v3, vcc
; GFX90A-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s[0:1]
; GFX90A-NEXT:    v_cmp_eq_u32_e64 s[0:1], 0, v7
; GFX90A-NEXT:    v_cndmask_b32_e64 v6, -1, v6, s[0:1]
; GFX90A-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v6
; GFX90A-NEXT:    v_cndmask_b32_e64 v3, v1, v3, s[0:1]
; GFX90A-NEXT:    v_cndmask_b32_e32 v1, v5, v2, vcc
; GFX90A-NEXT:    v_cndmask_b32_e64 v2, v0, v1, s[0:1]
...
; GFX90A-NEXT:    v_cndmask_b32_e32 v1, v1, v3, vcc
; GFX90A-NEXT:    v_cndmask_b32_e64 v3, v5, v4, s[0:1]
; GFX90A-NEXT:    v_cndmask_b32_e32 v0, v0, v3, vcc
; GFX90A-NEXT:    global_store_dwordx2 v2, v[0:1], s[4:5]
; GFX90A-NEXT:    s_endpgm
...
; GFX90A-NEXT:    v_add_co_u32_e32 v0, vcc, v0, v1
; GFX90A-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v3, vcc
; GFX90A-NEXT:    v_add_co_u32_e32 v3, vcc, 2, v0
; GFX90A-NEXT:    v_addc_co_u32_e32 v4, vcc, 0, v1, vcc
; GFX90A-NEXT:    s_mov_b32 s3, 0x12d8fb
; GFX90A-NEXT:    v_add_co_u32_e32 v5, vcc, 1, v0
; GFX90A-NEXT:    v_mul_lo_u32 v7, v1, s3
; GFX90A-NEXT:    v_mul_hi_u32 v8, v0, s3
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v1, vcc
; GFX90A-NEXT:    v_add_u32_e32 v7, v8, v7
; GFX90A-NEXT:    v_mul_lo_u32 v8, v0, s3
; GFX90A-NEXT:    v_mov_b32_e32 v9, s1
; GFX90A-NEXT:    v_sub_co_u32_e32 v8, vcc, s0, v8
; GFX90A-NEXT:    v_subb_co_u32_e32 v7, vcc, v9, v7, vcc
; GFX90A-NEXT:    v_subrev_co_u32_e32 v9, vcc, s3, v8
; GFX90A-NEXT:    v_subbrev_co_u32_e32 v10, vcc, 0, v7, vcc
; GFX90A-NEXT:    s_mov_b32 s0, 0x12d8fa
; GFX90A-NEXT:    v_cmp_lt_u32_e32 vcc, s0, v9
; GFX90A-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc
; GFX90A-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v10
; GFX90A-NEXT:    v_cndmask_b32_e32 v9, -1, v9, vcc
...
; GFX90A-NEXT:    v_cndmask_b32_e64 v0, v0, v3, s[0:1]
; GFX90A-NEXT:    v_cndmask_b32_e64 v1, v1, v4, s[0:1]
; GFX90A-NEXT:    v_xor_b32_e32 v0, s2, v0
; GFX90A-NEXT:    v_xor_b32_e32 v1, s2, v1
...
; GFX90A-NEXT:    v_add_u32_e32 v2, v3, v2
; GFX90A-NEXT:    v_sub_u32_e32 v2, v2, v0
; GFX90A-NEXT:    v_mul_lo_u32 v5, v0, s0
; GFX90A-NEXT:    v_mul_hi_u32 v6, v1, v5
; GFX90A-NEXT:    v_mul_lo_u32 v7, v1, v5
...
; GFX90A-NEXT:    v_add_co_u32_e32 v5, vcc, 1, v0
; GFX90A-NEXT:    v_mul_lo_u32 v7, v1, s6
; GFX90A-NEXT:    v_mul_hi_u32 v8, v0, s6
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v1, vcc
; GFX90A-NEXT:    v_add_u32_e32 v7, v8, v7
; GFX90A-NEXT:    v_mul_lo_u32 v8, v0, s6
; GFX90A-NEXT:    v_mov_b32_e32 v9, s1
; GFX90A-NEXT:    v_sub_co_u32_e32 v8, vcc, s0, v8
; GFX90A-NEXT:    v_subb_co_u32_e32 v7, vcc, v9, v7, vcc
; GFX90A-NEXT:    v_subrev_co_u32_e32 v9, vcc, s6, v8
; GFX90A-NEXT:    v_subbrev_co_u32_e32 v10, vcc, 0, v7, vcc
; GFX90A-NEXT:    s_movk_i32 s0, 0xffe
; GFX90A-NEXT:    v_cmp_lt_u32_e32 vcc, s0, v9
; GFX90A-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc
...
; GFX90A-NEXT:    v_cndmask_b32_e64 v0, v0, v2, s[0:1]
; GFX90A-NEXT:    v_cndmask_b32_e64 v1, v1, v3, s[0:1]
...
; GFX90A-NEXT:    v_mul_hi_u32 v4, s0, v1
; GFX90A-NEXT:    v_mul_lo_u32 v5, s0, v2
; GFX90A-NEXT:    v_mul_lo_u32 v3, s1, v1
; GFX90A-NEXT:    v_add_u32_e32 v4, v4, v5
; GFX90A-NEXT:    v_add_u32_e32 v3, v4, v3
; GFX90A-NEXT:    v_mul_lo_u32 v6, s0, v1
...
; GFX90A-NEXT:    v_addc_co_u32_e32 v2, vcc, v2, v4, vcc
; GFX90A-NEXT:    v_mul_lo_u32 v3, s0, v2
; GFX90A-NEXT:    v_mul_hi_u32 v4, s0, v1
; GFX90A-NEXT:    v_add_u32_e32 v3, v4, v3
; GFX90A-NEXT:    v_mul_lo_u32 v4, s1, v1
; GFX90A-NEXT:    v_add_u32_e32 v3, v3, v4
; GFX90A-NEXT:    v_mul_lo_u32 v5, s0, v1
; GFX90A-NEXT:    v_mul_hi_u32 v6, v2, v5
; GFX90A-NEXT:    v_mul_lo_u32 v7, v2, v5
; GFX90A-NEXT:    v_mul_lo_u32 v9, v1, v3
; GFX90A-NEXT:    v_mul_hi_u32 v5, v1, v5
; GFX90A-NEXT:    v_mul_hi_u32 v8, v1, v3
; GFX90A-NEXT:    v_add_co_u32_e32 v5, vcc, v5, v9
; GFX90A-NEXT:    v_addc_co_u32_e32 v8, vcc, 0, v8, vcc
; GFX90A-NEXT:    v_add_co_u32_e32 v5, vcc, v5, v7
; GFX90A-NEXT:    v_mul_hi_u32 v4, v2, v3
; GFX90A-NEXT:    v_addc_co_u32_e32 v5, vcc, v8, v6, vcc
; GFX90A-NEXT:    v_addc_co_u32_e32 v4, vcc, v4, v0, vcc
; GFX90A-NEXT:    v_mul_lo_u32 v3, v2, v3
; GFX90A-NEXT:    v_add_co_u32_e32 v3, vcc, v5, v3
; GFX90A-NEXT:    v_addc_co_u32_e32 v4, vcc, 0, v4, vcc
...
; GFX90A-NEXT:    v_cndmask_b32_e64 v4, v7, v6, s[0:1]
; GFX90A-NEXT:    v_add_co_u32_e64 v6, s[0:1], 2, v1
; GFX90A-NEXT:    v_addc_co_u32_e64 v7, s[0:1], 0, v2, s[0:1]
; GFX90A-NEXT:    v_add_co_u32_e64 v8, s[0:1], 1, v1
; GFX90A-NEXT:    v_addc_co_u32_e64 v9, s[0:1], 0, v2, s[0:1]
; GFX90A-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v4
; GFX90A-NEXT:    v_cndmask_b32_e64 v4, v9, v7, s[0:1]
...
; GFX90A-NEXT:    s_subb_u32 s1, 0, s9
; GFX90A-NEXT:    s_ashr_i32 s10, s7, 31
; GFX90A-NEXT:    v_mul_hi_u32 v6, s0, v1
; GFX90A-NEXT:    v_mul_lo_u32 v7, s0, v4
; GFX90A-NEXT:    v_mul_lo_u32 v5, s1, v1
; GFX90A-NEXT:    v_add_u32_e32 v6, v6, v7
; GFX90A-NEXT:    v_add_u32_e32 v5, v6, v5
; GFX90A-NEXT:    v_mul_lo_u32 v8, s0, v1
; GFX90A-NEXT:    v_mul_lo_u32 v7, v1, v5
; GFX90A-NEXT:    v_mul_hi_u32 v9, v1, v8
; GFX90A-NEXT:    v_mul_hi_u32 v6, v1, v5
; GFX90A-NEXT:    v_add_co_u32_e32 v7, vcc, v9, v7
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v6, vcc
; GFX90A-NEXT:    v_mul_hi_u32 v10, v4, v8
; GFX90A-NEXT:    v_mul_lo_u32 v8, v4, v8
; GFX90A-NEXT:    v_add_co_u32_e32 v7, vcc, v7, v8
; GFX90A-NEXT:    v_mul_hi_u32 v9, v4, v5
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, v6, v10, vcc
; GFX90A-NEXT:    v_addc_co_u32_e32 v7, vcc, v9, v0, vcc
...
; GFX90A-NEXT:    v_addc_co_u32_e32 v4, vcc, v4, v6, vcc
; GFX90A-NEXT:    v_mul_lo_u32 v5, s0, v4
; GFX90A-NEXT:    v_mul_hi_u32 v6, s0, v1
; GFX90A-NEXT:    v_add_u32_e32 v5, v6, v5
; GFX90A-NEXT:    v_mul_lo_u32 v6, s1, v1
; GFX90A-NEXT:    v_add_u32_e32 v5, v5, v6
; GFX90A-NEXT:    v_mul_lo_u32 v7, s0, v1
; GFX90A-NEXT:    v_mul_hi_u32 v8, v4, v7
; GFX90A-NEXT:    v_mul_lo_u32 v9, v4, v7
; GFX90A-NEXT:    v_mul_lo_u32 v11, v1, v5
; GFX90A-NEXT:    v_mul_hi_u32 v7, v1, v7
; GFX90A-NEXT:    v_mul_hi_u32 v10, v1, v5
...
; GFX90A-NEXT:    v_mul_hi_u32 v6, v4, v5
; GFX90A-NEXT:    v_addc_co_u32_e32 v7, vcc, v10, v8, vcc
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, v6, v0, vcc
; GFX90A-NEXT:    v_mul_lo_u32 v5, v4, v5
; GFX90A-NEXT:    v_add_co_u32_e32 v5, vcc, v7, v5
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, 0, v6, vcc
; GFX90A-NEXT:    s_add_u32 s0, s6, s10
...
; GFX90A-NEXT:    v_addc_co_u32_e32 v4, vcc, v4, v6, vcc
; GFX90A-NEXT:    s_xor_b64 s[6:7], s[0:1], s[10:11]
; GFX90A-NEXT:    v_mul_lo_u32 v6, s6, v4
; GFX90A-NEXT:    v_mul_hi_u32 v7, s6, v1
; GFX90A-NEXT:    v_mul_hi_u32 v5, s6, v4
; GFX90A-NEXT:    v_add_co_u32_e32 v6, vcc, v7, v6
; GFX90A-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v5, vcc
; GFX90A-NEXT:    v_mul_hi_u32 v8, s7, v1
; GFX90A-NEXT:    v_mul_lo_u32 v1, s7, v1
; GFX90A-NEXT:    v_add_co_u32_e32 v1, vcc, v6, v1
; GFX90A-NEXT:    v_mul_hi_u32 v7, s7, v4
; GFX90A-NEXT:    v_addc_co_u32_e32 v1, vcc, v5, v8, vcc
; GFX90A-NEXT:    v_addc_co_u32_e32 v5, vcc, v7, v0, vcc
...
; GFX90A-NEXT:    v_add_co_u32_e64 v8, s[0:1], 2, v1
; GFX90A-NEXT:    v_addc_co_u32_e64 v9, s[0:1], 0, v4, s[0:1]
; GFX90A-NEXT:    v_add_co_u32_e64 v10, s[0:1], 1, v1
; GFX90A-NEXT:    v_addc_co_u32_e64 v11, s[0:1], 0, v4, s[0:1]
; GFX90A-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v6
; GFX90A-NEXT:    v_cndmask_b32_e64 v6, v11, v9, s[0:1]
; GFX90A-NEXT:    v_mov_b32_e32 v9, s7
...
; GFX90A-NEXT:    v_cndmask_b32_e64 v5, v10, v8, s[0:1]
; GFX90A-NEXT:    v_cndmask_b32_e32 v1, v1, v5, vcc
...
; GFX90A-NEXT:    v_cmp_lt_u32_e64 s[0:1], s0, v0
; GFX90A-NEXT:    v_cndmask_b32_e32 v4, v4, v6, vcc
; GFX90A-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s[0:1]
...
; GFX90A-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v6
; GFX90A-NEXT:    v_cndmask_b32_e32 v1, v1, v2, vcc
; GFX90A-NEXT:    v_cndmask_b32_e64 v2, v5, v3, s[0:1]
...
; GFX90A-NEXT:    v_cndmask_b32_e32 v3, v3, v5, vcc
; GFX90A-NEXT:    v_cndmask_b32_e64 v5, v7, v6, s[0:1]
; GFX90A-NEXT:    v_cndmask_b32_e32 v2, v2, v5, vcc
