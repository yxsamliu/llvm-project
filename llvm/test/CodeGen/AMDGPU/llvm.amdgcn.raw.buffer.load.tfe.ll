...
=======
;
; GFX1260-LABEL: raw_buffer_load_i8_tfe:
; GFX1260:       ; %bb.0:
...
; GFX1260-NEXT:    buffer_load_u8 v[4:5], off, s[0:3], null tfe
...
; GFX13-NEXT:    buffer_load_u8 v[4:5], off, s[0:3], null tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b8 v[0:1], v4, off
; GFX13-NEXT:    global_store_b32 v[2:3], v5, off
; GFX13-NEXT:    s_endpgm
...
=======
;
; GFX1260-LABEL: raw_buffer_load_i16_tfe:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v4, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_mov_b32_e32 v5, v4
; GFX1260-NEXT:    buffer_load_u16 v[4:5], off, s[0:3], null tfe
; GFX1260-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_mov_b32_e32 v5, v4
; GFX13-NEXT:    buffer_load_u16 v[4:5], off, s[0:3], null tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
=======
;
; GFX1260-LABEL: raw_buffer_load_f16_tfe:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v4, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
=======
;
; GFX1260-LABEL: raw_buffer_load_i32_tfe:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v4, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1260-NEXT:    v_mov_b32_e32 v5, v4
; GFX1260-NEXT:    buffer_load_b32 v[4:5], off, s[0:3], null tfe
; GFX1260-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_mov_b32_e32 v5, v4
; GFX13-NEXT:    buffer_load_b32 v[4:5], off, s[0:3], null tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b32 v[0:1], v4, off
; GFX13-NEXT:    global_store_b32 v[2:3], v5, off
; GFX13-NEXT:    s_endpgm
...
=======
;
; GFX1260-LABEL: raw_buffer_load_v2i32_tfe:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v4, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1260-NEXT:    buffer_load_b64 v[4:6], off, s[0:3], null tfe
; GFX1260-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-NEXT:    buffer_load_b64 v[4:6], off, s[0:3], null tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b64 v[0:1], v[4:5], off
; GFX13-NEXT:    global_store_b32 v[2:3], v6, off
; GFX13-NEXT:    s_endpgm
...
=======
;
; GFX1260-LABEL: raw_buffer_load_v2f32_tfe:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v4, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
=======
;
; GFX1260-LABEL: raw_buffer_load_v3i32_tfe:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v4, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1260-NEXT:    buffer_load_b96 v[4:7], off, s[0:3], null tfe
; GFX1260-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-NEXT:    buffer_load_b96 v[4:7], off, s[0:3], null tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b96 v[0:1], v[4:6], off
; GFX13-NEXT:    global_store_b32 v[2:3], v7, off
; GFX13-NEXT:    s_endpgm
...
=======
;
; GFX1260-LABEL: raw_buffer_load_v3f32_tfe:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v4, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
=======
;
; GFX1260-LABEL: raw_buffer_load_v4i32_tfe:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v4, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1260-NEXT:    buffer_load_b128 v[4:8], off, s[0:3], null tfe
; GFX1260-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-NEXT:    buffer_load_b128 v[4:8], off, s[0:3], null tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    global_store_b128 v[0:1], v[4:7], off
; GFX13-NEXT:    global_store_b32 v[2:3], v8, off
; GFX13-NEXT:    s_endpgm
...
=======
;
; GFX1260-LABEL: raw_buffer_load_v4f32_tfe:
; GFX1260:       ; %bb.0:
; GFX1260-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1260-NEXT:    v_mov_b32_e32 v4, 0
; GFX1260-NEXT:    s_delay_alu instid0(VALU_DEP_1)
