...
; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1260 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG %s
...
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1260 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL %s
