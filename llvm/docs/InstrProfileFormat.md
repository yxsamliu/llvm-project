...
These counts represent direct block visits by sampled GPU waves, not lane
flow. Both sides of a divergent branch may execute once per wave; therefore
wave counts must not participate in scalar flow reconstruction. Existing
